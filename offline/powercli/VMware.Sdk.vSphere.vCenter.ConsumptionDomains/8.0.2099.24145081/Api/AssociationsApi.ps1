...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associationsactionadd/post/
#>
function Invoke-AddZoneAssociations {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associationsactionadd/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-AddZoneAssociations' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'AddZoneAssociations' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/consumption-domains/zones/cluster/{zone}/associations__action=add'
                $LocalVarMethod = 'POST'
                ...
                if (!$Zone) {
                    throw "Error! The required parameter `Zone` missing when calling addZoneAssociations."
                }
                $LocalVarUri = $LocalVarUri.replace('{zone}', $Zone)
                $LocalVarPathParameters['zone'] = $Zone
                if (!$Clusters) {
                    throw "Error! The required parameter `Clusters` missing when calling addZoneAssociations."
                }
                $LocalVarUri = $LocalVarUri.replace('{clusters}', $Clusters)
                $LocalVarPathParameters['clusters'] = $Clusters
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "ConsumptionDomainsZonesClusterAssociationsStatus"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ConsumptionDomainsZonesClusterAssociationsStatus")
...
.PARAMETER Zone
Identifier of the zone to be queried for its associated vSphere clusters. The parameter must be an identifier for the resource type: com.vmware.vcenter.consumption_domains.Zone.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associations/get/
#>
function Invoke-GetZoneClusterAssociations {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associations/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetZoneClusterAssociations' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetZoneClusterAssociations' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/consumption-domains/zones/cluster/{zone}/associations'
                $LocalVarMethod = 'GET'
                ...
                if (!$Zone) {
                    throw "Error! The required parameter `Zone` missing when calling getZoneClusterAssociations."
                }
                $LocalVarUri = $LocalVarUri.replace('{zone}', $Zone)
                $LocalVarPathParameters['zone'] = $Zone
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associationsactionremove/post/
#>
function Invoke-RemoveZoneAssociations {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/consumption-domains/zones/cluster/zone/associationsactionremove/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-RemoveZoneAssociations' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RemoveZoneAssociations' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/consumption-domains/zones/cluster/{zone}/associations__action=remove'
                $LocalVarMethod = 'POST'
                ...
                if (!$Zone) {
                    throw "Error! The required parameter `Zone` missing when calling removeZoneAssociations."
                }
                $LocalVarUri = $LocalVarUri.replace('{zone}', $Zone)
                $LocalVarPathParameters['zone'] = $Zone
                if (!$Clusters) {
                    throw "Error! The required parameter `Clusters` missing when calling removeZoneAssociations."
                }
                $LocalVarUri = $LocalVarUri.replace('{clusters}', $Clusters)
                $LocalVarPathParameters['clusters'] = $Clusters
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBDZpYJcgYg9PyW
# gyRvDpnzbrNrswv+JHZQMicKPb2iG6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE