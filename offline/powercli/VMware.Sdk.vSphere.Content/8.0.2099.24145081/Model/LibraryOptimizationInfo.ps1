...
.PARAMETER OptimizeRemotePublishing
If set to true then library would be optimized for remote publishing.   Turn it on if remote publishing is dominant use case for this library. Remote publishing means here that publisher and subscribers are not the part of the same Vcenter SSO domain.    Any optimizations could be done as result of turning on this optimization during library creation. For example, library content could be stored in different format but optimizations are not limited to just storage format.    Note, that value of this toggle could be set only during creation of the library and you would need to migrate your library in case you need to change this value (optimize the library for different use case).  This field is optional for the create operation. If not specified for the create, the default is for the library to not be optmized for specific use case. It is not used for the update operation.
.OUTPUTS

LibraryOptimizationInfo<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/OptimizationInfo/
#>

function Initialize-LibraryOptimizationInfo {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/OptimizationInfo/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Content => vSphereLibraryOptimizationInfo' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "LibraryOptimizationInfo"
            "optimize_remote_publishing" = ${OptimizeRemotePublishing}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+faGJrrueqnvM
# F1RVvJzw43b8mOumeg6zHZ7VZsuEGqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMJXC0nwEBBxalUG
# A88A7bedJkzWTzVhDxjEc5FjGNpMMA0GCSqGSIb3DQEBAQUABIICAFomRYwqlBoI
# 6DTzq+7INiIbIBiFy5Y7LLFemFBHM3XU/fLpAt7+3QeBWpV98OZy7SbPtHL2E+aN
# No5UZPBV8iMLnfhKNQFE5v8Zl7SMnHFlmbCnPgd5Y7jCO88UDwJ0E8adLcigD949
# Tfe2agAMEic0MiRtCMFwbwfrg7hMbQIJcWRNtDqnpRrTSX6j1m1uhGvgu/yKq3B2
# /5m00klxP1GvtDaXppFpC9U5BaFYl2HeXzOz+L49Hfz+nAqVABB0oNPwLNXN3+/h
# vacXq5rQagWNMxk4H6yVZ0sV9H9jvTK/pFTaaKM20E5o2L5+tC7wHRahx/B7z+Nr
# oSFsb1Vh2NGsZ7vi6i/+6fXPes2FM6/wAAW64kXW6qAvf9GxB29anetUMVzMy8fT
# dldzRp4I6xlL1P8h9oJnW/k7cMJEHjfMLcTz1fCj5GD8MqKcRvrqMLp5HcyQEkaf
# x/zG0bWQTaw7GdoGYJLa9RandznzcFXzby1tRt8eBAep1yWMA/OpQD9wrQUPrTu2
# EAg1iWMjnt6I4Gg8+LhoOGcSpv8fNh2kV5cdcCM3ycpmBBHq4Np4LrpwG80a5Reb
# Bp2LlsoJQdxK9Aq6dzIiVW+rt1h4FkJg6yAsVkC3MibUEthSvyqer79nczRl26e6
# aM0kUxQLwmi8JZFYXtGiBoOhBJTueomZoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGN8IsucL4O948kOx8YrEqf8JcE3nESxMYfvfQOLFqJMAhEA0eR+5/TSwxM/FPP6
# xM/3AxgPMjAyNDA3MjQxOTM3MDBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM3MDBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBpiaJUjvflbkqEHK97AzdO
# C0DfHxz4v3O4y56BnqvP2zA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAvY1lK
# Wl8s/0xkPm3vWofEdin3tluzaETWpaZKFGVGKT8qfnFOTyN4Y+iewjHI2pV4Yuzm
# 1c1d9CovpztnCEoRFzQb323bvXBQLwRRTvNdkmg9kGjMrOMMUOG3dXXkQvsQUkhb
# cUyX8uTVzWG0skQZivJ6VRvNUJgR+ceEEhbp9jMZJexftQO7gyzYKuSzu7aluvks
# UA7dhOf7ISiOqSxN4bWVbYmdptGgba4Tq5iwQXd++HAoLgAupTBgkUe0/B9nan/P
# NnbFYVLKwSe3/J298DWAZTfsxXNuTwOBVDEe7j4wym86jMexkr+2bnFhAOOAOGmI
# 3wNnutSG4raQQQ2AsIjBHYRIY2z4BuwG6mIKQIfn3X/bFrvDN4hoSzroet4VTXB5
# mmnuTeQ8naaPo2S+ToKtdDLAhHi1VmafXp7iGJheGkrOK/56VCQC+dXEok99fud/
# /R4ZBEHfUZ2HRqjXzEH72HGx4YTCKNWeI0Mv/xFrr7bxV94NP0VdrgSTKgJ0v0WN
# iXKbQZEhW12ivRE1qAR+nwd0O3Fq03nH3D8ccZohjRQTNvF6H856unxRKnyYz9yQ
# LWoIkYHP+77bREZpUfAMClaRdj9rpfUAzjaYthl138wQM2PPJM9E358/08v0OIQp
# IkFZyOyHNN583k6tqZFi5re1FsDc6+bWVr/GkA==
