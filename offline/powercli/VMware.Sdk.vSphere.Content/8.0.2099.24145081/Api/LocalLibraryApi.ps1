...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/post/
#>
function Invoke-CreateContentLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-CreateContentLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateContentLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/local-library'
                $LocalVarMethod = 'POST'
                ...
                if (!$LibraryModel) {
                    throw "Error! The required parameter `LibraryModel` missing when calling createContentLocalLibrary."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/delete/
#>
function Invoke-DeleteLibraryIdContentLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteLibraryIdContentLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteLibraryIdContentLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/local-library/{library_id}'
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling deleteLibraryIdContentLocalLibrary."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/get/
#>
function Invoke-GetLibraryIdContentLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetLibraryIdContentLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLibraryIdContentLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling getLibraryIdContentLocalLibrary."
                }
                $LocalVarUri = $LocalVarUri.replace('{library_id}', $LibraryId)
                $LocalVarPathParameters['library_id'] = $LibraryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/get/
#>
function Invoke-ListContentLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListContentLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListContentLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
...
.PARAMETER LocalLibraryPublishRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_idactionpublish/post/
#>
function Invoke-PublishLibraryIdLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_idactionpublish/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${LibraryId},
        [Parameter(Mandatory = $false)]
        [PSTypeName("LocalLibraryPublishRequestBody")]
        [PSCustomObject]
        ${LocalLibraryPublishRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-PublishLibraryIdLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'PublishLibraryIdLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/local-library/{library_id}__action=publish'
                $LocalVarMethod = 'POST'
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling publishLibraryIdLocalLibrary."
                }
                $LocalVarUri = $LocalVarUri.replace('{library_id}', $LibraryId)
                $LocalVarPathParameters['library_id'] = $LibraryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LocalLibraryPublishRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LocalLibraryPublishRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalLibraryPublishRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalLibraryPublishRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LocalLibraryPublishRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LocalLibraryPublishRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LocalLibraryPublishRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LocalLibraryPublishRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LocalLibraryPublishRequestBody) {
                    $LocalVarBodyParameter = $LocalLibraryPublishRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/patch/
#>
function Invoke-UpdateLibraryIdContentLocalLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/local-library/library_id/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateLibraryIdContentLocalLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateLibraryIdContentLocalLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling updateLibraryIdContentLocalLibrary."
                }
                $LocalVarUri = $LocalVarUri.replace('{library_id}', $LibraryId)
                $LocalVarPathParameters['library_id'] = $LibraryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LibraryModel) {
                    throw "Error! The required parameter `LibraryModel` missing when calling updateLibraryIdContentLocalLibrary."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBucBsiVM2BxXhQ
# +TFeIHYjm8TwQr4AAsiab7GUU/r9FqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE