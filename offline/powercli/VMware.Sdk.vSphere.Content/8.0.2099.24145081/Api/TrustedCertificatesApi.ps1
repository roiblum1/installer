...
.PARAMETER TrustedCertificatesCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/post/
#>
function Invoke-CreateContentTrustedCertificates {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("TrustedCertificatesCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateContentTrustedCertificates' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateContentTrustedCertificates' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/trusted-certificates'
                $LocalVarMethod = 'POST'
                ...
                if (!$TrustedCertificatesCreateSpec) {
                    throw "Error! The required parameter `TrustedCertificatesCreateSpec` missing when calling createContentTrustedCertificates."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedCertificatesCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedCertificatesCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedCertificatesCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedCertificatesCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedCertificatesCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedCertificatesCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedCertificatesCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedCertificatesCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedCertificatesCreateSpec) {
                    $LocalVarBodyParameter = $TrustedCertificatesCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/certificate/delete/
#>
function Invoke-DeleteCertificateContentTrustedCertificates {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/certificate/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteCertificateContentTrustedCertificates' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteCertificateContentTrustedCertificates' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/trusted-certificates/{certificate}'
                ...
                if (!$Certificate) {
                    throw "Error! The required parameter `Certificate` missing when calling deleteCertificateContentTrustedCertificates."
                }
                $LocalVarUri = $LocalVarUri.replace('{certificate}', $Certificate)
                $LocalVarPathParameters['certificate'] = $Certificate
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/certificate/get/
#>
function Invoke-GetCertificateContentTrustedCertificates {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/certificate/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetCertificateContentTrustedCertificates' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCertificateContentTrustedCertificates' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Certificate) {
                    throw "Error! The required parameter `Certificate` missing when calling getCertificateContentTrustedCertificates."
                }
                $LocalVarUri = $LocalVarUri.replace('{certificate}', $Certificate)
                $LocalVarPathParameters['certificate'] = $Certificate
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TrustedCertificatesInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TrustedCertificatesInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/get/
#>
function Invoke-ListContentTrustedCertificates {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/trusted-certificates/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListContentTrustedCertificates' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListContentTrustedCertificates' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TrustedCertificatesListResult"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TrustedCertificatesListResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD01RhKmaUDUDTM
# kth2vpKOdhBO3QZsDOE5xea8dfdg6qCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPx5Mm+nqGSIKmfo
# kjpjPwM7qzFMV6aYApTmMyP2VtoQMA0GCSqGSIb3DQEBAQUABIICAH91YMGI1F5X
# Gdgd2v3OTs7ehV1EtJxfvfisPRR9ar/+nvFP5X/2qwII8+G4z+pnyZAVq10yrcPB
# LFVtXzU5MqcX7GGb+EK3+vfGXRzpl+T5VECPLFlWGA3paA2ep+p4Y+zeeY5nbHYy
# p/Kacs1EBa77SdFN908aEmIdq5W7BEb86VY/N5azES3n4bb+Jl5Oh4rdLjUFNUFn
# 6yzM0ZaWn2k93hGRUZVDy6yQ5sANHTTbiGieLsMuutJFCwnrDPE/GBtxPaUiak4T
