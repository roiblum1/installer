...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/libraryactionfind/post/
#>
function Invoke-FindContentLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/libraryactionfind/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("LibraryFindSpec")]
        [PSCustomObject]
        ${LibraryFindSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-FindContentLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'FindContentLibrary' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library__action=find'
                $LocalVarMethod = 'POST'
                ...
                if (!$LibraryFindSpec) {
                    throw "Error! The required parameter `LibraryFindSpec` missing when calling findContentLibrary."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LibraryFindSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LibraryFindSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LibraryFindSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LibraryFindSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LibraryFindSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LibraryFindSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LibraryFindSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LibraryFindSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LibraryFindSpec) {
                    $LocalVarBodyParameter = $LibraryFindSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library_id/get/
#>
function Invoke-GetLibraryIdContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-GetLibraryIdContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLibraryIdContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library/{library_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling getLibraryIdContent."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/get/
#>
function Invoke-ListContentLibrary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListContentLibrary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListContentLibrary' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library_id/patch/
#>
function Invoke-UpdateLibraryIdContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library_id/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateLibraryIdContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateLibraryIdContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$LibraryId) {
                    throw "Error! The required parameter `LibraryId` missing when calling updateLibraryIdContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{library_id}', $LibraryId)
                $LocalVarPathParameters['library_id'] = $LibraryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LibraryModel) {
                    throw "Error! The required parameter `LibraryModel` missing when calling updateLibraryIdContent."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVCu6eYfKLf3rY
# Kh5u0AB1NeXDlsll3MsFo/2vgJmmVaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFFn/Xz3OvcJ0hw1
# T5zh7C8KMgYWP0P9mY42vZtn3SuNMA0GCSqGSIb3DQEBAQUABIICAEwd5ynF1AQz
# bIOq3TsXTEneDs2doC2iCfUdKPUkXl+f6c38pBwfKqYYlyPGtgyENgQPQrMiFj+E
# u0ElgvEW56mtFebdyVNs2BmaRTzwYGRf1sAKtKZZXbNomU6PzwaCCGJ5ww0MdvpS
# c/E0E3N+EMX81/mRWAUDZ0doTaU9fO6BiecGmwJ9eITzwCMrhN6AG3xYbJ4/bTMO
# T9OW7T1BmbgJtmhBSAi3+gSL6/Qy+uIs2a+rf5C+Q/Cw0tAZaH3/dO2BSjpyR9En
# YBX+e9438AE3HcOg7+8K6zt3qkixfaopvQOm3wgStpmrIJMVZN5KxxfpCL6/a5Ep
# yS4cZv+3i8Z26Kzh6BegekxE+vbFBHrzXlMHs/Rl3PWGYjr9DJS/NW4X3jGEGd3+
# mHF29dMpi5jE0NoE9ippQf9idprnnd0GjXLk3R/N0Je6wSxmXYBObjbFE+aNTYzI
# Fcb12L8SX/EtrJA7sqjOA6YMpIj8zOVXajXA0v+ap+s65PedpBTFqxwxaZhBhzdR
# NWvR+h5mqrS55tiaHS9eUY7utuZX8ydCNTBLFm4QgXYD9EL4j0xbHSXLDsEQVp6t
# Brix0q5uNUmcvQ7PJJxbHyN49HembXUNuZwngtSldZUprlE70k+YoHTRhtjnSmoZ
# qpqHfQOxyckGKc9kcGqYqA/EYJ+rLb7toYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IDA8TNcJbPQhqxynN9/5V0TKfdHKj1qmfbsn6PjbhbfDAhB/fY3VdQ7oUGaNWP99
# nG+7GA8yMDI0MDcyNDE5MzYwMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEICrNpqKfmR3BhhS2oxQB6TrQ
# zSQD08Wo9dab3ug0O918MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAAI1wago
# VSD8avTJa1IYnlnUm5Vh0pPIwRwlldBWnQvblfgvvpn/vKZ+11nMVvZn6Y4r6rZ4
# Nm1RK9Ie4HeBt7ifwik42JcFGRhqtD8JiONa21pZmdn3WBIsFa+nhRq2jlf6dsuG
# rpPdf5GXQxFKWapi7BtshzC9bXVKVASMBeWjrK3u3753cigqwcMwSQ856RpuWFlm
# VNyX4qwL/LxjkW6tyKHNHheeOfVm9rBtDGSYr1farXVhCCNi7+tIEMMvlQGygFKO
# KIJuTOojdkM+He6SvypC5RZGJRbAekO2ILsMjeDJdxQ1Ctj9d/sZ84l0B7rsFFgm
# YLrNCrxMGhH0DFaq01bVAODMXKTl7RfXWO+zi0MyIaVCv3JtZZ6gSExk6I6RjuXK
# grsA/YQViQsK5Nsq9BPBU/pHSTZIQ+1trbTkimMJY7m98imra1q9Ln097hOD4rNW
# ZoQMhn3aJa3+9ExT60XWUcCo9LLr5hQOQfZeH1JX0ZZkER3Vhx+eopFSWmRKB1eW
# HkbRFBlcRnOmPXry/kV1B0c5C4c4AyygcBGKCWTbyc+yU50gMhVjBQFN1XH3zrdK
# q8NmQQ1I834yDRJ3+Zyegdv4N/RQ+Cz1S8CPdbvAl+WoLbSqM9mBRsf+6j+uaYsb
# f8rEylCrCq/S6uZN/r1Psm/d3QNmme5Hu8Wb
