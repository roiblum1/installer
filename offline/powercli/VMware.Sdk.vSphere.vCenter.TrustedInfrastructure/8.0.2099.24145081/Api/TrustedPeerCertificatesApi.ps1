...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/kms/providers/provider/peer-certs/trustedvmw-tasktrue/get/
#>
function Invoke-GetClusterProviderPeerCertsTrustedAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/kms/providers/provider/peer-certs/trustedvmw-tasktrue/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetClusterProviderPeerCertsTrustedAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterProviderPeerCertsTrustedAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/kms/providers/{provider}/peer-certs/trusted__vmw-task=true'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterProviderPeerCertsTrustedAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling getClusterProviderPeerCertsTrustedAsync."
                }
...
.PARAMETER TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/kms/providers/provider/peer-certs/trustedvmw-tasktrue/patch/
#>
function Invoke-UpdateClusterProviderPeerCertsTrustedAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/kms/providers/provider/peer-certs/trustedvmw-tasktrue/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateClusterProviderPeerCertsTrustedAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateClusterProviderPeerCertsTrustedAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling updateClusterProviderPeerCertsTrustedAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling updateClusterProviderPeerCertsTrustedAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec) {
                    throw "Error! The required parameter `TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec` missing when calling updateClusterProviderPeerCertsTrustedAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDg01BcrSGt7M8A
# iKuSol07kZgjC6wKaPei36mZRouwOKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJoeF8KCXnufBrVd
# i7g6CL85bcX7TMA5YnY2N1h/Yge+MA0GCSqGSIb3DQEBAQUABIICAAZWA3BoyIEp
# BTR+DiBeQ2jC9csKT8FwUOsTIqNtWNI7h42KmrOHZpi1dVuSZNVy+1iUuZ8uW4NC
# wPA9UwZwD5j7Hnr1Vri0uvS4KU7jcypzq6MEWqYM/jvDJTvES/psBrFZO6FV2tKv
# h8UnzYePNNJ9+Sk32ZVgaqi2C4+1pgDNQ1KvRSht7UxIwd0UpoJS4+QjSICZjKjP
# R8Ech/AD0vPo1umhG7O/AB0cZj7A9S5cdo0AvH6h5LTkEZm7nZ6JUeE+NkYJxJlP
# tRpe0x4CythlleqAX0+H0g6+1eFt7lGxrkoSFY2vSr954daF0+F1QYy6FmFfdQzj
# yf0WRA5I+TcyeT5ibzcX5JKieN8llJBMgofB++meitguxC77z+1mUQaLJYeIvAVg
# bOFwZnDPobjqF1vkbfrGsyyKPWuk49uNGWVzEm3g1FbM1dDRl2Wdnxnwx9ldtnbD
# ZLHiCPJiHrK6LOJvxlx6dDws/qOR11VQnOUaTyo7pU0y9guVl7d84/W24jz5uxAc
# EYjZl/D/MTp8mTCQNG/oXYZcGsbDME3ef4B8nXtZDR03X1j/r3qHblVNML7VtYmC
# c4QC8tdBHFGbEWilBIH54JUp+TWYRt8Ke8pmoAarDpxY3F7edFO+1yHGIapSOPqr
# BVx6exqjltN9wTFdCYS2c6lTXotqcjKsoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IILperYcHhm7/rL4c5wqtvN4/vlzJgeG3hC2ljkaSu/zAhEA+CSEJvA+12fQjQPp
# 41eoxRgPMjAyNDA3MjQxOTQzMjRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCD6dK9om6dYCjIQ1zHDb2RA
# E1rqY/VTmDTooU+EpRjLNDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAxJ8yR
# 8h1uposCijjwyIGfnnT+Vvu3fXnfgLSbNP3LxrBk/2q/xk6K6UhyBa8TIlwoi/bp
# xKhcOE9rI+V3vCxSj4C71MZgzGVtYVyGn/367FZ1El7XSaBWGTArNTz/0qH5mM23
# HEvztXIrWM1qOOpBayS1TNpMhmSNAAyjvkuYqbBJWPjAF7W7x9ceOflU78qqJ851
# b/lQXBW6tGq+BP0cO5XZ1CdMUJyvK3Or4ffU1AhPfjj1+fLXDtFVpsLanN5cyPeQ
# mSgMDga4FytZ1ae4L02ENuhnaPgyWzBYPg3DoQb/EECz0dO2IrvP7OW9ky6KFY+i
# K/B0hf22AMdgMkdvpVyPq0IzBZohyotARWN3FqV3s/52jCskjQ4zAuR0lr83lOJL
# k2/4Bmt0bW4R1Pb2dxoU62G0YnfxVW1RF7jfaIXqzZEDWJhtekl8MRT6u3QaX9AV
# Kg+mZvHdXkWYiW3oxqGyLu9jWEc8gVwnzAs8vBS6NlaScUY4oz3Vz327UKWGba5u
# BOTh9WH2i1IffC+Q8TWeDvSargf6DIQDiADLq3KCoKeW5WXnMmkcIR/IKUapvpW6
# KwNS2ZacA91z4yc5zVdlxRMOgv1W/974Lb9spDNh6RHw1A3O33OqJ8+136aUETKy
# lxlOibXamVmoAlhWl2yGrijIZ7V7gnGc9jHKuA==
