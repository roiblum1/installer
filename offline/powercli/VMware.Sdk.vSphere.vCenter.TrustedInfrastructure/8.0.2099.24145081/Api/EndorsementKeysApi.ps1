...
.PARAMETER TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keysvmw-tasktrue/post/
#>
function Invoke-CreateClusterTpm2EndorsementKeysAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keysvmw-tasktrue/post/"
    )]
    Param (
        ...
        [PSCustomObject]
        ${TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateClusterTpm2EndorsementKeysAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateClusterTpm2EndorsementKeysAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/tpm2/endorsement-keys__vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling createClusterTpm2EndorsementKeysAsync."
                }
                ...
                if (!$TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec) {
                    throw "Error! The required parameter `TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec` missing when calling createClusterTpm2EndorsementKeysAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keys/namevmw-tasktrue/delete/
#>
function Invoke-DeleteClusterNameEndorsementKeysAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keys/namevmw-tasktrue/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteClusterNameEndorsementKeysAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteClusterNameEndorsementKeysAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/tpm2/endorsement-keys/{name}__vmw-task=true'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling deleteClusterNameEndorsementKeysAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Name) {
                    throw "Error! The required parameter `Name` missing when calling deleteClusterNameEndorsementKeysAsync."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keys/namevmw-tasktrue/get/
#>
function Invoke-GetClusterNameEndorsementKeysAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keys/namevmw-tasktrue/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterNameEndorsementKeysAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterNameEndorsementKeysAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterNameEndorsementKeysAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Name) {
                    throw "Error! The required parameter `Name` missing when calling getClusterNameEndorsementKeysAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{name}', $Name)
                $LocalVarPathParameters['name'] = $Name
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keysvmw-tasktrue/get/
#>
function Invoke-GetClusterTpm2EndorsementKeysAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/endorsement-keysvmw-tasktrue/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterTpm2EndorsementKeysAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterTpm2EndorsementKeysAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterTpm2EndorsementKeysAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/key/get/
#>
function Invoke-GetHostTpmKeyHardwareEndorsementKeys {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/key/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostTpmKeyHardwareEndorsementKeys' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostTpmKeyHardwareEndorsementKeys' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/hosts/{host}/hardware/tpm/{tpm}/endorsement-keys/{key}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostTpmKeyHardwareEndorsementKeys."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Tpm) {
                    throw "Error! The required parameter `Tpm` missing when calling getHostTpmKeyHardwareEndorsementKeys."
                }
                $LocalVarUri = $LocalVarUri.replace('{tpm}', $Tpm)
                $LocalVarPathParameters['tpm'] = $Tpm
                if (!$Key) {
                    throw "Error! The required parameter `Key` missing when calling getHostTpmKeyHardwareEndorsementKeys."
                }
                $LocalVarUri = $LocalVarUri.replace('{key}', $Key)
                $LocalVarPathParameters['key'] = $Key
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TrustedInfrastructureHostsHardwareTpmEndorsementKeysInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TrustedInfrastructureHostsHardwareTpmEndorsementKeysInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/get/
#>
function Invoke-ListHostTpmHardwareHostEndorsementKeys {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListHostTpmHardwareHostEndorsementKeys' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListHostTpmHardwareHostEndorsementKeys' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/hosts/{host}/hardware/tpm/{tpm}/endorsement-keys'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling listHostTpmHardwareHostEndorsementKeys."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Tpm) {
                    throw "Error! The required parameter `Tpm` missing when calling listHostTpmHardwareHostEndorsementKeys."
                }
                $LocalVarUri = $LocalVarUri.replace('{tpm}', $Tpm)
                $LocalVarPathParameters['tpm'] = $Tpm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TrustedInfrastructureHostsHardwareTpmEndorsementKeysSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "TrustedInfrastructureHostsHardwareTpmEndorsementKeysSummary")
                        }
...
.PARAMETER TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/keyactionunseal/post/
#>
function Invoke-UnsealHostTpmKey {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/hosts/host/hardware/tpm/tpm/endorsement-keys/keyactionunseal/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Key},
        [Parameter(Mandatory = $true)]
        [PSTypeName("TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UnsealHostTpmKey' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UnsealHostTpmKey' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/hosts/{host}/hardware/tpm/{tpm}/endorsement-keys/{key}__action=unseal'
                $LocalVarMethod = 'POST'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling unsealHostTpmKey."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Tpm) {
                    throw "Error! The required parameter `Tpm` missing when calling unsealHostTpmKey."
                }
                $LocalVarUri = $LocalVarUri.replace('{tpm}', $Tpm)
                $LocalVarPathParameters['tpm'] = $Tpm
                if (!$Key) {
                    throw "Error! The required parameter `Key` missing when calling unsealHostTpmKey."
                }
                $LocalVarUri = $LocalVarUri.replace('{key}', $Key)
                $LocalVarPathParameters['key'] = $Key
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec) {
                    throw "Error! The required parameter `TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec` missing when calling unsealHostTpmKey."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBLFEtU5dy6Zhcv
# qs4PRVQ9zUoyckmrzjnNHRTHkRc3sKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOoLH1vPSh39wUb7
# R04352Wbm2hHKA7ZGlVWhFiJHJi7MA0GCSqGSIb3DQEBAQUABIICALIFVNAhVHSU
# bYMvuGa/xKjD329J6r5ddiWmUZzTtpvpI2p255hffOU25iQlizH9A9ZoeTggFFaY
# dYbPs4CQ/B7SZqmBUzEboe6tMi6LopM2dXusaQ0Fu/DSLx5RCbZBxRmkZHlHhJrT
# v9uhrCuqpraY7z0p3Qzh8hQfS1S+68LEesKdOPe8VMYXzgJaLfQt2M0sT0Ly4BnD
# KxQgfKPAkRrKXJHwOw2jLhDnwC9fiLUlBUdBq7BlKsvcodQZ4i18HDHDbrU+vATJ
# zTrmAWMfe08OVyUsbD5t22MSvL4tX2d871ts0AuYmbC9FGHjSZmH9zcZ6y2nM+0c
# XWafdqqYg2eghlaQeJjxiLTBE0juGBS5BEoLxd83ugX7kSeH8PMtSDWFzH78RnYt
# L5jM8XO6B6zaEMu9A5ljq9JHMdZiKIjy/hdiW4VrQDkyCUc+JoE17YsNGBBbTFXJ
# iy3i1w7Dkp1/DDTJxjjTyg4KvwjZ3NaGc1oBlcN4GJ0Cj4hGQpmmhcJ7LF6bwheu
# ys9k6o2gNltII0BlSyRpcSyD5z8QXOor7/4dAuWPYUNqKhGGOVzC2TF8ZAqQ7dt2
# eR68cqqkU1JcPtu9PfS1OZLx9KVP6MVbPFkNI4V869uNUptHFr3UOdrKzpynJEcB
# rE4ihh+XQgYlmO/HeG+BGRKmqs7XCNqtoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INoMBOAacXb7xyytVuHOvJwbm/8H4FWGd889ZMtykMcVAhEA3RiUe+CUto7MW5Pg
# 717iwxgPMjAyNDA3MjQxOTQzMTlaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQzMTlaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBHFQnqInHjU9q+0B3hg+pA
# OuoL+vIiE/sbRJO9FsQonDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgADAAuV
# n/JqN9FNSi7wyfrI8c9QXvW2CBeFKnLipoGmSPbHRxlZiz/Wbx8el4uqV3fXyN8h
# vy7sG2xw/DyG9rxvsDThN3CtKOyWXUu8Fch+cd65BT8DlNrX/2hZikLGQOZBQwXH
# OT0SmKASx4koVQ4q+k/S70p5WZJ529exAzCxyvZ+MTJdUQQNKexwIR8WnwGCh0oj
# VG+6BE7Q+sy56qCVCWkrN1jCshoNBDmtOrZ2mM4UXWPKnE2pmagL3DYO8PluU+gw
# QzbuxbZuCWFbi4pe2A1F9UzPTMwkt/on2w073qLPTPVgP9CfbPbMWscFt32ODvLD
# Yx6Pn2rfjSOwb1WZXDHu25vF6ZlRBWknZdtuwJqR7oQL3UcS+GXUrMHNqxCgs5j0
# 8AV5ibbKtNd0RaxAyJyAd+CvsAHlJolNBa10M5jB1cDgBY4T6tmrwa24itDleFb+
# IiIBgn5JeSFLmRVMIQYxDvR5dPXD8WOag8t+dEQf2EzFMvO6ngB2BRG3I1ZgAItK
# UP5F3w19KYnZi2alWXScUyZ61NbMoIXmKioV6Fvd79ZTSnu7Dg+KShrdvVx5vzYX
# z4vS67uj8JhiLrnqJiiMtdhtwrYNpdLkmkDtegNsWbFeyaJcujxqBq+M2YGhdOwv
# j6HRYYZB3uPWyocl9tu5QgVyjy5a8htu8BG+2g==
