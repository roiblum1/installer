...
The type of the returned summary - brief, normal, or full. If unset a normal projection will be used.

.PARAMETER TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-hosts/attestation/post/
#>
function Invoke-CreateTrustedInfrastructureTrustAuthorityHostsAttestation {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-hosts/attestation/post/"
    )]
    Param (
        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [ValidateSet("FULL", "NORMAL", "BRIEF")]
        ${Projection},
        [Parameter(Mandatory = $false)]
        [PSTypeName("TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateTrustedInfrastructureTrustAuthorityHostsAttestation' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateTrustedInfrastructureTrustAuthorityHostsAttestation' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-hosts/attestation'
                $LocalVarMethod = 'POST'
                ...
                if ($null -ne $Projection) {
                    $LocalVarQueryParameters['projection'] = $Projection
                }
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityHostsAttestationFilterSpec | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "TrustedInfrastructureTrustAuthorityHostsAttestationSummary[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "TrustedInfrastructureTrustAuthorityHostsAttestationSummary")
                        }
...
.PARAMETER Host
Host id. The parameter must be an identifier for the resource type: HostSystem.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-hosts/host/attestation//get/
#>
function Invoke-GetHostTrustedInfrastructureAttestation {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-hosts/host/attestation//get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetHostTrustedInfrastructureAttestation' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostTrustedInfrastructureAttestation' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-hosts/{host}/attestation/'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostTrustedInfrastructureAttestation."
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TrustedInfrastructureTrustAuthorityHostsAttestationInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TrustedInfrastructureTrustAuthorityHostsAttestationInfo")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMgfqJTmvKSts/
# wfEmtPgT/w0jZdeM3kRzY5NPt3MKtqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOTnZcaz0j8iI2rd
# Giig+W8QXvJDZES+mjgHv4nBbEhZMA0GCSqGSIb3DQEBAQUABIICAJ6/Ja/4m0rP
# fsyrf2kWN0vkVdaual6GBBa8fwzuwEljjhKwVlapvFz3wbgoII7ZbzNQM9b5yk9t
# hfVd1GYPkpWxpb8OxqGvlZw1AKhyIs9llo+77bHbk4gQeZUGAr610RMuBRs5LBjF
# 3H4XcmaaIX0E9WdjzqyjbTU1W0yuoklCq7ZU35VjXbpm8d7ysnb6bWXX7dR6/Sys
# lSm/3InIAB7q20j/vgKXAKjihQMgWpIVua99AlOpe5StDGGfbEk/yHrHQzI6fpFJ
# Fu1ZZVXLhk96igm6qbkb9hAUEXqTW5NLswiL8lQToPB8zZHHXN1ods+Z/DsItf+2
# X+Kofkd8tUKzP9zME3PPjyEEl6vUwtC9Cn9Vca+s6fWnDeoAbv4cTjex52n4fyUe
# HxJsk5KaKoowGlpwZ87yAmu8xqwC3pNSUB4jtmcZkeVuf2KrfuTCDjCHsAKe8X9A
# 3S/vLnQXrAsyrQ52dRBk+zUNuXyHjwb7c4Clt5///M47lHbLrc10Ap604XRVwbPw
# RCWEMaIuJjd5km6GdpvcSRbuHLopMDjpdtlnspeT4A77JRDWy5we/0yMzbcp4G6W
# 4lBkMmaMoRYWmkyPg1sqOmPV1VgK0BHZnCNff32XqDRcUPhHxEl/Ku754zD3t5TW
# ZtLmoHZ3VF4Tmxh5725Lk+xC7eQZRzl8oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IBnwz957hyr7Y68kke9doIbQ6g/YQrmOhop4J4z0OQj9AhBU9UXeOonADCPzvvXr
# pumgGA8yMDI0MDcyNDE5NDQwN1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIEpxnwTw052ij0SSI1V2sfEj
# 8IRE5V1G0Aezi7zTxdMHMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICACAzra4O
# b5hNjkRvZDXT7wwvl/ad2hC0GK9XdO/ACPPd+WlZAG0Ceprq6bX0X5Gayvxz3nBF
# XsaM5+05IpehLryafELY4QbZs9OY+yuWpu3/sg8heVJ4s/WoVqXISlw+xKwfVtox
# exYXiXAgXI8JIDg5oUAeM4CQz34AFev5fkEAccSA5FDolMM+0R+DogWQMKNF/h2M
# U22pulbJKXZzkb2q/GkgSkgRQrSskOUtc4NKHkTQg+hqM85kPrLU/wlJjvOPzFzH
# FGWhsgn7KwyT7ZpGCcSl91exmZTwK71VoseEwxcy862GKwOajlc3dmDyiuLZTpy9
# CwO8eFsRQfUrMAjI291hKb6e7sWe6VX30yfmEmncxfwl6xfpabLx1fjBJAbmWsrU
# UHdePqWKs99b2IRs6VwA8en8M9oMUcUuSNy29NayBbvM2zNbYMby5KDOfzr6xi+C
# bEBGgjXlR+YoiYFhxZj0X7XWv6+JEvePXL5SZUBTjv46IH81cS73RmTK1tnel69U
# RT7Cj/hFzU/nIjtoa5tTnMsmwUSkyd1i8FMVX4fVqNMEkxqzg151gtnIYw0BLf8l
# CXsWgRgvXi3KBjfgYWbHvfv27/EJGIy1AAec3ohExx6w5L6A59Ws2OMp3XHJb1hK
# P6iYAr8jhM0kxxCvQEuDREay0YJiI2/Kgy6I
