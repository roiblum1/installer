...
.PARAMETER TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principalsvmw-tasktrue/post/
#>
function Invoke-CreateClusterConsumerPrincipalsAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principalsvmw-tasktrue/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-CreateClusterConsumerPrincipalsAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateClusterConsumerPrincipalsAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/consumer-principals__vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling createClusterConsumerPrincipalsAsync."
                }
                ...
                if (!$TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec) {
                    throw "Error! The required parameter `TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec` missing when calling createClusterConsumerPrincipalsAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principals/profilevmw-tasktrue/delete/
#>
function Invoke-DeleteClusterProfileConsumerPrincipalsAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principals/profilevmw-tasktrue/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteClusterProfileConsumerPrincipalsAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteClusterProfileConsumerPrincipalsAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/consumer-principals/{profile}__vmw-task=true'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling deleteClusterProfileConsumerPrincipalsAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Profile) {
                    throw "Error! The required parameter `Profile` missing when calling deleteClusterProfileConsumerPrincipalsAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{profile}', $Profile)
                $LocalVarPathParameters['profile'] = $Profile
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principals/profilevmw-tasktrue/get/
#>
function Invoke-GetClusterProfileConsumerPrincipalsAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principals/profilevmw-tasktrue/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterProfileConsumerPrincipalsAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterProfileConsumerPrincipalsAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterProfileConsumerPrincipalsAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Profile) {
                    throw "Error! The required parameter `Profile` missing when calling getClusterProfileConsumerPrincipalsAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{profile}', $Profile)
                $LocalVarPathParameters['profile'] = $Profile
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
.PARAMETER TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principalsactionqueryvmw-tasktrue/post/
#>
function Invoke-QueryClusterConsumerPrincipalsAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/consumer-principalsactionqueryvmw-tasktrue/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-QueryClusterConsumerPrincipalsAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'QueryClusterConsumerPrincipalsAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/consumer-principals__action=query&vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling queryClusterConsumerPrincipalsAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBv8zjb+QhntsF0
# r/3eJUFxVCxU7NQ10xsNVkGNJLoOaaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBtz9VE1/LVtA5kq
# mLQ4PsmRqc25KxsridDVQOqa4CbEMA0GCSqGSIb3DQEBAQUABIICAERORjktKmmj
# N1NeyOqeY4dYaJrMYWC2WhpOsG2H41SVNxCL9MCBXwAOSK7NFCp0RWTBIPSnALJg
# Wee+dIfMxJqun7Hkz05pjQIA0VL4ifn4D1dTq4r3Ax15V3FseP5aTgfy+4X3qB1m
# cK5HUElEA4reFsz7qmowAbW1pz2cJahXru+ELUE/IUxv7+USJyQlEPWDWdOyR3D+
# rD3GD83P/wmHal5HkTgv9iT5dGIzahthUysU9I0Gt3MFc1hMz8NBPO9Uu36xBiDU
