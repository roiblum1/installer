...
.PARAMETER TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificatesvmw-tasktrue/post/
#>
function Invoke-CreateClusterTpm2CaCertificatesAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificatesvmw-tasktrue/post/"
    )]
    Param (
        ...
        [PSCustomObject]
        ${TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateClusterTpm2CaCertificatesAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateClusterTpm2CaCertificatesAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/tpm2/ca-certificates__vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling createClusterTpm2CaCertificatesAsync."
                }
                ...
                if (!$TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec) {
                    throw "Error! The required parameter `TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec` missing when calling createClusterTpm2CaCertificatesAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec) {
                    $LocalVarBodyParameter = $TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificates/namevmw-tasktrue/delete/
#>
function Invoke-DeleteClusterNameCaCertificatesAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificates/namevmw-tasktrue/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteClusterNameCaCertificatesAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteClusterNameCaCertificatesAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/tpm2/ca-certificates/{name}__vmw-task=true'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling deleteClusterNameCaCertificatesAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Name) {
                    throw "Error! The required parameter `Name` missing when calling deleteClusterNameCaCertificatesAsync."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificates/namevmw-tasktrue/get/
#>
function Invoke-GetClusterNameCaCertificatesAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificates/namevmw-tasktrue/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterNameCaCertificatesAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterNameCaCertificatesAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterNameCaCertificatesAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Name) {
                    throw "Error! The required parameter `Name` missing when calling getClusterNameCaCertificatesAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{name}', $Name)
                $LocalVarPathParameters['name'] = $Name
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificatesvmw-tasktrue/get/
#>
function Invoke-GetClusterTpm2CaCertificatesAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/trusted-infrastructure/trust-authority-clusters/cluster/attestation/tpm2/ca-certificatesvmw-tasktrue/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterTpm2CaCertificatesAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterTpm2CaCertificatesAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterTpm2CaCertificatesAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDleTK9AZ+62zBG
# gPic/RHYDA7DA3tRLqURqPDqcnDV/KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOoCNhDI4Bo9zyz/
# k9kdNadp35w48Q+UPWKT2SJ7NHXYMA0GCSqGSIb3DQEBAQUABIICALRg0TdXYUE3
# GMYMI4+ho1P0Hadze+gnD3fQGUJCFfQUCOI4+ftoinI28ebr3Zl4UbUyqT0FQUL4
# kYlFgMRimINKidIuV46CLncoCQ+t4YJfy/oCVMJRRRRhWVs2PHPkswRhSk2v0boK
# iuYbd8uiSIO1pJ9rN7xv6XuJBg/rMCszIdBCaEOsl1Tww46JHuoT2k9m/rLxpkhY
# AbAVsT8b8ZwHRe3rvIV+X+QtTk/ExroqlZGyeH4IXBX+SMaT+iXEgnv/5dRiNPh5
# eE6Ar8fMBUpqXamSkTr6AYszWJDtdmteL2dW0x+dPyhmOMk5XgrMtV62ozIPAzOQ
