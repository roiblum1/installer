...
TrustedInfrastructureTrustedClustersKmsServicesAppliedConfigFilterSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/TrustedInfrastructure/TrustedClusters/Kms/ServicesAppliedConfig/FilterSpec/
#>

function Initialize-TrustedInfrastructureTrustedClustersKmsServicesAppliedConfigFilterSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/TrustedInfrastructure/TrustedClusters/Kms/ServicesAppliedConfig/FilterSpec/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.TrustedInfrastructure => vSphereTrustedInfrastructureTrustedClustersKmsServicesAppliedConfigFilterSpec' | Write-Debug
