#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.TrustedInfrastructure'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.TrustedInfrastructure.psm1'
...
GUID = 'fc0a73c3-d65c-4537-8500-aa0dee5bd1ad'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.TrustedInfrastructure.'
...
FunctionsToExport =
               'Invoke-CreateTrustedInfrastructureTrustAuthorityHostsAttestation',
               'Invoke-GetHostTrustedInfrastructureAttestation',
               'Invoke-DeleteClusterVersionBaseImagesAsync',
               'Invoke-GetClusterBaseImagesAsync',
               'Invoke-GetClusterVersionBaseImagesAsync',
               'Invoke-ImportFromImgdbClusterBaseImagesAsync',
               'Invoke-CreateClusterTpm2CaCertificatesAsync',
               'Invoke-DeleteClusterNameCaCertificatesAsync',
               'Invoke-GetClusterNameCaCertificatesAsync',
               'Invoke-GetClusterTpm2CaCertificatesAsync',
               'Invoke-CreateClusterProviderClientCertificateAsync',
               'Invoke-GetClusterProviderClientCertificateAsync',
               'Invoke-UpdateClusterProviderClientCertificateAsync',
               'Invoke-CreateClusterConsumerPrincipalsAsync',
               'Invoke-DeleteClusterProfileConsumerPrincipalsAsync',
               'Invoke-GetClusterProfileConsumerPrincipalsAsync',
               'Invoke-QueryClusterConsumerPrincipalsAsync',
               'Invoke-SetClusterProviderCredentialAsync',
               'Invoke-CreateClusterProviderClientCertificateCsrAsync',
               'Invoke-GetClusterProviderClientCertificateCsrAsync',
               'Invoke-GetClusterProviderPeerCertsCurrentAsync',
               'Invoke-CreateClusterTpm2EndorsementKeysAsync',
               'Invoke-DeleteClusterNameEndorsementKeysAsync',
               'Invoke-GetClusterNameEndorsementKeysAsync',
               'Invoke-GetClusterTpm2EndorsementKeysAsync',
               'Invoke-GetHostTpmKeyHardwareEndorsementKeys',
               'Invoke-ListHostTpmHardwareHostEndorsementKeys',
               'Invoke-UnsealHostTpmKey', 'Invoke-GetHostTpmHardwareHostEventLog',
               'Invoke-GetHostTrustedInfrastructureKms',
               'Invoke-QueryTrustAuthorityHostsKms',
               'Invoke-GetTrustedInfrastructurePrincipal',
               'Invoke-CreateClusterKmsProvidersAsync',
               'Invoke-DeleteClusterProviderAsync',
               'Invoke-GetClusterKmsProvidersAsync',
               'Invoke-GetClusterProviderAsync',
               'Invoke-UpdateClusterProviderAsync',
               'Invoke-CreateClusterAttestationServicesAsync',
               'Invoke-CreateClusterKmsServicesAsync',
               'Invoke-CreateTrustedInfrastructureAttestationServices',
               'Invoke-CreateTrustedInfrastructureKmsServices',
               'Invoke-DeleteClusterServiceAsync',
               'Invoke-DeleteClusterServiceAsync_0',
               'Invoke-DeleteServiceAttestation', 'Invoke-DeleteServiceKms',
               'Invoke-GetClusterServiceAttestation',
               'Invoke-GetClusterServiceKms', 'Invoke-GetServiceAttestation',
               'Invoke-GetServiceKms', 'Invoke-QueryAttestationServices',
               'Invoke-QueryClusterAttestationServices',
               'Invoke-QueryClusterKmsServices', 'Invoke-QueryKmsServices',
               'Invoke-DeleteClusterAttestationServicesAppliedConfigAsync',
               'Invoke-DeleteClusterKmsServicesAppliedConfigAsync',
               'Invoke-DeleteClusterServicesAppliedConfigAsync',
               'Invoke-GetClusterAttestationServicesAppliedConfigAsync',
               'Invoke-GetClusterKmsServicesAppliedConfigAsync',
               'Invoke-GetClusterServicesAppliedConfigAsync',
               'Invoke-QueryClusterAttestationServicesAppliedConfigAsync',
               'Invoke-QueryClusterKmsServicesAppliedConfigAsync',
               'Invoke-UpdateClusterAttestationServicesAppliedConfigAsync',
               'Invoke-UpdateClusterKmsServicesAppliedConfigAsync',
               'Invoke-UpdateClusterServicesAppliedConfigAsync',
               'Invoke-GetClusterAttestationServiceStatusAsync',
               'Invoke-GetClusterKmsServiceStatusAsync',
               'Invoke-GetClusterTpm2SettingsAsync',
               'Invoke-UpdateClusterTpm2SettingsAsync',
               'Invoke-GetHostTpmHardware',
               'Invoke-ListHostTrustedInfrastructureHardwareTpm',
               'Invoke-GetClusterTrustedInfrastructureTrustAuthorityClusters',
               'Invoke-ListTrustedInfrastructureTrustAuthorityClusters',
               'Invoke-UpdateClusterAsync',
               'Invoke-GetClusterProviderPeerCertsTrustedAsync',
               'Invoke-UpdateClusterProviderPeerCertsTrustedAsync',
               'Initialize-TrustedInfrastructureAttestationServicesCreateSpec',
               'Initialize-TrustedInfrastructureAttestationServicesFilterSpec',
               'Initialize-TrustedInfrastructureHostsHardwareTpmEndorsementKeysPolicyPcrSpec',
               'Initialize-TrustedInfrastructureHostsHardwareTpmEndorsementKeysUnsealSpec',
               'Initialize-TrustedInfrastructureKmsServicesCreateSpec',
               'Initialize-TrustedInfrastructureKmsServicesFilterSpec',
               'Initialize-TrustedInfrastructureNetworkAddress',
               'Initialize-TrustedInfrastructureStsPrincipal',
               'Initialize-TrustedInfrastructureStsPrincipalId',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersAttestationTpm2EndorsementKeysCreateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersAttestationTpm2SettingsUpdateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec',
               ...
               'Initialize-TrustedInfrastructureTrustAuthorityClustersKmsProvidersKeyServerUpdateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersKmsProvidersKmipServerCreateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersKmsProvidersKmipServerUpdateSpec',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersKmsProvidersServer',
               'Initialize-TrustedInfrastructureTrustAuthorityClustersKmsProvidersTrustedPeerCertificatesUpdateSpec',
               ...
               'Initialize-TrustedInfrastructureTrustedClustersAttestationServicesCreateSpec',
               'Initialize-TrustedInfrastructureTrustedClustersAttestationServicesFilterSpec',
               ...
               'Initialize-TrustedInfrastructureTrustedClustersKmsServicesFilterSpec',
               'Initialize-TrustedInfrastructureX509CertChain'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7+nIFusJhy831
# Sf7CXzrs9MvE1TtQ3MN/FpIdkNd3eqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI