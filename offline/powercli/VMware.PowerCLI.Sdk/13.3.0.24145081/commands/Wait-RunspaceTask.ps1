...
function Wait-RunspaceTask {
   ...
   Process {
      $remainingTasksList = [System.Collections.Generic.List[Task]]::new($Task)

      while($remainingTasksList.Count -gt 0) {
         for($i = $remainingTasksList.Count - 1; $i -ge 0; $i--) {

            $currentTask = $remainingTasksList[$i]
            $id = [Math]::Abs($currentTask.Id.GetHashCode())

            if (($currentTask.State -eq [TaskState]::Error) `
               -or ($currentTask.State -eq [TaskState]::Success)) {

               # The task has finished - remove it from remaining list
               $remainingTasksList.RemoveAt($i)
               Write-Progress `
                  -Id $id `
                  -Activity $currentTask.Name `
                  -Completed
               ...
               if ($currentTask.Description) {
                  $splatProgress['Status'] = $currentTask.Description
               }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCiwSiaP3ZjoXxp
# Re4yf+A0fADWNKM5n1OkkCuycaf2yKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAH3KxeWuw3KNo+I
# bk3Is8At5I22aNO4nqce0RXcS7EMMA0GCSqGSIb3DQEBAQUABIICACA18ttH9//O
# 80PznMuVRIFFe/HVDdLIaQCV7zIiHcS1erfB/E7TgjxdY1Ec+lZKBG8vItGKrnSZ
# 2RpxpgHGuMsZfKMK47UsOKxzxNlTUgfPYOFkC7RwW3Dl8Oq7Qk6XLojjATCEl3r1
# WpZMHV72o1zGye4gfE94dX8Vzy+xbQzC8QVdACv5R17sMWE8NOF15uMe3KuntMjq
# xDwROcpOEf6ZuVBxCu33ZyCvL+4igmpRMzoTUyVoSQaII0FwcSOdrWmU7CucB7JC
# NpiANP9fOQsV5CoRaJRrHRl4D414nZau3a6Srpw4S0Qzxn7dwlmX1W8ngoVxr48N
# to8mAh2fp2RjsS/EikpAb8K6tKJjcTDnuVjwm/IE6piKSUM81hLrz4/Xo+X+rI8j
# uX12XiyTcVItx1lzzDdwf6xRqZLeuzhgHBQAPuQMCy1gTQFnc4FRW6E9EZSYdV7W
# 76uH8PaJWGcp0NFx+HZ04TV5ABoGeYzI46D5cE169L9CiTNdvJEwEj23BIPhKGni
# IA9wuOEtAGogDLtqpNQI1S3HN7D11Ubcypwjt2ihOs8FuqsZv1m5R+wOJ20w1QlW
# CNEHPNXbInaG/h/axo/yUKEH8ob8rI2BIvwMZq8px8IQgrXVf3DSZpBa9xq+gEYl
# fXs3GX2yeTfR0YYEvG1ylR3wod+WlQoEoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IN21GjoFIfqDcHyJC3rnHf2CppdJupbMPg77C0qJD97tAhBgPRK97uLgDFDiUmjz
# CfkKGA8yMDI0MDcyNDE5NDkyM1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIGKocFjP8C3FpxUTodR8wmu4
# a8xhiTUngkO982CZ/A8wMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAAMM8w+c
# 49n69TLz5WdiAMMDufBGFaDfxBJcb2aZnjtuum2JNBFMr1dRZnsxmSph3LC5+xRv
# ZqJ3vrUO8SFf5sECvq4fNOvfcP3NkBnfrM6dg1CS7pZ2VrE9yR5mTn08a8eOFden
# saQ1zTeKIH2HHGT6+3j7cqWYcRxAN7SFAndtuJRmo4loBnUJgSQ82UB+B1OllkDx
# F8hU8p0j29nDtjh86MV38kXk/HAsM/GIp1WcwtNfLcc4Rysa9xKbKmcwZTIRtwiT
# JJ9oZ+OdxeSmFPEhLZB+chN3tybgIsT5QRrJYVysFHpnmva3uOIN7Zcwl2UJ+0G9
# G1o1Yf++9xu9gZOdVJ6QkP4n20AmQaOGqB77jIJ5F0wvsJ7fXOv4nGQkt+k47Nj5
# s2Ewfnvh4W6M9LiztlpYInhUx2GcG66jxoU47UuUJUbJLpxeTLD4KDUcwyVi846a
# PmbSILqN6vgRjRAPFSBI0AmqfSyOGC0hHlSr1lrSOzDeZ+N2QdYgSabpK81Cy7O0
# Coy4QxzE9LVsG1JXQYEl8pBwW1aB3yw9E7LBZKNcjLP1nZnEV1v1wLxI3puOim26
# IXszyMMEpcOjH64iZPqG5DXVweSOxm681euDDzmn8xOM1VZhn2GiAweFRRQzZkrv
# 1fBhdgCc1CHmpgDuf/TiPfgon4RjRRBTRMTW
