...
.PARAMETER VchaClusterPassiveCheckSpec
No description available.
...
VchaClusterPassiveCheckResult

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vcha/cluster/passiveactioncheck/post/
#>
function Invoke-CheckClusterPassive {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vcha/cluster/passiveactioncheck/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("VchaClusterPassiveCheckSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CheckClusterPassive' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CheckClusterPassive' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vcha/cluster/passive__action=check'
                $LocalVarMethod = 'POST'
                ...
                if (!$VchaClusterPassiveCheckSpec) {
                    throw "Error! The required parameter `VchaClusterPassiveCheckSpec` missing when calling checkClusterPassive."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VchaClusterPassiveCheckSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VchaClusterPassiveCheckSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VchaClusterPassiveCheckSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VchaClusterPassiveCheckSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VchaClusterPassiveCheckSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VchaClusterPassiveCheckSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VchaClusterPassiveCheckSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VchaClusterPassiveCheckSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VchaClusterPassiveCheckSpec) {
                    $LocalVarBodyParameter = $VchaClusterPassiveCheckSpec | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "VchaClusterPassiveCheckResult"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VchaClusterPassiveCheckResult")
...
.PARAMETER VchaClusterPassiveRedeploySpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vcha/cluster/passiveactionredeployvmw-tasktrue/post/
#>
function Invoke-RedeployClusterPassiveAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vcha/cluster/passiveactionredeployvmw-tasktrue/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("VchaClusterPassiveRedeploySpec")]
        [PSCustomObject]
        ${VchaClusterPassiveRedeploySpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-RedeployClusterPassiveAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RedeployClusterPassiveAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vcha/cluster/passive__action=redeploy&vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$VchaClusterPassiveRedeploySpec) {
                    throw "Error! The required parameter `VchaClusterPassiveRedeploySpec` missing when calling redeployClusterPassiveAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VchaClusterPassiveRedeploySpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VchaClusterPassiveRedeploySpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VchaClusterPassiveRedeploySpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VchaClusterPassiveRedeploySpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VchaClusterPassiveRedeploySpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VchaClusterPassiveRedeploySpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VchaClusterPassiveRedeploySpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VchaClusterPassiveRedeploySpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VchaClusterPassiveRedeploySpec) {
                    $LocalVarBodyParameter = $VchaClusterPassiveRedeploySpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQCwwJhkChK+LK
# FvwDRqAbck7VacrQYKTX9ENtRkAMm6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILqo8B+LMxBQgtff
# Lq0vNyp4UlfeQZY4AKrLeTQ8s7g8MA0GCSqGSIb3DQEBAQUABIICAF0NRU4SL4Ao
# SKxsnWtZkckqR4cvaIqWGrwgtq7DnOJwtNuBhVC41mzCQawTI4JiuA2UoGbYvndC
# Jw9cVAX2SbgD14Sa4EF4WrOfYmzzYm/2SWvbZqtzFVfgJxNr9/5uozsDiNTUv2bi
# lPlbkhFpGFOBtw6zjsGLvPIQaZG1cdkB5nxviDAlcmkZDNsCxknQFQVwBOvz3tFU
# EV5q6xooqcdzSYUcOQOxVl4m9ewa7MW195PLfHjKcxPp8IrE3vtLWUGM8wqjpKZ2
