#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.VCHA'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.VCHA.psm1'
...
GUID = '78528441-bdf1-4b1f-a4d6-b31213074abd'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.VCHA.'
...
FunctionsToExport = 'Invoke-GetClusterActive', 'Invoke-DeployVchaClusterAsync',
               'Invoke-FailoverVchaClusterAsync', 'Invoke-GetVchaCluster',
               'Invoke-UndeployVchaClusterAsync',
               'Invoke-GetVchaClusterDeploymentType', 'Invoke-GetVchaClusterMode',
               'Invoke-SetClusterModeAsync', 'Invoke-GetVchaOperations',
               'Invoke-CheckClusterPassive', 'Invoke-RedeployClusterPassiveAsync',
               'Invoke-CheckClusterWitness', 'Invoke-RedeployClusterWitnessAsync',
               'Initialize-VchaClusterActiveGetRequestBody',
               'Initialize-VchaClusterActiveSpec',
               'Initialize-VchaClusterDeploySpec',
               'Initialize-VchaClusterFailoverTaskRequestBody',
               'Initialize-VchaClusterGetRequestBody',
               'Initialize-VchaClusterModeSetTaskRequestBody',
               'Initialize-VchaClusterNodeVmInfo',
               'Initialize-VchaClusterPassiveCheckSpec',
               'Initialize-VchaClusterPassiveRedeploySpec',
               'Initialize-VchaClusterPassiveSpec',
               'Initialize-VchaClusterUndeploySpec',
               'Initialize-VchaClusterVmInfo',
               'Initialize-VchaClusterWitnessCheckSpec',
               'Initialize-VchaClusterWitnessRedeploySpec',
               'Initialize-VchaClusterWitnessSpec',
               'Initialize-VchaConnectionSpec', 'Initialize-VchaCredentialsSpec',
               'Initialize-VchaDiskSpec', 'Initialize-VchaIpSpec',
               'Initialize-VchaIpv4Spec', 'Initialize-VchaIpv6Spec',
               'Initialize-VchaPlacementSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBoe7UuZwSjgpcM
# 5yARW2T6Y/L5JrGvgrCEvWiiL8BCU6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJGVBFTZFphfLluI
# HNgDxARRH/UMg+x29vV9my9OqAblMA0GCSqGSIb3DQEBAQUABIICAFAVMEL2m1T2
# 6islpWwC7aoFgfATI+KhRudTDfxbfN85+U+5R2dTRX8U5aXC6/jT7nc02YLm7vQD
# aN3wDHfWvcyGxk7SeteZodPL+5apYr9lt3zOZq4r9Zqp+KPSyDitfDC0YMB4nNQw
# 3srSEu8uRHGgsGsiL3IggsnhcakOI85ZrT6A2hxJmpao2C3uz/vgBJlCEsOSRHr8
# y+CnKRPAvC+n48L/fcf+8/W8LHxPOHQ+cEmJKc21RYg9Ks82qmdOarEr3gd42xiG
