#
# Module manifest for module 'VMware.Sdk.vSphere.Appliance.Access'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.Appliance.Access.psm1'
...
GUID = '5163a70e-79f6-46ae-a491-47e87acda911'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.Appliance.Access.'
...
FunctionsToExport = 'Invoke-GetAccessConsolecli', 'Invoke-SetAccessConsolecli',
               'Invoke-GetAccessDcui', 'Invoke-SetAccessDcui',
               'Invoke-GetAccessShell', 'Invoke-SetAccessShell',
               'Invoke-GetAccessSsh', 'Invoke-SetAccessSsh',
               'Initialize-AccessConsolecliSetRequestBody',
               'Initialize-AccessDcuiSetRequestBody',
               'Initialize-AccessShellShellConfig',
               'Initialize-AccessSshSetRequestBody'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDlbLWFE+gYP4iH
# hD5RdPtWJaVp0VYxF+g8B0+nQ14m5aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILElnZaOPOgypSlX
# mn5nEQ5WEtVyNGPv7eLQIAksE14FMA0GCSqGSIb3DQEBAQUABIICADbc7+jEB/qk
# UOs46/JFYp8l5ISTymd9FI9GdNaqlXKuJr0CWAHHMxAl8LmYciN/QdOxRyjUqt54
# CLKfnskpRPrDy35Eg+/rSxRnWCcl8hDQIGdx4Zums4XXzEFQM/BtMl0pNYfBRVbW
# MDXP4WOjjQDIeTo2R6RygTQIIiwkw7xNzEhfIvJrmxAV4mQNe68ESafTtDv3hoy2
# u61llzNDjO47G3spuB4+3tpqPJ25m9s7tl6nEYNf1Dc1GhBSsHa/pkydyEZVg6P5
# g8IwNQZpVJg46Xr04c3V2cQo+tVHB4c77oiyumYB01LhJkn4rbt+GMJPLMP7zMeR
# hiXhG8KNhs3P3XPgjTGuKKCR//UaP4uNyAGkvd2bCNvPfMGSFkPolmqVMO4/ttEh
# Y/Iuq4p8H2uYqlUvBT+bOndlpoFKsvHcS8BsOfaDTL4RAw6/nwgI3MMNTcmmNQpl
# gSTkqQdb8tqjvhma6ZwpdccMJTo5HxAWjKlSwCeczDITIDPGQrdN0Qd/qLJABG4b
# Lu04Gh04Nl4egsEjooBtMcNj0C7Qdeo+i5+1KAlHChF7F1iz4PYkFmsKdcQnRIeF
# bTNoxPdOZ99RCs+2xZIopUBQdLKTynV5+diQFTHEdL3OFdOmCPsBhIkCGr5LmQFK
# TKEAOXBYUngzv01Qf0WdagyaVsccI6ajoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDL/wF03iTVScYqW/u040BbPKlSwD2Ob8MfEQxCpobTfAhEAtXbwzecE/uMZHY7F
# LGR1VxgPMjAyNDA3MjQxOTM0MjVaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM0MjVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDBtscOYoMNdFN6cnMnqK3F
# DmBz8j60rcyzc9ILEfmN7jA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAG5yb7
# 3dqe+VfDC8XoOhz9nT0gi1KG8hkhekLh4vvnjAUzBWWnbn23HvES5HpmmbXdTatu
# 1j+F0j6VXE1/H1hDvnkNvQDhZMFjaBPDT7lTVRRAj0uPpYiXfwfbppElj8PoMkBP
# Bdbff8hmxBgo5hM4DOAJWfsg8aCFPvY7HAhfAkpVW3EbBgBvMo3s3MnJLx5eXhoh
# X/S6tGYrZCvt5c8jfHr1WbrD6LgLKbf0eeedJCBdMK/9HaJsvJG4ytZzYKM1X+Q5
# EClmcQewtaPYa0u8nEcli+ndXA/3Ck5DN/sHQxRlccQ7Ye3g5b+3Brus0v3bHxoT
# amvZRBSkYiXBpihfBeu5z2pDNfP/03B/6TolSl0JvK1RUp/Z/8x6BI1DOU62Axwi
# v1geD3adUbaXhUjxoihC3EbZUKOqXEq0F5dgFBqabBKVNBj3hWTHQbhA7aScLeTO
# oij/xvyOkX2Y/qyLjuoG3DI9t/T/bF550mJp2FA5IxnKnQb63wMucm18B0uozPru
# cY3u1OgcHv1PuWY2I8t3hLIjR8lzN4tTPSVaON1mYoiyhyisuCre58XPrKMGO0b3
# eo6aKjvTPlNJSNkxVAzV5X5/XFGVsAjDtZnh3qoYwjs+nJCPkNMRKnk5SxvU6Lwv
# kRdxdZUi0YGleFRWY3zbe9HZxbc07GFumgHxqg==
