...
AccessShellShellConfig

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/access/shell/get/
#>
function Invoke-GetAccessShell {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/access/shell/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetAccessShell' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetAccessShell' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/access/shell'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "AccessShellShellConfig"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "AccessShellShellConfig")
...
.PARAMETER AccessShellShellConfig
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/access/shell/put/
#>
function Invoke-SetAccessShell {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/access/shell/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("AccessShellShellConfig")]
        [PSCustomObject]
        ${AccessShellShellConfig},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetAccessShell' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetAccessShell' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$AccessShellShellConfig) {
                    throw "Error! The required parameter `AccessShellShellConfig` missing when calling setAccessShell."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $AccessShellShellConfig -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$AccessShellShellConfig)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $AccessShellShellConfig -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $AccessShellShellConfig -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $AccessShellShellConfig = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $AccessShellShellConfig) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $AccessShellShellConfig | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $AccessShellShellConfig = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $AccessShellShellConfig) {
                    $LocalVarBodyParameter = $AccessShellShellConfig | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA5dgqoM275DWJs
# HZE/alHnbcua3r9NjhuoJwm4GIFERKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKK4mMXvQ15GNzlH
# a7EMzqAc7+uqf0TuvfffAAWZ7t88MA0GCSqGSIb3DQEBAQUABIICAHblhnGIEALI
# MPYFu/8cqQX6IBXYpXRvrlG/XgAuznpzWITEYkeiDdnYmV1exFlaJRoAyI7pFGi8
# xjc1RSHwv7bl4IqKjGAaorery909m6hhf5IuGWfGPvAUlDRe99OrvPMMODYD/X4m
# jPuqdeS6OGc7nYVUReXBiSJHwT7Qhbf6NxTrU+i8TCC5teTk0/mdj4Tx93KvmIp+
# WbUhb8f3NtGqYDJbEg/dQJOxA+x8Wyf+Zi874MFUJtF3iDqdkFpB2pLAxQz31n8k
# rtjf6GGYvn/V8V/ei5HNDyIYaUppnnOIAuDdv4XiuiXqkMRWAB3jMAReelZevREx
# Hv96dP36+oQ3xbsWXNrNebN+eThWhv3R7gRs1RyQ287FXs6jTpUrTGpB+ab3ukCl
# hqmRu2cPAy8JAOqqZnbNfkPyvTmYbpOQBcTSKjA8XKEdlj42tImhadj0ncR5zr10
# r14kGNxOUUhIiyFFYq51KS3ULK1YJQinpCVPpE5B1FwY8MNdGSQ0c3w7aIHdNYYt
# h4cOwjDHyPLAeh18TIjAroOru40ZoNJX758Jb8MxHT/odo3JnuHWR5fgsCAkbE3W
# MpvSnMFEMnfrBvnCR44GPCO5uTV1ZFadEUe3WsepxaE2tEIkc/W5XuGKMQ6O4gOY
# ewvQp5iYV/i31EpXOc6AlBv/pMwZqTiAoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INR/KfRuS83YrvHcZM8wXVUXzkgtoxJwEnN7yuF6GybZAhEAqhrEUJBKqnOgIzfQ
# WE1JhxgPMjAyNDA3MjQxOTM0MjZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDx89wllDdajedXLIPPKTnk
# pbc15K6estOdvaM0tnZhGzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB50y9+
# zSMjUa+IZmJQkDEuD9S40MAWMNXdF9+Ze2s/HOwCBhc6rru078sd9PQURIVaR+fj
# KSLKpraUUAGfUvMGhi7ssbaL/mabpiP/IUJXr+EJJCWWkTpCBcQ6Y4Mq1HXVQzLX
# 12Ra0S2Yr7hz+iljd+QDYUv7VEYGAY79lXCI9me32da//6Y5D6CbBN47AFaxYZp3
# vhJ9SUxQBdhkmONzMOtepWifUXUce9FfLQ5KbrjVIgEz0abOo351DDcNQalkoCTw
# 5p+Y3Ko1YtvCbMhhC8OJzy0IudlvLdyNd6dTSxJ2jbVsxfsZ31jng8oU8QQ0Ofgi
# 9RZ8qrlgFFpgg7/58Y6AQmYgdJYYiUc9B/1x2hkag7N6hQAehc3hPF2HQBc1wsBH
# J3x/5mqSJeyFeoZrh4zTJFMb86nzQvAAIq77ovWn9/H7JM5AaMEdqauo7FTb7VUd
# DOWGc9oO8fs7jJ/829bdo5s9vFcSgTdRSmOdrjTNc5jtKj9RlQ6jGrbUFm7SGapA
# 9k4G/lrpwpc4nvOCnSVh5ZP/kTO4DqTwVv+OuvokAfYk/Yz4aPInEhqpAxLm2i9Q
# sCYAum2o6eNUU1ZlZZM260yUGqr7cAIqAKNx/KeySYd/L4n0D4rGoN7PZr/VOlpp
# AYz3OSYERvLxEhnpyIrDb6SqohDy0jp/+y0Afw==
