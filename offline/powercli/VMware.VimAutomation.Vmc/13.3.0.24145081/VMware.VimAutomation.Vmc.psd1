#
# Module manifest for module 'VMware.VimAutomation.Vmc'
#
# Generated by: "VMware"
#
#
...
RootModule = 'VMware.VimAutomation.Vmc.psm1'

# Version number of this module.
ModuleVersion = '13.3.0.24145081'

# ID used to uniquely identify this module
GUID = '502c5bdb-da3c-423f-a4c8-8240b424f89d'
...
Description = 'This PowerShell module contains PowerCLI VMC cmdlets.'
...
RequiredModules = @(
@{"ModuleName"="VMware.CloudServices";"ModuleVersion"="13.3.0.24145081"}
)
...
CmdletsToExport = @('Add-VmcSddcHost','Connect-Vmc','Disconnect-Vmc','Get-AwsAccount','Get-AwsVpcSubnet','Get-VmcClusterEdrsPolicy','Get-VmcOrganization','Get-VmcOutpost','Get-VmcSddc','Get-VmcSddcCluster','Get-VmcSddcGroup','Get-VmcSddcNetworkService','Get-VmcSddcSiteRecovery','Get-VmcSddcSiteRecoveryInstance','Get-VmcService','New-VmcSddc','New-VmcSddcCluster','New-VmcSddcSiteRecoveryInstance','Remove-VmcSddc','Remove-VmcSddcCluster','Remove-VmcSddcHost','Remove-VmcSddcSiteRecoveryInstance','Set-VmcClusterEdrsPolicy','Set-VmcSddc')

# Variables to export from this module
VariablesToExport = '*'

# Aliases to export from this module
AliasesToExport = @('Connect-VmcServer','Disconnect-VmcServer')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCFqVTWhdRd0uCr
# mIiQDwUhjQPVEHTESjgIQyJsmN43IaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIK+7iqaSnJ96USy2
# syNLfio2TKgf3zMMa7q9Mt5KxegkMA0GCSqGSIb3DQEBAQUABIICAEYkNW4OW6Wx
# NiA3YyQ9iTa5QgivGfraVOxyk1jyeRvy3pC0SiMtLJB+y0KmQ1+Rgr+fR1I0vwar
# a8F+jI13tclPEBaAOadioxQMeMICB4lFlkR333gqDEx3BAZwTbXA5r9tXxYpNIe6
# 6YNrLrXCJRCwzjLQt/SgXVwG3u9Az/6QGp0V8lh1rfJ9oSW02ISDVMQ0SuzYgru+
# th2koY9HJ/uqerDj/7H/s8OMQKJAS/HX1Bs9ieZY8nQton/qSh5eI88CT7kRCEzQ
# azNagJPe4W7aO/LeYzYPt9fdKREH9YxXZiw3WyqGp+v8AUbXUOu/wiEKPdwCsT0l
# q+ZCtRrtuUkKZaShW3jn5tAA+1UWGrsZp64OBEbJNZuyQzV7LuHoBIVIoH2b+zQR
# 0SmOLRK0WH4452XT9YV6ijfIABWHH+Y2MMaaA2SBfKabnmVc2J8hsOH91TA6KRHM
# /om/qzs+vaehd3Tlv4SRp0ZydUyKAG5Kg4YJEqwM+IAlQ74Fu7FrJlONNnP7JbrH
# QJcsaPW2I+AJQTSHQYwFr6kwTTxZ+CdY/tKzm7DF1aYNTYzhosq/+3y1wQZCELU6
# oXdD+JdwViKRA3yJdXVAfSoViAipRvdmN1RXyrhoDqaoNGV0txOx/eilGdoPUnwV
# HtrgPjafSQ+qPkZTKXzLMxPQW+U6M7C3oYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ICLi5buFLNp9izMEHl0NwU5oiwadydSxqPiA9GmRfalbAhEA6ONcTsRdcYR2z/jC
# HcQgjhgPMjAyNDA3MjQxOTMwMDNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTMwMDNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBTB299so9cWbn9CEQnd2W2
# 0aQMOAxkcjXdOTuRwqBFpTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB3DbUN
# nQkAN8/cGPptEW+7Tu48oFOo0MzUOsZwDdAooDZVCXLouT1Vss6ggU3hgNx+Wj4t
# ZFSqcOF6YBoElPpsrFy1Bm+WJEudl5QYBLWxWWw8gbGukveNNS6DJV6YiNTNzl1F
# KtojTvGKsr1V//bfpKYf1dkbW0RqFnKcU9MD71JU4R3kXyc5uv40sTDvgkVJKwQi
# X8+GzWOMO1Rbk1vQ+XRL1NihKPGPt5MSoC9vD/JjEuZTtXhs/Bfr5BkMQrNgk1t+
# boTlbxQG4Z7pA39tt5OfcOb6fxuOifUboT1wgtbLRJWjcbWICxOXwaHF6l/zAFWN
# jrQhn8q1ysNXx7uWVafH/roH6Wu3vt785MNkDVNqf9EsPJKtG121/x9zOKDra4Xp
# 98u5uf760tM3j5x5DxPU9AMmDf4QxmQq7+ODAgE/Kbn8GerQ+f86A2Bz+PXgsHZa
# SMqIFsr5MMFtFaR8PBvKHMASEzagZfmYiLj8SwWSEXxwO8J7ohhe5obkWK5pNZJP
# DJj1/GRzxjjnUSWqn1/K+KH966Gs2QHiZkL5LaE//sZAYvRrQbcEsbkgZs6bD9HM
# 90ZOEx+rzyhEnSZc/Qb4M19EGRal0KpLPkPX8ZrwdXPy68zBOAjRAceNElStZnND
# QytOI7otu7y7++VuqXjiKsbcF8QoQkLWUDDc2w==
