...
ModuleToProcess = 'VMware.VimAutomation.Vmc.Commands.dll'

# Version number of this module.
ModuleVersion = '13.3.0.24145081'

# ID used to uniquely identify this module
GUID = '50245bdb-d43c-424f-a448-8240b424f84d'
...
RequiredAssemblies = @(
    'VMware.VimAutomation.Vmc.Commands.dll',
    'VMware.VimAutomation.Vmc.Types.dll',
    'VMware.VimAutomation.Vmc.Impl.dll',
    'VMware.VimAutomation.Vmc.Interop.dll',
    'VMware.Vmc.Bindings.dll',
    'VMware.Vmc.Autoscaler.Bindings.dll',
    'VMware.Vmc.DRaaS.Bindings.dll'
)
...
FormatsToProcess = @('VMware.VimAutomation.Vmc.Format.ps1xml')

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.VimAutomation.Vmc.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVSv46u/P14mBr
# 0YJjyryPAFtjpcONkdePXiUo0sR2g6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHv8Xq4t/TV1S5SI
# HrC4SJJpYQk2qd+OCJAEOads2T/jMA0GCSqGSIb3DQEBAQUABIICAFKPbWsMHeib
# jVoZK8/q4/0QK1cGGsgoV/Kma3kEHNYKO8bLkZYz2eO/9nZQaRlwpCvnoHsOyIXL
# /bb/inY5bImWO1P9nXHw/d80NCZmbiyWDwRW1IK7gNYqi6iOBucSI5rdF9Ku9syw
# KfpR/158gBokZDGAhC3OyGgcHjb51AYoliyjxNcA6xLGcetalMJqkkY5EsT4byZw
# mZ084He8WUZp4sevpL6q/O4/pTM+WdM0+Qki37BeFc3T5duxhTKir3/w/atG6v7l
# 5p94D7NX/Ib+g21L049As1szJQrMSmWlum06A0LW90Ztsxav5hI5Bz7RXy5KaKG/
# xxQQM78druzw5JpeejMBk0SuBfvDn1W3dRzPfflPuYyiB9goZDad19TlPf4abIAq
# F50Amgb/qA9fgX0aYrSdpeIgv5chdW/5s3JAJ+Eo5A5gt5CD+wLdUteS9WU4Kz8K
# iJAHAdj9IL0RjA01u5/2OuH291wOCkF0rzs+6qOwCVLrDiCHZkn1wPmArsETC6HG
# fayVbOXNVkpPyaT7iJNMPHOVC3oDIvGlL9YX8sVZw9lcpGwofsmjNKYQskubh+SB
# u8WsaRIXXfM2uOto+ZGWHSxXuqnOuI9rDMNJYzUictuHvzjPoUa+mOOMsLOAIEND
# 9BPM/zVOH27B6pJy64Dp3mguZiPiSyXmoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IK7Ml9ZqNUrJm+SLioHsBPwEfzOiG3QxMk/ZL5IQe6GgAhEA56OxqwpMgaLSCPED
# C0k1/xgPMjAyNDA3MjQxOTMwMDhaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTMwMDhaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCPZjikBq41mE1531jkptHe
# GbA8P8Fmjt+tQprV9annWjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBUS96a
# 00kW0JVM2AzmpAvL66HX+JJv3S3Jt7zEi5/VWNWX/k0JeNV3Q8K347b5CMzG0onv
# SQM7WHzjjPeY6smNlC0xlrQfcuXUvGNgvFL/Sb0us4x+/MBRJk4cvNXbeqYdaFf/
# 1VCwCQaUuVPocGXR6OAWR2jlDXtaBgE6QGBKW5LcS9KFr/QNqS+1lWXvy2BixmUn
# ed0wdSctwFGRciwkVpIUDlGgPQClkOWdkiTwqlrSLV8dat+3ODjnjJqnqeXNeJoU
# B+g+7ZBKcjw0wH4BjLlsPJQ5lRz58YKuIVQKmJW5ujRmZbTMG2Ul84Pg4o0VQ+Hf
# mqAo35hd1RnWyaEy3k95yXlJTEjKVqPetbcjZBNDOI7o3VK/T2uBNspj/Il7a33T
# JR8dU95npgvCzlBCzEZLDU5B4Cnis0hrg110YWixs6qRrRA8i7aofk6edn2EPK/G
# 92jSwrnz5sN8Soa5hP2S0ue5dzYTSgcJsOL8sFbhnDTE49HozdTuWzcP3IesE56C
# FNae8uptVnFMVkEVo7eYd5pbCCUlcDKNzIZYTkfPHTOIXgVpWDCDnJ8sItwPl64Y
# uDJbay1MHCsYKjaErwOze+PAKSA0YRjUuDKdTxwXOnifzgZA+ESo0KnWq6O34uLX
# ih0X5nlWz9HTbkdCcxCFKdZ2Do1S7JIPlF9GCQ==
