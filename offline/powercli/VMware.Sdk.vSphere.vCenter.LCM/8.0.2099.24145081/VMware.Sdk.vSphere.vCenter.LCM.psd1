#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.LCM'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.LCM.psm1'
...
GUID = '3ede3f1c-a4fe-4679-9141-fdf82697371b'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.LCM.'
...
FunctionsToExport = 'Invoke-CreateLcmDiscoveryAssociatedProducts',
               'Invoke-DeleteProductDiscoveryAssociatedProducts',
               'Invoke-GetProductDiscoveryAssociatedProducts',
               'Invoke-ListLcmDiscoveryAssociatedProducts',
               'Invoke-UpdateProductDiscoveryAssociatedProducts',
               'Invoke-CreateDiscoveryInteropReportAsync',
               'Invoke-GetVersionUpdatePending', 'Invoke-ListLcmUpdatePending',
               'Invoke-CreateVersionPrecheckReportAsync',
               'Invoke-ListLcmDiscoveryProductCatalog', 'Invoke-GetReportLcm',
               'Initialize-LcmDiscoveryAssociatedProductsCreateSpec',
               'Initialize-LcmDiscoveryAssociatedProductsUpdateSpec',
               'Initialize-LcmDiscoveryInteropReportSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAT/oYCl4qULvWW
# lGTeZQrfNdl0cu3MpVMr/K0yQI+gx6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG8UELtdT3TT8mPw
# 3cbNiCnOq8tOpEXhZA2I+RezI6rmMA0GCSqGSIb3DQEBAQUABIICAGfsZpVaBTLA
# wp4QpP4BxXPmJFGX9S0wvZY1SaKe0AcMSZjR4hQ8xLNCzr/3AsqLr+LfGs6f+FTL
# iMhof/c94SLFuGWdYkbxKxyRikaqayGzUGJsPJJN1N/OzI0nPSUkzBSLyC6XMkEH
# 7OXbbiuv3StRsHBfU94xZmlQ+L+QTr8+MaxzSSdnFSUFDR08JL6J88oL9C3F9D3i
# bNon62rGVetycEl7Ozc5ZtvkEaVXyX5HLuZIPIpySlfydqSgFb2rfIspAxcVRzAm
# QDcYvk6+/SSuSMX8tfcW/h45KuB615cPoJikmVWlLkmbH6MNP2TCDBueDONxHYbn
# vzbt8rKw0q7mwUX9dqcUA6YMjuqbR52IVM/dnY1RwJBtJcR1s5d+3wqcm0QyMUQe
# 46p4Q1gz4kj3VfTQG4lcSuR/0H8v93yIyaR4PBtZHeyJPZ3HLRbgur1SP1qLVHkP
# aEGGWDkH65ZPd/tAhxNFkrlpzeW7EQrt6LWG1KOAC3FR75zTNKiuhwjuPHnD98ik
# azkxnzOCrf0IJFN4OCm1UAWxqoeYKjI9uomJ7+p6Ew3Zqk32kwMD66V82fT0I59e
# A3GDBP8LhmV4vP8mUZLimARZ0vZXq4LpHaCDjV01vxLvOg2BQnjXDZpW+k0aYuV4
# vV6mTyCs7yHbg46ntJViD9M5xqOld5LroYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ILckJw7Ru6ruXKHkBicXVescrM/UrxIOgpAXssAhU1y8AhEAu0kCQhX5REORFUIr
# atOTQxgPMjAyNDA3MjQxOTQxMjBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQxMjBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCxLj98NZIRjLdFs5wx/Qjr
# iDhQ4r4nrFyLtEN7Q+wjxDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB4pEOw
# 0CNh3wjOdEPcHS3Lwb6oitu5KxnNnjp2kWSzRcrWAOqe1cFu9DL3ZzA9ncd1auDJ
# CuIHtNepYBClKa1v1iwR3stQ6P5oU6iJBx3VUwsQc6zQmya42DFaIV64OyO3tMIM
# nBeZHrfDly/dfQvw+HSTQnJziwso/jJXeAmI0pUPIcUcRRpTVoJ5/9pEpvlLNoWo
# we6mmhvqbdCG0aZ1ovouBNxFzpuH4gMjztQrzljKljHZsXMHOLAd+SpLYKgX2D+O
# tSJ1UCITltxtYGFw51iJq4AxXvixSYlHd47ATq7Lz6Yj797a7dEEMb9rY3onX6Ew
# tOWkNsHZnk2VGFF6ZJQ4P9P/yPJ5/jmbSFnymOwmxBZaZeRBbNByahWoqUKBdGql
# Pz/aJmo1hPyLvYAFuwmjYhZ8gdt7bGS6mygoAUTyX1Evos4nOA4sfE5laFVKpV8F
# 5z1DaUCfk6AytcMBbk/bh6h0DG2mlGeLAi1m7CbVVXrlWpMgvcEUTAw1aOVvldyH
# bWOqfD5LxyqjsViv4Jjle5oR7PNggkEfFBZpEsriUr2u5P9X2EzAS1anyWi1whkZ
# Pa6SBinKOHvMy7VSE0eoEX3Yx8JjNF+nG3cK29ipoNA+9J39pI4MAAtHJ/dN+y7I
# 8MQQbBKUoEcM4CJjxZ/UZJ8dA8Cffc9gynU9Eg==
