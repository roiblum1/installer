...
.PARAMETER LcmDiscoveryAssociatedProductsCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/post/
#>
function Invoke-CreateLcmDiscoveryAssociatedProducts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("LcmDiscoveryAssociatedProductsCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateLcmDiscoveryAssociatedProducts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateLcmDiscoveryAssociatedProducts' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/lcm/discovery/associated-products'
                $LocalVarMethod = 'POST'
                ...
                if (!$LcmDiscoveryAssociatedProductsCreateSpec) {
                    throw "Error! The required parameter `LcmDiscoveryAssociatedProductsCreateSpec` missing when calling createLcmDiscoveryAssociatedProducts."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LcmDiscoveryAssociatedProductsCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LcmDiscoveryAssociatedProductsCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LcmDiscoveryAssociatedProductsCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LcmDiscoveryAssociatedProductsCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LcmDiscoveryAssociatedProductsCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LcmDiscoveryAssociatedProductsCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LcmDiscoveryAssociatedProductsCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LcmDiscoveryAssociatedProductsCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LcmDiscoveryAssociatedProductsCreateSpec) {
                    $LocalVarBodyParameter = $LcmDiscoveryAssociatedProductsCreateSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER Product
An id of the product to be removed. The parameter must be an identifier for the resource type: com.vmware.vcenter.lcm.product.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/delete/
#>
function Invoke-DeleteProductDiscoveryAssociatedProducts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteProductDiscoveryAssociatedProducts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteProductDiscoveryAssociatedProducts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/lcm/discovery/associated-products/{product}'
                ...
                if (!$Product) {
                    throw "Error! The required parameter `Product` missing when calling deleteProductDiscoveryAssociatedProducts."
                }
                $LocalVarUri = $LocalVarUri.replace('{product}', $Product)
                $LocalVarPathParameters['product'] = $Product
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/get/
#>
function Invoke-GetProductDiscoveryAssociatedProducts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetProductDiscoveryAssociatedProducts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetProductDiscoveryAssociatedProducts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Product) {
                    throw "Error! The required parameter `Product` missing when calling getProductDiscoveryAssociatedProducts."
                }
                $LocalVarUri = $LocalVarUri.replace('{product}', $Product)
                $LocalVarPathParameters['product'] = $Product
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "LcmDiscoveryProduct"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "LcmDiscoveryProduct")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/get/
#>
function Invoke-ListLcmDiscoveryAssociatedProducts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListLcmDiscoveryAssociatedProducts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListLcmDiscoveryAssociatedProducts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "LcmDiscoveryProduct")
                        }
...
.PARAMETER LcmDiscoveryAssociatedProductsUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/patch/
#>
function Invoke-UpdateProductDiscoveryAssociatedProducts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/lcm/discovery/associated-products/product/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("LcmDiscoveryAssociatedProductsUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateProductDiscoveryAssociatedProducts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateProductDiscoveryAssociatedProducts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Product) {
                    throw "Error! The required parameter `Product` missing when calling updateProductDiscoveryAssociatedProducts."
                }
                $LocalVarUri = $LocalVarUri.replace('{product}', $Product)
                $LocalVarPathParameters['product'] = $Product
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LcmDiscoveryAssociatedProductsUpdateSpec) {
                    throw "Error! The required parameter `LcmDiscoveryAssociatedProductsUpdateSpec` missing when calling updateProductDiscoveryAssociatedProducts."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LcmDiscoveryAssociatedProductsUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LcmDiscoveryAssociatedProductsUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LcmDiscoveryAssociatedProductsUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LcmDiscoveryAssociatedProductsUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LcmDiscoveryAssociatedProductsUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LcmDiscoveryAssociatedProductsUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LcmDiscoveryAssociatedProductsUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LcmDiscoveryAssociatedProductsUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LcmDiscoveryAssociatedProductsUpdateSpec) {
                    $LocalVarBodyParameter = $LcmDiscoveryAssociatedProductsUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABC