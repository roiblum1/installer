...
ModuleToProcess = 'VMware.VimAutomation.Cloud.Commands.dll'

# Version number of this module.
ModuleVersion = '13.3.0.24145081'

# ID used to uniquely identify this module
GUID = 'c4ce848d-afcb-4db4-8a64-563979dfcb7c'
...
RequiredModules = @(
@{"ModuleName"="VMware.VimAutomation.Vds";"ModuleVersion"="13.3.0.24145081"}
)

# Assemblies that must be loaded prior to importing this module
RequiredAssemblies = @(
    'VMware.VimAutomation.Cloud.Commands.dll',
    'VMware.VimAutomation.Cloud.Types.dll',
    'VMware.VimAutomation.Cloud.Schema.dll',
    'VMware.VimAutomation.Cloud.Views.dll',
    'VMware.VimAutomation.Cloud.Util10.dll',
    'VMware.VimAutomation.Cloud.Impl.dll',
    'VMware.VimAutomation.Cloud.Interop.dll'
)
...
FormatsToProcess = @('VMware.VimAutomation.Cloud.Format.ps1xml')

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.VimAutomation.Cloud.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAmxRjmIVIgdsqq
# areon2nGrs0A1JIHjy6wta8NY0MU0KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEgfK2p8zzKG30/S
# XjaUnsXacTdZ1u+c8L0oB/0/Atz/MA0GCSqGSIb3DQEBAQUABIICAD5BmqyuA1zB
# io+Dij7gGwLK8R7fpn6TY+tyA/HGz3znXDnxjATDIEcSXW3ChYrZJHtjJR5bvvbt
# MK77gHVR7uQraSo1cIubkgyuRX44zEjrh2k7SPOGE/PK9NPTq/06RbtATqKARfYM
# uMrWLc3OsQtsZFuwP1UAb5STbMwbAjv3Vy634/AqB42FO76a58Y4e3XlQMFYXHJu
# oniO9nwdzrhyUx8uD20qM4iVpUx6JQyTNUzc93HaqZR8Mefd1jeG/IcY8mbikjmY
# zDyLvHZsXwBRy/9jksxa+xxvujq25KzODOCWLAhbhQdCMagJDdBpJ5K0t+41CiYG
# I8NVr9PmSBtM2VC2lh7Bzp+xDnaXfX2B/b1mDM++6NNo6MIvRjKJD2S4sw5r47HP
# yJIwbYaP8QJhj4SyxLfTjTC+01hOfX+AUGUNTR37BlixJwX0fqeVsj6Hu1T8TOWf
# DBi0Hmz4VClRSe/B7cu0shOj7kHY12DOC5F2xG2t3UBt0vfBQMo1Fp8oK4l+4u7E
# eAqsaRc610Jj8HfMx1SxL9iRu974pZhF9uEYIZBogZR5KftMRePnNXeqs+0zO62d
# SinQ1BCkuD0A883qLkL2kxs4E62Mg6d9qPwqYXuYP9zssk1SwywiZyYgIwO281ns
# pmg5SvGLZxzPMLKBv6N9pZonpr7SLkAwoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IFq/PCXAc2yzpRgF3lZzlfiA8fAXx2Bj15919fjmWKQkAhBT4D/veoUx1/OPsolc
# ZVYNGA8yMDI0MDcyNDE5NTUyOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NTUyOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIF5zDfn71EjenFZHoYYR0CYq
# a7+j2yUKDFiHsEMr5UieMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEKDopsy
# snwLOjgDtsL/q4wFqzFd+ZrDjpbcawLEpVubYgX7T6+fYD6RYVyL7CM2sxwDZN/X
# AIzBuxkcUtT+J96eiL4HOKM4LOb+sMYIcy8EqY4pvtySSv71UGbYlYzOIMHPPR2b
# SEp2igu+8D3Bs0vuTRegRBW62WaaSXnEfQWbzdueHz+avV5CPJbs1Oh7R8+oxrvr
# oWv1oGxseTU/Drd0GuwqrXFe24dpXAqs+fGvUj2jm5xD7cbX92oaee3WWNBtKJEJ
# hgrGCxuFo0G7yEQIyn3vppya5Pianphd1dEi97ZpDYTuI5YxZo33WakyNHIReU8M
# CdAL+4uYpXBWG/aqcCGEeiyT6vmxncJP4My1T4gwTOKIAKxMCGor1ata1RfJElXi
# T6ra1uVSI09Hzr6p9xvMkb3HxervcS/6xKg96j/Tniij1+phc5xZDP5mb/td+DWS
# TnDFB0fV3GOgZmFMm/weErMsF8kmeUdYwILGXWDUCjZhGT7XRVtlc3LgZIqvdL+g
# vg2J876EVqM6KgSbBYc1uvPrz6QAEaiz299i4R0dGBpL70XzhOwYBs+ljTcXRt4n
# wD38AHaom/OqK5zm+1lwGTKUJCK/Pq9UPRnKt3xgVctidahmdwbVSc0JnHGUQMkX
# Idyzdz9hMxMdOyAqI0TQ0LC/pQ8pF4676h2t
