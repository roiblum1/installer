...
.PARAMETER IdentityProvidersCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/post/
#>
function Invoke-CreateIdentityProviders {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("IdentityProvidersCreateSpec")]
        [PSCustomObject]
        ${IdentityProvidersCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateIdentityProviders' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateIdentityProviders' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/identity/providers'
                $LocalVarMethod = 'POST'
                ...
                if (!$IdentityProvidersCreateSpec) {
                    throw "Error! The required parameter `IdentityProvidersCreateSpec` missing when calling createIdentityProviders."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $IdentityProvidersCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$IdentityProvidersCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IdentityProvidersCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IdentityProvidersCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $IdentityProvidersCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $IdentityProvidersCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $IdentityProvidersCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $IdentityProvidersCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $IdentityProvidersCreateSpec) {
                    $LocalVarBodyParameter = $IdentityProvidersCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/delete/
#>
function Invoke-DeleteProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/identity/providers/{provider}'
                ...
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling deleteProviderIdentity."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/get/
#>
function Invoke-GetProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling getProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "IdentityProvidersInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "IdentityProvidersInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/get/
#>
function Invoke-ListIdentityProviders {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListIdentityProviders' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "IdentityProvidersSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "IdentityProvidersSummary")
                        }
...
.PARAMETER IdentityProvidersUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/patch/
#>
function Invoke-UpdateProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/identity/providers/provider/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("IdentityProvidersUpdateSpec")]
        [PSCustomObject]
        ${IdentityProvidersUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling updateProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$IdentityProvidersUpdateSpec) {
                    throw "Error! The required parameter `IdentityProvidersUpdateSpec` missing when calling updateProviderIdentity."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $IdentityProvidersUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$IdentityProvidersUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IdentityProvidersUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IdentityProvidersUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $IdentityProvidersUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $IdentityProvidersUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $IdentityProvidersUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $IdentityProvidersUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $IdentityProvidersUpdateSpec) {
                    $LocalVarBodyParameter = $IdentityProvidersUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/YKuO7sMin0m6
# NakINH5ypHewIf265tM4M0hE7lcjZKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKhx76NdCfOvtecw
# ou8Awjwq4cZs2ycb0AL+Ie6M1JsiMA0GCSqGSIb3DQEBAQUABIICACqa2AGb5Nj+
# tIP/XQ/9BdTh0rappq7LTgXJi8Io5U2Dr6ovhJ4hfkdxA1q4b3jchGFmXk1pG3MC
# 0Etsi+66aGVAKNKeSXgZvyY6b04NxdOFNFouUMGWQsKemK5QYh4XgyJOs2Ru88Ok
# 7cx+ISZDOJzxdKfSrDsxlFnjYHi/t2qgoT2aLru09wmqK1SN2ZaNcDoJmHkR3zGV
# okiBoSshhtiQFS0SOJJDCobmWzZVIN6ESOSt4ktDA9O/9i0LvhWNmNQCpXi6GOXT
# uae4JnVD/FGP5Zf1DB8JW01ymAQBDLNXrCSgpvCxUTZC1uJyE1f756KZkPc3eVwK
# bnuNQheiDSTGjfFa3XihBbURoC9HqyIE0FpvA1/nZooP228KuiclnAGzC+dzgcCO
# jfWzteRzgbDyU+4T8olYS+a4XjMb1jInco9Y0bIvBOLggLTrdAbDUK49feSwIWc3
# UiavsjUYicf8U1J5NX4xp0KRS+Gck+214MzAj0OnaKJmf4PS7LPudvpOXxTn06Nd
# lArOceig62QpZZpRgGF4q0OhrIiJl/8niDP2eToJgl5l3iRNr4PO/pqKXTRnZ19+
# zbqioNAbJ/08HNQ9UDsmzypQCEZMykl/mUY/DVioW9njVAunKkt/ad5XXEYDYd8V
# NaRRecfDEtxoMb+HyLkaQZSG2/9WkJNKoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IHyGDQ/jW83QXQ7+F7e2wnxaaseOCYEGQA8UcOa8A9V/AhAlkMuIDlNS+MrwLB3z
# 3uCaGA8yMDI0MDcyNDE5NDExMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDExMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIDRltxJC2BJG1jzHtjLcllqV
# YWtxdWXglgmUn67X9CZTMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEOn7pEb
# /Hxxb7lrEO7HK3Lrmu1/SlVANCRMMrZVwj4+dOwQf9+DrVPHdfkscf99hYHu/x2l
# U+0NqScSLMKWU92ZQEMW8PtwMVJHIC/lBzHNPI77+mvCzs/+3c3ahZDLSmBdqv9L
# WKGQ83uDj93W0+eSqqBgS4zlXbv7vuDKg45AY5Wz6mZSQJTHgzyvNtrgLqRNCLNu
# tz7/+kZMHgaU4CNWBx9jfrjUDe/s4zmOAqwFG3Luqgg+cF9qqLpCTgnpA361UF6x
# GQD7CjZ9Uvxw5GJ7OKIAOZreRwF7DyDLFCR5cz+FPzKWkq0BXNDhOFtu1lFAYOws
# /WDv8fwKFB9LbRxlYTIVYx/P/kmn8KCJAuIbsycLSLjqudMYHZ76E9ljxT7k/Fjt
# ARTS4FHT5fIhmN8A4ngaFPmCppI5XxB4V9Iihxiqas1hURRKKS3zPQXvx22/RmvJ
# gKnwlFb82cgmz3FmlDvFwvhNx89EArfxGSFUpvpFI9VuiDMjlV5rBNY/u5xcHJs4
# eWPtorB5Ry9DG7vPRRToCtV4UB9R6rn+kUk2VE6abl1bi7sTVKPGuijw3OBX05C4
# snZuucT0U8iqRCp36lymeYYSApqEze/p9QweFDBVd2jYAkGzFQiTYcFL7g8wAGXw
# q4UtmMCmX4hesGr2l2AxgiFXNdzoXuncWfEv
