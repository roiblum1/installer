#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.Identity'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.Identity.psm1'
...
GUID = '36365558-5ea4-42fc-945f-7a3a81fcbfb6'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.Identity.'
...
FunctionsToExport = 'Invoke-GetTenantBrokerAdminClient',
               'Invoke-GetBrokerTenantsOperatorClient',
               'Invoke-CreateIdentityProviders', 'Invoke-DeleteProviderIdentity',
               'Invoke-GetProviderIdentity', 'Invoke-ListIdentityProviders',
               'Invoke-UpdateProviderIdentity',
               'Initialize-IdentityProvidersActiveDirectoryOverLdap',
               'Initialize-IdentityProvidersCreateSpec',
               'Initialize-IdentityProvidersOauth2CreateSpec',
               'Initialize-IdentityProvidersOauth2UpdateSpec',
               'Initialize-IdentityProvidersOidcCreateSpec',
               'Initialize-IdentityProvidersOidcUpdateSpec',
               'Initialize-IdentityProvidersUpdateSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCy+o66A239lxHd
# 3PV0vOSWOMTo12xi2auZpZEfKic256CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEK3TMSYlAKX7YA7
# eAV28r5fV25irH3MP+Bw2Bl7D3QiMA0GCSqGSIb3DQEBAQUABIICAAbIJaVlGIkJ
# MajrlE9+DVbwwkLmpAeJ+SACdhynBWv/fZKsfssbpK3THncrYiD7WsTdqItG+QWD
# FaSQ9216uazbCJwC77hIiGycPQverLAmMCrPhsHjYJP12mPIQJMwujzxReiR66gb
# ckVST1Ky0lDmttnTNPgwrbvjFtR1G6LEREzsfVp1rWs+yTw/s0uWOCt1UcP98woo
# 2n9KDfabzjNCx52+X6vy+seXk/MWuHr3H8I5DpvXwvI9AYYA5NQwsyi33fij40HI
# 4GBzwjDC23vLoYFTqTXUIN014XcvPEcpbVNVIaK+YJJ9lQPTWzhFcxe1lLNpbcpL
# glPdevOfHNmKgTr20SEWWXSTp0BS/7Jw7USSWj2LhclJ7BvTzJp980uYNhqRVe11
# ZkIm6ylsmufpogJEbxWh2fDa9wdLtR1SltatF+TybNa4MwaxT5l4IveeEvdQepoT
# rBPUzORBjjatvHlHGvbN1bLMHmipDvIwyeQw5dg+n14D8ZNL171dBgEsaNZFBe8y
# WvpkzCInnOSYs8gckgCGLZ27lYjIqncYDGYLDPkqeGNs5dSWUHbCiw1DSgtQTYS5
# iS270tTAV+Yw7O6HVtYcLakxIH00t/8/Uzp4Oi3S1LdWsxRRFGayJzu7zWT4HqzN
# guwGp9JiBMBA5MqBS7WMyobA0Z7TglsmoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IG+XOOodN6r17ikDT22DI9j/ZgRiKjAXon8XqJ5jqldKAhBTFNMft8CPfmwB2eDq
# zzcmGA8yMDI0MDcyNDE5NDEwOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDEwOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIK+3siWXY6U7buqra/MOHUaW
# b76FdsZ/KRXWHdihM4QXMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICABo3YoQ5
# 16BjLoo3uIYsSsGgko+VOLYknG3T8HVsBV1209tWK0svAUfI64iBzOmvpT23p6O3
# qz5hcdQQjKCJJjQ3f/YDJYGtLRZ+dWoZNeyjWydpN6iKwMOwZQcmWyRki/XS5Wuf
# MqiJ2NTNsOWP/x1GlA43e7QhYsWdjhh5+I5P5ZCgJc5JMgssz16Sjven06mFKYx8
# QinSNUwVYJq3pzVryZ0rLcUUxzlKcx9YqEjELemc0bmxngUlL2N4FqhAqmRW2u+J
# sI3wWywCdJV4ksOVjzUNxbBwyiL0+hU4fWf17UAwWK+9uKmJWXX4SFFEWgkivqDn
# xRZEwiPI/h8jEPV925qaXJ0E6q9XxPpipus3zWhwp/QU/Dtkr76lPV2tnQFHxJKy
# +SOkQ1BLcbsfwZgfTSWueMD+tR6w93j853Ga/PZAO4wG97CP695FqmSOQvQ73us0
# S/0hc+C4yMJoB5V6qKk0pm3Hx5rZ6l52ejCHcEzhJS0bDD++m37s0d5Eo3FwsiP6
# oyZ+8fhtvTJIDnGtPLQd9hZi1JR+YppM8K6QhzdM+8ahwUN4pjFu76r7SxF9NAMX
# uA4bSaq4f8bZV7/mb8LIL9d6Z6/IAn3vStl0pYLedcYvVo6XnTri+2CV/Z4+OCmP
# xpdclw3U1Djp8oNAu+Vp5+f7rPfR1kZKWCU1
