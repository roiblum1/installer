...
The Providers.UpdateSpec structure contains the information used to update the identity provider.
...
.PARAMETER IdmProtocol
No description available.
.PARAMETER IdmEndpoints
...
.PARAMETER FederationType
No description available.
.OUTPUTS

IdentityProvidersUpdateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Identity/Providers/UpdateSpec/
#>

function Initialize-IdentityProvidersUpdateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Identity/Providers/UpdateSpec/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("Oauth2", "Oidc")]
        ${ConfigTag},
        ...
        ${Oauth2},
        [Parameter(Mandatory = $false)]
        [PSTypeName("IdentityProvidersOidcUpdateSpec")]
        [PSCustomObject]
        ${Oidc},
        [Parameter(Mandatory = $false)]
        [String[]]
        ...
        ${AuthQueryParams},
        [Parameter(Mandatory = $false)]
        [ValidateSet("REST", "SCIM", "SCIM2_0", "LDAP")]
        ${IdmProtocol},
        [Parameter(Mandatory = $false)]
        [String[]]
        ${IdmEndpoints},
        [Parameter(Mandatory = $false)]
        [PSTypeName("IdentityProvidersActiveDirectoryOverLdap")]
        [PSCustomObject]
        ...
        ${ResetGroupsClaim},
        [Parameter(Mandatory = $false)]
        [ValidateSet("DIRECT_FEDERATION", "INDIRECT_FEDERATION")]
        ${FederationType}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Identity => vSphereIdentityProvidersUpdateSpec' | Write-Debug

        if ($ConfigTag -eq $null) {
            throw "invalid value for 'ConfigTag', 'ConfigTag' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "idm_protocol" = ${IdmProtocol}
            "idm_endpoints" = ${IdmEndpoints}
            "active_directory_over_ldap" = ${ActiveDirectoryOverLdap}
            "upn_claim" = ${UpnClaim}
            "reset_upn_claim" = ${ResetUpnClaim}
            "groups_claim" = ${GroupsClaim}
            "reset_groups_claim" = ${ResetGroupsClaim}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD9/sCxKFKioD8K
# SCGItIopyRKwQzvFrxLi5Uu0XJHO9KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEOSrRENzAljAxp9
# wb5PGCLNErY8BezryAxWuwPXmeZQMA0GCSqGSIb3DQEBAQUABIICAGro1TBkE+jR
# ImccDWHe2FRNdi62C9e9HwrR7JO3Yo6ZuFALe9WK1m/BTkuMFEYdXSwszuycdR2P
# HowoTuiysgsugki4hk5Pp1X6VEakKYDtogZumWIGCi2bbkk+K+UBB8p9hcCDA1sK
# BWTeEGdyZiTxWOUYUkCoDMsFc2ZzrT1hhGG8pT6/kZA/zLd4JF0KAGza03k/Z2Pw
# B68oW5zQj0wxev38vXdtI3tviaJMmFSORqF0HdLexM2EMtF7WbR979DGDT90Xz0u
# bynGdjTNBpNkjOxLpPx8fPSOoLHYHrkcW4ucubczFNaZys8sMwoUDQF97S/lQYgS
