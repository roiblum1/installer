...
.PARAMETER FileAttributes
No description available.
.OUTPUTS

VmGuestFilesystemFilesUpdateRequestBody<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Guest/Filesystem/Files/Update/RequestBody/
#>

function Initialize-VmGuestFilesystemFilesUpdateRequestBody {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Guest/Filesystem/Files/Update/RequestBody/")]
    Param (
        ...
        ${Path},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmGuestFilesystemFilesFileAttributesUpdateSpec")]
        [PSCustomObject]
        ${FileAttributes}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Vm => vSphereVmGuestFilesystemFilesUpdateRequestBody' | Write-Debug

        if ($Credentials -eq $null) {
            throw "invalid value for 'Credentials', 'Credentials' cannot be null."
        }

        if ($FileAttributes -eq $null) {
            throw "invalid value for 'FileAttributes', 'FileAttributes' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCl5LOmZkxa0rWR
# 7Z9bPmTFklll19iFETUrXs4JVoUlhqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJxGQxnDsAp25bdK
# R/HjphBCC0eRvHzTjiEI6sj62LU5MA0GCSqGSIb3DQEBAQUABIICABmyHV+Mz57z
# NE9DXUiNIUadFhYE6wA5s1nQENCAxpP6HV1WO8hUe2CiFvHHpDZNbTpzgD00lYxG
# Ye2tPZBRXPQxww9ZK83YDHVpp2Ntpw3OG83VAHMwZ1ZsrGClTweQXE7uR1HulMKo
# MwTMiOmTvRdiuozZtg9mgkZ4N4OqiKdGYYCfPnnJzCrjjV98CEXAx2756ZVOMJo6
# 1Y6cDzTHk4Z1Rak24k69XFixeVy5QSmOcprFTLs83v4Vc4cJZbA6qZVMm/DZ4MeM
# D9omYrhNWILNaDWq2vOph+xICLukqv+bNUCP0Kl7C5ZLUKWmC/n5Iv96G10G7s1M
# V+hF/j0r4iRvsdHubAK64jEEvo+h9K3exa0bYjYKZfoR6hluecqm6RHwoxdkqLXQ
# tDcnFF7TCiQB2Lr68eo+xddSYo8Xt8EYlAQ8pYNnpZyPaX1HwktvqxIO2bkQ6Nxq
# 9IoSWZP83PETqgQ5c3hoFf5Yia1KOy7rS3XxSpqdV0BUzjllAwo6AsLpSQnpljhH
# T40F5/vofbm4fgG29Xs5BBa1GDr1Xe/RFG93lejJizufn8r02u+LBA5GX5wzA08m
# tvdlVnFnWIVJ2Gk2/b4ohwWdDL5s4biiqJbBR+IWzKGFYRXg3HJcfAy6n8XjgzTJ
# xlgCUt/gYmLsI/XDLsMfibc/BYvTqVDioYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IM+5Yn7K7vXuc9I2+4MpJiq4yLBTTl7u1savlMBV36ZgAhEAifSRg4TSEe/NxOII
# feg1OhgPMjAyNDA3MjQxOTQ0NDRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0NDRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAfGmq4WVr8VKhdSurv0mGI
# RP1LWPYZzG7DzcJHTyVmlDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBnRq5G
# TuKXjznDDK3kxRo+oXBzv/Ysaiekt672hvIOsdFSmmJ8Im9P9y/cB8tCEOj7N3Q2
# cTC8zthp5qbVuURplMEekkiLQ+PnTWoHzKnP9OWb2Sv8mC5uqhQEAEFkeVZccwXj
# exr9O0ZAJgNYh2KSkHB95JRGMiOeWb63ljr9PyynywG6zagIXIYS07Zxe7MS9uwr
# Qz1DhDzeKF/CWEZOaCZKWG2pz8oAAEoGf4/RsSUi1WMYChRpIPBlerMeXRHAE2K/
# MfCjn8QyVaY+oxsEVyR/UTO3PCz+6PckGZyuSvXQgErLcr8Cjt7W5Nio5pH2inI7
# wJImoD9yR5Hdq24lqZAGqtxD8UtHSCT83IqaEcji8H/ZnkEmu5ILnLYzgDSWUFi7
# 46zC5oUaFUl2lbLU54PYOA0f13xdmVRrMu94/rAKlH6+utESygoTEpYD7/Qte5US
# KKZF9Mhn6ZTtZXWxkvRjNkj/MJLt1gVeuUX/PyQI30YCLJYdU/bTCZWXQqclMuGq
# lwKT74W+TgtzN9CpPIIvc/O7hZfb6Ki5CPoioQ0dea4MbT8CIEzbseH1UBf1QYLQ
# /kWss4VCMUZfO1XE6D0+sWowoqVxXc3Yd9ZVZZaQZZzw0zhCaTDf1di0Vt3/yxj1
# dplNSw6SDQS13yHDEZjmB4UCtWbkKFucGiFuKw==
