...
VmHardwareDiskCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Hardware/Disk/CreateSpec/
#>

function Initialize-VmHardwareDiskCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Hardware/Disk/CreateSpec/")]
    Param (
        [Parameter(Mandatory = $false)]
        [ValidateSet("IDE", "SCSI", "SATA", "NVME")]
        ${Type},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareIdeAddressSpec")]
        [PSCustomObject]
        ${Ide},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareScsiAddressSpec")]
        [PSCustomObject]
        ${Scsi},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareSataAddressSpec")]
        [PSCustomObject]
        ${Sata},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareNvmeAddressSpec")]
        [PSCustomObject]
        ${Nvme},
        [Parameter(Mandatory = $false)]
        ...
        ${Backing},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareDiskVmdkCreateSpec")]
        [PSCustomObject]
        ${NewVmdk}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Vm => vSphereVmHardwareDiskCreateSpec' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9UOFrSnzDGdm1
# jB189yx8IYXaBXUpH6o7f8TQZJ4tyKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPi6M4RkJLDQ+7Vn
# WfZ/xKy/TRliG48A/S71vkfb5fmzMA0GCSqGSIb3DQEBAQUABIICAEz8PIY1us8P
# 9si1lQ0+Xbm5GyiLluZmtIJKwzb4psB6gXcE1mPa7YtwI7Lw8Z+kaVsEDrSJEyEl
# C4Hj8A0UrwZ2TiQC1pMf27LCTMWF4+Ms9X1z3Ogmssjof/DF9dlCyKqmYiLMzbF2
# IMI+ebfa5nwUhKCgDqRLfQmrFdZxoa9UJ2dgKYjFLR2q9V0J6b0dH6YeHjdjOkPp
# JMv/vwxae4DYYOxg7EW+wIjM+4IxximJagEyqyx4Nqirw61/8vv+umixTtGS5yHq
# SchsQ3XObNyrrxTOyaZRYG8ZEyIOr3pPfrI7nN5Ow+qVZ9703l41sTuooI9GOs4t
# Ve+J/r8/ZtCT+8duE2DxNl35qOOacbPoci4tBLOimIe0yC8zPbhVppXOkU0f9MP1
# JsMcwPAR6Xu34wjqpHZvvAT+sWGndNoztTNPoctUXZyXRSXWvj/ALpTpA6e7rFMF
# oumFPJ6xHX0POkQj2Wgc6szcCP7sWXjxtt29Sblg50DMAK6DOLPWfVrod8dNxTBc
# zuSJmhvtjbywges8IlWAEL5rSHQ0fRbUC+Jkj/8XLlCa2zG2inU0fhaxSchXfSum
# d7q0JM62E3yTf2aFVL71JHf/Wy8Ar3gXmRCkn+AcCsO3d6AVuoythF1B+RPYp31U
# 8Hr9yGKZnKwg0W5Jyl3ghbY4CBVyH5DAoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IHyuJjixq/V8DJld1YBlpXl+olcYPvNBtWP12PVilL7MAhBVJ92TYrvqhL2RhY6T
# QhF/GA8yMDI0MDcyNDE5NDQ1OVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDQ1OVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIMxwP2b0vQLSni7ciVVh/C9t
# BI4oFqcvN/JtNO5Q6R4VMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGStN+jN
# TZ2uDJCeofYOcP0rrXoyok/RsTLul683XCSnNNuJ0Upgfb8lxSsY4yykQVEnwURU
# jwGkx/mfIBkR0QKRKS2Vt5PeWMVG0yyYJfANWsNVyK/jCZ1312qrJMnpR80IyB92
# h3Tzf9A6AB+FOKkrm2QDtSJp6JABQPefyNhVnAs+Hw5Fn+honLY63IBTZiyQ81yI
# vZ4yonoqoYLLM1NFC76PwMAINyMHWKIFYWDD+0C5fzZHcpkRqSMphDDDjHsehmUN
# 5/T3jtKL4yH3XkZ0yllnoBcPRNAP2eN0C35WW5AXYBNo13p8MGVHjrwbxQQfv9pM
# O/syC5pIvikutL6BnI7Hx5re2Z8xRIoctXe0hMTuApZyej1Xu8pcNm/MmUxY+q3p
# Q+iPQfHpNRgc6p1crfKyXajSNMFbDBKQwYdZ9HgcScos3OAUayYW+T1mCtzIUH6T
# h/rW5u5sUjz2uIvJb4BERdOYOPVlK1nn9M3nuLsPvbrbvfF9VHgCD6PtJBM0bxKi
# YoVtoObT8gTg/lsG4PHRnWpEZJ0wkN3Wo1ankuoM7GljYCjzj2K6cQCdx2haAHRy
# e+z/qHXfgqRmikjv0XDY3zXZedKeET/HKKp5ZHK0FgmyqM4QmjaMWB05xymyhFek
# 8Tsr2xyDkOFqP62duPXTAqaQKMp9SvEHgfwa
