...
.PARAMETER UptCompatibilityEnabled
...
.PARAMETER UptV2CompatibilityEnabled
Flag indicating whether Uniform Pass-through version 2(UPTv2) compatibility is enabled on this network adapter. To enable this feature, the network adapter must connect to a network backed by DPU (Data Processing Unit) and network offloading must be enabled on the network. If unset, UPTv2 will not be enabled on the newly-created virtual Ethernet adapter.
.PARAMETER MacType
No description available.
...
VmHardwareEthernetCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Hardware/Ethernet/CreateSpec/
#>

function Initialize-VmHardwareEthernetCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/Hardware/Ethernet/CreateSpec/")]
    Param (
        [Parameter(Mandatory = $false)]
        [ValidateSet("E1000", "E1000E", "PCNET32", "VMXNET", "VMXNET2", "VMXNET3")]
        ${Type},
        [Parameter(Mandatory = $false)]
        ...
        [Parameter(Mandatory = $false)]
        [System.Nullable[Boolean]]
        ${UptV2CompatibilityEnabled},
        [Parameter(Mandatory = $false)]
        [ValidateSet("MANUAL", "GENERATED", "ASSIGNED")]
        ${MacType},
        [Parameter(Mandatory = $false)]
        ...
        ${WakeOnLanEnabled},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmHardwareEthernetBackingSpec")]
        [PSCustomObject]
        ${Backing},
        [Parameter(Mandatory = $false)]
        [System.Nullable[Boolean]]
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Vm => vSphereVmHardwareEthernetCreateSpec' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "VmHardwareEthernetCreateSpec"
            "type" = ${Type}
            "upt_compatibility_enabled" = ${UptCompatibilityEnabled}
            "upt_v2_compatibility_enabled" = ${UptV2CompatibilityEnabled}
            "mac_type" = ${MacType}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCiPyydGwqQlkuS
# XltlQykElilpChg9KVrrjRdFGvXxrKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKgBMphS7DhTccBi
# g8mx2/zjjLOsXxs8Wp5OvhnhXYjIMA0GCSqGSIb3DQEBAQUABIICAJLzXQQRNDfB
# PzzC0m27PvpuQd6rdTc9csUktF/mbMLg7FsL2zD+f6QgbOmvJAqba4EdvJow54sQ
# /LPY4SAuq0wqAnx0hbVaj28ki63MUbUegj7eADNb4CQaw0g1fpWojm9vRqp4akHQ
# 5Px2+8/PLu85FIRy/979LEhmvMR4Pkbxx7BRJsEeoc57Rf/Pvx/SKZ81/Cn67eLU
# 8IN8HNB18qex+uyucSIyzUUStq2HnvrgKetzntI7zPC341745MhNpHnHpo/bcJiL
# LBr6ts4ovzK/Y9pvzwolSK394tp6sAtn1Zn+COg6Eq5KBMNCranPII8Hmf2CVtsm
# lMLRBojGg906zaTh88VT96OUDmH1URH4rIFIVcNCyHhzC+W1ltP/zUJZ75WbWcom
# XJxzqaRo+ScTDXFu6ZqTfAZfPRSM2xueqmQvRdYMc61KWC7OXoMKa6qtekFGmw3T
# 7U4ASPvN5hj8fVVKRkdSVxzEOuw+RZgYupf/wietp8vJDjME8jH/AJY/zBWh2+UA
# 3DNky/Mja2r6AobcajK61GEZJnehgU/iF5dGmD3ck+121MO7MtTsHl8gbaeCJiGO
# 1EW3eW3K/zHjk5idFG7foVJaajxe6JjQBkRkN1btVLYJViC9phQJrIJDAuPzor8a
# 0tQav9rGDKoCtbNulBzFDwEJr33KUfRboYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INXHPVaoNIHLNE8ltuhcl6xRtms2QMEHUWsAgs4fBX7WAhAkZa23e+OY785YTn6I
# 5Te1GA8yMDI0MDcyNDE5NDUwMFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIKPeKihhX58dBrWQhdqlZvFF
# fykPMA6/vUCMvNRrMC6sMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAFXPTNAu
# 0PWmloApVzBuXuKddMO07/c+hNsuSKjfgyT1dmcR6p51kpHIm3cTwM8HasFZj2wN
# iml4MzJsnGYT7HOqTorhThHD7E0NHs2VI50G+KJdqdb8a7Wa05n2o8xCq6AH+hrr
# mIg0+0x7Lyu6xMzOCZ8OFgE1Xdz16DLF50N0kKYIXgOqkn4bCV83O7FVDNkuOmyO
# 2Pddnet0vIbuNVtDGTpWgG4nhlhlrqZQIxCF91tUTTPteGy9It0xYqeVE7XATuoC
# fvSfRSHtPzmItveKI0rJu54S2LEE0LbW7p0rkF5KoG8vT/1K8y/8ZEoWTlX7ph9c
# qQ+htZrzrXh9HzYU02m5qRLgXyUvv+tQqITTpSi+bXaySoBOLKDNg/U25RHvlNOe
# 1vClTgB3fqkfP66f237jA/bmzPmkNeACBXqeoergRGxHhQWNF4fPJlsxc9GdyV/J
# 5tum8m9l8wHgfijRyQdRwLNbpH/1G26avYioWpsC2KqreJrSvWzRAnpXKQD9ZFWR
# X42oR7wb5Unfu8mHmro5AXlQpXzJQwetKFQpZ4mwNCAAkSKYfegACVsx99J7JyB2
# tyqjyFz0sVIO9E6cvQVdPqa3zI1o4X3r2Qpt21viEea8HlY8+qDP4/7ES6OCGZgB
# Du1KwHYeNjHXn+ZKWiG1tS4xH/j2yx/wHcQY
