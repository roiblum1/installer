...
.PARAMETER Guest
No description available.
.PARAMETER OmitFromSnapshotAndClone
...
VmDataSetsCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/DataSets/CreateSpec/
#>

function Initialize-VmDataSetsCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Vm/DataSets/CreateSpec/")]
    Param (
        ...
        ${Description},
        [Parameter(Mandatory = $true)]
        [ValidateSet("NONE", "READ_ONLY", "READ_WRITE")]
        ${VarHost},
        [Parameter(Mandatory = $true)]
        [ValidateSet("NONE", "READ_ONLY", "READ_WRITE")]
        ${Guest},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Vm => vSphereVmDataSetsCreateSpec' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "host" = ${VarHost}
            "guest" = ${Guest}
            "omit_from_snapshot_and_clone" = ${OmitFromSnapshotAndClone}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAbkDzqvR6BHV7Q
# mYrPEvZh6DGtfryIs8pYTpwhOurrlKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKWaK7OwHJuNqcBM
# GF6efqgQI9GG1Rq+WCrPJVApMrKtMA0GCSqGSIb3DQEBAQUABIICAHKU3Tlix7I7
# 4ORNare1g1CrhCvShrI+K0jRh6gN26KiwmdsbP7oWflh1qZAPHo4cNdywCSBiErB
# 3TwvrJK0AVtjf7gyvHkFNwBOVjA2swECRnBtek/ZxSEmRflcZwdfnbwxNOu7IwAD
# ppmW1oa/xJ+QfjDWrgjE4LTUU1jMqvdb+eTORZ8ZEUHEsHtbFcejP1sTytxJOFAT
# qkjaP3U6W2d+xclywxI1vEwJrUDRmFWDCib24G6d/kKVPs5mzmk3GI2ZE7/6ra5G
# /IIqId06shhGNThNPqzMnDGjrZsyZU3SeyJsg3La/X7dwCBgYCY5kGoffS9v2yWH
# gAAFd3kxM0UlUfKvR/5PTpX+Snd805uqt8IHm9NQjhOfQ2JAveI+InSie+n9fKLM
# ZpNlOcqcvQslqfaIJD4oytlER79Qe+jblhjCa/WAddQSPi1A4oTq21Mm01zISlGr
# ZkIxZQySF2AA5B6OMvqyrIQwYxCftOuK4GGFXoCk9JFU4RZN95ijTJ9G3I5BCAAI
# JOiCVtOdt+C+Oo9/Ox1VvkM/DoEQP5RY4FpBsMZ28+5zhuRk+0JEc4edxhhshp2n
# 4Ha+5w97EG3uZfdSEQMQHFbPQGeOOD0ePubKZ+nAY04oX9vuJ/ROhluwfOjKSycD
# C8ffQnwV/rYhxe0yA6t9agVEWK3u3YwioYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ICJdeKU7CIqNKcrkUqH4fXH9a7Tugw+d9y8B7VnMrystAhEA3DPRkAbvQIbp9YW8
# 1EeDzRgPMjAyNDA3MjQxOTQ0MzNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0MzNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCC8xah41FYEKsClVzeJHwGd
# AfTe4sG5VHKUjusrmIo7IzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAx6Ih6
# zfKaIZFY3gAiIp0kl2BcwbKIL7hzR/O6LFkoh2kzxdKD77gvmLiEn3+aF1y60sj4
# ToBiR0krP5K13JL2gieMBnoOdiKJfDZb1Vwg7UQeqEg28CQnNC6YoI9ko4roO2jR
# qqQAFgv4q4y/NFswAXpNx1HC6o+aMbTVivTrXvTwyEqNjyl1eCYaobs1L0b25R3y
# WOd0wuD9LOayDnxx6sixHhWSrNLrPrF7jceFYztzz7/eSMAfE4DdiFcFHIAOraGC
# v8c8w32eeLV+j8FRjRDsLlIF/B2nGB0gvTqyNU20zXGMB7tYbZOXMwSgJ6z8loOC
# 98etkeCVmxy0QYC5y4SCv6vNZEgLWp1536oFFgUsOc6D1ISFmFLQtDYsmpNrOI51
# PD65tJym/WIyNXHICOCG/i8zGgt4DEhC7dqTfbg/WHrsPZpXU1N8+3WqZipBqolD
# lwgiK8kJyQO7XRVF8+I0DnOIVkcnm4FFftyd1+p6KoMVdVkxUA+2F8QPYdYkaPvi
# ogeC7n9jr75BxG7/nb6MRgBe3fXhlxiDwobtbMtGD9af6PanUt07UT8iyKgbkhcN
# hlLC4Eht17B1qc1FZX74RTFQz5RkpgwRAYoHGVwas3rxj7ytIDoLviAjrBc0xlbW
# Y6v2CWuxOgNwGxWybaPko1Sw4xcF7Yfts1ACpg==
