...
.PARAMETER VmHardwareAdapterScsiCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/post/
#>
function Invoke-CreateVmHardwareAdapterScsi {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/post/"
    )]
    Param (
        ...
        [PSTypeName("VmHardwareAdapterScsiCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareAdapterScsi' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareAdapterScsi' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/adapter/scsi'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareAdapterScsi."
                }
                ...
                if (!$VmHardwareAdapterScsiCreateSpec) {
                    throw "Error! The required parameter `VmHardwareAdapterScsiCreateSpec` missing when calling createVmHardwareAdapterScsi."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareAdapterScsiCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareAdapterScsiCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterScsiCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterScsiCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareAdapterScsiCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareAdapterScsiCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareAdapterScsiCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareAdapterScsiCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareAdapterScsiCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareAdapterScsiCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/delete/
#>
function Invoke-DeleteVmAdapterHardwareScsi {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmAdapterHardwareScsi' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmAdapterHardwareScsi' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/adapter/scsi/{adapter}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Adapter) {
                    throw "Error! The required parameter `Adapter` missing when calling deleteVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{adapter}', $Adapter)
                $LocalVarPathParameters['adapter'] = $Adapter
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/get/
#>
function Invoke-GetVmAdapterHardwareScsi {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmAdapterHardwareScsi' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmAdapterHardwareScsi' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Adapter) {
                    throw "Error! The required parameter `Adapter` missing when calling getVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{adapter}', $Adapter)
                $LocalVarPathParameters['adapter'] = $Adapter
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareAdapterScsiInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareAdapterScsiInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/get/
#>
function Invoke-ListVmHardwareAdapterScsi {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareAdapterScsi' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareAdapterScsi' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareAdapterScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareAdapterScsiSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareAdapterScsiSummary")
                        }
...
.PARAMETER VmHardwareAdapterScsiUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/patch/
#>
function Invoke-UpdateVmAdapterHardwareScsi {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/scsi/adapter/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Adapter},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareAdapterScsiUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateVmAdapterHardwareScsi' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmAdapterHardwareScsi' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Adapter) {
                    throw "Error! The required parameter `Adapter` missing when calling updateVmAdapterHardwareScsi."
                }
                $LocalVarUri = $LocalVarUri.replace('{adapter}', $Adapter)
                $LocalVarPathParameters['adapter'] = $Adapter
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareAdapterScsiUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareAdapterScsiUpdateSpec` missing when calling updateVmAdapterHardwareScsi."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareAdapterScsiUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareAdapterScsiUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterScsiUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterScsiUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareAdapterScsiUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareAdapterScsiUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareAdapterScsiUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareAdapterScsiUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareAdapterScsiUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareAdapterScsiUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsKWpwER1H8nUb
# s3fUMfiZ6kragmgHU+wnzDyqYGCwQ6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGNeglmyeG54xGjA
# dGvtdTJ0/bOC4QqnmB2+fHOBpHFGMA0GCSqGSIb3DQEBAQUABIICAG2RiG32cd5B
# s7VLOnSv0zqZopIo3or+STxK7YUmTfUzj/5CV8pd90BWWb8riuwOYPmS8XqfzHA9
# VSjsqUdnDA9ZIJ5P1YtYXtRMrbUjvJy896HEcnrcD7mKA45ZK8Pslaonv7h3EAb9
# 9fIX3ngTGynzNgIgCqpjBq5ZTWCc82UdlWAtCSNmMtGCTpcEyka3aVkJw0XRSp5m
# HbNVVZMDCVi34NZSPZENrarWmq8gt4+OrPkk5WyQqRWzzfOUUpjhRXAlsAzJ7WkS
# xyHgzXvndYTDR0WeoST+JGROpLVMSbj/4FlS+/V6sT1K2taT5tx6SJ61S2dzscnz
# BX/T/XBFfRctdtLie/CYat4hQal3Umo/SjSsn/0Pp4s4Zqawfwjr6uvkXSs+tcPJ
# 8P5tGHp5cUxtUMrIJVkh1+HH/g27rOINvWF4+OAHi2rFg+l8G/rPFUghTPBfgNZ5
# qYc3xpR3tk8REmhBMi2VobZgQm6rrsV+Z1YHxVXocgSomuaA0FBV6CoG5Mk3/g1W
# yWkfri21CK/Gkus9pYq7L/NkOJ1KrepaH282hmNvA5+M9qNveQU5HoYH9ebPUscJ
# YvGYAoLKgUc7CAOq8x3oj6RPC6q730cWi+5pDXozTTdGrVA+O+coY2VFBUihuuGC
# gG7dPdh4JU+iQx5zKndoTm6SJXdFok1soYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IMj4PdrLHRUUJ6ud8o7TI6LSw4SJOe8eE3113h0hH5VZAhAG60JyQeyHkLnaU4z5
# sNz6GA8yMDI0MDcyNDE5NDQxOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDQxOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEID9K/kw+dMcvG5+FlhVnnzLi
# daw5Y+oH1Lq+JqTfRMnIMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJWHDPkB
# lGP8rFpXnQt1r/uHBiKB+78gtc3bDzTfUKpVjta4gMjmn9Wlb9f7OWKZay0+9uY0
# NlqeUqvVoM2uOM0LJtcmnZ89uZEeBz8+6Kn9x7VXuyU8MUmsFfbn5iMGckl6trIj
# BtqamkRIk52elXT1rqI35xkutZn3vGRaTOm4XYuSeMbWy1d4w9fv3LVDKfLJlR6j
# i03k/kYIjoM5iCv9ivdSUQ7RlFSIsYJcx4DbF8l7kS8fZC+o590qb4BrVBsWb32Y
# gYJy9umnZL6RaFZJPd4iRzUbTGe5n/jJ9ENVHLEpq/7vb8aLxFDpHcDaTM/mrJGy
# X/eV5jj0RVoqXKv6FIlec2DcrZIEeh7rR0hg/6driWiuFSuGqm9KA0LKszBxn1o5
# 9wUv2ZhSXCVXFkWOxSu89HFUa6DSmN/wxp9SBqH5GKT2QIUhcvTw1qRg6wtcSf7B
# K0PGmVUYAJamCxHXWKLgu9SGSVABSP1sYV7EcZ2Z2ScMMPAcOypUN5UUPTGcW+Jd
# QJxsWHr0GcAG6jndHFEWkNrs/0IDCuRsJj3kPAzwiRH+zqmp3666ArHtZ9Pd3sGx
# xjhJyCZ/Wx4uM5nlq3Be/7wzHij+tU5owMUPgcHL9rdxTG49n87Vgu1U1vPjmoS+
# NAUyDkuLgVHxlDMSzL0DWG8osWQX7WpIA75U
