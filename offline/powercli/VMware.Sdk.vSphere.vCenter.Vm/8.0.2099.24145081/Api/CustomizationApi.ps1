...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/customization/get/
#>
function Invoke-GetVmGuestCustomization {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/customization/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetVmGuestCustomization' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmGuestCustomization' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/guest/customization'
                $LocalVarMethod = 'GET'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmGuestCustomization."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "VmGuestCustomizationInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmGuestCustomizationInfo")
...
.PARAMETER Vm
The unique identifier of the virtual machine that needs to be customized. The parameter must be an identifier for the resource type: VirtualMachine.

.PARAMETER VmGuestCustomizationSetSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/customization/put/
#>
function Invoke-SetVmGuestCustomization {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/customization/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("VmGuestCustomizationSetSpec")]
        [PSCustomObject]
        ${VmGuestCustomizationSetSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetVmGuestCustomization' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetVmGuestCustomization' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling setVmGuestCustomization."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmGuestCustomizationSetSpec) {
                    throw "Error! The required parameter `VmGuestCustomizationSetSpec` missing when calling setVmGuestCustomization."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmGuestCustomizationSetSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmGuestCustomizationSetSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestCustomizationSetSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestCustomizationSetSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmGuestCustomizationSetSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmGuestCustomizationSetSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmGuestCustomizationSetSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmGuestCustomizationSetSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmGuestCustomizationSetSpec) {
                    $LocalVarBodyParameter = $VmGuestCustomizationSetSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC5Vb2ri3jdVZ+p
# MLzbZkit1mbOIkkQlUcBurFnR0EWI6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPp5haF7MqiTZpXc
# k8fyMhndKMaeuO4cxEDpdOjSMKFwMA0GCSqGSIb3DQEBAQUABIICABc+VFPG1ZVH
# FOoFCBE9rXTLwMPAZAlBcC841kyzBTRr65CMng3Bfj7cOCgk22nbV+Via1WCnIgZ
# daHwhfEwMqcDOupNgIAvmOWCAexpLrpGy9UV6/KNeRgncU96o2y36DrPrVLJ8+RH
# 4Sms4ru8fNmWWpcUqyVjpSOgSscEFZ3ajOd9XDVfzK8PLETsSBNyNFbfQO+xpett
# JwVkcTUtyG7v7cRWvyYTtlh8gEigp1qg/AwHdrSILN8KUSqymC99CB8D/2yoFkXt
# B3DIGIMbAaVpQ7MKf77FGmiYEPy5v3uXCDf0omitq9BOMoJf6HYDhBgivaVGWELk
# KcFpoNfAp4sMPzxrp3EuEWBGdCwIy8eDtBntKTeVqG0XApY3c8b/AGu9oj0ocDxH
# o1Uz1J2IYTW3hx56DUOVArZoT6S79G6DwqPToJcgzP49kWJyuClDBR3Fb7OfABiJ
# z9yJE7JPY6h3Midx85iAIzpE5exICGWXYg+4yzuHtfKsoGF1YCl8Q+A5zSldEQq5
# rnVf42aJFKE1zTlTQn62UH7CJsZhHYT5nc7G4d1PF0Zv3XVTj8I6VxCcblAxWMAX
# ikoQ/d1tnJakgqRNgEYjhYzhytG+Eas7OCulXUnQaLMGkZb9yQcp0wvvcoASdijm
# fBO1vJTkG1dni84Z6gmSsNGetO8Kv8tPoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDPh36gsGGUJ6u4MkjKKs0lhX0XAno2umlgdAz8pxFD0AhEA2NdqQ4CZhAPsRZsX
# 7/GrixgPMjAyNDA3MjQxOTQ0MDFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0MDFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCC1kOtSftIC3+ohaNraQxWL
# SJql5Ims7a2B70EaAYPY1zA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCN+jF0
# +Q0qliItAjFy80ZRtVLasdkxfLMQKDJ98MNaBbxdOU/cdn/bHq/kLmw6PA2iQ5gE
# hzmE0PZ2KW4QfpG7Z9K5Z8zCWWyakp/ZEWSnoJ66EqWWl34TuvwnClPQFTKdQAMJ
# mm3xhCY1iysxhgkwEwzDHOWMd83frhwb5ju5tUEJbBllJkZoztN79p9vJs+LuTjV
# 7PjxR4/DpaaJ0PyQ5t9WlCqktaTQrGCiZc1v7SD1j6uYK15SNjYXCO7ONfsPohmD
# i+/1M0AZsnsJ4Fc0YRSRnBX2xaDWp+iE2jxRKq5l4vAmtCXD9xJGujaVpbbP7LE2
# kNct1JoB5bXDXkfdJ4oeDpx03cgES7sve4/nXDa8o6oR1Ce7qIYWpc8BY1vK+brl
# 0v6P0ID/uAaqFeyg7GbGYdInIi2gKmbDg8KWJMhTQwNynKiePNEB1hESifx3PeAg
# 3YhCJ2Fc2zK2qF402/S+XK9idQpKx9+1bC3mvG0cryQcTNi+D4q+bLOtMII/X68k
# y3SbggGyCAxmT6QxzNKTIn30v7C9/wVqzy0GLjI8pUL8JHQz5PhfLcBNy0vTT93Z
# yancU/d6sFOcB7nBZDr21v0T6+PIEQtWSE3KnAy8ZtMNEjlaql9fGb1Jfl5z0b/7
# RmeCWdhND9UD0FbjCZEG6djxBw62JrEtHSYcfw==
