...
.PARAMETER VmGuestEnvironmentGetRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/environment/nameactionget/post/
#>
function Invoke-GetVmNameEnvironment {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/environment/nameactionget/post/"
    )]
    Param (
        ...
        ${Name},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmGuestEnvironmentGetRequestBody")]
        [PSCustomObject]
        ${VmGuestEnvironmentGetRequestBody},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetVmNameEnvironment' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmNameEnvironment' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/guest/environment/{name}__action=get'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmNameEnvironment."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Name) {
                    throw "Error! The required parameter `Name` missing when calling getVmNameEnvironment."
                }
                ...
                if (!$VmGuestEnvironmentGetRequestBody) {
                    throw "Error! The required parameter `VmGuestEnvironmentGetRequestBody` missing when calling getVmNameEnvironment."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmGuestEnvironmentGetRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmGuestEnvironmentGetRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestEnvironmentGetRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestEnvironmentGetRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmGuestEnvironmentGetRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmGuestEnvironmentGetRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmGuestEnvironmentGetRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmGuestEnvironmentGetRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmGuestEnvironmentGetRequestBody) {
                    $LocalVarBodyParameter = $VmGuestEnvironmentGetRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER VmGuestEnvironmentListRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/environmentactionlist/post/
#>
function Invoke-ListVmGuestEnvironment {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/guest/environmentactionlist/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Vm},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmGuestEnvironmentListRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ListVmGuestEnvironment' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmGuestEnvironment' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/guest/environment__action=list'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmGuestEnvironment."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmGuestEnvironmentListRequestBody) {
                    throw "Error! The required parameter `VmGuestEnvironmentListRequestBody` missing when calling listVmGuestEnvironment."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmGuestEnvironmentListRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmGuestEnvironmentListRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestEnvironmentListRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmGuestEnvironmentListRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmGuestEnvironmentListRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmGuestEnvironmentListRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmGuestEnvironmentListRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmGuestEnvironmentListRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmGuestEnvironmentListRequestBody) {
                    $LocalVarBodyParameter = $VmGuestEnvironmentListRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALPDUk3Ww7Xcr7
# cc5b2VmBJQSrvK5O7YY/frGx8G/0f6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM8iexTo/jAU28fv
# xPJKFZ1XwZlhB/SJduw2FpaLyQRTMA0GCSqGSIb3DQEBAQUABIICAGnqI4wqZ3Jl
# toC4eIsYZ9AfVXat2bJCCMg+BHpBIu9oGiwIp4CbrtyleDd1JRx75QMibZtBxxoG
# DcHsRTj0OcpiPWi9us1TLrPYp/ardogQPkB3YmoX/9fanCwF43BPBgqE4sOtemH2
# /cDSgZE5JX9bKAIcYBKXCr+KrAsgPfdZEkt0tyDWDCYT9gxX+AsFZL+xbtnqUV9I
# wHtP5rxEMjQaUafRTDea3WSoISVkH/2425D+XW8NTS15r5Pv7lqw3C2eC/UE9REZ
# VbgAoHvRQCW1r+bvIhuU7bcQrlofJTRpIOt95D8oHmPd+sEeFljTH0vT45zCnmf0
