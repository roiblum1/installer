...
.PARAMETER Port
Virtual parallel port identifier. The parameter must be an identifier for the resource type: com.vmware.vcenter.vm.hardware.ParallelPort.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/portactionconnect/post/
#>
function Invoke-ConnectVmPortParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/portactionconnect/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConnectVmPortParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ConnectVmPortParallel' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/parallel/{port}__action=connect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling connectVmPortParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling connectVmPortParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
...
.PARAMETER VmHardwareParallelCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/post/
#>
function Invoke-CreateVmHardwareParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Vm},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareParallelCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/parallel'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareParallelCreateSpec) {
                    throw "Error! The required parameter `VmHardwareParallelCreateSpec` missing when calling createVmHardwareParallel."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareParallelCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareParallelCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareParallelCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareParallelCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareParallelCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareParallelCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareParallelCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareParallelCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareParallelCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareParallelCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/delete/
#>
function Invoke-DeleteVmPortHardwareParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmPortHardwareParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmPortHardwareParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/parallel/{port}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling deleteVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/portactiondisconnect/post/
#>
function Invoke-DisconnectVmPortParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/portactiondisconnect/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DisconnectVmPortParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DisconnectVmPortParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/parallel/{port}__action=disconnect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling disconnectVmPortParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling disconnectVmPortParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/get/
#>
function Invoke-GetVmPortHardwareParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmPortHardwareParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmPortHardwareParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling getVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareParallelInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareParallelInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/get/
#>
function Invoke-ListVmHardwareParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareParallelSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareParallelSummary")
                        }
...
.PARAMETER VmHardwareParallelUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/patch/
#>
function Invoke-UpdateVmPortHardwareParallel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/parallel/port/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateVmPortHardwareParallel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmPortHardwareParallel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling updateVmPortHardwareParallel."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareParallelUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareParallelUpdateSpec` missing when calling updateVmPortHardwareParallel."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareParallelUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareParallelUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareParallelUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareParallelUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareParallelUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareParallelUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareParallelUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareParallelUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareParallelUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareParallelUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAhcBDkmSWDUe83
# cPET6ARP6t1wkeqPx7P111DaNm3pRKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFQp1sWacKNCbbA8
# U1Emlf5hS7PPkB5rEtenb3NGpuVWMA0GCSqGSIb3DQEBAQUABIICAIn8eMDSim/K
# I7sMDtCsZpRQgPZkCHNjUhNs4zzoBfEFtjGnvUVHHxwpia1WPiNtyZm6g6yVOGg/
# 9b7aBLIaJNCMGHrsEA9fFQTe311hrZzYGXiVDdy+VJctkXzaY3LdnbQ9ebp/dmLy
# 616iKeZQt+FFmYwgjem81SGu8m4rg4FPzzQL7Mn2+ixlVEpr168COUgY4tRjWaRF
# zTP7u95Q3dqdRTWu2URA+EXXV8a4ReE8M7OS+FiZj+8KIL+//5jhykipolj1wbPs
# gRRqFXoETmALsbaEAjNn3iS+w1BPqJrnPN9fj6Vnu/tJki40dOgwSY1/OAHEXC/t
# A37lhD2S5v5LbXJkE/FkD81b+EspBNDrUUgv0X0VB0wRBJEOhaPLzUWIxGWtsKM6
# TIHssEJ+PH3ZIDVI0/QgQA05CCH31s5+EVpUmXT0EhOZqwweu+IrbteuJZF/nBX4
# TysJEhPxArYmZPQzH0QLdApSRcewWk2Shtt5k6WlXpl+LlGhidnQhRiGBrZlcLvX
# hNfI9f1z9YcAv7oiE+1T7JawkB17zpGwul3L+0GvWWxOOroAyyidl2KL9xj4xBMz
# gMSbFC5OW78X97ZC8BL6kakuPqqvKCioOuRw4pO6d9+CODWbwDriaJxD2jipI+55
# 5LJyHE2mO8wYgjcs04iFzuJa+d56ZxzSoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDroXsaU+rm5g45mmBMX1n9lh54U1NYTr1IHSbjXqaiyAhEA3ESkjiq8GQEUP8Gx
# Ndq2bRgPMjAyNDA3MjQxOTQ0MTRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0MTRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDiXyQPBP8cJ7Uz/7vFB0me
# HXT9TL34q3ukF8JCpffCkDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBavxBh
# APEZv2/nxkbhtAnUFX8FbflyroVJPfIi/cKAD2SxfpSzNZgHp1KUfl6otA38zGjO
# vAreGOzRAWe6+lYoVkD0MYe82Em8IFR8OWVykY6MmfaWEREMgbRYL/ZGp9kjqklA
# fk24BgHCP/F5rs1px1OieQe7HeIiD2DtTFYYe50T/Rv5+BHlXc2wvJ55uzOFDgdX
# o0CVingiJZ5at5K4u6PswOl4/bX9XLPmDBXJ3kvJpeyMrjQgsltQY3P+Foq9a66/
# 3vjGIUjC5y/nvP69xmoVkLeuTybb94VR71LqM+ucFQ3WTmNgU81rl6x6pqBvjyH+
# +0SJWH9bcH1kfmZxrQztj1gVhNkVbeZCTbD15KuW00SB7EaoXuNnd/qeviGtykwy
# Qqm8djlw8B1pN1BZJqSr7lRhsJOQBCQICfeu7sKzUBDdgAjHFtjjLedJ+RBRD22X
# yOaw84iRUSU8nHSEbUKRt1az3yvilDJsHjCfMDoa33iRzXkjh4KkkZZ/haSq1Wzs
# rywKknM3ilQ+4p6MkT+JNXwiNPRa/Zj9jtPJSf15YXRP4+tsLfDD85sGqWH5OqWZ
# lsWMwtSTFRKvMx/NhMyzupfHCKEa/XkfMYf+nRUDTDx+MRtA/CCIoLGhRw0idejC
# +mcjHeK466xWqsSIcIJnWzeVuZy0X0lyw4InpA==
