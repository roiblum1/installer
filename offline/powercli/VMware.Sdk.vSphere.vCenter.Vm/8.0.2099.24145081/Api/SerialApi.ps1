...
.PARAMETER Port
Virtual serial port identifier. The parameter must be an identifier for the resource type: com.vmware.vcenter.vm.hardware.SerialPort.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/portactionconnect/post/
#>
function Invoke-ConnectVmPortSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/portactionconnect/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConnectVmPortSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ConnectVmPortSerial' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/serial/{port}__action=connect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling connectVmPortSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling connectVmPortSerial."
                }
...
.PARAMETER VmHardwareSerialCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/post/
#>
function Invoke-CreateVmHardwareSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Vm},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareSerialCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/serial'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareSerialCreateSpec) {
                    throw "Error! The required parameter `VmHardwareSerialCreateSpec` missing when calling createVmHardwareSerial."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareSerialCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareSerialCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareSerialCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareSerialCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareSerialCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareSerialCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareSerialCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareSerialCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareSerialCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareSerialCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/delete/
#>
function Invoke-DeleteVmPortHardwareSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmPortHardwareSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmPortHardwareSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/serial/{port}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling deleteVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/portactiondisconnect/post/
#>
function Invoke-DisconnectVmPortSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/portactiondisconnect/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DisconnectVmPortSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DisconnectVmPortSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/serial/{port}__action=disconnect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling disconnectVmPortSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling disconnectVmPortSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
VmHardwareSerialInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/get/
#>
function Invoke-GetVmPortHardwareSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmPortHardwareSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmPortHardwareSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling getVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareSerialInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareSerialInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/get/
#>
function Invoke-ListVmHardwareSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareSerialSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareSerialSummary")
                        }
...
.PARAMETER VmHardwareSerialUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/patch/
#>
function Invoke-UpdateVmPortHardwareSerial {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/serial/port/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Port},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareSerialUpdateSpec")]
        [PSCustomObject]
        ${VmHardwareSerialUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateVmPortHardwareSerial' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmPortHardwareSerial' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Port) {
                    throw "Error! The required parameter `Port` missing when calling updateVmPortHardwareSerial."
                }
                $LocalVarUri = $LocalVarUri.replace('{port}', $Port)
                $LocalVarPathParameters['port'] = $Port
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareSerialUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareSerialUpdateSpec` missing when calling updateVmPortHardwareSerial."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareSerialUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareSerialUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareSerialUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareSerialUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareSerialUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareSerialUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareSerialUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareSerialUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareSerialUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareSerialUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZaOgdpHbwZqC2
# IA81O/45ujyrUcyre1jr4E+eidVeyqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIE+sN8Ouha9+LLE1
# R/IuVdTkVlcu5zOG5WSvtqBPGxJWMA0GCSqGSIb3DQEBAQUABIICAI+gM3d+X6EX
# 8JoKx8W6taWLyGnYXIQNwOwNda88XFqMJM3huvbvnO0ZP4DbrmzP37CaxE3WVdFd
# EJIQjSDIftMLJSPsRqYu55ZQROQlHjaaBVSp+93I/3uIM0wFx+XoSyledBYq+zMq
# fQQwO/jHEc4O9W2bQuNVh1Wlk6p4dnRBo2ZULt3u+x4ax1rcFz2B+M3gMBK2Yqzr
# laUSpymYIHW7kV79ucCG12H15JugfTQczhX4gFwEbCPq5LSx9EIGQL1aaVfo0Nib
# agFiFW7C6qtRzQlegy3VQf1tOduLqTLRC2bXHRsNpwqxtyRAgZzNO17X3RY1vDNj
# YRUeiw92+ZNniSRlrC6qLSkTqIdAxdUlxJtWaJ7mhnouwP9eOAAThJRx38wuZ2Ba
# /AEkHrP1P7Yj05j4BLhT4u8cZgw9mpY7goJDQa/o0Jtnb7Kr+dwEiBSEXXUYfuLZ
# YNdBlcQhX1cjybZYO8f3PU3QXR48J8JhGuIpBasFvsl2GcZ7+z5iVsldnoSqEYlT
# vxq5NAewHYWxX1i1NhpWSwJZIuw2r85NFPkOn3aOLX/R6rKwk8/4RvGIVM1qSwHO
# E5OgsXQbVC70scz5JB7sia/5zdrbDp3Uupr+cBfKWwu0/RbUtBuSyjX4NOlkIk8G
# caEQ0MUOcH28advGwARSmu0nNHFVnvKjoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IMaYHbGJI3YGxB04BDdfeubtOBMEgmQ1SP/vzXloGwe/AhEA9TTnBJ/sYH/GplGP
# L0h7mBgPMjAyNDA3MjQxOTQ0MTlaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0MTlaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAOGVlSUYrxY69Mx0aANdt+
# lRLwggCZup5friniznlRDzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCIEYW3
# 6FJjOWxMk5QAKdW80h/RdI/Bf2fSBG0L+ARQM7SE4qG5bmqoNkir5JvL1a93rJEA
# B22LXMgW0mwhqgVG9Oxm9L/qqhEadiFEqKI7bX9DPIWr+ZmwwX0res9B1U5cqnsA
# k/fQdMAUeG3cTJ6d2x1VdonLgpaNtYUzDvpR8X7ejx7kZyP2Nfszw0loxCv+KZ1u
# 6QXel8tH/V3SxIFJKo2vfvKSQ7NViG//feiHA2sap8MG8uz2LMyNLum1vETVD2O8
# xlyhpoI1beJnRQZza7t98JqzmBZiHe0ePk8W7+Nd8SPbRoxkdzUQ71VkWXO7b6fI
# F9OmIq+jqfQdXVirmJvKS3t6l9pI/rxEgC2nDbjvm7vSb1GwX7dTFekXmWjXs/uP
# iwAOf0JlldLi55PrTY6L2yTfANPM46sIR4pn7aI3ivhltQ10T6PGvOaQYahhDCF/
# cHYrCk3FgoG9AZkKede1Hgo2ewdM1xn6B0KzsONEBLu3j7LPh++G+m2TUGwJJmUg
# N5CZKe4ubuq8zuOgRMwBAZmuRxwp2/Tmjr0Q+txGTsZ0dFjc+Lv2G+FlJoSiW+DQ
# OHNFr7YDmoAmW3uOxgIAED/1z7K++u68PCuFqIPBc6l4fqNKVkXpJ85+FWyPYHzI
# hpAD5Gzs5lcaLeGnk3EAFGX/FU28NTOLCcJXLA==
