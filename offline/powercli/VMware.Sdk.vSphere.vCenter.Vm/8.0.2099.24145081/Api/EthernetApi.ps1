...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nicactionconnect/post/
#>
function Invoke-ConnectVmNicEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nicactionconnect/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConnectVmNicEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ConnectVmNicEthernet' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/ethernet/{nic}__action=connect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling connectVmNicEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Nic) {
                    throw "Error! The required parameter `Nic` missing when calling connectVmNicEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{nic}', $Nic)
                $LocalVarPathParameters['nic'] = $Nic
...
.PARAMETER VmHardwareEthernetCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/post/
#>
function Invoke-CreateVmHardwareEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Vm},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareEthernetCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/ethernet'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareEthernetCreateSpec) {
                    throw "Error! The required parameter `VmHardwareEthernetCreateSpec` missing when calling createVmHardwareEthernet."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareEthernetCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareEthernetCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareEthernetCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareEthernetCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareEthernetCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareEthernetCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareEthernetCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareEthernetCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareEthernetCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareEthernetCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/delete/
#>
function Invoke-DeleteVmNicHardwareEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmNicHardwareEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmNicHardwareEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/ethernet/{nic}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Nic) {
                    throw "Error! The required parameter `Nic` missing when calling deleteVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{nic}', $Nic)
                $LocalVarPathParameters['nic'] = $Nic
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nicactiondisconnect/post/
#>
function Invoke-DisconnectVmNicEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nicactiondisconnect/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DisconnectVmNicEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DisconnectVmNicEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/ethernet/{nic}__action=disconnect'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling disconnectVmNicEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Nic) {
                    throw "Error! The required parameter `Nic` missing when calling disconnectVmNicEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{nic}', $Nic)
                $LocalVarPathParameters['nic'] = $Nic
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/get/
#>
function Invoke-GetVmNicHardwareEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmNicHardwareEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmNicHardwareEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Nic) {
                    throw "Error! The required parameter `Nic` missing when calling getVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{nic}', $Nic)
                $LocalVarPathParameters['nic'] = $Nic
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareEthernetInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareEthernetInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/get/
#>
function Invoke-ListVmHardwareEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareEthernetSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareEthernetSummary")
                        }
...
.PARAMETER VmHardwareEthernetUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/patch/
#>
function Invoke-UpdateVmNicHardwareEthernet {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/ethernet/nic/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Nic},
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmHardwareEthernetUpdateSpec")]
        [PSCustomObject]
        ${VmHardwareEthernetUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateVmNicHardwareEthernet' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmNicHardwareEthernet' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Nic) {
                    throw "Error! The required parameter `Nic` missing when calling updateVmNicHardwareEthernet."
                }
                $LocalVarUri = $LocalVarUri.replace('{nic}', $Nic)
                $LocalVarPathParameters['nic'] = $Nic
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareEthernetUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareEthernetUpdateSpec` missing when calling updateVmNicHardwareEthernet."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareEthernetUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareEthernetUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareEthernetUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareEthernetUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareEthernetUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareEthernetUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareEthernetUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareEthernetUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareEthernetUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareEthernetUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAdo7aDzcyNszZA
# Q820YnS18ANE1AqXMpRPecZLlHTVXaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIP8kov8g3dMMY7h8
# Fe1fgOVGeCCzqfysyb4mmpOVvbjVMA0GCSqGSIb3DQEBAQUABIICAKTVyuww1Iuj
# a98TaMTDycgraF18WJe146cekKMvfoL3X3GPUg9la9fYG+a+6/xF4w4b7EW6clG+
# BK3xEw1qu+r7QzQ0GfkrlkXOjdIrr5aK934jvCjRX45LeZVXj+fAxf6wPhPwQpU5
# hhXLnyWflE4FCMLW2zopeQSvOIzhUmmkHemNp5Rh9v8PYr+jFL9PeOSyvatZmPJB
# z+MhaAe8ED4t1KMt27xEyqZtyltANzmxIaFg/yqNLnddFB7X3Eo04fm15afJKiPz
# rHaOyDbMceKU3JftFytUJg1lptRE9+l4xVh69jABVkhLxJM0iQhIjrf4s7smykaI
# MlIAsNqIIP/9mUgABdiSzhABMZ5pR3fyY360LbYcbxNiuX3HdmmBaD+2O1YwstNS
# o9Tz0sbLF68lrSHyeP++v+a6ZVwG1HHqwWL8DT47iXOFCripBur9k+4zemURvHvO
# GUynONLy9Zw7BARuqs4PCbOX84fcoDi1NkkVsgDPmxqaoiS/AgBu5hnVI3u765A/
# xk8qbVP2vVosf0fJTyENSZ2QS2LYiNNJ3X8sOISaJOg/R5QPXtRdt0DeGuYPU6rY
# 6hjeycvfcXToFd1+Efa1htmOudWgZapsxU8F2U4O0qqptpNEjc63IefdWGYYKadq
# /oyLDJXzcOZ+m14yHNzQ4hf5ZKEpH5rWoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ICEagTjo0x0CczvmhgJQgy5CWtQlMSIfI4w1W4mmpZyFAhEAmQ+V/lZ7kYF8Vgq0
# fHKeCxgPMjAyNDA3MjQxOTQ0MDZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ0MDZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAXYNeASZcgM8Ek8ayTo3U6
# Db6XLtXQ8umwhLt73pKJqTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBIdbRy
# lalQHpV0zLxL+p8h7COTqeiLnotqmqIY8+plVMX+ZJfgXlh0SWGOdNLML9C04dTw
# cZG6QUoth/pno/lSkRxyPJTxcKEgBEd8P8UZ94ohX9dgAnmeo3D+bqqiAfXQ/q7C
# VmBnibN65yj0V9o5NSNl2vY64o5IH7m/qp5SJsgbtYsowcdM4SJA4YxKnJP7xvrb
# WmR/4MKs1bIk8YivSppkjQG40GVp475eFsmTLPpmpUiyK+CPaXKuURmQIPbyNqJJ
# 7bIEICqE3I9Is6IvrE9k0SmIg2WJfnAskAuKbwvbIFHFaBIhvItWyy9xlB6fri+n
# 60btxXC/7sYNLuxhvEdIeOBFvdFq20UjFCwaf3v9WcnVQytcDtCSWd+Nx64apXmf
# 9G2ExEXc9DQxIyl61JMvJM+Ysw1B6HH4M9FrcicHFAQ/eQlcKDS2MwCAZz9UYwHB
# apoiu/tNJTOsn//g5xwj1XznoKSIIktllSE9MtB+y8RPiwn8BlgypqIlQ6jjMflD
# tbFX28Nvoq5mGKbvRJrE4nYViYMEfPb4yckarwoQNQLgLCYFed7eR5WJSnCxDqcR
# bpvjAVKThsTfWlSIeI/BIRpLtkpqmMVtjdotoA/KX8zcPV8iYStiie5sTupiKLzD
# b6fCxYpAIo95MXO+5fMdEEOd4vazzJkv+UpJSw==
