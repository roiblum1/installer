...
.PARAMETER VmHardwareAdapterNvmeCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/post/
#>
function Invoke-CreateVmHardwareAdapterNvme {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/post/"
    )]
    Param (
        ...
        [PSTypeName("VmHardwareAdapterNvmeCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareAdapterNvme' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareAdapterNvme' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/adapter/nvme'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareAdapterNvme."
                }
                ...
                if (!$VmHardwareAdapterNvmeCreateSpec) {
                    throw "Error! The required parameter `VmHardwareAdapterNvmeCreateSpec` missing when calling createVmHardwareAdapterNvme."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareAdapterNvmeCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareAdapterNvmeCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterNvmeCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareAdapterNvmeCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareAdapterNvmeCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareAdapterNvmeCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareAdapterNvmeCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareAdapterNvmeCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareAdapterNvmeCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareAdapterNvmeCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/adapter/delete/
#>
function Invoke-DeleteVmAdapterHardwareNvme {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/adapter/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmAdapterHardwareNvme' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmAdapterHardwareNvme' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/adapter/nvme/{adapter}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmAdapterHardwareNvme."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Adapter) {
                    throw "Error! The required parameter `Adapter` missing when calling deleteVmAdapterHardwareNvme."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/adapter/get/
#>
function Invoke-GetVmAdapterHardwareNvme {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/adapter/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmAdapterHardwareNvme' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmAdapterHardwareNvme' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmAdapterHardwareNvme."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Adapter) {
                    throw "Error! The required parameter `Adapter` missing when calling getVmAdapterHardwareNvme."
                }
                $LocalVarUri = $LocalVarUri.replace('{adapter}', $Adapter)
                $LocalVarPathParameters['adapter'] = $Adapter
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareAdapterNvmeInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareAdapterNvmeInfo")
...
VmHardwareAdapterNvmeSummary[]

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/get/
#>
function Invoke-ListVmHardwareAdapterNvme {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/adapter/nvme/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareAdapterNvme' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareAdapterNvme' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareAdapterNvme."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareAdapterNvmeSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareAdapterNvmeSummary")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDIbiw2+MuI3xa5
# jizA+uF0XXnlU0eSLnG4bufonxP866CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIE6DXwlPjR6nZ+yC
# D6+YAw1as74HckGVsgipJtwkbtRgMA0GCSqGSIb3DQEBAQUABIICAFyhd1C9x0n3
# drgec2Gxd9WSOM77233fXcSbIV/E4ZDhDFrjrwhagWQ5AtmelGlW5EEno6I5HGTB
# m+yYNkArh7VKY+oky4V0407IwFDc0QV1jb7BIuwe9rFSOaiphlbbLdkqxhxGdYoz
# Zo66naAvLBgyQRsafCSL/i/MI2S/+dlTxo6juC+l2KQVzsrxUh5y1aVS/hzSIFPa
# CQoPM0pc1aEzNObWHl9mASoiWUsaNiyAjYK2IN0r403o/0Ktg8x+YU7MmjB7ytVA
