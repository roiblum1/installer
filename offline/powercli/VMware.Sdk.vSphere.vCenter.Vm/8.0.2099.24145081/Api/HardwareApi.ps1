...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/get/
#>
function Invoke-GetVmHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetVmHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmHardware' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware'
                $LocalVarMethod = 'GET'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmHardware."
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareInfo")
...
.PARAMETER VmHardwareUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/patch/
#>
function Invoke-UpdateVmHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("VmHardwareUpdateSpec")]
        [PSCustomObject]
        ${VmHardwareUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateVmHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmHardware' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareUpdateSpec` missing when calling updateVmHardware."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareUpdateSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER VmHardwareUpgradeRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardwareactionupgrade/post/
#>
function Invoke-UpgradeVmHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardwareactionupgrade/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("VmHardwareUpgradeRequestBody")]
        [PSCustomObject]
        ${VmHardwareUpgradeRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpgradeVmHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpgradeVmHardware' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware__action=upgrade'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling upgradeVmHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareUpgradeRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareUpgradeRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareUpgradeRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareUpgradeRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareUpgradeRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareUpgradeRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareUpgradeRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareUpgradeRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareUpgradeRequestBody) {
                    $LocalVarBodyParameter = $VmHardwareUpgradeRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCAo4Bm7ykUvXGN
# wubqAK4p5URhasAcWyUbgbmrcjbT8KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINj/O0GUn7w/Rbvi
# GOO2YIOC1kH8IJ/IIAEd37uiigysMA0GCSqGSIb3DQEBAQUABIICAK6sqcQ5oCPk
# 5T1C2cPeBc+h6w1aStqzB+lFro+FMexNG0IV3Zmu8M6LVVdN2/UMiaRrPiu/0OHa
# Zo79Ht1zcPNLp8v9ehUR7y1LdOuuYEUQ60+Nea6DeMGVq46QMV/WuWT6UpRFoQCr
# N7L06Cz1pYuAkvKW6vDh/NrQ7edC/FOlItZg+putIaAuTPdYiZFrBEyIIJ/iQnGT
# xTlqaTl8wyj9jBz7du0/RsLP/hwsMb72phyEK+49SjnwChLmCjj9iR0OveCD/Mw0
# nrJP2Z7ShhyBJtj2iVBL7VZ4+OLhwJE6TLwEgk569AtTHqCNySO2cTV7ucjmx7nM
# plrpuJXx/MVcbQdhjTTTH5HJcrmRFaFFD9okSq76WyjiEJ+8pRtEKWuZc7xYR0ur
# WUgsOg7LV9NwoNDQzXSWOPTKvwfdjEqBLgmFm4Rrbe1+tGrF0pwGjIbrYH2XbmhS
# jFYP7xFHW5BqPgwp4MJxh4oDaB2Nik1LU2/AD5U3I2dNuii7jCFHXEX/s/XM3QDs
# IpiUjModpIm2t4wwdxi6e9rtyVztH/c+8fd/3+iJk0h/Ecr115mb3fjFzZkGfMGA
# QTs+tDwX012/I09MS5X7vhIY+QIQ+3LQPYqlO+Ex/q78kzXsTofvlNIZpl/QL0Kh
# bji+fzkEdLh96XHKnjRrA1LFVKGLwiVMoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDmCIcSN4AN4KuoDiSwPiQB7M5FbSQSYYda9s222u9cFAhEAliFURLcQMqQMJSCG
# cqTy0BgPMjAyNDA3MjQxOTQ0MDdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCfpQrcWOC+E6B9GivO/nUP
# JEeKXgCiNVISR21zmrJj2TA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAT6r8+
# XpcPyUQQPOozYqz0w2XFStGRlH5uDCDajB8atXIhFd4vB3D8p1ojNq1ZMtAg96U5
# E7JeN0xxKf1qC+rjBuIaSz7/uTwbBqoZECwxQ5JQYCKni9GIu9zxsf3FWB0x40U2
# KWvG2O+lT0Ik7/Q3igO6/tEl3Mem1vQNVqvWRhMbSdKs1ChhnhZGC0gAK/ZnRdVO
# ctGhftcrWYx34ixi2fYJ0CtTcNA5Rjj9siLUlPpbHnoky8xt4Vmmr9PVb09HBJxB
# 1ykgjJo/FaJzB8Ot7qDWieFRZRZ5HH0SJhasrKkFYvEVMIVGZAbTY7Hbv2XXzNMd
# LjM0CV/IVhai8kgFPoy8Gtt0NCTxFSSLrfDi6JWRIf/I2xtISpVuixEXW+bXDQ0M
# ObND61OFMCHQTMfhqmnQDVcoyFR171IKgn6NLUzR68AdKhqqQ9Ty1/shLa7QQhI4
# DDnfRndGU54738di2gkG7xYCk+K3q9K6iEjp2SNHuMFpVDv6vt3XBpSFTfNng1C+
# 3ALTCLIoE7FQCUZMsvOnnU/YWy61RS18oJqQrGj1mIwrN+R6LxG3LjnpWwuGN7Bt
# 2S0I1icpRBgEz37hDsGIbNf6BFr7259/NZGhSSGamZ6JxQzP3To+n6Iu1ITGFv2o
# Yacvxxz8p0ivwJFyHDoefvSCyazEIdyY5Y9X/Q==
