...
.PARAMETER VmHardwareDiskCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/post/
#>
function Invoke-CreateVmHardwareDisk {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/post/"
    )]
    Param (
        ...
        [PSTypeName("VmHardwareDiskCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateVmHardwareDisk' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateVmHardwareDisk' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/disk'
                $LocalVarMethod = 'POST'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling createVmHardwareDisk."
                }
                ...
                if (!$VmHardwareDiskCreateSpec) {
                    throw "Error! The required parameter `VmHardwareDiskCreateSpec` missing when calling createVmHardwareDisk."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareDiskCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareDiskCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareDiskCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareDiskCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareDiskCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareDiskCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareDiskCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareDiskCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareDiskCreateSpec) {
                    $LocalVarBodyParameter = $VmHardwareDiskCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/delete/
#>
function Invoke-DeleteVmDiskHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteVmDiskHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteVmDiskHardware' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/vm/{vm}/hardware/disk/{disk}'
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling deleteVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Disk) {
                    throw "Error! The required parameter `Disk` missing when calling deleteVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{disk}', $Disk)
                $LocalVarPathParameters['disk'] = $Disk
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/get/
#>
function Invoke-GetVmDiskHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetVmDiskHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVmDiskHardware' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling getVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Disk) {
                    throw "Error! The required parameter `Disk` missing when calling getVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{disk}', $Disk)
                $LocalVarPathParameters['disk'] = $Disk
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "VmHardwareDiskInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/get/
#>
function Invoke-ListVmHardwareDisk {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListVmHardwareDisk' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListVmHardwareDisk' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling listVmHardwareDisk."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "VmHardwareDiskSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "VmHardwareDiskSummary")
                        }
...
.PARAMETER VmHardwareDiskUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/patch/
#>
function Invoke-UpdateVmDiskHardware {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/vm/vm/hardware/disk/disk/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateVmDiskHardware' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateVmDiskHardware' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Vm) {
                    throw "Error! The required parameter `Vm` missing when calling updateVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{vm}', $Vm)
                $LocalVarPathParameters['vm'] = $Vm
                if (!$Disk) {
                    throw "Error! The required parameter `Disk` missing when calling updateVmDiskHardware."
                }
                $LocalVarUri = $LocalVarUri.replace('{disk}', $Disk)
                $LocalVarPathParameters['disk'] = $Disk
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$VmHardwareDiskUpdateSpec) {
                    throw "Error! The required parameter `VmHardwareDiskUpdateSpec` missing when calling updateVmDiskHardware."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $VmHardwareDiskUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$VmHardwareDiskUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareDiskUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $VmHardwareDiskUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $VmHardwareDiskUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $VmHardwareDiskUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $VmHardwareDiskUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $VmHardwareDiskUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $VmHardwareDiskUpdateSpec) {
                    $LocalVarBodyParameter = $VmHardwareDiskUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBBwaSUyoOZDVb7
# UEGrQksaUwj6yZDicmCFtowWvUijF6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICLj9OtooxQ2P9u+
# GWl1wJbvX5Mz26v3ySSce5uGksjIMA0GCSqGSIb3DQEBAQUABIICACAWUXwgXPPE
# +wn7KkKyFSE549SuvLCXtFCYCMb2z7pLWa+jPFuVebG10ceq7KB9UjhIcb6JZqtm
# 4ZoD2cc0HjIHxpSBJPXTGWI1v+OF5vkZpGoY7XNjj5/8GFxYEGO+l/wYA8o0oLhe
# ipKOyG0Eu2V2wrvmLQt7Y2KkvPCmWmAqVznqcTvUs19Gi8LgazWItrjTTWNcdPg1
# db87m7mwI9D1olIjuZa61HqfuJZSZuedaLssWF667UGAn9NeZl28NAm5G3YoX+5r
# 1xxBAwDo6pUaDqX6j5/HvlToynR3ZXM3i9dlpppZlxlUGO/zpi4DjTIcI7xyj6eb
# EylUDsuT8TWItDBWxpeKGaePEP3qRJPSiYCQJKDnJ64sPJd0rLBuCruAfxOd3rNG
# UG8pKcpfZZjKTvb5fPBSaojV0tjHwzk434LPEMst5Z+2Wt33rLK2HSTMAAD4im8S
# LC1lUerWelsCYCFtGMHQLZzXc5qA7FLFHb/FYR5rU0cwnOI1WCXkQ3+tityzpunQ
# fEao19dlvqucvksxhXY2o0C7UBRyJyLL5/NJBGNo2AeTDl8GyDKRYSSVZP0vsB25
# smsOqTAw4dOrSoEpgWbT3QLDjovmjE4vrjKfLta1XVhhKuuufdIr+FlfiGjsqRhX
# +HWAN5q2ulcpeDxW4Q26r6XOiu48QJZwoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IAhziqm5xqX6I5RZ/B/TVo61ofYNCl2B0ejwKbiTGEueAhB1qhttiICB8/qgU4rU
# RnhFGA8yMDI0MDcyNDE5NDQwNFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDQwNFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJblT5oeCPpfVs9L2EejauPF
# kePyYDxtAmyTPZGovyw4MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICACN7SmlC
# 1iG3g3UIXjibYYNRLqAxuXT4QfLPUE+es16JU6GGFrbMfYNy/Sl4wzQTFwuI/GjV
# Cs9BJnQZXHs6kgM+voe+n0UMVITl4a+GMQl9Py3wOexgoI6k3NCdE2gkSWUtVIdi
# OSGCqt5ok+0FS0HUqTSWu51reoKdsLpEAzWD3/dMfdeNhDvzgndV5MR5Sw2SY/An
# zpk0/x7QGjkPtInHio4sVQvFhgLEKZAl9D72yujvp3KGq0bjvOMYg6TnCYKtKxey
# nu/MBH/J83STtb6IEoNgRogIF2/j7ojse7ASPEO+5hnyav7mCAifYrifxFft9wyB
# yDak3oQLTYCGUQcdlsMsZ9dec5U9/Su0ApwGftOHK2tY4TvraBsNPj/Z+Vx0PyW3
# 5oV7FvN4gqZzbjomjnmp6D/vIwasmuzCQRKF2aEZK3JnvlAmqp0MGhCYCyuMMUxv
# 0A+AnolSzrg54hs+g1nFZL4AQ1SnaUHPPH9q2C8uCYbF5uTnFeHH4osgKA5mVnXK
# j7etEiYsVo7ymBsc8qLd6tVuArn5Nu5PFmVOod+5mHvxBx11HTfQzeDuJBAkwl6U
# yLeiOAJgkXKdfhp4Dt1ACQ/obgtFOS5EuSlu7dz84u3Mg3uV5NnqYB0TEk5kTv2A
# Q/Ja4FkCaSYEWKL2PgrFRtwb4Qcjoax1oykZ
