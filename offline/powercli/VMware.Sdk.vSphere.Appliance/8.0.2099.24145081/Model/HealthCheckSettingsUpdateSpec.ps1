...
.PARAMETER DbHealthCheckStateManualBackup
...
.PARAMETER DbHealthCheckStateScheduledBackup
...
HealthCheckSettingsUpdateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/HealthCheckSettings/UpdateSpec/
#>

function Initialize-HealthCheckSettingsUpdateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/HealthCheckSettings/UpdateSpec/")]
    Param (
        [Parameter(Mandatory = $false)]
        [System.Nullable[Boolean]]
        ${DbHealthCheckStateManualBackup},
        [Parameter(Mandatory = $false)]
        [System.Nullable[Boolean]]
        ${DbHealthCheckStateScheduledBackup}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Appliance => vSphereHealthCheckSettingsUpdateSpec' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "HealthCheckSettingsUpdateSpec"
            "db_health_check_state_manual_backup" = ${DbHealthCheckStateManualBackup}
            "db_health_check_state_scheduled_backup" = ${DbHealthCheckStateScheduledBackup}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpVOJqrRSHS5B1
# IfOZ76pT+fQtpFQYw0jF0YSt6WCR06CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEQWJhuYDSmHZbN6
# 6Pht6RuTVIJeLP825iU9x2c4Aw0jMA0GCSqGSIb3DQEBAQUABIICAFU+gWEynh3Q
# QcGzRmQ7nXOq77DPoQgjHmm4oICQ5v53NIUFZPcVVAyIiLZ7ibZ9wx55iI5pnpxl
# I03ZaklWB61kP8E+dNwMF0VBeFxZ0RAnJmzTw/0y2be2ytXag7sfrthwes7Ntb+4
# d1m7f7MWLjA8TowpS5BpAhd6ev4SBVY52AWomrt5QgZe6qh5GnhsmO1b754mETXn
# scaA60Ho65HqxOF0tatRq0QJFZmmf6OwUwNQbbPauO5EqDjfF4zM42BuCO1/UvvE
# nxliazUJQ4v3SsDoKnnkVyCFQyvG6/GTxPXVUmf4arS5JYJHkE9Nbk+juq/LtG0V
# 7OgunfT71h+HCAT/hVQEnqjjkh6gLJOhKb+xSHF2q49EkKSKwySqVf7Y86nhadYy
# RtOBM9e0297OzvURTnYCv74DB8RVoG3aRRZrH2pxtDcJupRe++/wwG7wDJXIm1bC
# ByrikchIADoLSc5ecivRyXM6sRgfXwIktQG4P8ey3iM09d8647z+f5ofrPLTuq/P
# ODw56RkpxkOttCm6l9/UAJ2mK4ijM4EQMP4mdwME+YlovM37btQW1MMb8ViJqq8D
# s8yXM1tk2UMoGauMkkEzaQVg9y2D1irxDlR7Ys91ibSAdVvGw9UbbjonaIOkzp0n
# DXlBdG/Vbk7ma6pcsyoe5X21az1ZfdC1oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IDhar4P+Cjn0WWjNdAl3SJG9xCcd+9vDKbWIsygpEE12AhAkWvHdWjZKV2rWElcR
# 5EffGA8yMDI0MDcyNDE5MzQxNVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIFwqv7Fh8gtLZLJ8z9bN2uX1
# Yyq7MR6+5i9HCeLBzyNhMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGTZJPOq
# Xikz10u+YD+xK8Ac8aPKUaB3sGQ47C4wxQa73v7qdonbDvxvqetG6q8kbMom2d2/
# b9f7vCYUEu/8MTQDcPtcCcHnLQayrnUzbsTbAH6Uyq9UlodMmVrkGyGd6AI6oscO
# cjx7sSrQmaOqH71+NkRTItap8zpvrFd/lNIGCAlP8KZLU9jkaHp38N3XhnNi+pDi
# XxVDQqv87WC+4K0R9+6FKQNNTEfZz/UAaAYkpNNRBqDuVDsawZGNb3IqXVjLY4J1
# 0MS392u0kBrUrLYEH8libRj5shrYOSMJjGWDcLcpBpfpWOL+2lbjCqxWt7WyKicF
# uW4SBKnb3dK9PsvRx7/GKBgMD5fOaYoCCzYXsKMQpZoPG0UBuCFoJwPjn5Pdevnu
# 6MKXX0a2r1TeiK/gXtSKdLl1gSrRLJTTkoGrrfmD1tq5ByNHlGEFv9vENebp1ULz
# JXN+45/aZ7KE7Pngp04NXKs0WxkZmo6SqQaqtJoyj6DMECDyX81wJ+2zNDZKmR/l
# Kcu9xa6sJjGcpUpfSzyc/j9vxLcNdVYF1oFSAMEmxXA17VN5eNDzFJww2HV2xw8+
# 5ppUs8b4PP9lg6IGqDg7vt8M0YCpa5MjNxOPpyd3M5Uw/1HrDY4qE2zJTj3ikF7w
# GHNEwejHX0AEylQxiwl1GUKQw1oIn8Ax5YaZ
