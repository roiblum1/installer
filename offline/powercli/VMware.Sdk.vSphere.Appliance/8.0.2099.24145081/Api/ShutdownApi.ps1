...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactioncancel/post/
#>
function Invoke-CancelShutdown {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactioncancel/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CancelShutdown' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelShutdown' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/shutdown__action=cancel'
                $LocalVarMethod = 'POST'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdown/get/
#>
function Invoke-GetShutdown {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdown/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetShutdown' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetShutdown' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/shutdown'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "ShutdownShutdownConfig"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ShutdownShutdownConfig")
...
.PARAMETER ShutdownPoweroffRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactionpoweroff/post/
#>
function Invoke-PoweroffShutdown {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactionpoweroff/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("ShutdownPoweroffRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-PoweroffShutdown' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'PoweroffShutdown' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/shutdown__action=poweroff'
                $LocalVarMethod = 'POST'
                ...
                if (!$ShutdownPoweroffRequestBody) {
                    throw "Error! The required parameter `ShutdownPoweroffRequestBody` missing when calling poweroffShutdown."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $ShutdownPoweroffRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$ShutdownPoweroffRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ShutdownPoweroffRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ShutdownPoweroffRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $ShutdownPoweroffRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $ShutdownPoweroffRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $ShutdownPoweroffRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $ShutdownPoweroffRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $ShutdownPoweroffRequestBody) {
                    $LocalVarBodyParameter = $ShutdownPoweroffRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER ShutdownRebootRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactionreboot/post/
#>
function Invoke-RebootShutdown {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/shutdownactionreboot/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("ShutdownRebootRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-RebootShutdown' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RebootShutdown' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/shutdown__action=reboot'
                $LocalVarMethod = 'POST'
                ...
                if (!$ShutdownRebootRequestBody) {
                    throw "Error! The required parameter `ShutdownRebootRequestBody` missing when calling rebootShutdown."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $ShutdownRebootRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$ShutdownRebootRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ShutdownRebootRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ShutdownRebootRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $ShutdownRebootRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $ShutdownRebootRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $ShutdownRebootRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $ShutdownRebootRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $ShutdownRebootRequestBody) {
                    $LocalVarBodyParameter = $ShutdownRebootRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCbGsaY2rZIR/j6
# /BlsM1mg/fJ0069b7hGfkckasZLRXaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEID2I/DuA8Zb75G/t
# AwkCwVYtUZWbQBjdIrvbdUUHVeNpMA0GCSqGSIb3DQEBAQUABIICACgENj4U16kZ
# ByrLPUnvPygvpdmJ6dU5BzzE/kAfxWhRAnSWIHXEvOOkPvbv9oCpDv8iHRdVwSjP
# VNMT/+JxOQejjiVtMwSbjzRC/jnLM0Yjn749Hq9rsA+z4CEHF/Nz8+KY+A3cuk6F
# ZYhBN60xNeCOf/15FJI7+agD2z7LCaHINEy6cRlVax0h96dxFZ9UxJk5bi9OJe5T
# vcKkZw5+czVYz1y9ydgiriJUxIqYpFkqTihHhg8R+NdnvEQRJxoy4zWyl9kNq9+x
