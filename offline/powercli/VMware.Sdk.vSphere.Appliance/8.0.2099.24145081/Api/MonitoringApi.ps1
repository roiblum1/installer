...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/query/get/
#>
function Invoke-GetMonitoringQuery {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/query/get/"
    )]
    Param (
        ...
        [ValidateSet("MINUTES30", "HOURS2", "MINUTES5", "DAY1", "HOURS6")]
        ${Interval},
        [Parameter(Mandatory = $true)]
        [ValidateSet("COUNT", "MAX", "AVG", "MIN")]
        ${Function},
        [Parameter(Mandatory = $true)]
        [System.DateTime]
        ${StartTime},
    ...
    Process {
        'Calling method: Invoke-GetMonitoringQuery' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetMonitoringQuery' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/monitoring/query'
                $LocalVarMethod = 'GET'
                ...
                if (!$Names) {
                    throw "Error! The required parameter `Names` missing when calling getMonitoringQuery."
                }
                ...
                if (!$Interval) {
                    throw "Error! The required parameter `Interval` missing when calling getMonitoringQuery."
                }
                ...
                if (!$Function) {
                    throw "Error! The required parameter `Function` missing when calling getMonitoringQuery."
                }

                if ($null -ne $Function) {
                    $LocalVarQueryParameters['function'] = $Function
                }

                if (!$StartTime) {
                    throw "Error! The required parameter `StartTime` missing when calling getMonitoringQuery."
                }

                if ($null -ne $StartTime) {
                    $LocalVarQueryParameters['start_time'] = $StartTime.ToUniversalTime().ToString('o')
                }

                if (!$EndTime) {
                    throw "Error! The required parameter `EndTime` missing when calling getMonitoringQuery."
                }

                if ($null -ne $EndTime) {
                    $LocalVarQueryParameters['end_time'] = $EndTime.ToUniversalTime().ToString('o')
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "MonitoringMonitoredItemData[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "MonitoringMonitoredItemData")
                        }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/stat_id/get/
#>
function Invoke-GetStatIdMonitoring {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/stat_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-GetStatIdMonitoring' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetStatIdMonitoring' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/monitoring/{stat_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$StatId) {
                    throw "Error! The required parameter `StatId` missing when calling getStatIdMonitoring."
                }
                $LocalVarUri = $LocalVarUri.replace('{stat_id}', $StatId)
                $LocalVarPathParameters['stat_id'] = $StatId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "MonitoringMonitoredItem"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MonitoringMonitoredItem")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/get/
#>
function Invoke-ListMonitoring {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/monitoring/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMonitoring' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMonitoring' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/monitoring'
                $LocalVarMethod = 'GET'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "MonitoringMonitoredItem")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAfHjVECIQW0RMk
# jE9CHObmGlEzPutUL4KF8N0C0GDZgKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBUobep0b5lvPJ18
# e1In6w8IOo10L1msNWpKt2w4XDQOMA0GCSqGSIb3DQEBAQUABIICAHB5OXOKxZez
# 706AKYx2x2S7PF5B8PdAjlFQ2xS5ue6/y5ZAq9kHNS1V1RxD6/THdGQVmUqsicFf
# XuWTbYHFfdpGoGkwBvgVwQazsIil6/wcD9VR1TV91wnHZdgI25JV9ayrg+k93v88
# 00PfvTqyW3lt+tK479gNStj6n/sM/R5Qzt8DIwIxyE2x0aSMaXY+caJRRuBb4CRx
