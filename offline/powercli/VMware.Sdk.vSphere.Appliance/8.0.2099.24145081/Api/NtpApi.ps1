...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntp/get/
#>
function Invoke-GetNtp {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntp/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetNtp' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNtp' on target server '$($serverConfiguration.ToString())'."
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntp/put/
#>
function Invoke-SetNtp {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntp/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NtpSetRequestBody")]
        [PSCustomObject]
        ${NtpSetRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetNtp' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetNtp' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$NtpSetRequestBody) {
                    throw "Error! The required parameter `NtpSetRequestBody` missing when calling setNtp."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NtpSetRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NtpSetRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NtpSetRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NtpSetRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NtpSetRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NtpSetRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NtpSetRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NtpSetRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NtpSetRequestBody) {
                    $LocalVarBodyParameter = $NtpSetRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntpactiontest/post/
#>
function Invoke-TestNtp {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/ntpactiontest/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NtpTestRequestBody")]
        [PSCustomObject]
        ${NtpTestRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-TestNtp' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'TestNtp' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/ntp__action=test'
                $LocalVarMethod = 'POST'
                ...
                if (!$NtpTestRequestBody) {
                    throw "Error! The required parameter `NtpTestRequestBody` missing when calling testNtp."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NtpTestRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NtpTestRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NtpTestRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NtpTestRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NtpTestRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NtpTestRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NtpTestRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NtpTestRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NtpTestRequestBody) {
                    $LocalVarBodyParameter = $NtpTestRequestBody | ConvertTo-Json -Depth 100
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NtpTestRunStatus")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDN2BNDz3fioeVH
# AkPJXQyhYEhK3CYZ/73jE9Eex1le9KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN9VCwXUBfED76u5
# xmnzahwqcI8LOrhV0TmJ/exKA9pyMA0GCSqGSIb3DQEBAQUABIICADT8mwiAmTKR
# knVhgedihEopN+RE8qdgOWsWHiZBaE8CA42+uw+Da172oqKU4beWZR5bFulSxJss
# +O00oW4UsFcV04R4BZ9wZjwS2gaaP6Z0tyORCCOr+fnH9/8rREuqj3BAqfUp24Tt
# 2Aslc6qIxgvQlsD2BRY2lozeEPbmxiCySOEX9hGRxa9yURIEDcLoMrUAeB8SGEDs
# g7xu6+uZJnlUVw+SRHkWBeXRjEfwmIBw4q4ZifyjMuVdselDquF8ov0Wwus/L30E
# f48Jbq/bosO6axkbwkAzH0Kv8fpdCfPuJCo/f+G1e1715YEjeX1tPbh81n5WB9Ve
# RPPZVszug+qBMwtn3BwnGRtxFiZxF8uF6xHArbVaNcYRkHRvWaJnI2tx0YchEeoJ
# y41z3TBkUxrjnmQkALWHRVwfB18OFHqMzxJ5bjZHmNZDeDqFYU1EHb1ViAjLuD0T
# 3Gu8y1ri2fVN2cMEIG03kDHKrnzor/2lN7s5y8cNpDShqCf12frCynEGWPUqsb+N
# 3carv27XzmM34Rv8Crflxc0wD2QD28DPVT5nVAk/toWpgwFmLRH7nOB3nBMN/vEj
# RAOYwTXIW++Uuj2YN8Gz7ZOTiatvR+LiTMYrAYTaBNg+gQRBYE3/tZPUpz4t0bhT
# UTe7Hj9CaOz+H7gshl1G9j6LC+0aQmPMoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IFL8ZE7hdS6u4jQKqoWV6L0C/zK2/2zpe2gMaTsnmUztAhEA9rmkEHd8gZhhVheP
# voLy1hgPMjAyNDA3MjQxOTM0MDBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM0MDBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCqHp40YTkI1nL/MdIvjIQx
# JZ5JUYbXgXXZWg0IOvAReDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAogHOU
# GUdjkb8t63gUl0+GFXv6DQMjEXfMkvYkW/OMdO2tgTCkBBdTbe6eUEoUL7w/4oX8
# 6zQxHeCoLadkzpe/kmMarmUVPob/Tfi+QeVVjBpyK6NliCTGW5vfCS96jizaA99Q
# 7BSiCwWZGL/Fiezfygn4HgFluq142zOxY3dT+/mzWTFk+8pfSFOJHkIGIN+Xf39i
# SEK7u89EJrbLndAEwPI0UIkVWUTj7ACsw3zoGHR5WpWH+Mgt0ZMjZeteSGHE90aV
# FLnVdd/LHyIeBLqS/8k7ZauhNKTTbiC0dKcuNKxhoQpAU7vy7A/NHE9EAbELAusw
# bQ1nW0kka55ylFqDiMFKGBvxHxhK7ez4tL31sstFcCcL20YZS8rWt1f+MMuRYT/k
# kOojpM0RUGvQoRbluBjNGVyZufon/ipWRRBa8vXIB02puSZ1RcvgAIlgDyNoCzD7
# r1DVWVkMUMxBKCrZuiO2lf3LA7DVaxb1wsPJ0ay3iHLpQKldurV+QZ6pDsPnsj1X
# P2GmTl44x4VSRYw/68aycuedAap88lAvcbtuyMu1CxafvyER3BNsnh5dEBvl80kZ
# vBXdOlrVUQhenQf+jmdYWYgs/eJesaT2LofZLnktTsKcXS9n0ujjfrr0hnKJYdP4
# bfvVXn+JCXklLvMqavPQ3LJv612F4xt5cv6+wg==
