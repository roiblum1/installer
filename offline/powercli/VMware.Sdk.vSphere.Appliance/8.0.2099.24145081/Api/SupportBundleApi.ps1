...
.PARAMETER SupportBundleCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundlevmw-tasktrue/post/
#>
function Invoke-CreateSupportBundleAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundlevmw-tasktrue/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("SupportBundleCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateSupportBundleAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateSupportBundleAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/support-bundle__vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$SupportBundleCreateSpec) {
                    throw "Error! The required parameter `SupportBundleCreateSpec` missing when calling createSupportBundleAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SupportBundleCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SupportBundleCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SupportBundleCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SupportBundleCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SupportBundleCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SupportBundleCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SupportBundleCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SupportBundleCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SupportBundleCreateSpec) {
                    $LocalVarBodyParameter = $SupportBundleCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundle/id/delete/
#>
function Invoke-DeleteIdSupportBundle {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundle/id/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteIdSupportBundle' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteIdSupportBundle' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/support-bundle/{id}'
                ...
                if (!$Id) {
                    throw "Error! The required parameter `Id` missing when calling deleteIdSupportBundle."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundle/get/
#>
function Invoke-ListSupportBundle {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/support-bundle/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListSupportBundle' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListSupportBundle' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/support-bundle'
                $LocalVarMethod = 'GET'
                ...
                if ($null -ne $Available) {
                    $LocalVarQueryParameters['available'] = $Available
                }

                if ($null -ne $CreationStatus) {
                    $LocalVarQueryParameters['creation_status'] = $CreationStatus
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SupportBundleListResult"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SupportBundleListResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBxAHYIqDR7wgym
# NVZUn+atGymmm8KeEMxRrgiT9nX1RqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINrJ7K41xDs97Lh/
# s0p/PBLc1yXbyiNekwkzLv7qNq3WMA0GCSqGSIb3DQEBAQUABIICAFNVTXcBUecc
# xJr3KFYJbESYID0M1Akadh7VC3BlnPMLpAxGRlJRwotDUj7uOiWzzYV+72qqJ+q1
# 0nESjJH8duNg6tHSpW0lDuYVz9EBXT74tG3bR98Nzs683tEZXwbFApTS30ryG4qD
# Tn7jQpXptl2/t0xULUpcUQOYLoQ4Umpw7IZSWML6r8P9zuAnpHTdIRmASjerOeqw
# /N2UTAqDHaLdB1k7+A1sYK2DeYkGYVuHJPAoEmlcqSFgHO30yoKmHIeFijogDPXU
# vRwVNS6xaMtPrtVpRRSQjR982+9bD4bXTxScY9NAeN4buWnSQ2AhqUbJgvxFqz//
# /AvuCUY6nrvD4phvM5tJtGTmsbjqI4SqprWGagZEauoPlx7ynyWE0NIXFim2J3aO
# eKAJ66FCSnIqBtL/1St6Ltzw6nv++ooojQW3vorrSjDFib6lW2hRJalOiJW+zLw0
# Z/sVHXodlUxLWmzWEfNCi4F+r8gUhv/DfRFlZmRHMox++hZNNx9fSrsFtuURnmiF
# w05YQyN451/nuVRvfV5btu0sKUfHJK61LOJ/KEdpk1QT9Ugc3M147vf7+I3vWPl0
# oaV+9fASoPkWLvkgdHnoE7Q3ldjH49cc1CMX1v8nHyfVlY1NCvmQkbA1TavI0Ozk
# yx3CS2dXBAIZ/Nz8jTl5unLjanKWUIxEoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IP2yHW7jmPF4Ao/VKog8wP0J2VhTKPTUZRDCBU0KghQHAhAJlabbLRecVP9im3fL
# C+WRGA8yMDI0MDcyNDE5MzQxMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzQxMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIKTVjsJkIyDoPxUP07f2wAs2
# ZzoSFUUTMtk9oH2p61N6MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICABqGS6fB
# qv98w5oBv6QNjKiAUBzja4YbW6Twe8Isb3ChF9M0T3qVk4Yms5fHe84F3tsITsBI
# LGGfN1bCLyU8u/ha/fycqlf8dJIqt1siNZ9YHBNT2/a168jzUYaJDtNoDI0Oc5fw
# pRYjreh1t1arWgWPVEGbH5BFWWVxQt32OWeZ55zhsAwMd1fCezAf9m6bvKXG7/g3
# Yb1rAvzmMA0TqATLuXy/FDKKNSkxy2SDAjBmt3IcjIUaIje7CF2/7u5DfgkJJ/GI
# v8MxjrNPdufKrJvNgs323MFPxRpT1uLaV8BzljG+wXYHzkq0NaEF3VQhbijkJr/k
# hB1/mRtHcT+vixIA7fVJcvggnhqEyjDEXJH1QHmFMD8ny6JPRGgj8dmd8AV/yd/t
# LgVVynE5dgoPL2RW4n4X9RnmTBFj2VIgpXlt2W7aCl0RVF5pgda7AowkO2ijbk+E
# CJhAAPXGikYGBFYxR10AVyRFDpY1cNBUidtqPG1auly8scLdSkMkM0cLmAzTKlMY
# dN0N9frlz9rP0zURbUP7UB5b09aJdrC98BsIBMie5FXBHqqqjUMVLQjlbacLIWEr
# 6VsfUEcJNaU4547plYI6td3ifBKPVGgaA3OKTFVd1y52nGJ2s7NM/VbxB6jqbS1E
# Rbyx61hOM8rlQe2ViPDV3JmzPQVDG6jKrQx2
