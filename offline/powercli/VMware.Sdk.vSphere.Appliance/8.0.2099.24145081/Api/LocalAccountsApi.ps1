...
.PARAMETER LocalAccountsCreateRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/post/
#>
function Invoke-CreateLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("LocalAccountsCreateRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/local-accounts'
                $LocalVarMethod = 'POST'
                ...
                if (!$LocalAccountsCreateRequestBody) {
                    throw "Error! The required parameter `LocalAccountsCreateRequestBody` missing when calling createLocalAccounts."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LocalAccountsCreateRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LocalAccountsCreateRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsCreateRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsCreateRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LocalAccountsCreateRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LocalAccountsCreateRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LocalAccountsCreateRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LocalAccountsCreateRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LocalAccountsCreateRequestBody) {
                    $LocalVarBodyParameter = $LocalAccountsCreateRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/delete/
#>
function Invoke-DeleteUsernameLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteUsernameLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteUsernameLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/local-accounts/{username}'
                ...
                if (!$Username) {
                    throw "Error! The required parameter `Username` missing when calling deleteUsernameLocalAccounts."
                }
                $LocalVarUri = $LocalVarUri.replace('{username}', $Username)
                $LocalVarPathParameters['username'] = $Username
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/get/
#>
function Invoke-GetUsernameLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetUsernameLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetUsernameLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Username) {
                    throw "Error! The required parameter `Username` missing when calling getUsernameLocalAccounts."
                }
                $LocalVarUri = $LocalVarUri.replace('{username}', $Username)
                $LocalVarPathParameters['username'] = $Username
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "LocalAccountsInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/get/
#>
function Invoke-ListLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/put/
#>
function Invoke-SetUsernameLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("LocalAccountsConfig")]
        [PSCustomObject]
        ${LocalAccountsConfig},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetUsernameLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetUsernameLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Username) {
                    throw "Error! The required parameter `Username` missing when calling setUsernameLocalAccounts."
                }
                $LocalVarUri = $LocalVarUri.replace('{username}', $Username)
                $LocalVarPathParameters['username'] = $Username
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LocalAccountsConfig) {
                    throw "Error! The required parameter `LocalAccountsConfig` missing when calling setUsernameLocalAccounts."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LocalAccountsConfig -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LocalAccountsConfig)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsConfig -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsConfig -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LocalAccountsConfig = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LocalAccountsConfig) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LocalAccountsConfig | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LocalAccountsConfig = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LocalAccountsConfig) {
                    $LocalVarBodyParameter = $LocalAccountsConfig | ConvertTo-Json -Depth 100
                }
...
.PARAMETER LocalAccountsUpdateConfig
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/patch/
#>
function Invoke-UpdateUsernameLocalAccounts {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/username/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Username},
        [Parameter(Mandatory = $true)]
        [PSTypeName("LocalAccountsUpdateConfig")]
        [PSCustomObject]
        ${LocalAccountsUpdateConfig},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateUsernameLocalAccounts' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateUsernameLocalAccounts' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Username) {
                    throw "Error! The required parameter `Username` missing when calling updateUsernameLocalAccounts."
                }
                $LocalVarUri = $LocalVarUri.replace('{username}', $Username)
                $LocalVarPathParameters['username'] = $Username
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LocalAccountsUpdateConfig) {
                    throw "Error! The required parameter `LocalAccountsUpdateConfig` missing when calling updateUsernameLocalAccounts."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LocalAccountsUpdateConfig -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LocalAccountsUpdateConfig)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsUpdateConfig -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsUpdateConfig -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LocalAccountsUpdateConfig = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LocalAccountsUpdateConfig) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LocalAccountsUpdateConfig | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LocalAccountsUpdateConfig = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LocalAccountsUpdateConfig) {
                    $LocalVarBodyParameter = $LocalAccountsUpdateConfig | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC