...
.PARAMETER NetworkingChangeSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networkingactionchangevmw-tasktrue/post/
#>
function Invoke-ChangeNetworkingAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networkingactionchangevmw-tasktrue/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NetworkingChangeSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ChangeNetworkingAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ChangeNetworkingAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking__action=change&vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$NetworkingChangeSpec) {
                    throw "Error! The required parameter `NetworkingChangeSpec` missing when calling changeNetworkingAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingChangeSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingChangeSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingChangeSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingChangeSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingChangeSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingChangeSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingChangeSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingChangeSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingChangeSpec) {
                    $LocalVarBodyParameter = $NetworkingChangeSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/get/
#>
function Invoke-GetNetworking {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetNetworking' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNetworking' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking'
                $LocalVarMethod = 'GET'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NetworkingInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networkingactionreset/post/
#>
function Invoke-ResetNetworking {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networkingactionreset/post/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ResetNetworking' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ResetNetworking' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking__action=reset'
                $LocalVarMethod = 'POST'
...
.PARAMETER NetworkingUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/patch/
#>
function Invoke-UpdateNetworking {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-UpdateNetworking' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateNetworking' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$NetworkingUpdateSpec) {
                    throw "Error! The required parameter `NetworkingUpdateSpec` missing when calling updateNetworking."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingUpdateSpec) {
                    $LocalVarBodyParameter = $NetworkingUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCClZSmiKxUxkjnZ
# XS5SUuoxhN8DTR+zNJvxBOfYE+Vb7aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIFPpBYycg++Qwou
# qAKEiPuHBUfnK4d5s2LLjIlkJw4BMA0GCSqGSIb3DQEBAQUABIICAEMX06y1XKL2
# Rd8BQchzSrBqULAYD5w7tckjFhD/fX/3TX4ddjC+KH9O1md40Ak25nbd8pTgeqai
# 48jExHIOz9U60ek2bI9t6wHOs6Dyhdh3y9RWJV37lXvkZ40PL4kBDT+z3+ajkWho
# bi96l2w3pJ85oGG8cHWAH2UpOmBiyzTQ/0xLK2Uaafw/LosFQ096UjCAVaKizUvZ
# 8rwXr1cYbc3uU3kMaBY4fvcmMg0yfj1ZZoUrMQYZu9JvDq7/Hk2CR7e6Mex//JNK
# VcFBxd34uSJKoSsjhtB4JxejjCZpfUmb8+EBUFvoW7vQoRKdCwAwao+mElsLMMVI
# 3qPJ1bWxCKXsPJz1yXNZtfOzr+/xdRLMK74etMzd1IPDJFDKSZvCWr8TsgygkEJQ
# cPNvDaD+3z0lqy6pN/W3q00fAQ/0JaQ36c/Pk5gvFJ1r/bmRkEuN8clqPlpx0o1b
# Dz+Z6ojsxBaCXY2p6JNiNQCILvA+ZWdstDohBx1IBAKdOaQPP8MfOreIyA0rU21w
# 4GSKM5krGDQJj+tPeKa4EnSBge+madjNbgH9QwL2hHcgbpMJCuKqFgAuDJqhAxqH
# +7JMlSpOrW+GE0s7B/5GeBKrQNb5jm3OsvFdwf68K78Crj2tPFhNZatbIpLTEaga
# +Tsh9FgXmKaS/cUjd+dk5eCykYn/Eo4poYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INBQF8cOhb9YlNLV4XvaPSfI8YlTB/d+jJwbdZYtiKo9AhEA461+CgBI19lC5eSK
# gXv1BRgPMjAyNDA3MjQxOTQ3NDdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ3NDdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBXGaF7VuVZYkyLW6i4xeRx
# COD1RzBmPLIVr8Ypjou4DjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCFYaxR
# 0nRycWHO/9yGm10Huu+gVmBSME8JtufEu1gMCv8DTTTg5pPlZwFSnC7zY5aceO1a
# Dft3oBTggqNAYn2IkiFFLzOWcYKN4PTIocr2nwbqwUamlDcQFdSjSWpwMQtLYhaE
# yE1/PEJ7HgObvUH+0TIrEk7KnBJ1LNEAwvsKZdz+RaMHpxWHde4xrRGbGVjuvGzA
# hc13InQXcEmaAAshzuw9/eirof7Oa3f/OvouWvaguTXm7x75YEjhQ/+dhUN+0B21
# 2hEqM4OqNa/d2fwA3AVael53Nt6SclEG3iQGg0hBMMPa3J8JtxZw3va3oTFp8D0d
# QY8wuP2xl8J+yxrIKxsj/+j0zS4b7V/Hvlt0lNeIlMn9RS+U+GJh2i855WyomX3P
# yOoBSDz6fb03eC/YvxFOaLYnD/xz67q725YbIWdVgJcJoOA+VP1kYTNM5LSIs2Wp
# lHOZA9buRvIRclQbTdMbMA+W+YZJFBv1mQ3QnscvsXQbJG1IzwC7lH0le7KyKksR
# 3cJ0VC4giwVYQFzcF5wNcajHANnMlt2iAbYQ29XeoF0INJEAkQqIwjvGydmVpIyj
# TwuMyOj61JoOYS4mEstrl2x+9G3X3G6g+KYjS4h35ZB6B79jxnt1kOyrdYjC0MUX
# 3JXc2qP+fbpNJCyheBk9BAr8Hor+2oDOaDLdIQ==
