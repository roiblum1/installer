...
Description = 'This PowerShell module contains PowerCLI Auto Deploy cmdlets.'
...
RequiredModules = @(
   @{"ModuleName"="VMware.ImageBuilder";"ModuleVersion"="13.3.0.24145081"}
)
...
CmdletsToExport = @('Add-CustomCertificate','Add-DeployRule','Add-ProxyServer','Add-ScriptBundle','Connect-AutoDeployServer','Copy-DeployRule','Disconnect-AutoDeployServer','Export-AutoDeployState','Get-CustomCertificates','Get-DeployOption','Get-DeployRule','Get-DeployRuleSet','Get-ProxyServer','Get-PxeProfile','Get-ScriptBundle','Get-VMHostAttributes','Get-VMHostImageProfile','Get-VMHostMatchingRules','Import-AutoDeployState','New-DeployRule','New-LCMClusterRuleWithTransform','Remove-CustomCertificates','Remove-DeployRule','Remove-ProxyServer','Remove-ScriptBundle','Repair-DeployImageCache','Repair-DeployRuleSetCompliance','Reset-LCMClusterRuleWithTransform','Set-DeployOption','Set-DeployRule','Set-DeployRuleSet','Set-ESXImageProfileAssociation','Set-LCMClusterRuleWithTransform','Set-ScriptBundleAssociation','Switch-ActiveDeployRuleSet','Test-DeployRuleSetCompliance')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA5JE9xEduaC5Gh
# fof/PJ0T9FKqlU3Qmco2y43LavlVc6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN5Q3tz4thCwvHrU
# zENE+BG66sCWnFKBgJxRJ6n925rOMA0GCSqGSIb3DQEBAQUABIICAD0CwbXVBIzJ
# mvVn7A1IQkYuKPtWncafDLtr87M1rcZqUDW3xB/jFtrKjmaT2mRCwivwZuUZY9tA
# KimMW/rn++TVIPkHrWVS+OxJatXakzZ5sXiYd169e5EeRPH/YoeBGMwTB8kt8gN6
# WHVWh+TcD+nR68ncXfYxGGJdgfNKF71KNn+kLGytYWDdqqgIEiUHil938T5Yp2LR
# YsRA6XcEMU3X2c5vJtDywzbiYbkHLbZOrpwvBXrBOwpTWZmu+kBLha6z9XHVcwXw
# 99Q+oA1b4k4CRzfxnY7j2hCpbyV8F6/sx/Tio7fLZy41TdIa/FGDDIeL3ztdVTid
# yLCGUwPNVMOcO6NF8bUvNfScAGshl5F7Yhe0G/E8dvpGDLQhaBvJ2WP/si5VNSxT
# +jKBcMlQBLM7eEwFP1U/4YufOhgmYXnqnkQf7kY8T7AE3ukcS9nG/7YBLPxLL3nG
# RTnzLwBCxzlOUJa4B+XtOBbkdYRfxMbb0DoZUYAuIFJPgdDKb8U4+UW/3PtHOykp
# ZYWahGQ1x4KwLPOtr/RNPwMHo+uHJfp7K0bTd5pPrWFDeAjW3KQIbRlNCE45ZOT5
# yGb6Nl4+zdjcwY9O042mrr0oUij/rqa1DaAznx65UEJJPP44AYe2Ob3hApocuGqz
# BtetTdYpCg3kJf0kmpkIekfLGKBgxsRzoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IAOyV9Vuhj6Yzk+WE1vrJ+/LVhLXdjDqYsi6QxL00r35AhEA5xGlOivLb1r5D0iW
# jm6bkRgPMjAyNDA3MjQxOTQ4MTdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCcqY/Hs7OBl0sdIm2zYLR3
# AVPcLnbeS2tlyjx4KRKUMzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB1cgDG
# pHkzrNo6VOofIELdxRpvGkwq1VJHGAdKmUK3Sjv5ZzBrDyKUPoHzBELvyR+bB0gh
# Rwm2/oFO4pWCgoMJJ6Q3MXhTqOs7rVD6IBxnxlm1VwmQRUskrrOE+Lup7iaWbgF7
# Rp7DPHmxnSBmd5t0B4vt0V2rXXsyv+NuGKiVdckaj7a72mnNQwPH23KfoQP4sCS+
# AU4K3pEfgfpiRyBq1I7rpQdqFyOw3sl2mMMRB1hyBhvmtheGSYcLO8iBinia2Fe1
# NQBxRw1dRxWGOSrpvLBc75geiYxT0qGnqMkWoyjWeJUEQTOqeILjB0H3f6BHrfy2
# WEUqGbDZg3R0EzlHIJkrqKcdpJH9+6WeemwkB2Ac1Sw6J0sKv1AWVazAyLCeQxBe
# /Kz+9ElbdYBnzU+qpYvoM7WjpIhnsOKKGNjpRp/+OTICrjBx8U5SlpylUclgLhOV
# U9qivfNvOfxa68azroqrv74YvA8c5YH7UnHZQvenT5E+lcksoyUcSW6FRFXwaar/
# 0FUcUJsrIiWQB81B3YgpDjhSR/RQ971DrQnqCFKBF5/VVCQWIqVyrBu8wFrIWJaU
# XeFY4mfHkfhepK81L0QEPzEOcUqK4zj1MHtTQ90U/qUQSu7XAJ1XREeHDWCGRtEP
# OHoCJ7PM79eLdUzwgU+IGymeVRVa2dx0UcVRNg==
