#
# Module manifest for module 'VMware.VimAutomation.WorkloadManagement' core version
#
# Generated by: "VMware"
#
...
ModuleToProcess = 'VMware.VimAutomation.WorkloadManagement.Commands.dll'
...
RequiredAssemblies = @(
    'VMware.VimAutomation.WorkloadManagement.Commands.dll',
    'VMware.VimAutomation.WorkloadManagement.Impl.dll',
    'VMware.VimAutomation.WorkloadManagement.Interop.dll',
    'VMware.VimAutomation.WorkloadManagement.Types.dll'
)
...
FormatsToProcess = @("VMware.VimAutomation.WorkloadManagement.Format.ps1xml")

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.VimAutomation.WorkloadManagement.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3fEWK9CgYWs++
# KKWKZJOG7C+iCLmLDSJRZnjqTyOITaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIL2CkXHyK1/gNZgF
# QXBtTqTe83hXjIdPt+mP4d/4k9h6MA0GCSqGSIb3DQEBAQUABIICAEWeNuPQLs72
# GZRfR9meuSlCkDqBJR9GSjQRAz7c1Dhpwb6LxtPgbCoGjjGMlsROMBjvlNDyAt8I
# 2zxkWbw1NiK14F2NvpaRmjLxWwrnpvesovfVAR+87RC5ftYHHT+iqovlc+Dbin8Q
# PEmEJxKW2g7gDhRun0PwS+cPnM56uHggo6Fa89SRF3iPNFmmumKZs4IlsJuymVFm
# o0NI/9HsY/m/8to9NVEMaruly4ULPZixKRabT1bQw8OqHNTspy1eL+kEv3XCKhb7
# wHjMHnRjkH0bUbQQrplAxe7zRFbHH1n9JXvedEBKRrtDks0+FwD6Dne2Lm64G+i3
# wjE7LL3mNtfn68OxDmXZAA/gF5YGoIxw70yR6nCKHs8vv/BPJRbgRxFK+R8uLjbV
# bLcC8VAi7o15qf2F8D9Isbcdg55sbMgFca7yqy2JazT6MSVA+sdTsVATUoz45y/z
# Rg5uePXXjOVTZnQqO3SnxqpetL1u0uWNqJezcyxFG3WFk5mid4QCPMlNQuYBI1Xn
# AzIcR7JRWrjmguSKCmkl9DjPZTtRRqfGOBYH5+j99hA0S+qxHNLZNxlNv6lfPD2c
# B/NojfIlaiIKKzVXQYsSeVBAFbDb0SEEuQ/9/MZfaKj/3MxbUo6W3Z7ulq+9B5za
# AGUY17v65QEead9uxd2Awihv/uUYNMTzoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IF0bsCEpMScgFZ62bap07rMHpNIj4bP1oZCB8VoYPAoPAhEAlZTPRHRs+YNJime7
# rZxf6BgPMjAyNDA3MjQxOTUyNTJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTUyNTJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCB4eSul24sVD4+ifN6xuD78
# /twOx/t0PNhV4d7TuueH2zA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAruE7R
# +GDaBbR31L/F4nOK5foLq9XMrmHJv8/WRYbXdBgZ5sCzyZP6fmaEcVSh2EOcmIn5
# iBkdMY8vgQ7NfiyqDrLZGE2+7hA6qN5lBioqwqn0yTBiw+J7cdYP7nGgmDcVYDRB
# oQnsBgKakZsl45wStUknrEEwnaqTV+zA1gFzZAcC4iadaCXu8uJxH1NcEEc8s3Jz
# u7pmaYIbNevWNB9ihSHOl1XgD5Q534ljI8cebcrbzge05OECTCeWusfVpg1zZQ1n
# O9jr/G7dPUMf3ZtDWroCplKwhlYLZ8Y9+rUm5/q76hbD8gOOLYxyKGmlQNZFaMEj
# MZ7MnvwAu0Guq/E7Yh29Sdur6rpn1mO1GK3kejBNOZdFG9ulkVoobZlchF/OJJBT
# EFZnOrZ2eqgS91P2JgoJ4vCfIeA/4vuRlAv0lfQYKB8z9lZ5iIQ/goyA5Txqnofz
# va44skCdueAdMg2BkridQhQBHdji1iVxDw6zMdDwfnjED0SQ0VVFapOJjcxESpqj
# Hzgju/5qyqZ85sOGvvnmawsvEqE6DbSbzmpdnJAAdLhvqmCGPwtJv5HQ0xqcJasg
# FTP9UQn75nQoPcNOrbTdWi9p27T2c83e+Hf0ZE8shISefhNyu/NyJ4CGd4K44W0X
# wUBWo1IXCE2Jh1uAMWrCkkStXbHNUjXlUStkEA==
