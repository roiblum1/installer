...
.PARAMETER IsoImageMountRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/iso/imageactionmount/post/
#>
function Invoke-MountIsoImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/iso/imageactionmount/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("IsoImageMountRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-MountIsoImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'MountIsoImage' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/iso/image__action=mount'
                $LocalVarMethod = 'POST'
                ...
                if (!$IsoImageMountRequestBody) {
                    throw "Error! The required parameter `IsoImageMountRequestBody` missing when calling mountIsoImage."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $IsoImageMountRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$IsoImageMountRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IsoImageMountRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IsoImageMountRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $IsoImageMountRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $IsoImageMountRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $IsoImageMountRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $IsoImageMountRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $IsoImageMountRequestBody) {
                    $LocalVarBodyParameter = $IsoImageMountRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER IsoImageUnmountRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/iso/imageactionunmount/post/
#>
function Invoke-UnmountIsoImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/iso/imageactionunmount/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("IsoImageUnmountRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UnmountIsoImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UnmountIsoImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/iso/image__action=unmount'
                $LocalVarMethod = 'POST'
                ...
                if (!$IsoImageUnmountRequestBody) {
                    throw "Error! The required parameter `IsoImageUnmountRequestBody` missing when calling unmountIsoImage."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $IsoImageUnmountRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$IsoImageUnmountRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IsoImageUnmountRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $IsoImageUnmountRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $IsoImageUnmountRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $IsoImageUnmountRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $IsoImageUnmountRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $IsoImageUnmountRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $IsoImageUnmountRequestBody) {
                    $LocalVarBodyParameter = $IsoImageUnmountRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfW3yoRZyDD7n8
# o19Q1P2pq3ce7GNtcyfSNsalNgQix6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDvnaB56xvlLXtwA
# K7xD4pBya9Z6fIY/1jhrLUknrYnLMA0GCSqGSIb3DQEBAQUABIICALDrQRf4ENYH
# FyYCe487um0T0wpTva9gzswEvvPdZX2tgNgbHuAg/tUcioyJBHsxWO/0vVkA/X6j
# DuHPhEeIh02eB9EfjgJfm7CI+S8UuMJg6IzouexEq+sL6ObAIBFC62O8NGR31Tdm
# 0LFBkTXo/H7lSpUcy4LQjBljLFwbssGhcqZ7jGUS7vH6GrKsB357SE2AwXSgy2QR
# 5WSrxrKnkvdl9jSid4JRcBhxz5HRiYT8jD1uWF7jU4BG6kWhpfKMuDLTfv1up0t7
# 1AYdASHa+stmc+y7AfPX4ZiHhwBF5f6pVjSFThKBgUVH7OiZ0ikdskmNpBjuaREL
# stkqDo+QU+cj4lMeeNpnOxjjdba0feHhJ8mCzkwE24kfN2w12Iz89CSov7kze2Ut
# aY0DL6hh9Dv/PftVZ6vbw6CBDYCIXxRzI8yAf08RdXwqrKIgSOhdx8q2rXCn2tid
# QChMynLkaUzvxmcySiFWBbs2ApURlcfiq349afOC1ASYNe6D4o4GUjNBDvALeFDL
# 2peRerYHxwNpSdguj1YMIKZljGEvo8T6WPMuwWW2iXfWbpxpmDMlrjp2aLtAc0XB
# gOf5R/vfijGJ3yKYOf6NubxuhiCaC4pBj3eegw5aKs98QIimlZMu7McVSv9j4FGT
# GgYd4xtZHy+Jq449UfxFvGUioIzfsNvcoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INSd42ClVOSEc2j1KkMUZsIW/9jDWfxv0vQ8ckJLWsbpAhB3hcSolExRBe1JEph4
# qglNGA8yMDI0MDcyNDE5NDExOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDExOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIKX5gWZToa6tjkKtzpNEtXAV
# RSbomRlLkcsGj0ieouRUMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAFFSs329
# X7AM2q9O8DgDncpSSCs8Hu8U+QD2QrGxWdp9IgqFwOcsIRfQTyEMpj9VYM8wYGnF
# UirjM+HXaj27G7Evke6AqEtD2W6moC5cOGbe7O5ZhdMxDYgBZ5U/UYw+fFbE7Rf9
# EoOPBwDbs6WjtcNUj+CA+lGcqPZaQWzITKm0/0DtcbKaai/90uNg9ken832WWQwF
# F5LW+/FdIJPq52FYgoaNQOPB3UAjTiCLT4IzdhiT2gkS6NADowika7toJs5j5JU1
# pgOueIT2HtgZW7LfNB2h89V+gn17l5apmwC3SyMMkU49CHESZnxYKLVN6Assl4Yb
# vWoZ1nU71djKLKoeqIkwonhu7BtRq2jza9OxqkOGa3+CjC58RPijy/jcIyDpBpma
# pkDfMEv2psBBlATJFyEUnNXfKYRqFejj45Wz6z6ph9FCPtlm+Ek4Yf11tSXOk+Xr
# CZTa23tCVIkJO6LkWmV0As3M+AzGVhIiigu2lGkYM8/q9YYSUcA5rAsJmNJBcsF6
# LjH9E0W0alhQRZ4NisVG2pGAwSNITlEFXG5yVi8STNgo+3KjbliwWiwIinOLlKQp
# cHmKbZ45/FebPR+BV8CntG2/L9vYh0FUOXuZ2D2z1wrCkHZsIZ6WO9iIP0tZ5TYn
# FU/chbRvxQ+DSEhgumaGV5hED6Zh4tuUEHOM
