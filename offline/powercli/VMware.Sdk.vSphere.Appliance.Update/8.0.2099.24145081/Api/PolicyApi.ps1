...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/policy/get/
#>
function Invoke-GetUpdatePolicy {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/policy/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetUpdatePolicy' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetUpdatePolicy' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/update/policy'
                $LocalVarMethod = 'GET'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "UpdatePolicyInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/policy/put/
#>
function Invoke-SetUpdatePolicy {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/policy/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("UpdatePolicyConfig")]
        [PSCustomObject]
        ${UpdatePolicyConfig},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetUpdatePolicy' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetUpdatePolicy' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$UpdatePolicyConfig) {
                    throw "Error! The required parameter `UpdatePolicyConfig` missing when calling setUpdatePolicy."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $UpdatePolicyConfig -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$UpdatePolicyConfig)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePolicyConfig -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePolicyConfig -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $UpdatePolicyConfig = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $UpdatePolicyConfig) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $UpdatePolicyConfig | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $UpdatePolicyConfig = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $UpdatePolicyConfig) {
                    $LocalVarBodyParameter = $UpdatePolicyConfig | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCla+nhCBvL7h+k
# 64ncLeFcl/7QA62+Cgi/wvJu25fLoqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEVc+iQp6wx57Igz
# kM6TEa0MaX+jbyqMcixsHt3gnR7jMA0GCSqGSIb3DQEBAQUABIICAB4tLpmFqJze
# nX4mMEydmrziyRuQbyyXdlKg/1JWH1OqGZsd8r1uK5XD6qdAxYOt9RW6TXqGd9d2
# /2mXMpOlgCzZOo5H/tYabkWolkrJij3lPNx9FphmfAsckepQr6R+F0RzkRFmeym3
# aBTgFPuIgLfqU2TLq5xL7CEG5TH9PLreEzwsNzZ438xdziO4F955eiIK7UzNPOBh
# Y0qbQC5Rah4Wh0Jhd4TlDNV+aJexAASvP0F9AmgbFti1AO0BPpds5bUTy34xS25v
# tTAYaQJHvBhcryxSIzWQH0XJ/ex31l1J+CzDfctteIPOPRUUgEIFcyD+dX/XrOVR
# Hbqe/rXQQbaeKLMtYrXxY3G5TWQLE8c16Ha7GH4ayD+tJqZw4KKHk/ohCdiieu5z
# rkO7h5W5/Z3JVQbjwecFdXAHVDoY+rbvDRTPdnekH6/DjTycnW2U5LszYFBSreaB
# GrUjVYctU4ThCZnn6ruwpF42WPokw8hYcyL3B5HhAWrVx4L9CVBeD15ikVG7aaK9
# rkWee2StvrOdfLUmToHWyX32sxIZa8DrScFLC4OkIOUxurTzWfBP0ZGg9CMLHb2r
# 1sLKf/CptsMrMqOS2Iqpn7ywj5Fb21abONtG0lpXH2qsQv8InFO6f58GBN/MsNEE
# EwM9NWdjdu1hCv37XXIi1n2d83o2TPIOoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IDKl5KBkZoH7w4qFzd5OqBlprEtlOeQCwDuQSOckPkLZAhBOJclWwvwizC/OoIKM
# P01OGA8yMDI0MDcyNDE5MzUzM1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIFqCm1BZvIUApRyvYCKhIbdN
# uGPWtcdTxTBgzHtJmOY+MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGYGiABz
# h+52kG+yianGlLJCozRc4pP+2KZVR8hW3IeMO38iL49ilILAUrXWR1oXohBv+G7X
# 8NI1Cw190jydAbddXxKM2ULrJVU2a6K0p1AnFc+vILffWkTAFwyudNCkWM4vPeNS
# FvyU8ZH1WRtSHWi4y/XkZftb3zM84gYa/wOwiFDReLxoq1hU2WHgLPuEhPSYyrZD
# eSukq6pQDUp3x0+55fLz/eOlnyP5K0sxpVDue0fmKTpP929OuI2k3n9osM+X0fgy
# nnqUQWM4S6AWCgMsFRM1n58oLenpEvT38EhNcyJbqvSb0EgvsEff/GDnt4oGLo90
# Xz0dydsmnI1sE9M2qCRT8/N4TNX6xaGyV0vAnbqHTcVnAROfmXHqYu140lC2Kkjo
# cXmXsf/e1RHv9Hi34ds5EU6zDv+cz1KKI/CSvgaF235gxzMxImzJCi98506SNqmh
# zC1cpYwuwKD0W15ytk3K7s1K8dwMByqDU3tqonFlcXYbn8Cwse5mCH6FOyvIs+ri
# /hHO4sE5JYre1pGXqSYKNzGqEZ5qHVBdD49UMKTH+sk+1pQ6MHdgK6rO4jqT/W/f
# PHpk8Unnm1TpzHbku0ecoK+72tWtVd/R3B3D4STp0zocFwt82Lj+p38EAOMosB2D
# LNNpDWSHx8qyPRA1E9KkficHfR0Opzn7dkAU
