...
.PARAMETER Version
specific version to check eligible updates The parameter must be an identifier for the resource type: com.vmware.appliance.update.pending.
...
UpdatePendingUpgradeableComponent[]

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/pending/version/components/get/
#>
function Invoke-GetVersionPendingComponents {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/pending/version/components/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetVersionPendingComponents' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetVersionPendingComponents' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/update/pending/{version}/components'
                $LocalVarMethod = 'GET'
                ...
                if (!$Version) {
                    throw "Error! The required parameter `Version` missing when calling getVersionPendingComponents."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "UpdatePendingUpgradeableComponent[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "UpdatePendingUpgradeableComponent")
                        }
...
.PARAMETER Component
Name of the upgradeable component This parameter is optional because it was added in a newer version than its parent node.
...
.PARAMETER UpdatePendingPrecheckRequestBody
No description available.
...
function Invoke-PrecheckVersionPending {
    ...
    Param (
        ...
        ${Version},
        [Parameter(Mandatory = $false)]
        [PSTypeName("UpdatePendingPrecheckRequestBody")]
        [PSCustomObject]
        ${UpdatePendingPrecheckRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $UpdatePendingPrecheckRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$UpdatePendingPrecheckRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePendingPrecheckRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePendingPrecheckRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $UpdatePendingPrecheckRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $UpdatePendingPrecheckRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $UpdatePendingPrecheckRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $UpdatePendingPrecheckRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $UpdatePendingPrecheckRequestBody) {
                    $LocalVarBodyParameter = $UpdatePendingPrecheckRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/pendingactionrollback/post/
#>
function Invoke-RollbackUpdatePending {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/update/pendingactionrollback/post/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-RollbackUpdatePending' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RollbackUpdatePending' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/update/pending__action=rollback'
                $LocalVarMethod = 'POST'
...
.PARAMETER UpdatePendingStageRequestBody
No description available.
...
function Invoke-StageVersionPending {
    ...
    Param (
        ...
        ${Version},
        [Parameter(Mandatory = $false)]
        [PSTypeName("UpdatePendingStageRequestBody")]
        [PSCustomObject]
        ${UpdatePendingStageRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $UpdatePendingStageRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$UpdatePendingStageRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePendingStageRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $UpdatePendingStageRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $UpdatePendingStageRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $UpdatePendingStageRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $UpdatePendingStageRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $UpdatePendingStageRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $UpdatePendingStageRequestBody) {
                    $LocalVarBodyParameter = $UpdatePendingStageRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCDnsGGRcfnsz1W
# YEoFVV+viCjeh45Y0+UlxGKWgrtK0KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE