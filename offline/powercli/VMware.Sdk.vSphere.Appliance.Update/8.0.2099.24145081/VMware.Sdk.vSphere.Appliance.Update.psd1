#
# Module manifest for module 'VMware.Sdk.vSphere.Appliance.Update'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.Appliance.Update.psm1'
...
GUID = '6b247f15-efa3-472f-a184-d18dbf2254a1'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.Appliance.Update.'
...
FunctionsToExport = 'Invoke-GetVersionPendingComponents',
               'Invoke-InstallVersionPending', 'Invoke-ListUpdatePending',
               'Invoke-PrecheckVersionPending', 'Invoke-RollbackUpdatePending',
               'Invoke-StageAndInstallVersionPending',
               'Invoke-StageVersionPending', 'Invoke-ValidateVersionPending',
               'Invoke-GetUpdatePolicy', 'Invoke-SetUpdatePolicy',
               'Invoke-DeleteUpdateStaged', 'Invoke-GetUpdateStaged',
               'Initialize-UpdatePendingInstallRequestBody',
               'Initialize-UpdatePendingPrecheckRequestBody',
               'Initialize-UpdatePendingStageAndInstallRequestBody',
               'Initialize-UpdatePendingStageRequestBody',
               'Initialize-UpdatePendingValidateRequestBody',
               'Initialize-UpdatePolicyConfig', 'Initialize-UpdatePolicyTime'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAKQFE/Omh1tRht
# FBY/yWh+26ebCpEc0jod+pm0p/Wl+aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINzdW69My4rkKul7
# MxCz6c3EuxeF5mjLjmacpCFwsuQyMA0GCSqGSIb3DQEBAQUABIICALC2t4xWM9x/
# nb67hRqR6qwRQiOsT/1QGnI7hAbYUfMnDO5/9qUDujd2cpDBcqKwyO7AfosVrKyK
# lW73oUmAykMmQcYFPKU+GRSYGCuz+Oc3gUDmFq9C/3cPiVir0hFRBLQ2/L8jBqbT
# hBBRK11APuLfBJ98D37G/qKilp32f3PmAeH0ARDV6DeXvQ0oDYAQxMukQqB7JnY2
# FFJEVDDmBv0AZmZ1+t5oDmC0mXc4reWKekA/3ZGzmAouG21q6RQ2UFUBqluPPhd8
# NXjPDOreai8E0G3IiunYrVHPgP8gujHovQsLKSqtVEFBXcgHE9ZW2sDRuTlEbhwI
# qMWilk3wjWLn/3DROX3M2mV5V4doVn8l/51ZSg2s4N5OTjqbVIu6KOssSn8GBbJN
# z1M/Jn8ybz2EIdk6tUHYxnsc1oxOND5QB8KX9/lh02dJ5eaSxF69eReQuop7XKWF
# n2P5nSYSF+43PSx9hgVA4qt6SZzWZtqcl0a4UEtB8gW5bsyzSh/R37tAQE3dc4Vp
# R9u+K0NRwNHU6+pv0hD8NCr92OnSn0kEo1pt+BnWes7jgvJCTiYIY12N6dmsU0OU
# CQ5zoQC2BhT5TABx+HSiGjPD+fHeV70dDph9C1jRKUJ5mBsxiZH0YvQMRivvdOMX
# 8aG2cmVIjqy0MZr4REeFx33VXg5sTtveoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IHILWbOLTQJXWyWhFC3N4AP7t70KjNFwKQs6va0pVBH6AhBhTi+PZK9/kIFJZDEq
# Hf57GA8yMDI0MDcyNDE5MzUzMFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzUzMFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIAxqnVdmgY+O5S9JGJ+E8VRE
# QMsFZkGILKKTkehtbpxOMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAF9SEPCH
# RZkFc6i3JkYvF2GXg96ZRCKDs15Do8/D90bSbNEyBI+P3b4+k6NwAetS56nROoSK
# zs4mG0fTTSaVtnTJud9EbWBFioDPD5KCoG4Fy9iJEmHZT5fdDfg41z3HTGU/zQRE
# wxFVPPXyJ5nAMPEjS1iOu0MOMNDXovyPfAGrZ+bjtSpmC18pz1nTJAaM+sD5hD/O
# 0A8QFMp7ewO8rClLsBeZ2kyULXTa/h0PHUuQnIGhgfP10LBTkbI0txBMabun9U65
# BIQhf7KEambvsQkEpHkbG7xfVzXenEiL65/8g2uY0MrtS53ZtKSuOLCrpaUnnT34
# EFNTU+1CWTJtpCV7hyVK2uxcbwwYjG9BTs678+Pi8EfZOC+qMa40PO7DjCM6INM9
# 8yoM6VuO/uTEeAe8kCnjGD9e1hK+llj6I1NSip9itohBNlkwv6LeQzUcuOHXRyDp
# +g9JM6gL+PEi1d7Kpil9M5AA99j8Mc22VdXMXGo3ZfBKRqfVouy63CJHIQNBI7bQ
# zJxbmroUFWY2kK/6ov8FI/i9Bw+YgWoSa6f8hWHylYjvsBpnz7hkayHn8+h4P6Vd
# vPtOJ55acfcemwgdVvE+69evIOeDCxS5bib4gyjSJuE1BTehsel7TTVokXnft5K+
# ghT+r5fPDYPA6xNa8oRZy/AkBa9zbJ5Lp8dN
