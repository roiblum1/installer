...
Indicates whether certificates will be checked during patching.   Warning: Setting this field to false will result in an insecure connection to update repository which can potentially put the appliance security at risk.  certificateCheck If unset the certificate checks are enabled.
.OUTPUTS

UpdatePolicyConfig<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/Update/Policy/Config/
#>

function Initialize-UpdatePolicyConfig {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/Update/Policy/Config/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Appliance.Update => vSphereUpdatePolicyConfig' | Write-Debug

        if ($CheckSchedule -eq $null) {
            throw "invalid value for 'CheckSchedule', 'CheckSchedule' cannot be null."
        }

        if ($AutoStage -eq $null) {
            throw "invalid value for 'AutoStage', 'AutoStage' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtDnA46DoQFTlr
# ALoy3NajsLN6IeXJNFDxwmPimJOJm6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHTrlkroLe1T8Q/H
# 8Z/Xd+Ym7n4X4Cma7S7Cfn3UHd9hMA0GCSqGSIb3DQEBAQUABIICAITYCjfsmpHC
# ReHiI7AZxV2+0m/jI9jrPAN2ldLwrjhz4gUPXL43Zvw7smAuieRNBQL7uSI6dCz5
# Ys5XNJ684UwN58xAE4rSCAqcAl/vW5bgAM3W7vcFJKI2aqIMvw4rhh2/TXBECMyD
# fb2lWiD41LibWdCJNpJZaX44nw7RB61zSZ9XHrOXS6/JJohph+VVWxPzKFOTGXIK
# cw7f2psKcYqXo5fugAP9+kpiWdHSyPI/c3Po7w5GB+lRjNmXTlx8INUaM0jTaaFJ
# COM/IyzD9eGnEVsXCW3jwZQnPrx40qhvAGgv2RJMzteNoBDnW7ZKoG7eYc/EIN4p
# V4SqUr2MVjk+KJcJXtUGpjqUGcFpt8nY8VUu2dChi5ZJZifqZZ5MZZDoCxqGpGPX
# b3ZO6/vP+r7nrR4xfsOJo+U4J5opP39cAQRrv4DOBwQmON8vjiqpVLBzxUNdutnw
# JM/iEPilbQKx8u5qm3cDxq7+fHHpzg9uOEpMQ7eV2c96xI/yL20l6H/MGj9bz/Es
# 1sUydEqP52JsBrOahu9AYLtSU/Z7CKwJkYbGXHQuk5xgLCzUeIZ153GBt+K0SDpw
# VVKF/mWQyB6QtqqqFH82Vs3YXlaVXhavrsTE1qetfJn4e4rH1eWZ408h0ybRyYju
# VThEMUwLJWjnLAHP3uboBNM3P9x8NCjJoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGs47sH8nbkbFWF9VzxJqrvLkRm7vNmRaWirJoNDHC44AhEAv4lj0oUo18OTagH5
# 1yBpdhgPMjAyNDA3MjQxOTM2MjVaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM2MjVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDdAW1q6tuTgvq+6M9KCgXD
# wxHMIgHmcEeTC++7fp8YyTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAauyRz
# g3TjZE/6IO4809v/EElcGDFI45rL8Px8A5P8pZfdQbjcizv6fs3UTxwaQppHG6IV
# in+4BiQgS3TZa0EZHcNPt8rZKXtoe3oEoXLciFI0kMpvqvGp1MAgp50K3jPRsGVM
# na3GAqmRLy0Sy45YLuVyCmKjsp6d+9A+ri1NhrdIM1GSEWkmAqcwRMZPbBCbKjIn
# d9LygCwnVjw/m25sX0b/O84n9+qxVn7rT7+/Y9CCJXf8ZzkXdbS4F1CMUIjCtuWO
# Wy9i4Dcdb/HNyFrQGsKoUaHhbGYA5MUHxvJzLLV6OBjYjAN2OYLL4tHMM/cj68k1
# gcX0IddCWU/dz3JAt8U3Eego+giF/SwOAZafAOcCKNjB/9qhv2h35G/kFmHDDn3l
# yIDw4Iob0gqQpVbVXeGtiA3ainEQvvYdlry+aEF5q5PohTEIryB07Wkku5fETFcc
# kctGCi3vXcvYaDUJbd4X2SkO3hOrOXLyCvDYt7u72hOpq1RpdRwMKCIgf5VimJKQ
# SoT0IETBeHI0w9rv2FkLMSk/ImvK7IR/z+keqlM7tay2BC7LK2bJN3NQAJVoprLa
# Tfd+hV7mXMu/M5Id+YJ83KvEOCYlr3ZF0u7UqNa4day1XHT78AWmACa4VUfqHnWU
# 7rnYx8ONYk5KGRzyban1HbwqPFE7BEqBJHjsrg==
