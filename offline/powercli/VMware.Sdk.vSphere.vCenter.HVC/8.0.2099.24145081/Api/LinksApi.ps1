...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/post/
#>
function Invoke-CreateHvcLinks {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("HvcLinksCreateSpec")]
        [PSCustomObject]
        ${HvcLinksCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateHvcLinks' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateHvcLinks' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$HvcLinksCreateSpec) {
                    throw "Error! The required parameter `HvcLinksCreateSpec` missing when calling createHvcLinks."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $HvcLinksCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$HvcLinksCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HvcLinksCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HvcLinksCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $HvcLinksCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $HvcLinksCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $HvcLinksCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $HvcLinksCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $HvcLinksCreateSpec) {
                    $LocalVarBodyParameter = $HvcLinksCreateSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER HvcLinksDeleteWithCredentialsRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/linkactiondelete/post/
#>
function Invoke-DeleteLink {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/linkactiondelete/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        ...
        [PSTypeName("HvcLinksDeleteWithCredentialsRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-DeleteLink' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteLink' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/hvc/links/{link}__action=delete'
                $LocalVarMethod = 'POST'
                ...
                if (!$Link) {
                    throw "Error! The required parameter `Link` missing when calling deleteLink."
                }
                $LocalVarUri = $LocalVarUri.replace('{link}', $Link)
                $LocalVarPathParameters['link'] = $Link
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
                ...
                if (!$HvcLinksDeleteWithCredentialsRequestBody) {
                    throw "Error! The required parameter `HvcLinksDeleteWithCredentialsRequestBody` missing when calling deleteLink."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $HvcLinksDeleteWithCredentialsRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$HvcLinksDeleteWithCredentialsRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HvcLinksDeleteWithCredentialsRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HvcLinksDeleteWithCredentialsRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $HvcLinksDeleteWithCredentialsRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $HvcLinksDeleteWithCredentialsRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $HvcLinksDeleteWithCredentialsRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $HvcLinksDeleteWithCredentialsRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $HvcLinksDeleteWithCredentialsRequestBody) {
                    $LocalVarBodyParameter = $HvcLinksDeleteWithCredentialsRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/link/delete/
#>
function Invoke-DeleteLinkHvc {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/link/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteLinkHvc' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteLinkHvc' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/hvc/links/{link}'
                ...
                if (!$Link) {
                    throw "Error! The required parameter `Link` missing when calling deleteLinkHvc."
                }
                $LocalVarUri = $LocalVarUri.replace('{link}', $Link)
                $LocalVarPathParameters['link'] = $Link
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/link/get/
#>
function Invoke-GetLinkHvc {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/link/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetLinkHvc' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLinkHvc' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Link) {
                    throw "Error! The required parameter `Link` missing when calling getLinkHvc."
                }
                $LocalVarUri = $LocalVarUri.replace('{link}', $Link)
                $LocalVarPathParameters['link'] = $Link
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "HvcLinksInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/get/
#>
function Invoke-ListHvcLinks {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/hvc/links/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListHvcLinks' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListHvcLinks' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "HvcLinksSummary")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCApk2XGqEvMbctT
# kzM+pcQven6AIgvEggaEuEVS2eLhJKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI