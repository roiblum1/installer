...
LocalAccountsPolicyInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/global-policy/get/
#>
function Invoke-GetLocalAccountsGlobalPolicy {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/global-policy/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetLocalAccountsGlobalPolicy' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLocalAccountsGlobalPolicy' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/local-accounts/global-policy'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "LocalAccountsPolicyInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "LocalAccountsPolicyInfo")
...
.PARAMETER LocalAccountsPolicyInfo
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/global-policy/put/
#>
function Invoke-SetLocalAccountsGlobalPolicy {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/local-accounts/global-policy/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("LocalAccountsPolicyInfo")]
        [PSCustomObject]
        ${LocalAccountsPolicyInfo},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetLocalAccountsGlobalPolicy' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetLocalAccountsGlobalPolicy' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$LocalAccountsPolicyInfo) {
                    throw "Error! The required parameter `LocalAccountsPolicyInfo` missing when calling setLocalAccountsGlobalPolicy."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LocalAccountsPolicyInfo -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LocalAccountsPolicyInfo)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsPolicyInfo -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LocalAccountsPolicyInfo -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LocalAccountsPolicyInfo = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LocalAccountsPolicyInfo) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LocalAccountsPolicyInfo | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LocalAccountsPolicyInfo = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LocalAccountsPolicyInfo) {
                    $LocalVarBodyParameter = $LocalAccountsPolicyInfo | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/F6djnqUST0J4
# r4uCobIiw3bCAn6jgi9WezXK//Yg8qCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJoC2130KzSUHFEF
# MiHY6NaNp/N/7BYQo8Kf2FEO1s6DMA0GCSqGSIb3DQEBAQUABIICAGkNyMmPq9Xb
# nvstcglrVJUbXNtPPoyfUotdOjnrfSv902eMUvNPgKeh51xrbD31XWR3izFw6QmB
# bcNwehVm6DidPtGDCvrLspLBsfhvhSU+CJ+mHG6XLULhVG9K0D0E1GLSlrevAB9t
# N3enhUXrIpQz21TZ5L0Ls9tJlHijjKQo25yRYODvuNw5Ks+jsYsQnGBP8IkJGHKH
# pZQKngYcYE/3+yrKAUqdpmNNZcomfzFEw+qsZsH6lAIQ+GssKgl/FISCk9FVKU4J
# eJlgrTcuGbIejdUgK9WaRP2uBmctQ6Uh8QBk52SCf3z6Sm18jfOFoL9v2nJGqvqD
# DSDRBuiEnE8joyXN34LmL42kqDtofKd6gRZMNYND5TJKasEThxKKInbolLo/xhHP
# jUAE6Ii7DNQUd+1glMeZgDeBbMeQNKvmDUa5DOMrTdS0sH4OTFR+3FVfzeO5lg93
# BtBn7LJNvVv9rmNVCSkVh6ffYRPtFWQz14pRTA5oPzlrwGkQ9GAa+AMNkKNmjPI9
# +KfJodGfr5fS3IdyraYdcl5Fyk1/jqRLmNYtf3xbqO5tDvxQ2hEOY7yg9bxdMmdK
# vFw2kX4SPPTxz8MV6R+Jq1WrFXZZHZdO+Q/6lZ3kYuLQVVlDpUFKjd90LYXYAP4C
# vaKqL5ZzB/fVsuikNDawgLBh12esURDcoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ILu9Qvpv2TiuDvvjQFPn6Y1WuLM+WTrZUtq8CgtKEeSVAhAT2ufiRO1b26EZS188
# 7OpBGA8yMDI0MDcyNDE5MzQ0MVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzQ0MVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEILONphgyTPwAaMHyhD/3+KMA
# ZXtOe4+j9mXmdO4jpFPTMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAALYIie0
# G7s10Da6mLFtvu/c/NDLH0+MDxzqiYyy4ZVVo7s/cmTWIwok3OEgGxnF1VO3ZvS1
# 5wIsJqhPJnfx8dKLIANi8tEG2WLdWoCXH91sqyUCvclFMgIbcWDWsKRFtOrF5ozw
# 0CEJgFRsswg5H712lgRRUgdFTvFpa0P6aPvzqJnI+a/TtsPJGGPuVlR6F0LhHw0/
# knX2OAdMs6APLLVupE5eHpQceTcqtG8l7wvtC9cphQPw6nxroqymXpE56gxBjQpe
# BGBDBtk7yKyKBMhU2piFWV7uv7TZ+L0gvE8McaCUKpvCTGevsQd8yg5MCLqenlQ4
# s+8+Tgba8GFsxU7Ue7e00+cG32qy7Zj1svbLq3zsq/9byJFvdrRREIfRFCVoPRwP
# fEIwve9iEzShc1IrnJBkhPrj7uNUxyiIfkZ3keC8+4v7OuqWXaAuhxRtsr/HfIja
# fpWid3UrMMFetzT455S8w3PcqdmRHF6mlZRZ9FGO4b4aw6IwPfRnJOOyx7pZEuEY
# xGz+8RdFB9lf6md0GFIn7C/CnbbrWhR0B6Z5+0CFcJdNjeQNakN1v4NSuRCrr9gE
# 8uud/ZVeV0ZEPVYoR4wvRUuMg9z+nQtZLOP+cb/BXlv78zUTcj3hEGYE6GIRg0zK
# 64V+DhoamrTwk1/h8RDulCnbunaJ1l/Mrb1O
