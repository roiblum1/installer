...
Provides input for the country field. You must use the two-letter ISO 3166-1 alpha-2 code for the country where your organization is located.
For example, US, GB, IN, and so on.
...
Specifies a common name for the certificate.
In the case of a CSR for ESXi, you must use either the ESXi host's FQDN or IP address. The common name must match the identifier you use to add the host to the vCenter Server system.
If not specified, the PNID of the vCenter Server system or the FQDN of the ESXi host is the common name.
...
Creates a CSR for the vCenter Server instance and saves it in the 'csr' variable.
You can get the certificate request in PEM format by evaluating $csr.CertificateRequestPEM.

.EXAMPLE
PS C:\> $csr = New-VIMachineCertificateSigningRequest 'MyHost'

Creates a CSR for the 'MyHost' ESXi host and saves it in the 'csr' variable.
You can get the certificate request in PEM format by evaluating $csr.CertificateRequestPEM.

.OUTPUTS

A ViMachineCertificateRequestInfo object
...
function New-VIMachineCertificateSigningRequest {
   ...
   [OutputType([ViMachineCertificateRequestInfo])]
   Param (
      [Parameter(
         Mandatory = $true,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgUl9DB5XtsMRj
# h3iR2zDJVzD+gyoCp+2XhYXcHouzv6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINASUM26RIZsHdOp
# jKG7k3HpYgbXxySggcQEUEN3iaqYMA0GCSqGSIb3DQEBAQUABIICACCB+NzZPEQn
# 7rGQwqEfk1j8V5Dq4rILGKEnYb32q3kOE4aC6Mc2w+z0ZMTOm/n7ziqQGEfzrWce
# 7GSwiFWZJ2SJl0+e9H1iZrETJ91Ibe6p1bEof1kdMGMG9UeOHrJ8792offyjGY5C
# yoBLD/dA3/xwGY3Okg/QcKYLNrllWIiLpFXADfbJropgpJYbuCjOcLGsESXjDOFX
# Za4Y9nGPq3wCLPKImXPN74WFGVdanXl6O4bquClmq1D0NmhqmipmEQdeogv7p1l3
# z2xumufGFxTBYIKxIZOvayuIJH3QTqhur+TT3QsbNjBUfztgeyMynEuQW54by4vu
# bE9tBkJda6FiUhWemse3a9Jq9BC/g7p2itRmBQOg1wor2rQiaG7aaybWuTJejaaH
# UXgJw+bEjpB0aIDLy4MKEfwzsDKpsBpDCKQZ6CSjYZYNtNacOSxt2ErOqp+pUROH
# ZUYtU/i0ZSciamfu/pSb/UiOeC/pFNzo+DchPbbvoYB4KtYpLnlOA5deU+2x8l+t
# iYJF74lK+vel5dLqNlhRum4NCwYzVfuWpvs3rOPmMVHeQVX40sD4gtnaDK3fCrul
# ja4kSUDfFSoRU9Imqpg0x5jWTziWFwZi96eHxzy2lPR1D4xqL8+uGROGYDrj0O0X
# vBXp1Gl7nENe+8GC9B7Za/szwhBre3RvoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IMlBl9QEIf2vt1vaxpsOGjZRLCq4rEdF1JJg2m8G69NJAhALFcf7vQnDC7wVSQzj
# XfB7GA8yMDI0MDcyNDE5NDkzMFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIH7gB8MRxkEfNkdQts8tG3do
# lhQrD0OQyAgVUqBeqbjWMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJET8x15
# Voh2hkzP5ArQYYLFivFFnGC0XORP6/KaCGbvlTA24XkBaMZhxYnE8gvwQDnMK5r3
# pg/gVK0Mg0WZk0wefmjE4ZlQ2fcCeiv5mQ9UDE01KlwQ2Y/X9cXwS+/QcCx5XGNq
# ko3myRJnvbUsHwV7qahamXZvYWxB9ekEk4olWarknjZBS9L0E81UDLczMvCg5hLE
# ZWcnCsxwSZ/UWFMHhQsST/U1Tipeavm3Lt8Ncy6h+yoPgprMZX9BqHDQyFsJ0t1a
# GFHeTEf6UTl+2aoioJ8vW0ho7bFFg6hB13E6s/NKtOHRKwrsRbua6hE9yNJdybFp
# fWqHIM5A1fv2wZl+FUNNOIlSWS99xmBTkGncGjTb+1Sb9sELnF3vwTCtMnxeW0uG
# 0B3WTH3hrOEIy3xhk/iBwjVvvsIKKXbIMfYm0iYt/uTHY9lpMHNTYdB2O8mNo8pB
# Y8EXrrqwFnLe0sIYrhdFfiUlwA9zHng2SZtE5U6p61nv7wpG6jdhy/cZ85glX+PR
# KEoBrq8CgOW66QlpDZjL4ovphNTBbYRPu4L2iTxg9JA9oPAIp2ByGE8XbaFs0+oV
# KFBMpj72LYCtsJDAjQDqosCh8LjfXxnsK5Cu3NN94qd6Of6mi632gci97JGmP6em
# 1IuXNiuX5FqWKLQ5fzqwgX1tt+l/mONdEG+K
