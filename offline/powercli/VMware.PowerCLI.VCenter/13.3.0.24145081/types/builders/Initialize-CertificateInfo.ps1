...
function Initialize-CertificateInfo {
    Param(
    ...
    $InputObject.Subject = $Certificate.GetNameInfo([X509NameType]::SimpleName, $false)
    $InputObject.Issuer = $Certificate.GetNameInfo([X509NameType]::SimpleName, $true)
    $InputObject.SerialNumber = $Certificate.SerialNumber
    $InputObject.NotValidBefore = $Certificate.NotBefore
    $InputObject.NotValidAfter = $Certificate.NotAfter
    $InputObject.Certificate = $Certificate
    $InputObject.CertificatePEM = $Certificate | ConvertTo-PemCertificate
}

# SIG # Begin signature block
# MIIphwYJKoZIhvcNAQcCoIIpeDCCKXQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsTHt7I6UNvMFe
# JIjgoQhXttMRybpv9gNWW6AqArEQaKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBP48Wn5PAHEyRjT
# HpgAGhMWJdWi4jAK/Qc6xZHOCiEuMA0GCSqGSIb3DQEBAQUABIICAAZ6pk/0/A99
# YYV87CN4Zom2D7QuEL1YVlPEYqhEt1Zr8bNkp1jlD39AyFRfoU7JQ3RowRxMjkwm
# LUcsi2qbL1D1F8J2EecZ6as+a4Nx5nle50X5qwBGQNBCm8jvMGm5rWCBymaQqtFx
# aDMWTh7o2mTpO2/kZBnttYXU1nJdHcSPxEejNRFrF8K2j0D0CYiRDQBSV+aZ6Hch
# UtlUQQ0f6KvpSgfuao0cE6q09mjL4KiB3XRHgg2Qt+JwQFvWbcqPDwWyqVD1KtsI
# T+0YdigRavvU54wT9Eib3wLVy9JhgSvbIm3TU2EfjdunjQsrWlA6qBIwc71OGpVx
# aAC359fwGxmLPO+rfcfm+jattRpRs6VRIoDziPShKDI01NC0Th4qAf7D+KLWSbyV
# 7xJQby1K40cHuh6uvDhhNDut0s8BRUHSjKV1JdPIYio2UwSU/7s0i0gRO42O9Cpb
# yYE+P7tFmDRC7eQCTkiTQD+DmjsIpZj/0l9Lwt6SBpBwYr9kToMzw34MgaoGa9JT
# 5EdS6OmTwkFQ869ZZJm6hGgQh5h9IjRLeAswHl7JWosNwinFYG7DGJKH0SKwJ+C0
# j5SEUyL2U3azau9OmilF1WPV81mCat5m+Hm64enPB5HwznMNsu/EgofwVDWsmnuf
# OKbAlyHcrfaqh8keRoMNfJ9qQFaqsB6QoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IOvtBqhFdG4IKnkthvcm9nuqKN+kmArwvuGg7D+n6zU1AhALCnWIpkYXVBGhPOWd
# R9jZGA8yMDI0MDcyNDE5NDkzMFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBivcOjW5M6CLg5Z4cDASaOy
# BAlU6PHwTgDgv6PrG0TLMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAHmVB9YC
# jsyItaSnwGFWtetzJblB6UkQXnyMzqE7s8/HkVdnFNpmD8tPv/Qf5Q8Pq+MAyVF0
# dGQ3WxKa9Wp+cDk6bo82Ql+Heu95VFMxU2CzRyBdrF4NgoOP6g74nxg1/jDOV4qL
# 64FQPLoI/u74+WRj0vfUMQIzrw74bhl7WvNM6dAZ6zhW/AJXUn6d6TzH3yFJhZ9C
# mem9gozFBKEaS0yc7kXYUQJSeSOkR0ZZ68v6ewtB5Jee2be/ZcWeeyPC0BtzuUcV
# E/o4hrX0s3Rm0RYdVYbABMffIeOi014HYZv220CNHvzkzdRqE6oVN1DPUqarB+eD
# ulYf7piA6iSywgfuXU3X05xAHJxahrx+QDnk+dB8GMg/M8etvBjUYSQQnYf+d3ed
# 1dvSTDgbX5LQVPigAEg3nNhqqw+rRbaKra7xoIGvzfJGcvXRKrmBtsWV3ujeWJgZ
# qGLEp4pEUdg6JiEK5mM26QLTkfIZS2yK2c7bv+LTjYhDziwzXjgjRYcq1ix6QuHJ
# suQQBCTXR3CkqxaCjQkrtShtlgN2PS3upqg4ghtgmoTkpRHCWqLvQDn0+DuaCPqA
# SfaqtmQgSxyldiPSWnDy6UOG4T6R8OliHiKlLmyQPzfErCcdD9gUGo1TneIJXJQs
# rppq+BHMXzgd7Rq3BTSbzk/Jn74bRUWChCh+
