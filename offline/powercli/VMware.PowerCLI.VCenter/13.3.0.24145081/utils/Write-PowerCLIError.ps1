function Write-PowerCLIError {
   ...
   param(
      ...
      [Parameter()]
      [string]
      $ErrorId = 'PowerCLI_VCenter_Generic_Error',
   ...
   Process {
      ...
      if ($ErrorObject -is [System.Management.Automation.ErrorRecord]) {
         ...
         $errorRecord = [System.Management.Automation.ErrorRecord]::new(
            $ErrorObject,
            "PowerCLI_VCenter_$ErrorId",
            $ErrorCategory,
            $TargetObject)
      } else {
         $errorRecord = [System.Management.Automation.ErrorRecord]::new(
            [Exception]::new($ErrorObject),
            "PowerCLI_VCenter_$ErrorId",
            $ErrorCategory,
            $TargetObject)
      }
      ...
      # $errorRecord.InvocationInfo = $stack[1]
      # $errorRecord.ScriptStackTrace = [string]::Join([Environment]::NewLine, $stack, 1, $stack.Length)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdKnwY/Nv36Boy
# i5tVQe2VlRkp4em/be7al9ddFCOrl6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIItaZdY4Kf4PLACT
# +lekwF47IeChtPuzO+mg4xsDwgVIMA0GCSqGSIb3DQEBAQUABIICAAYcz0TXVi5k
# wbdJ+917H12Y9pp0OWXMXA3PHFxFj8xuX7QP40uhfmd30zpRi+rGibp42EBpME3V
# F/CphbrGmp3NOolHQAedD/SveglXOSgh4ql0XNiOifWBjI4RCeWSHryvizfj6yWt
# 7PFGuzLgqiNK4ZOMR/xKW/0BxA0u6a/kJrvxV4jbOvhPD/02vMTYINH7z6y7/t4g
# qHZZYZpcmWLpuPoiKY6EpGfOOoH0dXi1owwJme0rr+IGhiIGtOFk/Ft0Au/NT1Xc
# LzvkUPjDb/qhXcoAEONLrSw9yrM3PW/cGbxhtqctpzEiO4nu1yDGtwQkCeeLfyr2
# jKVAOQpIuTPlL1UqtcG0ZJhrUJMV/8sb8oU/mvIbn6xRVmtKVbrlm8U+R4GWg40g
# SAmp2YlQ4w+Y2KU1FBbpg3x9l78Vq8QYENRZ8Zce5AqgIWsyACHmC0nry8ZWidAj
# USblEctZOOFx7g0tyKz5m2iZu7VAv/rvBCkRIVENEbxc5uaNHqphkR7losLP2K4V
# Dvem2HbKbYmkcn1QcwFbNEeqtzLcfid62AGtP7QnVx6pfa4Z28QQiKhSi83Ibgdb
# DFE8p46qiTzpaxmKuAPPBHi94KWQH/RmzrtQAfiZmIqwuIT6Z6Im+f5CE2nhlkmY
# x+/6XuQctwyv1z+3dyY4l/eGVzH63B+xoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IFQvITzfad86qmCg4jPyr+YyHKJDQEQ1rMi/JUjZPkuBAhEA5FidIa2Rs7B6JBju
# 4lbB3BgPMjAyNDA3MjQxOTQ5NDFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAjFsqUCSa70ir7Q4h5TKev
# iqL252R8WmGDpoCM74WVzjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAQnBeu
# fTR50D6zn8jIZNK7GiaYSQu50RGiiBchRjPW548lEwMpAZ8RH2PkU/xqZd3Jx6DR
# yK0jnZaZQAwT2oYr4PX8aOaQaGcIOV89srwLWqdTTTrWXfd1Q/9LFe7B8MJW4rfT
# YRFPDL31XSqGq1CJbmeuL6GvDkkXYEcDIASZ6cud7/SEbpNWL9cWoCxc0ntZMXaG
# gblNIuo0uWxhyUA7LUmh9ZyMwXCbk+58cPGoMMCMTj7n8yBjCR4oUIcPbOF/YqP2
# XybTztZ/6CpPOtmqI+FG3UxH0FKDa5d260BgMBIC8CtEbs5CREf7SZeP9EtWuteY
# EmICprZCxbNrSeeG/R2UJs04OIr/cibd5a9niT4ueRvKu46/55qAutcOcV1y9++g
# o0AfmiPjSuKsSMghAymgTcosYoFcBZh/TY389LfHfmWHXh8DvxbN7aimDVHOGsY+
# UBo+YRV9Lyez+/NF71VWaKqVmqBuvWwYWCLwxjeXXwRC5z+fVYfDgQjiXYWPLb4S
# AC3qNbPwKImJcKo0uDFE6a8E3hQ1Fe8OQhw7oiN8DiOCsmBXSDUn64m0Tg7x+b7W
# CPB3l+Ykhd48XO6Il6PGTwAbaE1iq26tWobmk0A7ae1e/25RWuEEQO+aUAKFE4oi
# d29GqE435C4sHDMOev0UdVT4HhhbmtYLvYWViw==
