using namespace VMware.VimAutomation.Ceip

function Report-CommandUsage {
    param(
        [Parameter(
            Mandatory = $true,
            Position = 0)]
    ...
    try {
        if ([VMware.VimAutomation.ViCore.Util10.SettingsManager]::ActualParticipateInCEIP) {
            $cmdletFeature = [CmdletFeature]::new(
                "$($invocationInfo.MyCommand.ModuleName)\$($invocationInfo.MyCommand.Name)",
                $invocationInfo.MyCommand.Name);
    
            $componentFeature = [ComponentFeature]::new(
                    $invocationInfo.MyCommand.ModuleName,
                    $invocationInfo.MyCommand.ModuleName);
    
            [CeipManager]::ReportFeatureUse($cmdletFeature);
            [CeipManager]::ReportFeatureUse($componentFeature);
        }
    } catch {
        # Suppress any errors with usage telemetry
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwejSt8TyyK8X2
# A6cb92YF9pKORI9bKyKzF7ZFu+Lu1aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOPlDW4joFmx3v3l
# IcAwGpDMO1zDl9JpgQP1cvrzDjgxMA0GCSqGSIb3DQEBAQUABIICAB/L9gzqqdWO
# EF1aGgiyjceMqBapZYfIpau86CxBplu4NYlKKnOT/n+t9YrJylnfnMjA6o1rV3Yc
# vY7KfbTZ0lj7vl4eTZJtJduPIdbhTKLG0uaPWu8eMfuFHDodxzaZ3aLkgutzZ30K
# d6AUnbEWQPRGTMG27K+U5fOE1fHf8BRVDxjb5jhz0ujPqU25tYDQ4y6ME2SnJw4l
# iHg2e+4qqVHjPmW/bBP92xmXdGfXlnulO2GNLi5Ex2p2EuiQcLzpX97MkoBK2mX+
# 9dIiFk5BJPjhZWCtJMxATibZ4fPpe3oAjRSNcIBxSdsz4WvnxL5WVcXiC6pV107K
# k1K07qGpjLqiRbJWJl59RrfED2ngHLqsJ/xoVTW1t403nOv+ylj3stLmK2k2NhEn
# 8RkAxCU4Jp3YmBK1nYcM9Ev2M4NOAZ4RH9xWGaCkjuQMm7ExtusRvpEL7SJNB1fF
# XeuTK+I7zzE6cS7MYcpjPrzvkxZ02UNXtYewLo1XYZGyLsGiOtAKFRf25dHf9gbK
# UVOw3E20VN8LOS2LFgWWDFatW9n7okzQVjrcIz6aBiqf1z6eOTrJoRmBlvP1ZOWv
# SKClqjltTF+vhAes6xiEiB6PRFzMGRSRlctkzgxfW3ZBk0CYlWrJg1OwNgL4ojDa
# 5vEFP/kK50ndd3qT7gwfRym4YxvskGesoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDu0KDPEPhosW57OQici9zWO0mtqIzxxBZvtNWkoX7CRAhEAgzUdtZVaguRu1AKd
# JLFkeRgPMjAyNDA3MjQxOTQ5MzZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDosDA4vulLMAqGwJJ14Hr+
# BXIWFAf5FUO7PNM5uSRj4jA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgA1QH/u
# uurSVu0WEGJK2C9oi4VMFPSqjWEbHKX3eNS5eu9h35g6i612F7qHY5u6VXg+h+th
# /vIxOdTdN+4jMwuvdwjwR8tUgCQI/+R8jIjC26wbuKdTcIuiMSbIkbbOC8iR975o
# uvz4XzaLJmCjstzkzPlJo2KUWopiG5vcTrVNI96Kn5jd9XxUv/KbGTOSUMMnriLk
# n6TWAel8C1uLX6c97Z/P3gxafRb0GG5eowU6bI9TA399+MV/UZgSROdvv4/aMVPB
# n0URIQvzhxFctkSWJNS15g3eTGzzTY1FIdoif6wtocx70bm9jtKUv7HepvzAwLH8
# ohiFRt/KzwEnUPNjr0/bhe5SaaHPQhhlSSneTtF+wi2XaQAuPLbiJT42n2SYUtzD
# GWIR94r/5BMIBRigqmHSRokksaeU6u9DhOeJ0P/i7d47OgPyuZeqfxb0JBISJema
# GP4Zx+bP8Vrt8QuGYnGMZRfMGU4eyVIeDbY10eDxchEtNiLhV8TFWmxuylSCYgx1
# K3FuNPFVNLBt00h7ZdvsvRpk8iQ1Sg2C1IjtehzIYvYn/QwedMoV3aR2MqYNIKzE
# uFFyXPyOMIb6SzAsm3GisrJmfr97cJdG7qW7HjGcbfHZ9yE3gF9jXb+hBPLKzVsF
# K/sAgQTwTza1EUwOilu0esQwM1gxyW7riPingQ==
