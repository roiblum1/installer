function Resolve-CoreServiceObjectByName {
    param(
        $ConnectionIds,
        $ObjectNames,
        $ObjectTypes
    ...
    [VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.CreateObnCache()

    try {
        return [VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.GetObn(
            $connectionIds,
            $objectNames,
            $objectTypes,
            $null)
    } finally {
       [VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.DestroyObnCache()
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALF8VywHaVypfs
# Y32XKmem9Rp7Wbsou0ekx0HPzxrkCqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOfPKyyGoVgrj8e3
# jQHKEYlTS03sQVd+LfsUM/yGtdtRMA0GCSqGSIb3DQEBAQUABIICAEtF4paRdCyb
# I3GHcoctmQU5Iqvf9rlz41iIQyuF1/k0Got4R9uicE7vWL+oDOW3PzUXy7Nru4WW
# kFcorUm9/xEwEVy084UFs0azu3u2TAcTbL6SsUVKYYUKo/OKv1CLrzEcBDURp+di
# VbsWkpEOyMTYe4B4+09ft1bI7+HD5aWDfTGnHxPK+mdTxr0Qi/H7k/iB2sVL5zd5
# 99tL+wnMm5dKEjW8GHGBqr0NszW0IxfSwsivh/iXat6ehYFON1YKAIxDf0K15hEH
# 9a2mOVhlYSzZapF9VJTuIQHfecrwLRL0kNhaWyEmG3EsVzAol2bmCFGRXO2/X0gh
# fJNA0w/B3nsfh5BPpiRzgkiTgkDhgp7bCNgE6zXQwe8RbTo76/lZHh5v4X7Jnf5M
# xfIzretc5qUEeeqY69U+FeQViUMwgpIIYsmp76tQXzhBXaQ23mNEJ5MHSDjhHQne
# r6p6PBmWNh4xA5T1sW0SwjY02P8pV2H50PKdkpn1c53mdIDSiBe9Xw3+8q8gaRrY
# YEJ8y7FRF9XSNMCm5uHbuuF0Gsi2sDUNSsw6bga+iCNNdVDaLaaaCkD2hDpKmsqe
# VN46hVc9JaL64aFEKwR2pY4xvhZ+CQCVkrCgMlk/78fgqKvOc5NQslACnAEu6Z1T
# mk8AlhNHHcgbm2YrG6GzelwMiUsfhYT0oYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IAYBs1GW6QZ1LyZYCXxun54mdmUNsqXIS7Fe/kFqKD7LAhEA/cAwFKOUPu8J0dw7
# ZLZKHxgPMjAyNDA3MjQxOTQ5MzhaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ5MzhaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCYebOFB88WClXvSfH2cRoj
# Ze0uerDRbShH51S7HzEMdzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCE5rul
# p22WIhAY2KWt9sjCBcOjmujmJC86ISHRgiOHZeKy+P+q9pjnurovoYJsDuy1oI51
# Xw3P9yqF7lkk+QeV5eusB9Szj0JqrycCJDBrn5YScZYBzIfrgbWke07xGYY8x97J
# iuq8xcai+8dLf6/BS9ni4ndOXrut0R306v+T/pgDmjoEM/58UMDkLG8CfBZshCjQ
# Absi+qP62/S9vS1H38IlwpsHPC+hfIOJ7VX9xZ59rgeYMNF5biie9r/jQh5cdIBV
# foWZZBK0f2M4l6auWT0kogG2daWZP65qbihB3YWgWehzEQTTkQRT9NF2K7bqMTvK
# icS8Wz4vugC2blJoCzKdWdMmUh3kGumCTOByS9sF+228pVVGRs7PbuqJLDchQhC3
# HWQTxMtj1r5IuvO3aWR71IFGxn01dSc3zw71vAzwZrFtSHeFlU+9wrmmq61Qd5bu
# ZoEUxUMWZMVSwvyOhepWWQlhQRqREUbPthfECseC+8f4FFq30lR9+Q8xHCYHXULF
# Ku4MtofdoE4oVtPTrC5lrWm4Lms0LLl18a5IyRIfofpbvHp0jMCC4SILGUXQdVwD
# +Qj72uHmBwBgidZQo74/QiUIRH8I0aRGlz/crK15yZcd2subABdLKdqoegBkDsD/
# lcsAbxsZlM6M9PYuLmrtKc71O3r7O/mGigmyiw==
