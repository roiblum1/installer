#
# Module manifest for module 'VMware.Sdk.Vr'
#
# Generated by: "VMware"
#
#
...
RootModule = 'VMware.Sdk.Vr.psm1'

# Version number of this module.
ModuleVersion = '13.3.0.24145081'

# ID used to uniquely identify this module
GUID = '434764e4-7d93-45d7-9a84-12cd99b546fc'
...
Description = 'This PowerShell module contains cmdlets for managing VMware.Sdk.Vr API.'
...
CmdletsToExport = @('Connect-VrServer','Disconnect-VrServer','Get-VrOperation','Initialize-VrConfigureReplicationSpec','Initialize-VrConfigureReplicationVmDisk','Initialize-VrDatastoreBrowserRequest','Initialize-VrDatastoreBrowserResultDrResponseEntity','Initialize-VrDatastoreDrResponseEntity','Initialize-VrDatastorePathData','Initialize-VrIssueInfoDrResponseEntity','Initialize-VrPairingSpec','Initialize-VrPairingSpecPairPscInfo','Initialize-VrReconfigureReplicationSpec','Initialize-VrReplicatedVmDiskDrResponseEntity','Initialize-VrSessionIdData','Initialize-VrSessionInfo','Initialize-VrStoragePolicyComplianceCheckDataDrResponseEntity','Initialize-VrStoragePolicyDrResponseEntity','Initialize-VrStringDrData','Initialize-VrVirtualMachineDrResponseEntity','Initialize-VrVmDisk','Initialize-VrVmDiskDrResponseEntity','Initialize-VrVmDiskFindSeedSpec','Initialize-VrVmDiskIdentifier','Initialize-VrVmDiskSeedInformationDrResponseEntity','Invoke-VrBrowseDatastore','Invoke-VrCheckStoragePolicyCompliance','Invoke-VrConfigureReplication','Invoke-VrDeleteVrPairing','Invoke-VrDestroyReplication','Invoke-VrGetAllReplications','Invoke-VrGetAllVrDetailsInPairing','Invoke-VrGetAllVrServers','Invoke-VrGetAllVrServersInPairing','Invoke-VrGetLocalVmDisks','Invoke-VrGetLocalVms','Invoke-VrGetRecentTasksInfo','Invoke-VrGetReplicatedVmDisks','Invoke-VrGetReplicationInfo','Invoke-VrGetReplicationsCount','Invoke-VrGetReplicationsIssues','Invoke-VrGetSeedsForDisks','Invoke-VrGetTaskInfo','Invoke-VrGetVcStoragePolicies','Invoke-VrGetVmCapability','Invoke-VrGetVrCapableTargetDatastores','Invoke-VrGetVrInfo','Invoke-VrGetVrInfoInPairing','Invoke-VrGetVrPairing','Invoke-VrGetVrPairingIssues','Invoke-VrGetVrPairings','Invoke-VrGetVrServer','Invoke-VrGetVrServerInPairing','Invoke-VrOperation','Invoke-VrPairVr','Invoke-VrPauseReplication','Invoke-VrReconfigureReplication','Invoke-VrReconnectVrPairing','Invoke-VrReconnectVrServer','Invoke-VrReconnectVrServerInPairing','Invoke-VrRegisterVrServer','Invoke-VrRegisterVrServerInPairing','Invoke-VrResumeReplication','Invoke-VrSyncReplication','Invoke-VrUnconfigureReplication','Invoke-VrUnregisterVrServer','Invoke-VrUnregisterVrServerInPairing','Set-VrOperationParameter')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGl5Dsa1MxCDVB
# vM970zOgTQji8oFAK03pVi2RoDuSd6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI