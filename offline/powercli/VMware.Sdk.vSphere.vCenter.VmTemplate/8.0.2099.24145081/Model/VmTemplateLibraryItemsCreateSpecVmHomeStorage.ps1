...
.PARAMETER Datastore
Identifier of the datastore for the virtual machine template's configuration and log files. This field is currently required.   When LibraryItems.CreateSpecVmHomeStorage.storage-policy is also specified and is incompatible with the LibraryItems.CreateSpecVmHomeStorage.datastore, then the virtual machine template will be flagged as being out of compliance with the specified storage policy.  When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: Datastore. When operations return a value of this structure as a result, the field will be an identifier for the resource type: Datastore.
.PARAMETER StoragePolicy
No description available.
.OUTPUTS

VmTemplateLibraryItemsCreateSpecVmHomeStorage<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpecVmHomeStorage/
#>

function Initialize-VmTemplateLibraryItemsCreateSpecVmHomeStorage {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpecVmHomeStorage/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.VmTemplate => vSphereVmTemplateLibraryItemsCreateSpecVmHomeStorage' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYryJ/MtL6HH7O
# x0CZyWmMlXKYYGhT5O4zhDJicZMdYaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBit/taQYlhd3wfN
# 5mFwPv5d9lzPt5aGInfRzNhgAn+kMA0GCSqGSIb3DQEBAQUABIICAG6ymZdq/f1I
# KgmLXiNCeInTZ3yfMmHwlxDnc7cFXiHCsys0aHG+6yL9225Qm4d9YiBQJrGvsNIf
# 1cdf1E9mITWpy5qjEMyt2IMLbsodqQs6pARN5NabX/fbhx/BA4foGkPs0FbgjSEq
# U+g7dQ5BGgpAnPbjaVVK1avyYRR9+b4xIuRnRF9Lxix2fWq/9R5Zm8CxbCHTioMc
# paAE6FSJBfkaQqCWB9ugGxLwFWnDeot7GdxzD5lSpjILGRHvsreWSsaQj7v+gtM/
# KjmWkZPRSekXbrv1EsRKKqT45dLhzas4bCexhfhxE9KqajxkQGs3zXmuqAORCzuo
# pbAIDYOB5FZ+GapPCV1CxS4Uq9ZMfCnFejssrRpLFNCQQw7i3lRPXfpzd0LeXPVF
# YddWdf8EdqlAFoXw6IqiK1tTSIL+1Rx+PS0elGbwIBGEdcOYHjphANl0AVGtrBXD
# Y84aBBqNWg/YJuEh7oivI+BpbipPcyhLpijF6d540Lk20Mjiu8ffn8kuRHOFz9qh
# +LT/2moujA2U4L7dl8k6AI6m2a1ZSkrMPtV4GTNThYdfY1zN/uyMxV0mO5gtUDtV
# A3qTGzFc7nZJ3XQsq1gDZr+fwjS8nDeQgjjqpVZozM8xaXFrwp6+EuKPThUnFVX2
# CJ8vsyZRLCfGm6ihDnVxZOZpgXGcNnFLoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IGwCukjpXdS3U9MpraW/a4TLMzTPUT9HcEPg1JTv2LikAhA1cxAYbM151098jygB
# G7zEGA8yMDI0MDcyNDE5NDUyMFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDUyMFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIO9RI1Cdr2EkdHDPrLOHqV69
# kdcLuSvALBMe85P3C1zbMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADBGWBRH
# vEUARWnTn1+mXp6IXWVW/dMGQctbqezKWizJ0FYxdKRX4xhD3gXQpyLo3ZBhhiS5
# 9NnfmcHpbbaw+MoTj6U0tvcfkpd5BWd56dAK7YJ07BPTNp9JlITGIUcPro6EWXFI
# vyakaKttxxPLANLL4WP3I6BNLhVIyv1Pn2/gXXriPqmUnTf9rso5wRWCEsucHTPr
# smmMgrm9c9uvT1C+Ra9SOjkXjQrEVzBDpw0B5rvjMiaoz1gCK+y2a+4+sOcyLS4X
# RlPOsbjIzI/poxWFI58aYnJ+OnJkqqZOwI6CmkNFrabyDpJT3tsMc+TiKuxtMAm5
# Abwc75RAPXs3hpIITNcptFuc4cuB9CSvb2X/gGVMQyDPgFQJMu11nVSPJuh8zfog
# e2WTRMBIomWETBF0q9g+X/bDpYh8VNrEtXr3jERyYjMDZJy6zQCMRRV/lfL6s+yp
# Ak2tzVmtLcrisMIFj8la4Jk++kTIjuvllSWO6G/0Gwp+4nUYqLVjUQxz4PN0I+h0
# 10PV6exxn7JCv8JOeuOWTM9LTb/B+qdRdQalqJpw1XIF8rp4UIVTt7yuAWJW8wul
# ca9pcBI+/NL8uk7XpCWFNiKlkUXp9PgUssJev/GBZOs00tM14QTigGt7iLwumvQ8
# UzEWiUSTOZT3eMnJHroO7GsnD0qit4WS/f7V
