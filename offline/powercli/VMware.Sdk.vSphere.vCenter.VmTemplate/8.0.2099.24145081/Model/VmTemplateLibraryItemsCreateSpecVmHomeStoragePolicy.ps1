...
The LibraryItems.CreateSpecVmHomeStoragePolicy structure defines the storage policy specification for a virtual machine template's configuration and log files.

.PARAMETER Type
No description available.
.PARAMETER Policy
Identifier for the storage policy to use. This field is optional and it is only relevant when the value of LibraryItems.CreateSpecVmHomeStoragePolicy.type is USE_SPECIFIED_POLICY. When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: com.vmware.spbm.StorageProfile. When operations return a value of this structure as a result, the field will be an identifier for the resource type: com.vmware.spbm.StorageProfile.
.OUTPUTS

VmTemplateLibraryItemsCreateSpecVmHomeStoragePolicy<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpecVmHomeStoragePolicy/
#>

function Initialize-VmTemplateLibraryItemsCreateSpecVmHomeStoragePolicy {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpecVmHomeStoragePolicy/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("USE_SPECIFIED_POLICY")]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.VmTemplate => vSphereVmTemplateLibraryItemsCreateSpecVmHomeStoragePolicy' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            "PSTypeName" = "VmTemplateLibraryItemsCreateSpecVmHomeStoragePolicy"
            "type" = ${Type}
            "policy" = ${Policy}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2D8jizf8XgG1r
# 2hJLor2EOP6s/vyXPX7NwXLBJekgzaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII01PtptdclnKe+1
# L5Vgdu+VvpALWZkEUjPxUBqhnJq5MA0GCSqGSIb3DQEBAQUABIICAER3/3DKwxN5
# Alytos7/QkJm+5LBlQtsVpIP7/FLyrIWXSyBvtWdSf0yCWwi3fPuF0cvP8SXsVEo
# IAXfutNGVzHgfzytp6L/zXW2GhTd4TXln6/LZIpWlnP/5xgD1OIN7vMViTIx8+c8
# N0lXTP4Cp7gwbakY4NHL+tOiwuPd0VjX1jKEzYWNK2neRIr04SdWsrngTdHB01rB
# lB35pogFpqJKWCYkl3ZpzmWEMen7HL3/Dvrc/2lmGSZqc4lTwxKeiuTQO0r+OG7P
# //jK7Wc8EDFame/yG4nCRL8hT9vvGBEGLOk1jgH9OOwFybO4nzvjLwMBLEjC2pH0
# EC8ogAzbVJkN38JCWOZ8+mmyfu/sTA8muB5d4nv2u+d3DpQXNCyHzxs3QnSEkXTO
# zULLcXeYVqMnlhDrTWSLbeo3IOjlMLcTpmcyHayoumNGD9hLFRoeJyaTOGEYOj/3
# nsyaF+DhJzyFSX+TL5dnKhVKD96u5zuQnDmEFA9WX2uDnjYoPJHrFmiGytQe0spb
# UzERjZoNgpddXtx1Ax4lRuHTx3aETuFIrqCQYV1/xwo4dm2K5oNAVPOv3Pezxr07
# IqrhhS9inFXkY+BCKWwcAUfeh43TQE8yr/n3hprsYPFGSxRogn+rU+y+0i1AtIWe
# 39S0JeXkqgygRoBaQgoBe5jHAry6k8MioYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IDd9mDT7kJsqa+FEI7bkSzjmtjk/HnVJ9WBLT88rmddtAhADlmGbEiIrc9t1Lk9G
# SxJPGA8yMDI0MDcyNDE5NDUyMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDUyMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIF1aiHObLKJsP8q/6ZWWpvP1
# kSFwQSAQss02HBPH5iBoMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICACJuxsl+
# JfdF/dUy9X4S8WMGGk8e1XAa8euRW5UyQII94TUhpJzZ0YnD94+tygUFg1wsgWZ7
# zvPuoQvfQQVAzEb0U/wY36GWbTGB4Dvs97mXxCxsTn2uVjGWc9gapQeZpFnH/lvS
# cAfQIe/e9dNZ3dK8jLWhFRYt5YJk2YNjVeugzxa79rQx/865ObwBQviQhB+LvEqf
# mCJrEedLN1tDV4Bwjk1hhZcFHRbL4+USibwOMFI8CxXvGq2VtUAgCrrDLMZKRSdk
# vdkklSWVusHTrwcgsb2NbSAxQCmHrBgmbLO/gQ2fKfgt4oSHVQEI0v+JyiBjxdBm
# CkeNpX987ZuyVEvohFwpkLDamAphvdJ1vjR83xO/q0HXEi0PT7mofbpsZw/KVAv1
# L61xHF4he0KnsHYtxiGMU0mDiqw1JhjtY96QaLRnurXlXlQbOJyfNMbSEUt4OJwP
# 6iHb7jIi/ZEwHkbr53qw1yllv+xJlAm6WLKuxr1q5EXDBdeRBDHqZNDWuaxi4Pjn
# nLjFnUl8kkwSRXV1qvNgY74EfHfSTMHXxGGkKnKolznV430Xbdqnh7WAlqRoM9JC
# xIgG3XWq8LL8gVE/493sht/j6/3s5WkB5KHvxnfptTWmofrwH9nZJLFbpBt9vYW6
# diWTBjFuW6a4WVZL5k1qZHNEuMULt2r7db8E
