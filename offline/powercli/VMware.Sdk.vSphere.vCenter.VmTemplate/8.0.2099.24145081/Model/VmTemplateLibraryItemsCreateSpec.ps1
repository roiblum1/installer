...
Storage specification for individual disks in the virtual machine template. This is specified as a mapping between disk identifiers in the source virtual machine and their respective storage specifications. If both LibraryItems.CreateSpec.disk-storage-overrides and LibraryItems.CreateSpec.disk-storage are unset, the virtual machine template's disks are placed in the default storage backing associated with the library specified by LibraryItems.CreateSpec.library.   If LibraryItems.CreateSpec.disk-storage-overrides is unset and LibraryItems.CreateSpec.disk-storage is specified, all of the virtual machine template's disks are created with the storage spec specified by LibraryItems.CreateSpec.disk-storage.    If LibraryItems.CreateSpec.disk-storage-overrides is specified and LibraryItems.CreateSpec.disk-storage is unset, disks with identifiers that are not in LibraryItems.CreateSpec.disk-storage-overrides are placed in the default storage backing associated with the library specified by LibraryItems.CreateSpec.library.    If both LibraryItems.CreateSpec.disk-storage-overrides and LibraryItems.CreateSpec.disk-storage are specified, disks with identifiers that are not in LibraryItems.CreateSpec.disk-storage-overrides are created with the storage spec specified by LibraryItems.CreateSpec.disk-storage.   When clients pass a value of this structure as a parameter, the key in the field map must be an identifier for the resource type: com.vmware.vcenter.vm.hardware.Disk. When operations return a value of this structure as a result, the key in the field map will be an identifier for the resource type: com.vmware.vcenter.vm.hardware.Disk.
.PARAMETER Placement
No description available.
.OUTPUTS

VmTemplateLibraryItemsCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpec/
#>

function Initialize-VmTemplateLibraryItemsCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CreateSpec/")]
    Param (
        ...
        ${Library},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmTemplateLibraryItemsCreateSpecVmHomeStorage")]
        [PSCustomObject]
        ${VmHomeStorage},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmTemplateLibraryItemsCreateSpecDiskStorage")]
        [PSCustomObject]
        ${DiskStorage},
        [Parameter(Mandatory = $false)]
        ...
        [Parameter(Mandatory = $true)]
        [PSTypeName("VmTemplateLibraryItemsCreatePlacementSpec")]
        [PSCustomObject]
        ${Placement}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.VmTemplate => vSphereVmTemplateLibraryItemsCreateSpec' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBofuVo9CZ1CMBO
# jAC5/G3440YceuDwFY1v8y4wuQODl6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM4894bbsLDKZZcn
# hNZZM0NimI3xKnOYkSQT71HDOd+5MA0GCSqGSIb3DQEBAQUABIICAJHzdaMS6QZh
# GahlW8CUAs1I4htwKWtDnpRWWvxI5rPFrVJJVPBCisHu7HhCL3a/j62G6Q8qkz93
# /hquHbzWDnzlz2i6AF/bl2SPhSvUArH2AbR+PwRYSeKU7V0AhbPVuQEWUjH0ozMQ
# T9NZlqCLnbCYIGNwoLavMpX+vbHJwRF5ZyWFovCrnD8UyMSM7T1ptqtiKPI51Nf+
# ta37fJbzF7W5aebQPP515aqdSuaJ9lgnXJgFuJiARb9uwewTUlTH3UKqeBynZcKf
