...
.PARAMETER Folder
Virtual machine folder into which the virtual machine should be placed. If unset, the virtual machine will be placed in the same folder as the source virtual machine template. When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: Folder. When operations return a value of this structure as a result, the field will be an identifier for the resource type: Folder.
.PARAMETER ResourcePool
Resource pool into which the virtual machine should be placed. If unset, the system will attempt to choose a suitable resource pool for the virtual machine; if a resource pool cannot be chosen, the operation will fail. When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: ResourcePool. When operations return a value of this structure as a result, the field will be an identifier for the resource type: ResourcePool.
.PARAMETER VarHost
Host onto which the virtual machine should be placed. If CheckOuts.PlacementSpec.host and CheckOuts.PlacementSpec.resource-pool are both specified, CheckOuts.PlacementSpec.resource-pool must belong to CheckOuts.PlacementSpec.host. If CheckOuts.PlacementSpec.host and CheckOuts.PlacementSpec.cluster are both specified, CheckOuts.PlacementSpec.host must be a member of CheckOuts.PlacementSpec.cluster. This field may be unset if CheckOuts.PlacementSpec.resource-pool or CheckOuts.PlacementSpec.cluster is specified. If unset, the system will attempt to choose a suitable host for the virtual machine; if a host cannot be chosen, the operation will fail. When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: HostSystem. When operations return a value of this structure as a result, the field will be an identifier for the resource type: HostSystem.
.PARAMETER Cluster
Cluster onto which the virtual machine should be placed. If CheckOuts.PlacementSpec.cluster and CheckOuts.PlacementSpec.resource-pool are both specified, CheckOuts.PlacementSpec.resource-pool must belong to CheckOuts.PlacementSpec.cluster. If CheckOuts.PlacementSpec.cluster and CheckOuts.PlacementSpec.host are both specified, CheckOuts.PlacementSpec.host must be a member of CheckOuts.PlacementSpec.cluster. If CheckOuts.PlacementSpec.resource-pool or CheckOuts.PlacementSpec.host is specified, it is recommended that this field be unset. When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: ClusterComputeResource. When operations return a value of this structure as a result, the field will be an identifier for the resource type: ClusterComputeResource.
.OUTPUTS

VmTemplateLibraryItemsCheckOutsPlacementSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CheckOuts/PlacementSpec/
#>

function Initialize-VmTemplateLibraryItemsCheckOutsPlacementSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/CheckOuts/PlacementSpec/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.VmTemplate => vSphereVmTemplateLibraryItemsCheckOutsPlacementSpec' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "VmTemplateLibraryItemsCheckOutsPlacementSpec"
            "folder" = ${Folder}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCByflm3JELjQqjG
# K5pzQiqt+cSRDWdyZlo1om8M6SqIOaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFb40+abk1Jf4Ehi
# MnFhuOnk3OyvMdSmt++BL1Qjdd04MA0GCSqGSIb3DQEBAQUABIICAID3+99IIzVG
# ZJ+GfQwmcQPvjlOQ2eFEgeeNN2q3ccrPwxCVptkYKMB6fHChnW4HqYZ5rMXQ1OOn
# 86/bJjGj36eSjf2udtjVLsF1ltlSKd8ENg8ZaYvMD4WZ2NKE5+RBQp8K0mSNC5PG
