...
.PARAMETER Datastore
Identifier of the datastore for the deployed virtual machine's configuration and log files. This field is currently required.   When LibraryItems.DeploySpecVmHomeStorage.storage-policy is also specified and is incompatible with the LibraryItems.DeploySpecVmHomeStorage.datastore, then the deployed virtual machine will be flagged as being out of compliance with the specified storage policy.  When clients pass a value of this structure as a parameter, the field must be an identifier for the resource type: Datastore. When operations return a value of this structure as a result, the field will be an identifier for the resource type: Datastore.
.PARAMETER StoragePolicy
No description available.
.OUTPUTS

VmTemplateLibraryItemsDeploySpecVmHomeStorage<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/DeploySpecVmHomeStorage/
#>

function Initialize-VmTemplateLibraryItemsDeploySpecVmHomeStorage {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VmTemplate/LibraryItems/DeploySpecVmHomeStorage/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Datastore},
        [Parameter(Mandatory = $false)]
        [PSTypeName("VmTemplateLibraryItemsDeploySpecVmHomeStoragePolicy")]
        [PSCustomObject]
        ${StoragePolicy}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.VmTemplate => vSphereVmTemplateLibraryItemsDeploySpecVmHomeStorage' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDycmFmbMgMk8ge
# MWxKPr4it3NJCsg2SZVB9GS8XhQsUqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINKl1ZEYmagfSVR+
# rmKLeJeuRP99w7hSc+oHknL262VAMA0GCSqGSIb3DQEBAQUABIICAHwdAodY957L
# yNmOdWvosh6jMlpMnQdQyGjwd6cFbav6fSMX6DUwF7Q12/viqzZss6Yw8B5O108C
# Qp9a5Sa4rV5FawfvFVmg9HK5IGR/kfZJHvtMF+NU1X6ZUENDo48yerRKWuF+cmc+
# n/369VljjGV6rLk852ZLIFAZsNXNXv8NJ/jvU2/9T6GYAM9Nq7c7iPtfv+CfOwWx
# 2C8IF/Y97cEB3s5EPKLmVOtJJ/9uUuBiXu5wNCAuj36DovaIEl94tg1xhleAzC03
# xqhsr1AxZsVQdCF8uXB8PQfi6vnYaZRWs1po0tjLucJzjZUJGhheO+gGTIzw22Wy
# CxJNTUX7DsgRk0g19P4uU3uHV7zppE5RmhVUTZUwZXsYLKdB6XvekjDR95FkBzn9
# otZHa95LetI7PC5mWfxNmHvDtf+GnxvztzhJbu6/RtHbco82egoOzpHtVSQ8kT5d
# SaR0NhZ7J/jgZzjGISWxiaEblK5Wa7mP86/Es0YPcKzH7T/uuNOXVUmqkPKAS1VV
# f3wG1+KJP3CK4zk+Vh1KCdoV4uahY+ANY/L+uLvZdw11fFZ+89vJ49Lem/Oz67cb
# 1VaigYSHrCtPGF4AFniPD05AyuzqqMRP9+uqntlj+QmE6xQX+jjYAaReP90tqMr/
# 0eJNdYgQ7iImA6qn1WGQcdfXrQcEEaGJoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ILu1wVThIP4XnJIL1q70tQkzHFotol3kHaPL4prwTphcAhASxsgEmV8L9v+OLZQg
# P4wdGA8yMDI0MDcyNDE5NDUyM1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDUyM1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEILdRogWwLKk2OQfaXsJnA5rD
# 4QNax8dYWBQVOorJYnWDMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADfyRjR8
# urUnRPJiEmm5T1VpHq/bTJPH3Nxu/pysocqh2iwL3UrhaFT2lN4pa74s/b5PGb3e
# WrLSS/OAUDq8d1uUsMHRW6P+kgV9fJMhKuIIayQDw1YZamGKynKpM+NUfgKe1zG7
# Z1DjmmmGcXapYSKcttjvDgWgjERtG3925fq/EiiZfzTFGk7n9Gpa9Bf7DsUOFhD7
# 06RA4PYoJmrtJ8rlwKo1kV7Jh8eOtGDOm3p55bjmKTGZscZs1C7DVfldCvjf9FuF
# Cy6PE/yxvjj+UB0X9SPdQyjN4xisZY9aJbqqq6figDAQwpV1ZFgMdN3eWstFEtCS
# JvrQXoLVhQj96/I5jM8oRQ6Ku+uDREO6Mfcc42y3BLq2Et0oeK668007xVOI5JdI
# TUx2CJkvRMSsRPyRTSrIH9ub/wvCbQUoAYWtQHp7bHW+il/rrM1AytSAz5bGr5ZO
# Iwr4idzXcXxsfB1gN2WjiLIxXcUpEREUQI4oMmNnugzCFnIyoe3o5rc1aXDs0gZv
# tehuFwjnnh4Ru/Iie8Lgi0s3Wj+XXl5W6aDRnDwBe5wG+7ePkImkR/ACCZuvr5q9
# LwDsHJNy4UpAkpJjXDfTY1+cuvHrVNZdkiX/hHcjghcisiQOD9O0tP92sjwo7R0z
# moH2D80R3EpmkTw3Zsioy1VuZNR9O4h4N9Vt
