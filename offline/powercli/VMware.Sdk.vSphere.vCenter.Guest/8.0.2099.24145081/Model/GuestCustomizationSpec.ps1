...
.PARAMETER ConfigurationSpec
No description available.
.PARAMETER GlobalDNSSettings
No description available.
...
GuestCustomizationSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/CustomizationSpec/
#>

function Initialize-GuestCustomizationSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/CustomizationSpec/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("GuestConfigurationSpec")]
        [PSCustomObject]
        ${ConfigurationSpec},
        [Parameter(Mandatory = $true)]
        [PSTypeName("GuestGlobalDNSSettings")]
        [PSCustomObject]
        ${GlobalDNSSettings},
        [Parameter(Mandatory = $true)]
        [PSCustomObject[]]
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Guest => vSphereGuestCustomizationSpec' | Write-Debug

        if ($ConfigurationSpec -eq $null) {
            throw "invalid value for 'ConfigurationSpec', 'ConfigurationSpec' cannot be null."
        }

        if ($GlobalDNSSettings -eq $null) {
            throw "invalid value for 'GlobalDNSSettings', 'GlobalDNSSettings' cannot be null."
        }

        if ($Interfaces -eq $null) {
            throw "invalid value for 'Interfaces', 'Interfaces' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2zVb4PgzZiRpy
# Z90KwlIy/YtxYZQnjhG55e1e82cozaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPZHiCghdecfBSXf
# igEG1E0+mwn7bH43AI4eWd/rTtckMA0GCSqGSIb3DQEBAQUABIICAHWKwB7Dbj5M
# bKsbRTRnej3zewfJRrN3ZjQRROvlpX3ns/myzz67eU7bju+UVjHYDUg6+oOy2wTL
# /O97EszQGLXedI27hrek5u0LfNrrKbkwaTp3Z5ZPkhMzUQTY7OiddYzIMMOcv6+s
# kMvEiPvRNUQpwWSup4j5b9GVUON/NykGTBn/iHk+Ugy1B5Ye1SgOkylsJDfxWkXi
# IrKiQcnaY5cZqueOn+sE/KMFQmpUJ//6GiPG1SgTzwhVlsnaUXP/a8gGR6qFPLpB
# NZU/XQutbhx2cnVbux2C+/uJEdBQNk2OQ/BRE6hfDel/NUflj7OrCLJeA7cjextT
# nGlyukTIHe6E3Mr4VVt7GIZNUi9drMx20HPZGT5Brz2xdLQsne2RlEihLPMgFrZF
# GP2D+pBD2NU6+eQmgclNlppcP6rehqtgIvZ4yYR9yzSDGpf4u+o/aDlr2eso74YR
# lasVKhQB008vX3poDkr9ZYxhuiSI0Veod0dqmCeuOE98PQexeY088zhgeeNTdU+n
# gzTOhddTfwWMwKkLlKuKjs9cpB+GUOBXEv6BOiRdQdqvBmj4/AbieVqkwTxAStL+
# dr+CQZrQhoX4h5ZyzwFBlC4y6CncZz9LxKfkk+VsoZCf6blywudEYZKAsqKWW+Bq
# 1Zr/u/OTj4tML6ba+GnY06sTXuTE4KIJoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ILLM3AEKHFM20R/JdGIVvijEvAoW5s5Sz8BQH5pTrt07AhA1tLW5QWbr5Bg86tgT
# qexKGA8yMDI0MDcyNDE5NDA1M1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDA1M1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIAVcYMpXiVvZzBNU08POwTPo
# LLOaNHY1evWo6b+R+nRSMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEzjHKSA
# Lpa1mB9Ld9rBwnnvTxI3zpHEjThEP6MzAy819WpwyUz9pI53BzIl6TwItUagqZuS
# 2ID0snLgYdzvsAvVr0w+MmbcOyq5cG2UA5+zkU41/fZ6J/D+7sbkCKW7n/TPt2I+
# y55FFVpjaGonZRJ7ObtoKnm2WpfjBPR8j+sCPnAS/9r8YjFvIY/gwC2GT80mCEVu
# BE5PWsARNBg4EJH5e5b94TolBsqB3Ob4+76EaZYD6Ak4IG5EeBfK4tqG3doF2qlQ
# bsiasH+6EYqqHuWcrbxfIsvepciGLmDaUwtXK0aQRJ3qy+C9b3ens5G8hWoMZNpT
# uVsNzbOnOABH3YQxOUXJrm12YpP26xFP17nzSaKnCkSSBurQ/elQ5QI3Fg1+AB7Q
# Q5VSbA5aXm7tvBneK3sUX+EisxAsdn1iJIkFWJwp+kZqoYWkCsQQ1Kz1CFKmKGLv
# Dbzfd523NE9a2AuQVJbYSzMRhxhJ0R81VCV7qQbhWAnv7hyHwYFvbXERJfWusYL0
# KnOlbYICzwPtQzjEhz1J3nYJ+VT0FqBAfwW2Ta/FitPN0//U+c7F62uieUoZnrha
# thdtgOLCuaHLwEL8yrtnaPwELWXgIhMagRmFvPcz4h3CcP0gcKyZOqCOJ81X12EA
# 40ebq1kg3ndXmSa9Ne8DrMfiVkB9Gmthked2
