...
.PARAMETER Domain
No description available.
.PARAMETER GuiUnattended
No description available.
.OUTPUTS

GuestWindowsSysprep<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/WindowsSysprep/
#>

function Initialize-GuestWindowsSysprep {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/WindowsSysprep/")]
    Param (
        [Parameter(Mandatory = $false)]
        [String[]]
        ${GuiRunOnceCommands},
        [Parameter(Mandatory = $true)]
        [PSTypeName("GuestUserData")]
        [PSCustomObject]
        ${UserData},
        [Parameter(Mandatory = $false)]
        [PSTypeName("GuestDomain")]
        [PSCustomObject]
        ${Domain},
        [Parameter(Mandatory = $true)]
        [PSTypeName("GuestGuiUnattended")]
        [PSCustomObject]
        ${GuiUnattended}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Guest => vSphereGuestWindowsSysprep' | Write-Debug

        if ($UserData -eq $null) {
            throw "invalid value for 'UserData', 'UserData' cannot be null."
        }

        if ($GuiUnattended -eq $null) {
            throw "invalid value for 'GuiUnattended', 'GuiUnattended' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "GuestWindowsSysprep"
            "gui_run_once_commands" = ${GuiRunOnceCommands}
            "user_data" = ${UserData}
            "domain" = ${Domain}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAiuY/g+ssPGeCt
# WtAcIP//wXkzFRL3hHRnqlqX4gN4ZaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOFILOnQJ6JFq7UW
# 0gLlDWLxXtU7MIOT0c+ygqOSPLP7MA0GCSqGSIb3DQEBAQUABIICACoJwUQtUaXT
# 95anpVtW7SDc/qp8bRoU71/PxgfMCmQEp4G3rKeh/Y6nL+w0ifFFCeXKWqkVJ/oq
# YmYDOPfSbYwzETREUGy0Z2XKjhfBh1l7wRQe2nDszs/yLTHwjG3q81wKmtzax/2O
# w3I6Isx12OKUD4hFCP5H5rnx8pDVGG1U7KOBP1/nnusYetaOBpzb1yjAE+JJmP7q
# dqOSvtdGoyHYVXv83p7jp9K9xF+0O6Lw8h2Ov0V4OZXz1nRhvz+qAHx7Yv9fuoND
# Pk5YdQyJRRS2ZJVaoWyitS47NoqSmQxST607Cnf6rjXdAPlvvGY5T7s6rLRFpzCm
# SaqqR/fZPoVum5pLGggP2uyLdLR7qpfCBOh4fovGKTBez0qPADjNAD4aRkFw/0QH
# u4P25jR3jMbm/qUGFDJ1C75eqONNn/8Kc9EdP6aF362RfWspT+/bgpoC+MFaY51B
# ey4SYYLCJk8Lwz3K/+JmSpGv/mrqYnu/zIT5qY4OzPNqGM6EHMD/pfeQ2cXXGUQe
# VJ3i0+EG5IzL3wDm58ho9u8puCJ9F3wsBG0RH7xQPUMXkgAA79hi88OxZ2bQjQss
# AFpH9/xsUx0UTPZznE5uVxcQFXU9e4o5L+RnbyYFdYswv1qd5jj2Q3pScjOWkUnn
# 5vfk2PknwDBmTfnrWATAq0idSeMXwV9ooYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IHr772xyvXvNLrrWxpljY0OhWBaq1oH2r8yHf/MrkC4lAhByiAw5wjHy2YlFpuXW
# my29GA8yMDI0MDcyNDE5NDEwMlqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIB1CLJnvt0NIy9O+tmxJeJCb
# sp0YvgbNGRBrWgSOX58ZMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAE/8ZfBx
# AiyFl5TDgAt1N9VQb0/QOJJTwY8X1mkhJdYhFIKeQ7ckig58lYqK+DuuN2rFB+PN
# DMR3m0eEId1UQGPt2NqKPUUgR0LwzXDSUXUqUfWu8bf8sHJFRDuzDHfpSKONoIUj
# 8zofLh6JsJalRDMFq/Aj3Hfv5UW1vbea4DzutjXT1qM7qrz9iuT9gNq4sMUqU6my
# jvOEwMJYNF+NQDo877zpzwKvkMfLqQ74H21b5RglSL3YJV8Jr5QBERJWb7WubM4Y
# GIjN3HbNZHhDjrmuNT02k9lsxoY81ccfbi9umN9ImQp1b/ny1/d68XPTccqzvu1F
# zfrda0sfx8nHYEa49eEd/irb8Z994/TOLVcn/JDNftN96y6k5SgEai2/FlEQB3pb
# EILFh1XpJahZuGC6kl4TwKUn6vdX/Cfy1P61SnwBvNrS8iH9OMpbUDmR8AMh35mn
# g6RQiELuJLG2j7xIsKAVIQm6dNTJgYOZUcsgCWbR57Lv4RRS6tW9kF1zV173hqDp
# bgalYgTOyknsgWFU/aUIImWbQS7Taunffi/TbpGok5BauCdE7rk7JUUVweSEE1Ql
# wOWByJ1C0BbfDa4DLdIaZGLXoFws9H2VQ3FwvDZcor+TncChJRSvq7vx7fWB7CS2
# 4sj6vvRzYrRPUBHgdDWzuzeC5HOMi2XK8Q6S
