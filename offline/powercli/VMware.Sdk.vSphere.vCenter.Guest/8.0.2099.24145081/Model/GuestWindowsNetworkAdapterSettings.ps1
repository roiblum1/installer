...
.PARAMETER NetBIOSMode
No description available.
.OUTPUTS

GuestWindowsNetworkAdapterSettings<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/WindowsNetworkAdapterSettings/
#>

function Initialize-GuestWindowsNetworkAdapterSettings {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Guest/WindowsNetworkAdapterSettings/")]
    Param (
        ...
        ${WinsServers},
        [Parameter(Mandatory = $false)]
        [ValidateSet("USE_DHCP", "ENABLE", "DISABLE")]
        ${NetBIOSMode}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Guest => vSphereGuestWindowsNetworkAdapterSettings' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "GuestWindowsNetworkAdapterSettings"
            "dns_servers" = ${DnsServers}
            "dns_domain" = ${DnsDomain}
            "wins_servers" = ${WinsServers}
            "net_BIOS_mode" = ${NetBIOSMode}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAmRRsf/pDMUKH/
# xtT0+HIzGPvDk1f5ZVHNJTUDJRU/TaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEFCjt5ro71NB7WT
# gq8YrBoNSVNHpemZN1970yGmSRnUMA0GCSqGSIb3DQEBAQUABIICADGSicYZenGW
# Bcde23GXjOTmOAmXpZdcs7zEhGDfC7RsCKO5+IjkoDZBU4Yxwa7bafLrIg9oJvKD
# Avm/FXpqZKMLHiOrfJHN4N/PVwCQyZh5iBQSwjqmyKVwQq3S+zjmyreG7jzx+a0k
# +KncrNEPo03XntC+CQYPGvzADov8P0uP3QPge2+nqmaIOzGiTZmtK/6TaGYv3l82
# ajJ0OPOEmOtTttmlqzcDu5WW8lZk5031FW4YaNQQ+zfOm/FBqWHEeCDcptbixpaC
# IsXGxt7zs3bIrD+PNMUsSsjM7zzVIeMc1uyfBnbQYBzk2q7YV5qAmsptJ3aWp5Cr
# h72++PVkCZjg1+QAO3ygD/3anYKdlCoZL43qvhNnShiqT2SQNfHww3R7GZG9X1Mc
# jZECY1ySeQ5XGKiaVijiUEqlzeYE4yOg5QiPE+aO8nXJYWaiS9Von3jAioA1vmRx
# MbueRR7nxssZs+56X/d5voR0BHZnz2nkiAdVpUr3Psv0qjHHG7U89PJkXEjPx1kc
# QYmP+Es5xiPG9S1G0VCxKyuNv2cxlsrz9AnacS3HW4Mitm0bDo7lP0vD00eO40S6
# sIBRo39LUaUbCv/cuePTUTLNCDJ5PDL0xb1rtsQRELDCbxMWQ73AbDSkOw3suDjh
# n3kH1CCH/a+Sqmf59+WEyxxZ22iOwOQVoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IKNAm8GoMLQ46prksGTJtWayjfN83C68nQBK9UYq0zo8AhA54gMWZY6ZAtP1z2sw
# b9jhGA8yMDI0MDcyNDE5NDEwMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDEwMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBkWYhF88SSGootdWTpRYIzN
# dzY0XQyNMkIrzoak+niBMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAFjIqp+E
# ZXkQWXxwfvTpL9wLssDYwIaIBrwYbRgVbFxTIj3FU2/QkRU78ocLHmsdFH1fSSTU
# xx+jyK0qVQ8QF2ecxCqCFVHuQ6SMvgL/XSlhKVJLrqvyA9XTY4wniNbDa6/B4PSP
# S/XVkZ3+s3ImXWqbxtQXwryflo7lKyI9uXZwsIiYbjsuyNbn9hERwMNJxRz8qb+u
# 7tPHJvaBKaO0dPA7L0ONU29gcXSa6MNri/ZoWsPEyHdP3A41FUbF94pGKI0fIBkM
# UpIfloEydojH676RAevtMj/l1HyxfHTgQZ+36qbL5f1cItAi00YRSiDFDbQXfk21
# NmydPsHkT/2v/gBqd/o7oOAhBefqRFn1dw/mDl7lXv/IJia6m5RwlYERaP3JV/J8
# ibo9PtxpRCRQcXZB5qu0tCbfk8xG7E+L8ueju/zUBOkg44j9X2gCQ/Ktq6eWDwxo
# yUuW6UH7xvoJJVdSaEOoyVOGwkmQToXpzuYdi8x6SBdzNfXfiLyUzdDwLWBHw9MO
# Bo44i3an6a6mn/fdZWHogWWiE6aPC7rpKUtww1ciq+bg7GFl7hJTdQP5Ltol8xwn
# niMgWtbA5vCginxsS9lPSRa8AElPCWphoCE1Tugsn/uiZ528XeUAicLkcj//o4VS
# NOEPpWNnt2VKP8KfzLLyTkd20fXdiVXh+oCl
