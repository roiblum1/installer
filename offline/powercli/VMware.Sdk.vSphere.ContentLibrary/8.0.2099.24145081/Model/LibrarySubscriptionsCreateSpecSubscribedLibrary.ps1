...
.PARAMETER NewSubscribedLibrary
No description available.
.PARAMETER SubscribedLibrary
...
LibrarySubscriptionsCreateSpecSubscribedLibrary<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Subscriptions/CreateSpecSubscribedLibrary/
#>

function Initialize-LibrarySubscriptionsCreateSpecSubscribedLibrary {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Subscriptions/CreateSpecSubscribedLibrary/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("CREATE_NEW", "USE_EXISTING")]
        ${Target},
        ...
        ${Location},
        [Parameter(Mandatory = $false)]
        [PSTypeName("LibrarySubscriptionsCreateSpecVcenter")]
        [PSCustomObject]
        ${Vcenter},
        [Parameter(Mandatory = $true)]
        [PSTypeName("LibrarySubscriptionsCreateSpecPlacement")]
        [PSCustomObject]
        ${Placement}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.ContentLibrary => vSphereLibrarySubscriptionsCreateSpecSubscribedLibrary' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            "PSTypeName" = "LibrarySubscriptionsCreateSpecSubscribedLibrary"
            "target" = ${Target}
            "new_subscribed_library" = ${NewSubscribedLibrary}
            "subscribed_library" = ${SubscribedLibrary}
            "location" = ${Location}
            "vcenter" = ${Vcenter}
            "placement" = ${Placement}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCsyEYPSwurI2zl
# Z7+TlXMQodjkVdvH0z4SVeZkuMCC66CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFtQfMVhG5pPTxM8
# TTZiXs/g5jmvgcH11S+DU1GILGjyMA0GCSqGSIb3DQEBAQUABIICAIQnJhFchkge
# FybYxGLFcYy8UwSkm5NObZxLukbcZbItzok2htPtnG2x3SCsh9chaqYLbypNgt6v
# 6RN+XgCG9PasiAKoXAwNa2kUDDgLpZvGuExuGcIv2C1ljcSvV9P0v/tyeUrgK4u7
# NFszIOyZBZrFFLB03FjBR+cuu+5WI/zBmfYsAiuOf68b/03JoTrAsEuWc2fTQL1M
# lSbfh/rE2Y+u5RWSfH2AAjsO+lkF1IJIBudOL7b8mNhNegmUz7EKnE1x6MzCMT2S
# jNvQWURySxRglhFx+YwwLjw6oqIa2m2M7O9Ys4ImbUSWMYHxZmniuMmWDTtCMng8
# JigngXfyq0tcuEKLxhUaajCs3+WUspZn+zFeOaFDqB9ZcfsLoBxPerw1ffSthC0b
# 83XoMymopkn6VDt+aNYxw1E7tb2/E+1XNAR3OvqQHM3glNAtVRXlmyJxjSsZR5tw
# HZoVpQprfzG/KicFBSltCYjbMQjk9G/5GJMBsgKAeFZeSadl+VTWOYTXzpwHsD3L
# 73MBu/uqVYRFE98Mas6RRa1UqRQSdQCmtEGPQpGK7lWNv4pK1M94RZ0A8qbCgQOh
# NloeGwDyc3H5ZPLGgjCdPdFpiyjCFPTS5DQacq5TU1lxfavXs9MqWrTHzR2ollbd
# H3DylUAL6GdbvNXB6X57wD8kbXBzfaRuoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INWGKk7ZdgkoE4xlwIj43Bso9xp+1CpDERjSLUkTGmroAhBcZKSFt5kcFNhLprHI
# T+vFGA8yMDI0MDcyNDE5MzY0OVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzY0OVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIK8DHhXTK4m3jNJqvyEA7My1
# WKILWStrQA5fD9Q6ELNaMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAIdpTjOj
# R53f+eHZZVpSg3mwaTGiC7VJ1skWnn9QpEP5ZWvQtVtCucXIxI5mC0CTcTnHpYmj
# b45cGN9FlWeaom2SnopWaFfDfSaO/5n8mFnFYf+LxpMOBTN2h7Ks0EzOXK7yXHfb
# 2MwQPcJBy1USC3lqqnUBlwD6jGDQdK0iWVWTLPZdBURJMS4tkuSWj+Hm7hSkQjlP
# r0gzoy+CHdSHs8t7YrrMNi9I3d3NQSkPFeDwXn/6rjTeULJRHnrzFM65PJYISL5D
# oo0yCyB89v4+/x5rdonBIPpXyouxKW3g5j9AtYWdMW6bVO4Km94Ls1iaTy3OsQ6x
# j0tSSlQs1Ywhgcq1SPFRq1x7Eudj+hge7J7k8piAFkbZr+GDh52ZBjlHuMJxKkZR
# lc/P0iCmfhSFq3plbYRbRveKH/lAeJi4GSRsnTOvhf6jHGatW2Lk//S/tBA0XO56
# JDzAIIY3VMOO3UIuY0WAN4q6l7fbHgVFwDRxt9fcRYFomqiWFWWkNVkIkMFguJYx
# h5YOApgCXq6xKe5CEBGu8+Q77P+TGkWD1y5qMT1m5/aq8BW24WRaeiuqcG7JoHCB
# +IGgLJiOLpIIl6wUYeW7Q+jCMwvSJaC71shxh93egsbklw9WSAGLuDBOYXmBAtpp
# ZvQGJ2oyH2JFyx24SgOEvaJuhX9uTxes2+qb
