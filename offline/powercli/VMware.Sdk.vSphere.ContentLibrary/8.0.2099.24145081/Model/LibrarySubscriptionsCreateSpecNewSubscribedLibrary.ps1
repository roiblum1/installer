...
LibrarySubscriptionsCreateSpecNewSubscribedLibrary<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Subscriptions/CreateSpecNewSubscribedLibrary/
#>

function Initialize-LibrarySubscriptionsCreateSpecNewSubscribedLibrary {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Subscriptions/CreateSpecNewSubscribedLibrary/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.ContentLibrary => vSphereLibrarySubscriptionsCreateSpecNewSubscribedLibrary' | Write-Debug

        if ($StorageBackings -eq $null) {
            throw "invalid value for 'StorageBackings', 'StorageBackings' cannot be null."
        }

        if ($AutomaticSyncEnabled -eq $null) {
            throw "invalid value for 'AutomaticSyncEnabled', 'AutomaticSyncEnabled' cannot be null."
        }

        if ($OnDemand -eq $null) {
            throw "invalid value for 'OnDemand', 'OnDemand' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "LibrarySubscriptionsCreateSpecNewSubscribedLibrary"
            "name" = ${Name}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDe/59s7txCutTK
# xnjmOGkrchZipeRSI+Cx2qJ296oMeqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEsEPMHMbHjnzDTE
# TNnLX8laXM+E6BQ8bxofIp9Oq8CcMA0GCSqGSIb3DQEBAQUABIICAI1F9cVxAXjn
# gX76eYpbS30cRaxpaWGOH+H60ZTHMI3eTRC0UGueFZChQYmQo4B4114zRnHJgjnk
# LfBnIP7Mry1dC8aA63zAoek6sj6FVU+ZgdMLB1RAD+XoPIDmaYxcAEESXeC1qaCp
# k2d/eRMqx1xm5Dg2x2TjYxZ8NffeorEijNsy20IraEL4muKl12AXyAdyZA/W4a6V
# h2254v+oEawE7zT86jXB9RpCSUfPdf62e9E4KB79eJ/h1kEHpLdQ770AMpMZgfiw
# gwNrLTWHEhQsdlJIvvlNYna+YjMgW9+Tjr3a2k854OgTs/mP8QMZsWeVw72DAl0V
# W/DGx6XGhdOymbVY+w+Jtl0fLsWhQ+XnEopEHzZi5ybiRVQkB7zfkC2GI+ldZsZ8
# JoPwliUpmjLwfdvzp7df5JjpUPyBlZ6RPGJ0s+aBJs2mWJw3bIJ81sscwdLxhTh2
# YKtteBnK2mUFOoSh8Qp1d6EiJPENdgyhhG7d4s9+G+rX23g24fQ6a66Bf9vYQpGf
# FkiKo54aapz3IuAhVvzMkw44T2E8F8ABKAhUqEWldxRCe1j5/vxiXLEmLzdR0vxe
# 6BZQGxnwsX6TKI8c4KSRseSzmluwguoVPhhi8K6QakY56UgBeQsvj7v4F5QRVON4
# vZ4XUh7UjzPF6sIL3SGtawwslRgXzCk2oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INLO9a8Og98+0IZeBHHbr68e6a5vQ5gwMt+Me9f+W5h4AhBNm7/xnOOJCIbTS8mZ
# i6P6GA8yMDI0MDcyNDE5MzY0OFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzY0OFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIB0phynf9cdTPC/bO7UHNP3y
# X203a3Txp5DMu/4sHEBfMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJ/lkvmz
# F/3ShjR2UmpD2ODaaHfKpv3dudcFDDSEHdTt/WxC6m+be8hnPJVhJBG+ITNtqTc5
# tTauRJOyQIU8UROttAOrY9O9QCHYCuuLc+qBIXAOIPNxOV+D8H3F0il1eI1JBIrp
# dGS1nDAcUS01EVxmEp5MKNzpHni+OSMUikWB9e1GjMQIfJAVi1Yaa0MvT99aw1Oj
# c9IYP3Nzpri7PbVwAO5yCg6bBa1HgrSKNUouOV3tRlZ5Iw5Od8S77kg5ImTcbiXu
# 7Mf2Jpq2Jhx/PreIDnzTXVyM8+lGbHQT5gIz46ljkSgac3K9mQlfRumaXKvtOmJJ
# PkJJZOHM42uPux1D0kSJcY8n/mkDAr8KIqOR2E8t5g+rziLfXf2tTnclYneMbT4W
# Z29OQJLTfouh2FmA4Yx+Gq06JvdoQfgoxR/uPQws5dYtnZMqgr+qKZ6M5I72zNsc
# 515PV8fVQGvlH3Y9erZdUDxoJcWokpoyicx6Zcij6rBii6jnr6TJf2WOS3s7zjH3
# ihI6mXKUCXnmnjrTnj4zNfyDsXXq/5aSZcVYu9QvvjfehXL0SSuuJEt0rbrh9CTX
# 37G30eOQzXee03ZSPH+RF0/0aD2w4TcNQ7Y1DZBfncwatT3unfh5Vaa8SIGaHOHj
# 5FlqpuWZfctIgD6bXTwt4vTd5c9hD5qhODwp
