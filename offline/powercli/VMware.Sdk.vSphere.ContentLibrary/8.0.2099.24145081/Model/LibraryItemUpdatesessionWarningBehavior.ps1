...
The WarningBehavior structure defines the session behavior if the warning is raised during the update session.
...
LibraryItemUpdatesessionWarningBehavior<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Item/Updatesession/WarningBehavior/
#>

function Initialize-LibraryItemUpdatesessionWarningBehavior {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Item/Updatesession/WarningBehavior/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("SELF_SIGNED_CERTIFICATE", "EXPIRED_CERTIFICATE", "NOT_YET_VALID_CERTIFICATE", "UNTRUSTED_CERTIFICATE")]
        ${Type},
        [Parameter(Mandatory = $true)]
        [Boolean]
        ${Ignored}
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.ContentLibrary => vSphereLibraryItemUpdatesessionWarningBehavior' | Write-Debug
        ...
        if ($Ignored -eq $null) {
            throw "invalid value for 'Ignored', 'Ignored' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "LibraryItemUpdatesessionWarningBehavior"
            "type" = ${Type}
            "ignored" = ${Ignored}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBXYmIo/RPaWS6J
# lZ3cV90mV+WkfTY1sLPUh4+SkqGek6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIP3HYDgECJWyUJJZ
# VsemM4ttk6BjMPjvnbsm+9jL4YEbMA0GCSqGSIb3DQEBAQUABIICAEx3kqBdwGSL
# 6utEXjOdKX6oS+8kzJAHHzhPvqqeZ9oeQs0Hvj4MkAkj+LvihQ/JTzEerlu58UIb
# IdBfmySf0eDGDOHw6Y/r9PeDBdD7f6ZYfxHEo2mMSqRVNf9QWPXufDD9wtX5wekT
# awi49PkwsJ18T6Th82jUb1G2yH9TwpB9sTOPLEfa19hG2LkgpKo5ch+Mfw0TrL2A
# aFA537C81ofBCYzALewVcA7bNZd5oFZOMB7Yf1iCnH82UwPOwNfuOmC7egO1Ey/w
# qbJGwI4YZB9kGPru6P/7grz0+YalTfTqYHQorBYiwWWItky8D/2B0RUYUwqC2x9C
# 4wCSi+c9AdlnzI9vJVXvbGUDsYb6DZXjUPnWEy35kFGP1fa7aFlwsoWiLIhl35jj
# YPhK8twnsYH9HM3E+Fm3EbpLvyJT3vloyGzJwVsrtCNSxhBUtxipIHAu5d42pI/U
# /nAoFu9ScdmhZ1QPPt1YVA27TMIsOiOkxXSoy5vOtH6+MKWpwtMu4aRKmeMwryMh
# Owc0gpk+fwSt944sH+sg5A5QGdFFUAStRro4/KBSlGIVwsyVwZ4sA8vd5wxxGa1K
# hVESyZfYAgqaQYTuY1NjSnTpNUkXMK6QQ/PdQJ1/odowSOYem1tLe/HIV3E5HgEd
# RfbkIsnnXHgUW/vXuD59eIrJUNszb2hfoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IKHKdCgcdjbi0N3qKGOJ+ZNF7tOgYYipC7oQ1V2X6UauAhAUc1xHLz3ialsTqXdU
# wPsfGA8yMDI0MDcyNDE5MzY0M1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzY0M1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIO4MA3HjK2edHYoG8bpbMqZ0
# njrVQyHA7mCxIHp14LyXMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAAtmHE4k
# CSOU31NU1VD2ODqU70vjKSTiKzVT82w7dxi1Hs+8q7lBXib9gHTWkaqZJNWbPGXP
# 55w54bVEJx0mSJcE78fe1GNtaYKQfelKs+TeWTsGKv8lZpAz01N/fziaoC5ip9qI
# HHoBCTxRm/e8L2mlgbkX5UL0Q3TnmuekeDAVP8ljE0WVMJtEqFmR5mEUwVkE3DXq
# MYlepNlnZN0L5wOCKo/wHVBmNe412/EXx7oBPLBek3jqntcfn0HZUKP9bGESM+wS
# uYR7zsY1Ya8ms0J9Qz0URKZeoor9g3ear1+qwYfKRJSbl1wjnX69FNL/PSLHt+SC
# iyoJ52q+7asXIN9pWwzkzhOB+8ZS3wGG0bHiDhX/B16fCLydBRCFZWaUU9Md6wau
# OCAn7IoaMCppcA4TocsXCLrhmvrtORYWMUnz5vdyLzv0IzBi1I/LxM1QzDrD5aXR
# J9XO/JkuXEzTe+HBnjspwt+l2PGoU+p6dNHkvmSzpWNhZOYPcerDEZlHIpvS1wY8
# LNFD/mvWB30SnEC9RRTaJSJ8ZafRx5oOO+KqSovfqsEVDe6unlS/ywgVHUwzsqTl
# Dy8yFazJk15CPLMVdnKgjUbLGCFy5WXTI0nliJQw/nE0hERbkb8y2Mrwd1GFhtkN
# iGaDDIND6xTWDg1wTwzV7Hy/izcZ70FMSQrE
