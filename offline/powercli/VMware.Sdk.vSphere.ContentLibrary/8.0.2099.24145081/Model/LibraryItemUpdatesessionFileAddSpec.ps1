...
LibraryItemUpdatesessionFileAddSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Item/Updatesession/File/AddSpec/
#>

function Initialize-LibraryItemUpdatesessionFileAddSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/data-structures/Library/Item/Updatesession/File/AddSpec/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Name},
        [Parameter(Mandatory = $true)]
        [ValidateSet("NONE", "PUSH", "PULL")]
        ${SourceType},
        [Parameter(Mandatory = $false)]
        [PSTypeName("LibraryItemTransferEndpoint")]
        [PSCustomObject]
        ${SourceEndpoint},
        [Parameter(Mandatory = $false)]
        ...
        ${Size},
        [Parameter(Mandatory = $false)]
        [PSTypeName("LibraryItemFileChecksumInfo")]
        [PSCustomObject]
        ${ChecksumInfo}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.ContentLibrary => vSphereLibraryItemUpdatesessionFileAddSpec' | Write-Debug

        if ($SourceType -eq $null) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDv6dXZQheYCFtL
# MY6CnkA1lzRvVnZiig69Ycmj6kZzNKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG4/sUWcGWtz//ls
# dBG+jae3h4YUi0S800j4Ao6Fv6CpMA0GCSqGSIb3DQEBAQUABIICAEYKH+Om4FtT
# 53VbxmtbLFvQyromHcpR/1EjguTC7IuJIPOJac/38lt7c9ngBc1TSSL2SGWcM4Rn
# V7JpSgNw2B7QVE0Lbv/zcW5ev3Ukajse8E/AaEO86UG3N3kbs88rFb62yEQqtvId
# ukRgJwHTzjRGVFvCadKTi2XbKGbnFU1D0E6eWwXr0W2zftNiM2A3X8H5esc2TWya
# nF2If/enxS4IIIV0KPDQddKugL5X2+5mhjJWtG5wGd1DylUdioPyKCx7qDastSNc
# gR5IdE6X5Cxs0Cw4mbhDD3eUXBt4WGuEBDpETbI6doEArtIrVmMet7A3pbREczwM
# 9PqKi027cmvqzSuxGwKnPpJ9aNe+0Gqp9L+0w1Ww2oQldO1VlHj1RAdmBW2d7Ox/
# IjrV5auPpJsRCKVkmqYK0DUTW6zXQKFKUqTwN0R9vHTeJz3+2MLqZ2WBGTcg2099
# NPk7XiRIIariNiRPLmwAmOKl4vyHQNCOfPcpgFYnrBToI7lpjFy5sqfDDrVqS+1v
# 1CJX1eR7Gu8e+xGVuqEKGIa+7EIIAHIVJqIzI7rknZYrRGdtD38tX2aBpPQLjaz9
# 6/LP0jlKTt0E88fPdSwPu8ucm99cR1pzuFVzQSwT73vfRKPUqcJeF6ySA5Y09Wh9
# LnoKrAt4CZ8qVSYjkUhVeAszbY3JD20ToYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IGFcDBMABERDDyT8nuLmI/TcaS2tG7LIGsN8R/1lKFRZAhBFaRLULBLolKbICFij
# PlkpGA8yMDI0MDcyNDE5MzYzOVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzYzOVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBkev44kmf6rOyTwAITh1m2/
# 9FxGRfkLA1U7t1x4NCl3MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEc0fFHR
# AzBOCzzgDBogCVT9LrhU7R+iAgGb5hJ4M37OVeMy8kgJTmBV4ZWXBIMIi32kW+Zz
# gbVSucfby8OQeBahITPaer431/RGcoIyM+14Xw8e0ZyX82iwGMnSEqrPcDRenAUb
# lQ8dF73Y6CSU2uiQKpWzCnM1rNmX/IVo9IDIAGsiQPpe+xGmNIjaXalwJDsST+Q/
# a3E9zahgJbGISqa1UeyCQEu3JltU55FehNZKS4fozwDf6vdHGf36TFgpPrLQDQ0i
# xxNnzKcHS0HfqVH445x+G7kx+1BWxXMu0MIgHxeBxxL2gVhdLRI4t8eOttKI5lcM
# nL/5ozZmC7X44Jej4v0Wn3yERQ/rYNX5t3EmVOGZjrrb+Bovaf308iPnA+jqjEr3
# FNeCcmdigiWnO4Ny8xII3xqCFWj0LlTOoRnCumjW8BOp/rqPpgLr4c8FA4rM2F54
# TI6XBjmBu1ODMQHd6xyy8Oj1T/O3pEOdrOELsg/4oyUs6cezUNbep6ASJdvebuHS
# fxY1F+SzJEfpXLskIlKmXoXSCs4Fy1dUwURbGR2u/Lg8TgkDWg4zC1npYBEHPg13
# zfgZ7DmrJje7R8uRazlVHEMTCuUnYFx77BpGBJM3yAMEKUChsN7gJ/mOQYRGBhO6
# w/Xb2eeo1Qi8ylQk24qv+KIEv9aNFGPMHYbk
