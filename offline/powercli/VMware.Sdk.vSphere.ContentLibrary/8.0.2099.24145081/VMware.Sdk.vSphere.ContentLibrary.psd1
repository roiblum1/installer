#
# Module manifest for module 'VMware.Sdk.vSphere.ContentLibrary'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.ContentLibrary.psm1'
...
GUID = '04f4f6c3-819a-43b2-ba5f-ecbeaabec3c9'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.ContentLibrary.'
...
FunctionsToExport = 'Invoke-GetLibraryItemVersionLibraryChanges',
               'Invoke-ListLibraryItemContentChanges',
               'Invoke-CancelDownloadSessionId',
               'Invoke-CreateLibraryItemDownloadSession',
               'Invoke-DeleteDownloadSessionIdItem',
               'Invoke-FailDownloadSessionId', 'Invoke-GetDownloadSessionIdItem',
               'Invoke-KeepAliveDownloadSessionId',
               'Invoke-ListLibraryItemDownloadSession',
               'Invoke-CreateUpdateSessionIdItemFile',
               'Invoke-DeleteUpdateSessionIdFileNameItem',
               'Invoke-GetDownloadSessionIdFile', 'Invoke-GetLibraryItemIdFile',
               'Invoke-GetUpdateSessionIdFileNameItem',
               'Invoke-ListDownloadSessionIdItemFile',
               'Invoke-ListLibraryItemIdContentFile',
               'Invoke-ListUpdateSessionIdItemFile',
               'Invoke-PrepareDownloadSessionIdFile',
               'Invoke-ValidateUpdateSessionIdFile',
               'Invoke-CopySourceLibraryItemId', 'Invoke-CreateContentLibraryItem',
               'Invoke-DeleteLibraryItemIdContent', 'Invoke-FindLibraryItem',
               'Invoke-GetLibraryItemIdContent', 'Invoke-ListLibraryItem',
               'Invoke-PublishLibraryItemId', 'Invoke-UpdateLibraryItemIdContent',
               'Invoke-GetLibraryItemIdStorage',
               'Invoke-ListLibraryItemIdContentStorage',
               'Invoke-EvictLibraryItemIdSubscribedItem',
               'Invoke-SyncLibraryItemIdSubscribedItem',
               'Invoke-CreateLibraryContentSubscriptions',
               'Invoke-DeleteLibrarySubscriptionContent',
               'Invoke-GetLibrarySubscriptionContent',
               'Invoke-ListLibraryContentSubscriptions',
               'Invoke-UpdateLibrarySubscriptionContent',
               'Invoke-CancelUpdateSessionId', 'Invoke-CompleteUpdateSessionId',
               'Invoke-CreateLibraryItemUpdateSession',
               'Invoke-DeleteUpdateSessionIdItem', 'Invoke-FailUpdateSessionId',
               'Invoke-GetUpdateSessionIdItem', 'Invoke-KeepAliveUpdateSessionId',
               'Invoke-ListLibraryItemUpdateSession',
               'Invoke-UpdateUpdateSessionIdItem',
               'Initialize-LibraryItemCertificateVerificationInfo',
               'Initialize-LibraryItemDestinationSpec',
               'Initialize-LibraryItemDownloadSessionFailRequestBody',
               'Initialize-LibraryItemDownloadsessionFilePrepareRequestBody',
               'Initialize-LibraryItemDownloadSessionKeepAliveRequestBody',
               'Initialize-LibraryItemDownloadSessionModel',
               'Initialize-LibraryItemFileChecksumInfo',
               'Initialize-LibraryItemFindSpec', 'Initialize-LibraryItemModel',
               'Initialize-LibraryItemPublishRequestBody',
               'Initialize-LibraryItemTransferEndpoint',
               'Initialize-LibraryItemUpdatesessionCertificateInfo',
               'Initialize-LibraryItemUpdateSessionFailRequestBody',
               'Initialize-LibraryItemUpdatesessionFileAddSpec',
               'Initialize-LibraryItemUpdateSessionKeepAliveRequestBody',
               'Initialize-LibraryItemUpdateSessionModel',
               'Initialize-LibraryItemUpdatesessionPreviewInfo',
               'Initialize-LibraryItemUpdatesessionPreviewWarningInfo',
               'Initialize-LibraryItemUpdatesessionWarningBehavior',
               'Initialize-LibraryStorageBacking',
               'Initialize-LibrarySubscribedItemSyncRequestBody',
               'Initialize-LibrarySubscriptionsCreateSpec',
               'Initialize-LibrarySubscriptionsCreateSpecNewSubscribedLibrary',
               'Initialize-LibrarySubscriptionsCreateSpecPlacement',
