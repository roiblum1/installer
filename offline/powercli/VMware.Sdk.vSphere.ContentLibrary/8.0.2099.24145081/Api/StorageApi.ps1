...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/item/library_item_id/storagefile_name/get/
#>
function Invoke-GetLibraryItemIdStorage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/item/library_item_id/storagefile_name/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetLibraryItemIdStorage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLibraryItemIdStorage' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library/item/{library_item_id}/storage__file_name'
                $LocalVarMethod = 'GET'
                ...
                if (!$LibraryItemId) {
                    throw "Error! The required parameter `LibraryItemId` missing when calling getLibraryItemIdStorage."
                }
                ...
                if (!$FileName) {
                    throw "Error! The required parameter `FileName` missing when calling getLibraryItemIdStorage."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "LibraryItemStorageInfo[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "LibraryItemStorageInfo")
                        }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/item/library_item_id/storage/get/
#>
function Invoke-ListLibraryItemIdContentStorage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/item/library_item_id/storage/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListLibraryItemIdContentStorage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListLibraryItemIdContentStorage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library/item/{library_item_id}/storage'
                $LocalVarMethod = 'GET'
                ...
                if (!$LibraryItemId) {
                    throw "Error! The required parameter `LibraryItemId` missing when calling listLibraryItemIdContentStorage."
                }
                $LocalVarUri = $LocalVarUri.replace('{library_item_id}', $LibraryItemId)
                $LocalVarPathParameters['library_item_id'] = $LibraryItemId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALtOoGWgT2DL40
# pgqDCLaMuA9x72ygm0HZSsDAr/99E6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILp3f/lYhuQZdykk
# +gGgsvY/CSop8GHhWemPQKDdzCCVMA0GCSqGSIb3DQEBAQUABIICACUHarCzt82e
# M4u90TFUSvRJb67qmzg/w2XbFO4OYc6nO46V7l4kIwupX61eLZdJia/ezBqQUJaE
# 8vFJ/OU+/pMfZPUKnB17AT57eEG/AUdtCG66fbqunipK6Il1q7aIyGoBYiB+KJ2O
# QF7kQFNi9eWU+P2INpmzw2nm7Dha9aEecZeUFORY3wkq15t3Q4h1/ZJrHhPhTBIQ
# JvzFqO8fYVgZZvHlGll6Bz4J0QQ0Lk/VHj4srgfkpHkpLPbrJ5ynXAHoK6wLGERZ
# rMxG8Q9liLuz8GBXOlrknxG8oLmtVamM8Pyb7IVmTydhpTqLsQC+L2MSiI5ft/V1
# /vjSThVHyEW7d3hIZFi6BGef4tX2TzmmvmmbY4VI2yU26eOoeqUdGIIf9cn508Ot
# ygPv+qhq7ltfm5DhAQGELJs0591+g0fXaMODyqRhRfPUP6ugHvOT1JRa8eoh9dzU
# Ha8sHo3Hcs2D1+75zFBupkTc3bkUq7Ac+sfBef9yPgi4Qz4CS2xv7p5D0lOPYVOv
# JMZenV8xiMi+Mfu/nBTPHxKSLgH5oBHZTyFl4SDrW/GRl5euw/kfMjBGdcqeIfyR
# 5lBInTZcEeC0k1Rvj8HuGHcF9KVna4ZGt9bh6KIgNUEIiW5/vdxXSmJNJLW6JLz0
# U4nBBPUNjUY3U+yRNjUWrduPCUa9BrF+oYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IHEt3CBV6XhnmhEESIgzthMJdCJD0dVtLfxYkZwFwqk/AhEA1LECD/rOrzSB6ZzC
# Vg+fDhgPMjAyNDA3MjQxOTM2MjJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM2MjJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDBQNKHWOgLTJAuO3jd2P2X
# a0iy+wzkIrFWgsrlLZhetDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCYA854
# X/gGbo8bURBtisD4jE819kpst3TAwmm0ePW8jwQ+gSGbo6kBfa9HjjhTQrBlwnHR
# JIdCUfgZEHXDGWt/IZv+3al/Y9NZYmEgdIq/GRj3KdZ062b8/piwSN8t6tIBiXvB
# ZptlyM3af1Uu26K/c8leA4Oatd/Wr6wuwnX+yHe40yscpBAMa1VQjsughFmFfXm7
# WI0sxWxYEYoRiFFnkFD2ROHKu74T4DDbslbpkrTJtgFKVSQC/K9E43dohgNHWkXg
# Sm14QjTsUM4pWLgCFluM8QMjEmChLrNCGjQ21BqFoH7xNCTpnj3DTJmM9KITbjZr
# Q0AgFvzwANR54YkuYrHJQegtjXbzOyvPFDkLHW26OYJ5+vtOlxGy3yCLIiQfBVV5
# eo4QDnifjkhXepMGgjqdpi5eQWT7Kod+JcW3yziZ1nRVTQUnwc8hsGnnKXAHSFYc
# HZMorEQaRV9Fhev9hRYrezKvdtZguHXMP8T2LKDLMtlbn1um7zdaPuv2PIcRp7ER
# kyf7pdnZwbuyLMRt1gZIvLZ3jGSNUhBG0DlBZtF4XB8qHgFNIy0LHm4bJWpy9loG
# 4XucryCr2cJDv9HWEjawQtF0V4NLpfcZ2C0UmHL3zyZWRa9xNVtOJIKQNhe3cjh2
# v2ZIvmNR6HLtdnOjK/JAv9v9+CTgqA+pw+HdVQ==
