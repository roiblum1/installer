...
.PARAMETER LibrarySubscriptionsCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/post/
#>
function Invoke-CreateLibraryContentSubscriptions {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/post/"
    )]
    Param (
        ...
        [PSTypeName("LibrarySubscriptionsCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateLibraryContentSubscriptions' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateLibraryContentSubscriptions' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library/{library}/subscriptions'
                $LocalVarMethod = 'POST'
                ...
                if (!$Library) {
                    throw "Error! The required parameter `Library` missing when calling createLibraryContentSubscriptions."
                }
                $LocalVarUri = $LocalVarUri.replace('{library}', $Library)
                $LocalVarPathParameters['library'] = $Library
                ...
                if (!$LibrarySubscriptionsCreateSpec) {
                    throw "Error! The required parameter `LibrarySubscriptionsCreateSpec` missing when calling createLibraryContentSubscriptions."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $LibrarySubscriptionsCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$LibrarySubscriptionsCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LibrarySubscriptionsCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $LibrarySubscriptionsCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $LibrarySubscriptionsCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $LibrarySubscriptionsCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $LibrarySubscriptionsCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $LibrarySubscriptionsCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $LibrarySubscriptionsCreateSpec) {
                    $LocalVarBodyParameter = $LibrarySubscriptionsCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/delete/
#>
function Invoke-DeleteLibrarySubscriptionContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteLibrarySubscriptionContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteLibrarySubscriptionContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/content/library/{library}/subscriptions/{subscription}'
                ...
                if (!$Library) {
                    throw "Error! The required parameter `Library` missing when calling deleteLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{library}', $Library)
                $LocalVarPathParameters['library'] = $Library
                if (!$Subscription) {
                    throw "Error! The required parameter `Subscription` missing when calling deleteLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{subscription}', $Subscription)
                $LocalVarPathParameters['subscription'] = $Subscription
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/get/
#>
function Invoke-GetLibrarySubscriptionContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetLibrarySubscriptionContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetLibrarySubscriptionContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Library) {
                    throw "Error! The required parameter `Library` missing when calling getLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{library}', $Library)
                $LocalVarPathParameters['library'] = $Library
                if (!$Subscription) {
                    throw "Error! The required parameter `Subscription` missing when calling getLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{subscription}', $Subscription)
                $LocalVarPathParameters['subscription'] = $Subscription
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "LibrarySubscriptionsInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "LibrarySubscriptionsInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/get/
#>
function Invoke-ListLibraryContentSubscriptions {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListLibraryContentSubscriptions' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListLibraryContentSubscriptions' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Library) {
                    throw "Error! The required parameter `Library` missing when calling listLibraryContentSubscriptions."
                }
                $LocalVarUri = $LocalVarUri.replace('{library}', $Library)
                $LocalVarPathParameters['library'] = $Library
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "LibrarySubscriptionsSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "LibrarySubscriptionsSummary")
                        }
...
.PARAMETER LibrarySubscriptionsUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/patch/
#>
function Invoke-UpdateLibrarySubscriptionContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/content/api/content/library/library/subscriptions/subscription/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Subscription},
        [Parameter(Mandatory = $true)]
        [PSTypeName("LibrarySubscriptionsUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateLibrarySubscriptionContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateLibrarySubscriptionContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Library) {
                    throw "Error! The required parameter `Library` missing when calling updateLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{library}', $Library)
                $LocalVarPathParameters['library'] = $Library
                if (!$Subscription) {
                    throw "Error! The required parameter `Subscription` missing when calling updateLibrarySubscriptionContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{subscription}', $Subscription)
                $LocalVarPathParameters['subscription'] = $Subscription
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$LibrarySubscriptionsUpdateSpec) {
                    throw "Error! The required parameter `LibrarySubscriptionsUpdateSpec` missing when calling updateLibrarySubscriptionContent."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $