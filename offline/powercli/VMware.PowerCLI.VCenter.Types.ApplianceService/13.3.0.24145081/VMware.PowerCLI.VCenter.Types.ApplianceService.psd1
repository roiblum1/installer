#
# Module manifest for module 'VMware.PowerCLI.VCenter.Types.CertificateManagement'
#

@{

    # Script module or binary module file associated with this manifest.
    RootModule = 'VMware.PowerCLI.VCenter.Types.ApplianceService.psm1'
    ...
    GUID = '78e8b12c-2fbe-410e-bdbe-b115dda2566d'
    ...
    Description = 'Types definitions for the VMware.PowerCLI.VCenter module related to the appliance service management feature.'
    ...
    RequiredModules = @(@{"ModuleName"="VMware.VimAutomation.Core";"ModuleVersion"="12.4.0.0"})
    ...
    FormatsToProcess = @('VMware.PowerCLI.VCenter.Types.ApplianceService.Format.ps1xml')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpXKS3kaU8sj+1
# WYWymcWtkkSBPwC5ycjofV8NFwJc+KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIkK+bfjKXq1fCaR
# LPeOdLrJl9XgM1XPeCGoSTYsxVGeMA0GCSqGSIb3DQEBAQUABIICAIXRWsYriJVc
# BwgCvtVuYer12GJtz9jM/eyYOUaiUYFaSO2e46bKWtQdfSWyVQuzVd23MizImzkr
# ft0vFidvP88v3hmCa/F5bz9EX7GujJw0AweA2uQr0E65zk0rkXka2jY+Sgtk6mMB
# IC1Ab4w7D9FAkGA2hmbzGitvLsK66pjAr9wq0MagaibZ6klwPo6k110ln/nmwQuQ
# jyV3sTUzgoppEBQbZjNP9IOJqFE2OHMpeiuGL2XFohBnoEzpTAiijuUBiN5CSZ78
# 47PhgsczwMpSE1a5w3UBFr0BDTBxcUzWFjB/BSTtNFHlYizbR/U8NR7fxIXfi3CR
# FBfmimhTihRqloaDmzTQuWUZKzFiynXt0ie4QzAG9bHoROQPjWNehDnWzfuNQnOT
# s+wojhYabs24ldUy6LYzRaWlutCfcMjmpMO3Cm1m3Hfx9vOLMSuDesMDZGPZIS0j
# 35O+6frL0OXkwzdiNky12VjKstIUPmOwFbjOY/vr/gD04EpEKKgqQo+/BhGCO8LI
# eW2N+WhMV3eJd8JTMNiJbWwWQcrXhWQrEiZkvFDYIAhsUT+08BuJy7WM77UkT3GW
# t+QdjELPAsXoR9SjM4hkGQHiNgczZLPe1Dir93opClpiO4KsQYd+Q3q+DTKO2rkF
# cXp+ZgwtSwxgsiNGidvnHtuaHQ+cEJlcoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ICFPcjMTJQrb6gTsmtpIB4qbhuc6pd3cDzj5JFnYOfoKAhEA9kULeOZnlqXQi7xc
# VxcJkxgPMjAyNDA3MjQxOTQ5NDFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ5NDFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCA9zZ7piy18hCXG7PTMowaK
# A3pPqpx9mptmkHR2DL8HyjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBqpD2I
# bxwesZTwIwa92j3lqOl1Ks+JsJ9tdzIq8HBnoKUifJ2e1Cy3f2PqPDQYSs72YbWu
# BMYIzJ8X+Kunc0kqIedwYFFOvO2YGgPf/5xdF3Pq7NdUtbzjivmId9ZXBnm58oZy
# W7G4igAuVaS9mgHNROciDAk2RZejKUXSt7HlruX3ZGGhligsXQ4MwZbUnVyOMSG9
# lAVa75Mivnz6kK75MIEkhkJ8lKA9XlvBhE9UpdOE+SPTGaZEXNqO065G+3tWVPgc
# Hu5KZlEf8njDKGXQnrF9a5XIlUfhN9hbBVFZOJSs/5sBY0b5WRpylpk7MjFbsmMU
# YLTnU11Ui+woz1ASIYeCKa9nzlrMyyYRGK6u5Ql+CWYYPSbv3zeXxoc65yaVXzy6
# NP2n3j1w+GuWT1QbTsE9TyRkusNGZibgQa4s9sLxE07tSTN6W5dtxiPwKsKPfEMe
# kglspwiT7x3K1at5KwFL9vg262FJ8Y2n/Fg+GmfRMW/QndLwKBjPVfBPayq3Uora
# Q4pi2wZ+pZSTk0rfdMOJ5IwZ652M1YNgxcApSAua9EXnoXWNE7QyxqKx0hQ8ywZp
# mwyQ6ZLQmFAzk/N9bwTOhopdpYZ4Lbt+FLGuaW5aVPywdjkN/jviYXw4s4S73r4G
# bxF89+8JcsXV66wKdOqSGNlQFP4fmZwbCLfzgQ==
