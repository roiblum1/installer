...
.PARAMETER TaggingCategoryAddToUsedByRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionadd-to-used-by/post/
#>
function Invoke-AddToUsedByCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionadd-to-used-by/post/"
    )]
    Param (
        ...
        [PSTypeName("TaggingCategoryAddToUsedByRequestBody")]
        [PSCustomObject]
        ${TaggingCategoryAddToUsedByRequestBody},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-AddToUsedByCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'AddToUsedByCategoryId' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category/{category_id}__action=add-to-used-by'
                $LocalVarMethod = 'POST'
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling addToUsedByCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                ...
                if (!$TaggingCategoryAddToUsedByRequestBody) {
                    throw "Error! The required parameter `TaggingCategoryAddToUsedByRequestBody` missing when calling addToUsedByCategoryId."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TaggingCategoryAddToUsedByRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TaggingCategoryAddToUsedByRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryAddToUsedByRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryAddToUsedByRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TaggingCategoryAddToUsedByRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TaggingCategoryAddToUsedByRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TaggingCategoryAddToUsedByRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TaggingCategoryAddToUsedByRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TaggingCategoryAddToUsedByRequestBody) {
                    $LocalVarBodyParameter = $TaggingCategoryAddToUsedByRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER TaggingCategoryCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/post/
#>
function Invoke-CreateCategory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("TaggingCategoryCreateSpec")]
        [PSCustomObject]
        ${TaggingCategoryCreateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-CreateCategory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateCategory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category'
                $LocalVarMethod = 'POST'
                ...
                if (!$TaggingCategoryCreateSpec) {
                    throw "Error! The required parameter `TaggingCategoryCreateSpec` missing when calling createCategory."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TaggingCategoryCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TaggingCategoryCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TaggingCategoryCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TaggingCategoryCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TaggingCategoryCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TaggingCategoryCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TaggingCategoryCreateSpec) {
                    $LocalVarBodyParameter = $TaggingCategoryCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/delete/
#>
function Invoke-DeleteCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteCategoryId' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category/{category_id}'
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling deleteCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                $LocalVarPathParameters['category_id'] = $CategoryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/get/
#>
function Invoke-GetCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCategoryId' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling getCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                $LocalVarPathParameters['category_id'] = $CategoryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "TaggingCategoryModel"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TaggingCategoryModel")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/get/
#>
function Invoke-ListCategory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListCategory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListCategory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
...
.PARAMETER TaggingCategoryListUsedCategoriesRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/categoryactionlist-used-categories/post/
#>
function Invoke-ListUsedCategoriesCategory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/categoryactionlist-used-categories/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("TaggingCategoryListUsedCategoriesRequestBody")]
        [PSCustomObject]
        ${TaggingCategoryListUsedCategoriesRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-ListUsedCategoriesCategory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListUsedCategoriesCategory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category__action=list-used-categories'
                $LocalVarMethod = 'POST'
                ...
                if (!$TaggingCategoryListUsedCategoriesRequestBody) {
                    throw "Error! The required parameter `TaggingCategoryListUsedCategoriesRequestBody` missing when calling listUsedCategoriesCategory."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TaggingCategoryListUsedCategoriesRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TaggingCategoryListUsedCategoriesRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryListUsedCategoriesRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryListUsedCategoriesRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TaggingCategoryListUsedCategoriesRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TaggingCategoryListUsedCategoriesRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TaggingCategoryListUsedCategoriesRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TaggingCategoryListUsedCategoriesRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TaggingCategoryListUsedCategoriesRequestBody) {
                    $LocalVarBodyParameter = $TaggingCategoryListUsedCategoriesRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER TaggingCategoryRemoveFromUsedByRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionremove-from-used-by/post/
#>
function Invoke-RemoveFromUsedByCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionremove-from-used-by/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${CategoryId},
        [Parameter(Mandatory = $true)]
        [PSTypeName("TaggingCategoryRemoveFromUsedByRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-RemoveFromUsedByCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RemoveFromUsedByCategoryId' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category/{category_id}__action=remove-from-used-by'
                $LocalVarMethod = 'POST'
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling removeFromUsedByCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                $LocalVarPathParameters['category_id'] = $CategoryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$TaggingCategoryRemoveFromUsedByRequestBody) {
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TaggingCategoryRemoveFromUsedByRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TaggingCategoryRemoveFromUsedByRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryRemoveFromUsedByRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryRemoveFromUsedByRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TaggingCategoryRemoveFromUsedByRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TaggingCategoryRemoveFromUsedByRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TaggingCategoryRemoveFromUsedByRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TaggingCategoryRemoveFromUsedByRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TaggingCategoryRemoveFromUsedByRequestBody) {
                    $LocalVarBodyParameter = $TaggingCategoryRemoveFromUsedByRequestBody | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionrevoke-propagating-permissions/post/
#>
function Invoke-RevokePropagatingPermissionsCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_idactionrevoke-propagating-permissions/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-RevokePropagatingPermissionsCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RevokePropagatingPermissionsCategoryId' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tagging/category/{category_id}__action=revoke-propagating-permissions'
                $LocalVarMethod = 'POST'
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling revokePropagatingPermissionsCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                $LocalVarPathParameters['category_id'] = $CategoryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
.PARAMETER TaggingCategoryUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/patch/
#>
function Invoke-UpdateCategoryId {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tagging/category/category_id/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${CategoryId},
        [Parameter(Mandatory = $true)]
        [PSTypeName("TaggingCategoryUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateCategoryId' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateCategoryId' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$CategoryId) {
                    throw "Error! The required parameter `CategoryId` missing when calling updateCategoryId."
                }
                $LocalVarUri = $LocalVarUri.replace('{category_id}', $CategoryId)
                $LocalVarPathParameters['category_id'] = $CategoryId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$TaggingCategoryUpdateSpec) {
                    throw "Error! The required parameter `TaggingCategoryUpdateSpec` missing when calling updateCategoryId."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TaggingCategoryUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TaggingCategoryUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TaggingCategoryUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TaggingCategoryUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TaggingCategoryUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TaggingCategoryUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TaggingCategoryUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TaggingCategoryUpdateSpec) {
                    $LocalVarBodyParameter = $TaggingCategoryUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# 2IYWv1KK6OXjN/CuQoNxwVpMtJ5LraCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI