#
# Module manifest for module 'VMware.Sdk.vSphere.Cis.Tagging'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.Cis.Tagging.psm1'
...
GUID = 'bcae82bc-4396-4a81-8157-920ce94d41a7'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.Cis.Tagging.'
...
FunctionsToExport = 'Invoke-AddToUsedByCategoryId', 'Invoke-CreateCategory',
               'Invoke-DeleteCategoryId', 'Invoke-GetCategoryId',
               'Invoke-ListCategory', 'Invoke-ListUsedCategoriesCategory',
               'Invoke-RemoveFromUsedByCategoryId',
               'Invoke-RevokePropagatingPermissionsCategoryId',
               'Invoke-UpdateCategoryId', 'Invoke-AddToUsedByTagId',
               'Invoke-CreateTag', 'Invoke-DeleteTagId', 'Invoke-GetTagId',
               'Invoke-ListTag', 'Invoke-ListTagsForCategory', 'Invoke-ListUsedTags',
               'Invoke-RemoveFromUsedByTagId',
               'Invoke-RevokePropagatingPermissionsTagId', 'Invoke-UpdateTagId',
               'Invoke-AttachMultipleTagsToObjectTagAssociation',
               'Invoke-AttachTagIdTagAssociation',
               'Invoke-AttachTagToMultipleObjectsTagIdTagAssociation',
               'Invoke-DetachMultipleTagsFromObjectTagAssociation',
               'Invoke-DetachTagFromMultipleObjectsTagIdTagAssociation',
               'Invoke-DetachTagIdTagAssociation',
               'Invoke-ListAttachableTagsTagAssociation',
               'Invoke-ListAttachedObjectsOnTagsTagAssociation',
               'Invoke-ListAttachedObjectsTagIdTagAssociation',
               'Invoke-ListAttachedTagsOnObjectsTagAssociation',
               'Invoke-ListAttachedTagsTagAssociation', 'Initialize-StdDynamicID',
               'Initialize-TaggingCategoryAddToUsedByRequestBody',
               'Initialize-TaggingCategoryCreateSpec',
               'Initialize-TaggingCategoryListUsedCategoriesRequestBody',
               'Initialize-TaggingCategoryRemoveFromUsedByRequestBody',
               'Initialize-TaggingCategoryUpdateSpec',
               'Initialize-TaggingTagAddToUsedByRequestBody',
               'Initialize-TaggingTagAssociationAttachMultipleTagsToObjectRequestBody',
               'Initialize-TaggingTagAssociationAttachRequestBody',
               'Initialize-TaggingTagAssociationAttachTagToMultipleObjectsRequestBody',
               'Initialize-TaggingTagAssociationDetachMultipleTagsFromObjectRequestBody',
               'Initialize-TaggingTagAssociationDetachRequestBody',
               'Initialize-TaggingTagAssociationDetachTagFromMultipleObjectsRequestBody',
               'Initialize-TaggingTagAssociationListAttachableTagsRequestBody',
               'Initialize-TaggingTagAssociationListAttachedObjectsOnTagsRequestBody',
               'Initialize-TaggingTagAssociationListAttachedTagsOnObjectsRequestBody',
               'Initialize-TaggingTagAssociationListAttachedTagsRequestBody',
               'Initialize-TaggingTagCreateSpec',
               'Initialize-TaggingTagListTagsForCategoryRequestBody',
               'Initialize-TaggingTagListUsedTagsRequestBody',
               'Initialize-TaggingTagRemoveFromUsedByRequestBody',
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBob69mc55o/ozU
# pycfcICfxjiYjfuW2mD7zLYUVW3xOaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI