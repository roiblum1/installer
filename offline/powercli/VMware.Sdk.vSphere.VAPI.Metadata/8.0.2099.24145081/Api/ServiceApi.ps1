...
MetadataAuthenticationServiceInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/service/service_id/get/
#>
function Invoke-GetServiceIdAuthentication {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/service/service_id/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetServiceIdAuthentication' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetServiceIdAuthentication' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/authentication/service/{service_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$ServiceId) {
                    throw "Error! The required parameter `ServiceId` missing when calling getServiceIdAuthentication."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "MetadataAuthenticationServiceInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataAuthenticationServiceInfo")
...
MetadataMetamodelServiceInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/service/service_id/get/
#>
function Invoke-GetServiceIdMetamodel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/service/service_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetServiceIdMetamodel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetServiceIdMetamodel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/metamodel/service/{service_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$ServiceId) {
                    throw "Error! The required parameter `ServiceId` missing when calling getServiceIdMetamodel."
                }
                $LocalVarUri = $LocalVarUri.replace('{service_id}', $ServiceId)
                $LocalVarPathParameters['service_id'] = $ServiceId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "MetadataMetamodelServiceInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataMetamodelServiceInfo")
...
MetadataPrivilegeServiceInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/service/service_id/get/
#>
function Invoke-GetServiceIdPrivilege {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/service/service_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetServiceIdPrivilege' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetServiceIdPrivilege' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/privilege/service/{service_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$ServiceId) {
                    throw "Error! The required parameter `ServiceId` missing when calling getServiceIdPrivilege."
                }
                $LocalVarUri = $LocalVarUri.replace('{service_id}', $ServiceId)
                $LocalVarPathParameters['service_id'] = $ServiceId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "MetadataPrivilegeServiceInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataPrivilegeServiceInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/service/get/
#>
function Invoke-ListMetadataAuthenticationService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/service/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataAuthenticationService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataAuthenticationService' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/authentication/service'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/service/get/
#>
function Invoke-ListMetadataMetamodelService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/service/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataMetamodelService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataMetamodelService' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/metamodel/service'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/service/get/
#>
function Invoke-ListMetadataPrivilegeService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/service/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataPrivilegeService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataPrivilegeService' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/privilege/service'
                $LocalVarMethod = 'GET'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBnsgJ4oe9I6KTE
# hQT65eOehdCkKDRZRYhx/eTQSWYEpqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIEQvK249oBQcBjD
# SUIxwKvdmzhiG1lydxU8Kudls0DpMA0GCSqGSIb3DQEBAQUABIICACIl4/nipUT8
# 7xnYWQZtu7H/65pLcHw7nF08gSt1qiCIImoMWpl2IgmuL5qgDWCTqVMPqGiOV9C+
# VjAFpZgxhQA/Ww3uL9UkOP7zszZruTHpkcc2pvLtGFuS+ic627+yWg7VoCvEDeDi
# NKrt4nd2Q7a2Xm6vuVONw3FrJd+vn1d7PhGsyFgqpEoxp21n3mPHCLMZ5OBNWWgJ
