...
MetadataAuthenticationPackageInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/package/package_id/get/
#>
function Invoke-GetPackageIdAuthentication {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/package/package_id/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetPackageIdAuthentication' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetPackageIdAuthentication' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/authentication/package/{package_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$PackageId) {
                    throw "Error! The required parameter `PackageId` missing when calling getPackageIdAuthentication."
                }
                $LocalVarUri = $LocalVarUri.replace('{package_id}', $PackageId)
                $LocalVarPathParameters['package_id'] = $PackageId
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "MetadataAuthenticationPackageInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataAuthenticationPackageInfo")
...
MetadataMetamodelPackageInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/package/package_id/get/
#>
function Invoke-GetPackageIdMetamodel {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/package/package_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetPackageIdMetamodel' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetPackageIdMetamodel' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/metamodel/package/{package_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$PackageId) {
                    throw "Error! The required parameter `PackageId` missing when calling getPackageIdMetamodel."
                }
                $LocalVarUri = $LocalVarUri.replace('{package_id}', $PackageId)
                $LocalVarPathParameters['package_id'] = $PackageId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "MetadataMetamodelPackageInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataMetamodelPackageInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/package/package_id/get/
#>
function Invoke-GetPackageIdPrivilege {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/package/package_id/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetPackageIdPrivilege' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetPackageIdPrivilege' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/privilege/package/{package_id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$PackageId) {
                    throw "Error! The required parameter `PackageId` missing when calling getPackageIdPrivilege."
                }
                $LocalVarUri = $LocalVarUri.replace('{package_id}', $PackageId)
                $LocalVarPathParameters['package_id'] = $PackageId
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "MetadataPrivilegePackageInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "MetadataPrivilegePackageInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/package/get/
#>
function Invoke-ListMetadataAuthenticationPackage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/authentication/package/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataAuthenticationPackage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataAuthenticationPackage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/authentication/package'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/package/get/
#>
function Invoke-ListMetadataMetamodelPackage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/metamodel/package/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataMetamodelPackage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataMetamodelPackage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/metamodel/package'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/package/get/
#>
function Invoke-ListMetadataPrivilegePackage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vapi/api/vapi/metadata/privilege/package/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListMetadataPrivilegePackage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListMetadataPrivilegePackage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vapi/metadata/privilege/package'
                $LocalVarMethod = 'GET'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+h9mGZECnO+Xt
# IPlKHP9DE7QIB3DZgIWCnWAeLgID2KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILW7V4PE2AFXI7GK
# dNoMp9DEtZ/qFVxO3Ajd6pw/mphxMA0GCSqGSIb3DQEBAQUABIICAEPRLuWiw9qh
# ZHaRjeFylSyy6U7Ypfl5QFrtPF5qUg4a9UTLSioeMCdeiEOe5pS0uMkBU3IYqrPG
# e8fFSVReAZFvALVQgAHQBZoAcg0MjbMSAjwt02LoNbFqoL5GYh3iVmvOkSyXKwvc
# ou3aozOVuU6gK7NVj0rhZR72tRSnxGPT3oczoOsPlvKHyqMpzD5QVcoY3xmdnY0X
