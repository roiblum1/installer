[VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.OnImportModule(
    "VMware.VimAutomation.Hcx.Commands",
    (Split-Path $script:MyInvocation.MyCommand.Path));

# Aliases
set-alias Get-HCXApplianceCompute Get-HCXInventoryCompute -Scope Global
set-alias Get-HCXApplianceDatastore Get-HCXInventoryDatastore -Scope Global
set-alias Get-HCXApplianceDVS Get-HCXInventoryDVS -Scope Global
set-alias Get-HCXApplianceNetwork Get-HCXInventoryNetwork -Scope Global
# SIG # Begin signature block
# MIIpiAYJKoZIhvcNAQcCoIIpeTCCKXUCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3iRrJTdV4gZ37
# 1WkG//xq42ZteZqB9RZeg9IAtln2aKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINE/43xhPD462WpE
# 1ETObCXfgVcanc02bHB8ovr+7M8QMA0GCSqGSIb3DQEBAQUABIICAFKLwrc9eF3Q
# QvvVpwErh99HqyUuKFxijZDYruK0nwwlwbCf89+JCOyOUxw1glzEyTtQxc7hb7Nz
# 4yDAud7b+JaSweULmrnWbbF59wZci0dAjxuyErsSkSqVlghTOgyP2VKI9awRSYdn
# XEayepoRIFVpyoniipAoACu81L1dtc8SZGSTd/W3sWQPlGu9p/sBIutK3KXX+MEm
# 5YUsTkewGh7PDLY3rfu07rp/8kSzdaEMJqB83/mHNAFwvailIaDsIjWeWgceAgeU
# aRviNdg+TR7iui4Ge2Y5pRuWIy8eNIEmuAlAKotzmIzbNSYbEiHw8G6hrr7+iT8n
# usSUqePX+/jSdiMTC7pGXFUV6qpg65UJiOMoWFlefFBZsG1NfxCio+JQJP4sWmh2
# Y13P514ohHrnqMiWBwipS8LoMWVmd1kbCFPyLxKf7ZLEqvHRr0VO9AlMzB3uMJz1
# dnSffgk8jPDWENY5MBivppAFEY+rDIZgHnGEUUe+7g7EIdA8aSyw2WTfL7WwHcMh
# 26US3nrMQVLzbdYKkSP7N4Bz7dp+9K2IXmfaAFjZqk8cdj1/xZEsaCTkIOaJ4U78
# BpdwZ9396RonYKUY+6BF+xLhxog9k2aH4QXTQHIb3uzAaCHTeUvKakh1I/KDUAzy
# yBWyppiiIGJtpsWu/R0xWsNOUaaCgC8moYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IKqt4IEIgJHAOas5QhzoLTxxoUh5zePkbH76k5FM/N2KAhEAos0AK9f/AJxIE8oa
# 6W5OnRgPMjAyNDA3MjQxOTM1MjRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM1MjRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCmN0Kft92rMiCxSae6uwee
# EwJo1I62aF3+ObKjh/qpLjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgApScFb
# 9DtX2A4mvrZdMvW4fnGN58bhBFl+SeBLZPjINyxMbQlyZdAlF1oZEVZifQE1ibWD
# toaxACm+edYGFgyOlqGUfrdm9Hu8DNMD/tnaK22OLl/ZMa3Cl/W6RaUem5h2Y3cI
# EOH5hqbX6QW2b/uyLolKqhCu9NffsHCPCzmtH580ZI3ptmmVKy+3Rn++sPlmWbII
# 2zCu8X09is3v4irww3s3+5U3LvQPHnWST7caN4G2vXWWfHYco7LtaqyFrfIa+uiB
# RkOSgiRve4s/tMKWXF0TjkA1mOZjy1Lom49UllnVqkH03QY/e0kj8Pcsojhd2h+k
# fGogjIGzfP02AzsMnwkoeSvtAZAeDUdkkue57n/IYMasx7GVcdy/Y8K/Otgy+bYJ
# zw7NWzYGSn8WRR4ld2jyAYE77p+Hms7mqS+UMmAy3oR9q5B0g8VksFtIgIdcY4AO
# 03IgWOYEEG12L7AVFftPjodgQOvpAliHz9x3zLDS4H6Fq79RGFSaTzZPMCokPb1s
# 776eQB1H0wCXKdDZOFDOf27X31oDhhnwKxxtbF9lVxh7NMIGLJ2A8uAdeHG9pwrJ
# dabONz7/kSwaM/1e7+oe9bHItzbcbeK6X62k1Kl0Iug79v3wKVtLYSjGTAituauS
# pzJnXdCTNr8Is8JMiKRbRnjFS6ZoYEOlpUM+2w==
