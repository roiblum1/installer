...
.PARAMETER GarbageCollection
No description available.
.PARAMETER Storage
Storage associated with the Harbor registry. The list contains only one storage backing in this version.
.OUTPUTS

ContentRegistriesHarborCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Content/Registries/Harbor/CreateSpec/
#>

function Initialize-ContentRegistriesHarborCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Content/Registries/Harbor/CreateSpec/")]
    Param (
        [Parameter(Mandatory = $false)]
        [ValidateScript({ $_ -is [string] })]
        ${Cluster},
        [Parameter(Mandatory = $false)]
        [PSTypeName("ContentRegistriesHarborGarbageCollection")]
        [PSCustomObject]
        ${GarbageCollection},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Content => vSphereContentRegistriesHarborCreateSpec' | Write-Debug

        if ($Storage -eq $null) {
            throw "invalid value for 'Storage', 'Storage' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBU7lC5ZxeUxnKo
# jhJyNreN6CxDVMNTZmy9vQOYH98TE6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJvB1f9zJ9erPed0
# RLj3xzxyVEff/J26WVd/EQhFukR3MA0GCSqGSIb3DQEBAQUABIICABxCYlHH4IFW
# 4OzPFh8llo+6W05n4NzDHzlZJjCpKh5RQwFZzfY+Bi/Ce+Ev9aUbEuDVDODhC01w
# hH9Qr6sOEk+/74KWVHHnsmtmC8eBnQMKsRiCKTQIPh+GPPx8Erx3m1PMRPJKBa9h
# kvv8qKyQtssitV0Aho/EVXUgiDPXl0APIJt0Y8trhcFutnEdAXhWJ/BFoVZD8USE
# 8tgJJnUDDLMmYN5z7ZTtKcrr6CSIxgQA3Xj4F/R2MmIDsRsAJ7VDXYP9bkCr4yRy
# WFE6rLXkERU6Bf2Gg65Sq1RIzsa2KaGrnA4I6dX+nGApqLPn4SWoxk+PaUNXS32X
# 3VyB7L7tHpUD7t+jxHqRBFXHsKSKs898CsY//Z25NHJy3kXXH2relhZ6pKhpIldK
# AJxOUGebGucMlX99YrJiKQTCEPpgmQa+8rcAskhZObK/gRLsJj+hpOctec9p72Hq
# MB9rrEoBp9stEOcqrnijIKyYCt1MbwbZZtiOPcDquGZxbofECtr4OUbGKnimT+SW
# WarVYowjXr77pvnd7SjCzhPsu1Tt5zN87y92vBOj4BEJM11N8MJAte67vYVYETOO
# k3VcTER/hHsZZOSwQDQ67/qkzdRXFKN3C5fuif0pLb0BkFVpvl5vI4jO87aEq2qb
# jfKg3D9isyQB/4dw69r+dY1GDb7ZEbLQoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IL3DQFFpECb3x1wIykpII4Oh8TIjPqRVh1DL9jZ1bSBSAhEA5B9WTq6k/154+t67
# IIHFIBgPMjAyNDA3MjQxOTQwMjdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQwMjdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDpO31qH5HmL9GYqbuHzKZb
# xYRJLBExsLd56hJb8cQ7gTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBP0wce
# RavK5sLGrgDegl6WrVlf7Zc4p5Oi8+HnevvSRtDulba+xa9J+YxcPvAHGXmvnCCz
# 9a5tJ8Lb0pbYqD9OwCQjLdBpbA6Xyph5sR0CUVl8al/kuV0gdSAvI7GRNt8iJkjC
# 1q/wUi2+74bDVt9EDLtbI3jqV8ZskFtsJCvxYY4vQjdXi0jnyRT9i/RhbmKS9JYM
# wI9AtortNSg2i/28pXWLC5npwiI9Z7uzzFjKUJnuEPuBBnUPkqmWRvOxV6rRRrJU
# OgUKuYzWGwesV1i3i+qw80BfcGblczrv9kV0FbATCiy0bF7jh87LxpFa4OLeAHVd
# hy9yjeXBYCsxb5oWa67flkL1orpsIxWe8CRWphYn1od0K4difV05BBZPeCVAVHEf
# exruzqxzqYi3krJFo9lMnMex24lQg90cWcPlVEZP68tBGViBvlEj9iNqcz5nlRQy
# 2csit/5+/bFi36cdbNJZGi+AQm9uKCSZTz4RdNdVJvoWVb8eFg5UfCz8u1rDUGni
# regGdvOB53ymllGchuMHtLy2Ce3OqYrNW/Q6GvLbVDBtgPkctWVEJWXgWyGscTyn
# 24byffzH/e2xniXb+peHr1IvUJ/PC53+jsw1npKYQtB3dS6f9WmVMMrhezqukUqO
# ILzyVjJnxcidE7Kr7kyr/68LVp+qDMfrymhN4w==
