...
.PARAMETER ContentRegistriesHarborProjectsCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/post/
#>
function Invoke-CreateRegistryHarborProjects {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/post/"
    )]
    Param (
        ...
        [PSTypeName("ContentRegistriesHarborProjectsCreateSpec")]
        [PSCustomObject]
        ${ContentRegistriesHarborProjectsCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateRegistryHarborProjects' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateRegistryHarborProjects' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/content/registries/harbor/{registry}/projects'
                $LocalVarMethod = 'POST'
                ...
                if (!$Registry) {
                    throw "Error! The required parameter `Registry` missing when calling createRegistryHarborProjects."
                }
                $LocalVarUri = $LocalVarUri.replace('{registry}', $Registry)
                $LocalVarPathParameters['registry'] = $Registry
                ...
                if (!$ContentRegistriesHarborProjectsCreateSpec) {
                    throw "Error! The required parameter `ContentRegistriesHarborProjectsCreateSpec` missing when calling createRegistryHarborProjects."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $ContentRegistriesHarborProjectsCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$ContentRegistriesHarborProjectsCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ContentRegistriesHarborProjectsCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ContentRegistriesHarborProjectsCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $ContentRegistriesHarborProjectsCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $ContentRegistriesHarborProjectsCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $ContentRegistriesHarborProjectsCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $ContentRegistriesHarborProjectsCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $ContentRegistriesHarborProjectsCreateSpec) {
                    $LocalVarBodyParameter = $ContentRegistriesHarborProjectsCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/project/delete/
#>
function Invoke-DeleteRegistryProjectHarbor {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/project/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteRegistryProjectHarbor' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteRegistryProjectHarbor' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/content/registries/harbor/{registry}/projects/{project}'
                ...
                if (!$Registry) {
                    throw "Error! The required parameter `Registry` missing when calling deleteRegistryProjectHarbor."
                }
                $LocalVarUri = $LocalVarUri.replace('{registry}', $Registry)
                $LocalVarPathParameters['registry'] = $Registry
                if (!$Project) {
                    throw "Error! The required parameter `Project` missing when calling deleteRegistryProjectHarbor."
                }
                $LocalVarUri = $LocalVarUri.replace('{project}', $Project)
                $LocalVarPathParameters['project'] = $Project
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/project/get/
#>
function Invoke-GetRegistryProjectHarbor {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/project/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetRegistryProjectHarbor' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetRegistryProjectHarbor' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Registry) {
                    throw "Error! The required parameter `Registry` missing when calling getRegistryProjectHarbor."
                }
                $LocalVarUri = $LocalVarUri.replace('{registry}', $Registry)
                $LocalVarPathParameters['registry'] = $Registry
                if (!$Project) {
                    throw "Error! The required parameter `Project` missing when calling getRegistryProjectHarbor."
                }
                $LocalVarUri = $LocalVarUri.replace('{project}', $Project)
                $LocalVarPathParameters['project'] = $Project
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "ContentRegistriesHarborProjectsInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ContentRegistriesHarborProjectsInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/get/
#>
function Invoke-ListRegistryHarborProjects {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListRegistryHarborProjects' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListRegistryHarborProjects' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Registry) {
                    throw "Error! The required parameter `Registry` missing when calling listRegistryHarborProjects."
                }
                $LocalVarUri = $LocalVarUri.replace('{registry}', $Registry)
                $LocalVarPathParameters['registry'] = $Registry
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "ContentRegistriesHarborProjectsSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "ContentRegistriesHarborProjectsSummary")
                        }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/projectactionpurge/post/
#>
function Invoke-PurgeRegistryProject {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/content/registries/harbor/registry/projects/projectactionpurge/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-PurgeRegistryProject' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'PurgeRegistryProject' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/content/registries/harbor/{registry}/projects/{project}__action=purge'
                $LocalVarMethod = 'POST'
                ...
                if (!$Registry) {
                    throw "Error! The required parameter `Registry` missing when calling purgeRegistryProject."
                }
                $LocalVarUri = $LocalVarUri.replace('{registry}', $Registry)
                $LocalVarPathParameters['registry'] = $Registry
                if (!$Project) {
                    throw "Error! The required parameter `Project` missing when calling purgeRegistryProject."
                }
                $LocalVarUri = $LocalVarUri.replace('{project}', $Project)
                $LocalVarPathParameters['project'] = $Project
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA