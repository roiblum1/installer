...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/authentication/token/post/
#>
function Invoke-CreateAuthenticationToken {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/authentication/token/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-CreateAuthenticationToken' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateAuthenticationToken' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/authentication/token'
                $LocalVarMethod = 'POST'
                ...
                if (!$GrantType) {
                    throw "Error! The required parameter `GrantType` missing when calling createAuthenticationToken."
                }

                if ($null -ne $GrantType) {
                    $LocalVarFormParameters['grant_type'] = $GrantType
                }

                if ($null -ne $Resource) {
                    $LocalVarFormParameters['resource'] = $Resource
                }

                if ($null -ne $Audience) {
                    $LocalVarFormParameters['audience'] = $Audience
                }
                ...
                if ($null -ne $RequestedTokenType) {
                    $LocalVarFormParameters['requested_token_type'] = $RequestedTokenType
                }

                if (!$SubjectToken) {
                    throw "Error! The required parameter `SubjectToken` missing when calling createAuthenticationToken."
                }

                if ($null -ne $SubjectToken) {
                    $LocalVarFormParameters['subject_token'] = $SubjectToken
                }

                if (!$SubjectTokenType) {
                    throw "Error! The required parameter `SubjectTokenType` missing when calling createAuthenticationToken."
                }

                if ($null -ne $SubjectTokenType) {
                    $LocalVarFormParameters['subject_token_type'] = $SubjectTokenType
                }

                if ($null -ne $ActorToken) {
                    $LocalVarFormParameters['actor_token'] = $ActorToken
                }

                if ($null -ne $ActorTokenType) {
                    $LocalVarFormParameters['actor_token_type'] = $ActorTokenType
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "Oauth2TokenInfo")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCArCi8KfOggMv5K
# lbYTNTXqPBcCJyKvWa4USP2Uy3/RuaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDUSlaoyefg74nJL
# P/UWbGlbAP0c1enWoA/EnJB8eqB5MA0GCSqGSIb3DQEBAQUABIICAGRxafHh5P0H
# P/AwrydouvCllTzwZ4/hGR/xFuH/yeuIE9DzgP0PI2H0kL7lrC3TK0ONbkFvlYxf
# TwbXDrFOssgv8Yj707YwoH+2vcr97UlUuqINiAVkSpeoTVFdTqZbyNykruOMlnXS
# oDwul2j6tQoO3EHNB81JNESloNfY/phpc1eCexHz+CkNEbRfuOliRJyEyzOJylZI
# ToD8UJwCuJXvzeAahlau/Ku+BFQMvn6S9+ys9eHlRJuqJJ7GRnLdyfLi0+pS8mRD
# tBNta6fFu7WqrZbL9OgORl+5ycMgT1i14q4QVgzCDtXXzGC2J98kKRLsO6wz84kJ
# ATeEBLZ90upe7MKb+Ktx7UvnHZBDa7Yx1r1YkaZnpK8Id4Xt4cdNORx1X5khZWLi
# d9bS86MoFqa2CISGdJsLykjNMDILQBJV+VR4TTULUAoTETGx0oYWl84DVA3+vqIX
# glv5jbJ8U37sqw/PRbVkVnK0+EDn/h32moRY85ztJsmY44lk2U0diRKoKDYbE99X
# U4idPd27qKvZQeDfK42h1YnxrQ+l8Tlh1ttjOA0zXQ17A4+peYRPYmD4o0iqn0Bp
# B4yTuBifk2Nk4q//rH0pWBdK5P+7Vqm8sGhXQqapBPY9waaRdPv2k9xBfchBu+wX
# 5TzFpBqc8/6ehp2rUTvJhiiV/sJFEfuGoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ILjsoAqJgqgdpSzCwHu9M32XgMdzojshUQOFoAjR903CAhEA0Th4CuX1X7/S+cCv
# b0ABtxgPMjAyNDA3MjQxOTQwMDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBYrP5dL9D1m1ktni098I2M
# Bul3iYxfxAWjxq85AGhipTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAubxYM
# ntcLh3M7utSxRsDLcgq2BKRlOerokRGzsjqnrnpv7rsETQBpOihA2JT02Kbku1aP
# IaFuTRo485fjjwcBdvHw/Y753EGcwzq+oQdQxMoVGiWV1ZV0Mll+GbhpHgUUt32l
# fmn2dIhCkQXIHhrOx7BcSaM9vZfrMlO1ks7C8ZrdV22yxRJBBoNAG9tRfXg1niKY
# voNg+q7DtU3HeZldGLOZMRqm3ickNGHDPA9NT1LWPddLG38ZWN43Av1FfA9k1vAx
# Vg7q1YrKp6XaUVQ2DPte++DiN/x2UPuHuwPLNoo+fMqjlt5kITiBPD7yaW88p37F
# 9d9JUU+mErmFFvghVO9qYMPmgQaJU1RXNUMBayWXoCGgLmIWcnoVIx098u6q2e3w
# D1usixW6MMZHU9pFKSX/GO89Eqs5VdxtKjYnCorjkTlTpx5RVjJQdtmUPq30Rja4
# nQdhE/4OG0tZmoXMouJKmmhWjTuD4g1U6yyWDuohqt6ozDTCZsbwYTi82+QfLDpz
# ewxLf3Nf39QAthyGPrNId724KW/OCsfKm1dcbV6Xlmf2OgDzTOtEytz6XROgfXlL
# Akhuu3myZIMXVojlCvp4FnYOXAq5H1KyHAYuTyvICTHSjhLUb8nNUqw8GB83Z+mq
# oZTANfMgypJ0AmzDlXB9dCg5hGQoea7nN+hhJA==
