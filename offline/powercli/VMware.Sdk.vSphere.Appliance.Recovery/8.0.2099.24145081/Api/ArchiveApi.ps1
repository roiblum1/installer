...
.PARAMETER RecoveryBackupLocationSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/recovery/backup/system-name/system_name/archives/archiveactionget/post/
#>
function Invoke-GetSystemNameArchive {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/recovery/backup/system-name/system_name/archives/archiveactionget/post/"
    )]
    Param (
        ...
        ${Archive},
        [Parameter(Mandatory = $true)]
        [PSTypeName("RecoveryBackupLocationSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-GetSystemNameArchive' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetSystemNameArchive' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/recovery/backup/system-name/{system_name}/archives/{archive}__action=get'
                $LocalVarMethod = 'POST'
                ...
                if (!$SystemName) {
                    throw "Error! The required parameter `SystemName` missing when calling getSystemNameArchive."
                }
                $LocalVarUri = $LocalVarUri.replace('{system_name}', $SystemName)
                $LocalVarPathParameters['system_name'] = $SystemName
                if (!$Archive) {
                    throw "Error! The required parameter `Archive` missing when calling getSystemNameArchive."
                }
                $LocalVarUri = $LocalVarUri.replace('{archive}', $Archive)
                $LocalVarPathParameters['archive'] = $Archive
                ...
                if (!$RecoveryBackupLocationSpec) {
                    throw "Error! The required parameter `RecoveryBackupLocationSpec` missing when calling getSystemNameArchive."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $RecoveryBackupLocationSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$RecoveryBackupLocationSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $RecoveryBackupLocationSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $RecoveryBackupLocationSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $RecoveryBackupLocationSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $RecoveryBackupLocationSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $RecoveryBackupLocationSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $RecoveryBackupLocationSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $RecoveryBackupLocationSpec) {
                    $LocalVarBodyParameter = $RecoveryBackupLocationSpec | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "RecoveryBackupSystemNameArchiveInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "RecoveryBackupSystemNameArchiveInfo")
...
.PARAMETER RecoveryBackupSystemNameArchiveListRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/recovery/backup/system-name/system_name/archivesactionlist/post/
#>
function Invoke-ListSystemNameArchives {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/recovery/backup/system-name/system_name/archivesactionlist/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${SystemName},
        [Parameter(Mandatory = $true)]
        [PSTypeName("RecoveryBackupSystemNameArchiveListRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ListSystemNameArchives' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListSystemNameArchives' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/recovery/backup/system-name/{system_name}/archives__action=list'
                $LocalVarMethod = 'POST'
                ...
                if (!$SystemName) {
                    throw "Error! The required parameter `SystemName` missing when calling listSystemNameArchives."
                }
                $LocalVarUri = $LocalVarUri.replace('{system_name}', $SystemName)
                $LocalVarPathParameters['system_name'] = $SystemName
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$RecoveryBackupSystemNameArchiveListRequestBody) {
                    throw "Error! The required parameter `RecoveryBackupSystemNameArchiveListRequestBody` missing when calling listSystemNameArchives."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $RecoveryBackupSystemNameArchiveListRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$RecoveryBackupSystemNameArchiveListRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $RecoveryBackupSystemNameArchiveListRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $RecoveryBackupSystemNameArchiveListRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $RecoveryBackupSystemNameArchiveListRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $RecoveryBackupSystemNameArchiveListRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $RecoveryBackupSystemNameArchiveListRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $RecoveryBackupSystemNameArchiveListRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $RecoveryBackupSystemNameArchiveListRequestBody) {
                    $LocalVarBodyParameter = $RecoveryBackupSystemNameArchiveListRequestBody | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "RecoveryBackupSystemNameArchiveSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "RecoveryBackupSystemNameArchiveSummary")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAYW/UevUt6eiUW
# f6Wu0kP2obTjfvttnTeKiQzBbTm3g6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI