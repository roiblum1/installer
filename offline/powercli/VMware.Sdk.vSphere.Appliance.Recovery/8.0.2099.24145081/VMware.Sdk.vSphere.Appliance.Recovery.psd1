#
# Module manifest for module 'VMware.Sdk.vSphere.Appliance.Recovery'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.Appliance.Recovery.psm1'
...
GUID = '1fa0da9d-4f8d-4116-bb3b-206e99bde902'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.Appliance.Recovery.'
...
FunctionsToExport = 'Invoke-GetSystemNameArchive', 'Invoke-ListSystemNameArchives',
               'Invoke-ValidateRecoveryBackup', 'Invoke-ListBackupJobDetails',
               'Invoke-CancelIdJob', 'Invoke-CancelRestoreJob',
               'Invoke-CreateRecoveryBackupJob',
               'Invoke-CreateRecoveryReconciliationJob',
               'Invoke-CreateRecoveryRestoreJob', 'Invoke-GetIdBackupJob',
               'Invoke-GetRecoveryReconciliationJob',
               'Invoke-GetRecoveryRestoreJob', 'Invoke-ListRecoveryBackupJob',
               'Invoke-GetIdBackupParts', 'Invoke-ListRecoveryBackupParts',
               'Invoke-ValidateRecoveryRestore',
               'Invoke-CreateRecoveryBackupSchedules',
               'Invoke-DeleteScheduleBackup', 'Invoke-GetScheduleBackup',
               'Invoke-ListRecoveryBackupSchedules', 'Invoke-RunSchedule',
               'Invoke-UpdateScheduleBackup', 'Invoke-ListBackupSystemName',
               'Initialize-RecoveryBackupBackupRequest',
               'Initialize-RecoveryBackupJobBackupRequest',
               'Initialize-RecoveryBackupLocationSpec',
               'Initialize-RecoveryBackupSchedulesCreateRequestBody',
               'Initialize-RecoveryBackupSchedulesCreateSpec',
               'Initialize-RecoveryBackupSchedulesRecurrenceInfo',
               'Initialize-RecoveryBackupSchedulesRetentionInfo',
               'Initialize-RecoveryBackupSchedulesRunRequestBody',
               'Initialize-RecoveryBackupSchedulesUpdateSpec',
               'Initialize-RecoveryBackupSystemNameArchiveFilterSpec',
               'Initialize-RecoveryBackupSystemNameArchiveListRequestBody',
               'Initialize-RecoveryReconciliationJobCreateSpec',
               'Initialize-RecoveryRestoreJobRestoreRequest',
               'Initialize-RecoveryRestoreRestoreRequest'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzhmZTflcjHOU2
# xHg5fTb8lzQkcpkGwSsM9e7KoecUiKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHKubImkqf5TV7Ms
# nfEhJbdvgGvMyPXcWlso90BH/IqFMA0GCSqGSIb3DQEBAQUABIICAA73Lo2pEtZX
# g4+UDruv3rJuO2hsU2YsCZsv7jCQ2HBLZvoz2C6EKrTrehk5O7S+LS2ZODXlaKpx
# REO5TOazs3ma0gpI5mKYTIYjojaXyd7DnALm2ytN2xHwGNDhH9hhIzmXPulDmL4d
# XRxqDXqV2pKbyF/1KQVelUTx2DSlWn8ZxH2ZbcjiKjRHbik/JfHb9I/9gVB/lzqO
