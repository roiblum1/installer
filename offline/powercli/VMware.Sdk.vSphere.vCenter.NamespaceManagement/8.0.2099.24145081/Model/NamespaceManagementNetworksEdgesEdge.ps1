...
.PARAMETER LoadBalancerAddressRanges
Edge.load-balancer-address-ranges defines the list of addresses that a load balancer can consume to publish Kubernetes services. This range must contain at least one IP address unless the NSX Advanced provider is selected. It is recommended to supply a large enough range to support load balancers requested for pods in the control plane and Tanzu Clusters.   This field must be set if Edge.provider is not an NSX Advanced Load Balancer . This field is required if you want to load balance traffic on a DHCP Workload Network.
.PARAMETER Haproxy
No description available.
.PARAMETER Nsx
No description available.
.PARAMETER NsxAdvanced
No description available.
.PARAMETER Provider
No description available.
.OUTPUTS

NamespaceManagementNetworksEdgesEdge<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Networks/Edges/Edge/
#>

function Initialize-NamespaceManagementNetworksEdgesEdge {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Networks/Edges/Edge/")]
    Param (
        ...
        [Parameter(Mandatory = $false)]
        [PSCustomObject[]]
        ${LoadBalancerAddressRanges},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementNetworksEdgesHAProxyConfig")]
        [PSCustomObject]
        ${Haproxy},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementNetworksEdgesNSXConfig")]
        [PSCustomObject]
        ${Nsx},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementNetworksEdgesNSXAdvancedLBConfig")]
        [PSCustomObject]
        ${NsxAdvanced},
        [Parameter(Mandatory = $false)]
        [ValidateSet("HAPROXY", "NSX", "NSX_ADVANCED", "VSPHERE_FOUNDATION")]
        ${Provider}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementNetworksEdgesEdge' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "NamespaceManagementNetworksEdgesEdge"
            "id" = ${Id}
            "load_balancer_address_ranges" = ${LoadBalancerAddressRanges}
            "haproxy" = ${Haproxy}
            "nsx" = ${Nsx}
            "nsx_advanced" = ${NsxAdvanced}
            "provider" = ${Provider}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCsNxi1bHyHKQiW
# SEnZhSCnsDZhE0zzS6dwKgOtbLYgY6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPCfjKD3d8CWMogr
# saTAM05sWrG+BpJvxeXghjghCJ+8MA0GCSqGSIb3DQEBAQUABIICAK2aqT+4HkUx
# MyljrbeQZAr0ez3CiXhti0CEg3kVX0/88FPXqbszG+JeUJDWRgEmwJB4p9eRoYuv
# PE/Zg6Kcfx7SgLNI7iichKKossUHkYbbmASBEm4nnxdgSMtATcwW+Vw8DVhI7zYJ
# qLn+r8wTjux3UrdPgRClq126MWdsvPmcDSFvOseLczbkNlz8whA9zEN2aYz7WDTa
# h5QJkQDuCSyGg6lvEW0AOP08xsdHheg21uoazY9ACbCtmkzPAdJPrcdChNLBYhvC
