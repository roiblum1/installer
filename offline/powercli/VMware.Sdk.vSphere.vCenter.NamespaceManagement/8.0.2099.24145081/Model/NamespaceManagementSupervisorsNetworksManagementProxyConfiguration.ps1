...
.PARAMETER ProxySettingsSource
No description available.
.PARAMETER HttpsProxyConfig
...
NamespaceManagementSupervisorsNetworksManagementProxyConfiguration<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/Networks/Management/ProxyConfiguration/
#>

function Initialize-NamespaceManagementSupervisorsNetworksManagementProxyConfiguration {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/Networks/Management/ProxyConfiguration/")]
    Param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("VC_INHERITED", "CLUSTER_CONFIGURED", "NONE")]
        ${ProxySettingsSource},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementSupervisorsNetworksManagementProxyConfiguration' | Write-Debug

        if ($ProxySettingsSource -eq $null) {
            throw "invalid value for 'ProxySettingsSource', 'ProxySettingsSource' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "https_proxy_config" = ${HttpsProxyConfig}
            "http_proxy_config" = ${HttpProxyConfig}
            "no_proxy_config" = ${NoProxyConfig}
            "tls_root_ca_bundle" = ${TlsRootCaBundle}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjSqgJ/L8hkZ0a
# stjIBWy5mSZMij5TyILjmhg8HBcOIqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICq3jxxn5/8C8cMH
# Ry+JXTYa9xy35Ewxar2l17trS5lIMA0GCSqGSIb3DQEBAQUABIICAHKovzXE3oUl
# KYI2kwuhOVs+rLc+426QTI8Ki9wuz9r/47wVQph8wgR2hrj8WOa0HNjdWL+D1527
# q8v6tNQ7QuADXxFSlj+FtcDkbqZpYR2oS6y+FNmmfrmP41gxNSoPYKpxzcXK/YiI
# 7HJAem3BZ+6HlzNkCdc8YmDGNN7RvmNlYyQrXxhQNtGXu0Nzn94XAuAmi2puaspH
# GGGx3BJwD9hgBgamqr7l3Z7aIpiOe3mVOp0j5ez5VMou2EivQl4OiTEQx2wwPSQo
# l1RB/mDezgWVpKca3nVMWdhlfFPTghqpYjIT4Mf5ULWO+JkPlDZAgmliG8+IRNlm
# HuhqO1gKTnOLM2ikncHGaD5L9AzWGkqmlijTlo7edOYCLXiOnnPlq+wimlz2ZwZ6
# UD2gqa7iR3hTbhn1gfEqHjjK9gGLGsYqEZHFdTQ4kM2I46YS3/89DgVAGbZYN2+a
# OHOtmfrE2zOFh/Y4Y2W2kZV9+bpy5Jetvnl7TSASeRo/Wd2YgLjT+Qp1OXzXlFog
# sml+Z65HDb6NSzcjpc+hzIeBRcCbO2syjhHol3FgNp3rJ0kjO0XswWYdw20F149a
# cnjwm3ErnDJcuMa4PJc6IbMwDeuGfnLsWtcsDv2JHX1g+yXPU86Qe2uIcrenuAfr
# Ho8zNSuw8DnlfGLYif+AIbLXNqHF2a8ZoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IFUyHNd9kq/MwkY5NK9sjQpeovOZzG38CoIacwPJhJOmAhAOsDVXA9AqZcZtti/n
# 3dREGA8yMDI0MDcyNDE5NDIzNFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDIzNFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEII9xOGYLSEdl6M+Cy2gt2QCa
# lxGo7LF4xik68u4yXC6WMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAC2Wjclc
# /6nxels1X71rAblwpJy4pRlZxLKyD1jX9B1xkSJXqU9hdvYvwyLznTUe/1NFxrUA
# mZPyno8lI9yfpgOHaOTKKZB4NHnZDyD1eX8E/mdHl+iDqGdBHxGFpI8UwiESSS9t
# NlNCCkR8/0l4rrIN8OgJ3652lWJylJSzqd09hHAqtuQa2FgQ78Y6y48nR3qjg9lC
# sI2q5cRfrZK7pkmj5usZDjc5Oj8+9e5ogygxiNoXkDOFCpVlvFgNETtRsELBv5ep
# OUtF91Pc7mbKVmLFAO2FOkTuD2CI0XT1L3Tw1gdWb6nW0jcA1KF+OG5nLxUX4mzf
# zNsTMI7a1/E+kluCerrTcNE1vgjOoThyBoVETAhgfnbi2pDIdhCTiXACAhKqZkVk
# bSx4qIj3WNfowqmNka+V7FWrrDsOqkjY1Cd+f54/WJy+Nk+KDJ3bHPtl2nZl8U/U
# bIpN6HrOKiQKlnAeM33MJ8ov1nD1ZO7BxGrmBj4O4uoKVI6ui5h6kz9i4vigj7iu
# fwk9A/gKe/kneXXSp5OoTrO6OaW1rD7ZhxM7ok3hbUmZ7YJYsKLMnunTCRAqNwDY
# 3ui6a0Yj9W3Ms7BUaYrv7Tq28F2xh+zBDUceTdojfi5FJPzuBpz2j268cbETCLGe
# 5q0Ws6ype2JaKgdtCTVrGXQ9ycYto6YV5Wfn
