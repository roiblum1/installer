...
The Supervisors.EnableOnComputeClusterSpec structure contains the specification required to enable a Supervisor on a vSphere cluster.   The ability to add multiple workload networks at enablement has been deprecated. Please use the Networks APIs to add additional workload networks after the cluster has been enabled.
...
NamespaceManagementSupervisorsEnableOnComputeClusterSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/EnableOnComputeClusterSpec/
#>

function Initialize-NamespaceManagementSupervisorsEnableOnComputeClusterSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/EnableOnComputeClusterSpec/")]
    Param (
        ...
        ${Name},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespaceManagementSupervisorsControlPlane")]
        [PSCustomObject]
        ${ControlPlane},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespaceManagementSupervisorsWorkloads")]
        [PSCustomObject]
        ${Workloads}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementSupervisorsEnableOnComputeClusterSpec' | Write-Debug

        if ($ControlPlane -eq $null) {
            throw "invalid value for 'ControlPlane', 'ControlPlane' cannot be null."
        }

        if ($Workloads -eq $null) {
            throw "invalid value for 'Workloads', 'Workloads' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC3Vi5m7ffq7QBS
# RphwMeYIBCIhtgTa/OzVI/vLXNEjYKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJqXdGVIh6rNPJN6
# lv/g/JYnFr32mw4x5rmybzQyTB51MA0GCSqGSIb3DQEBAQUABIICAC72ofqqlC5F
# ZrFJLQPyPVYdku8p5/tKnNojUqu1OwFtQHI8O8VlHCTvb3TA3GCFzA/ZkH96SWR8
# QT4xRMFQFk4xawMT/m6t9OR/pkPDW4CL6jjn6pWkiJf8bvqjs72qjTKQP4IrrKEt
# jV249ycQKbdCRe3DGX4tz3i2MVquO1mz5/Mb6YAhyb6BvyjP/At/oMgjR2pyATSt
# 1XTiHLcalhk2xVNH9nxW8utJaISCrlIKtyFhX4cYP3u102E7ubKQqEk6sXt4skjE
# durmHnO54wPHH0R4lzLrFAo1ZJdapBjg9NBASQMujFb7Cwdd5H6Wk6GqFBHlZMbj
# z75UUQDwwcyDcnmG235JJG+QI3ta4eWW1at/N0AwR8bkLlNrU6bvdAzs/n2jT2Lo
# syXNQR/XUTlL9Zvhb2DDoDNCkY+HUaBqE4LBQuoW2YvGunJ4A8zfCQ1nH4NURadT
# lhqDnUB0O3OZkyvMGqhDw2TF9Nm0wyeA1B82/8SSjnYAwlbrFSMhNHn4xyNVOl6f
# CiyNcpUVVY9X3X0At2dv6g6ibl/O/bXxIn4Dcvn4Sos+o6hRhkDoF3DWn2JXSCz6
# vo9rbXaujFIdiEvddmjs25yOCMYb3xdyr/zP6snoOYPPFqRr1wggPe8Ix6ASyCeU
# 4r98fouNQ8lZScPYDIZ/OX0eXVQSeg4ioYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ILy4DQG1ljvx32S0o2+rycb0aXrtMWk2Q1osnu3jZqU5AhEAvIMdRDQXlgzZo5Cp
# DFm9kRgPMjAyNDA3MjQxOTQyMThaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQyMThaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCD3ksSvQWDixJb9ZnLiu1B8
# R4/ArMEP3gaf0nL88l797jA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgA+WtHp
# ay6Hq2z0VZZ54/bOdHxrEPDFaliQj1EB0a6SBJA1orS/JPDCI2w3egfVUmp4TMAz
# bexeUyduai58KUhNFoPAMkvI014ddgFPaabmE+u4xmPLphmZUmVZ28I3RksVqkKi
# RPtpv3OmFmuEDhGT6immUGPtK1vziTVDWapAywLaF/5nCL+4mW0U/Zg47vG6cdKd
# 1sjNrMIcpH2hWAZTOMo/HQRxXDD3e0OqKUR4QlBmJiv2Toz2RBiU5Au0YWWADOAD
# HgwTI0VlRA8p+MFTDEgpDPgv2HEgUyf1uzwugdK8Z5BFYpxKFc+LOD7/1250tgVs
# KgcTHlxfV2R/9fNpbXFfqp6GmpnBXtP9WX9PDb8E4bLrTWgw5UDXfTDJb3vXvz92
# EHCrmIuDqkPY5dhG4emaTOzF736dGyU5PZpS/oB2G1MndtWhEtE3Mi4VBlSxLEWV
# W7v2xSicbGs3j3VRvFDw6fSwA717vzUnXF7iniPBcdR3ZgxIemctFjFzmUouM83j
# 5UG7ZLqxlp9v7dwMN6qBTM/ySekdYOUbb17vPNXlHFMsIpC6v4zomTuRm1K7DHCj
# 4H2MG+M/Hy6OWHxZ34jZaVUsvKA3/nl0L6duuqt5eIMYDk9/NiG5x30NUwcjjDm/
# HDp7H5oon/cVGNa8XvevMyMNsk/GjB7mLUwHzw==
