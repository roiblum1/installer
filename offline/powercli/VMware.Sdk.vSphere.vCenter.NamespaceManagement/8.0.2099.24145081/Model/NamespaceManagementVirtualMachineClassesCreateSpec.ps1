...
.PARAMETER InstanceStorage
No description available.
.PARAMETER ConfigSpec
A VirtualMachineConfigSpec associated with the VM class. If unset, no config spec will be associated to the VM Class.
.OUTPUTS

NamespaceManagementVirtualMachineClassesCreateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/VirtualMachineClasses/CreateSpec/
#>

function Initialize-NamespaceManagementVirtualMachineClassesCreateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/VirtualMachineClasses/CreateSpec/")]
    Param (
        ...
        ${Description},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementVirtualMachineClassesVirtualDevices")]
        [PSCustomObject]
        ${Devices},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementVirtualMachineClassesInstanceStorage")]
        [PSCustomObject]
        ${InstanceStorage},
        [Parameter(Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementVirtualMachineClassesCreateSpec' | Write-Debug

        if ($CpuCount -eq $null) {
            throw "invalid value for 'CpuCount', 'CpuCount' cannot be null."
        }

        if ($MemoryMB -eq $null) {
            throw "invalid value for 'MemoryMB', 'MemoryMB' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDbYoa84n+ui101
# KX6xdTO2OQ457U19i2za+8kERcxy56CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBVruq5rGclQFZeU
# f1UjC9Hf8ikJukrISexYmmysrOTJMA0GCSqGSIb3DQEBAQUABIICAEQ2zYDyZ0UT
# ecGCfDD70W+qee9a/sq7WGmIGQ80MoWFAI0a/Ovri7m9S5yhEo99WGnGokY8Kutz
# dwU/fr6uvDqHXXssr6mo5wBvOuO5hjpHICB8UBBLTUoFqYJllGmdazMU52GQPNSb
# 1K1JufhOrmZS4g6AC6G8McnXQ40+GTH4bd7ttfH3vXwDycOr1aSlq+14a5qMxQqs
# StO6ul4cisu9z5x312woahma2AOjyDUpAdf45cEjk9MiZ7GFfsbK9iodaYc+r5U0
# GizoVgyUsEwNbwD5LSJNnG+6yuIYSH1cOf0pKUw6ks3Dt3nN8PJ/RijXhEmw/SS0
# bCAQlwt4Jek03hCQC5u4t4p48Iz1BWDqvuKI9JkPaL7XpOEscoFauJqq9+Q4oHas
# OvGu6ZvasxH2oylA5A/OEuX1O8fxVu7vwBK4Dvfm3q6HnoOqj1o8Qa6AovAohK01
# deh7uyPoHTRmgn0Q4JxRuYTFcduX8GpVf1sEdVEZFByIXNIS+m/WpXUrokoAqI3H
# lUPyHbo/8tFltfB9m0sXnvCos3GXaNeLG6HH81lzneN9NL0El3me5dRATqjROpXR
# PbduREb4/KJu7aRsl+y/PN8+cgv190hOC7EtHoVkjkYJauH4jSWkUcHrdaj+QiPL
# Yw7/9UkMOD9YjD4GS7O9cAgjFzgeTSS1oYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INvt9anAuDblskk6yahfSMTnQP8sn+ajZGnG0VRMzpzqAhEA1kD6YcO26uG0EvNm
# CanKExgPMjAyNDA3MjQxOTQyMzdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQyMzdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBSasyKywZoTIptfB8NdXG+
# tfMgbSSzpfzXE1sOUIiAMTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCU6dk0
# Yn7PDnBK3Ik+AQvZ4eYe57parMRgVamcF0WdWdKD4YSbV1Ew269NUgqzqYnCjOJc
# SIdtSrnEHnvj9oKrjTz/ZmivoS0IUcX0CihDjS/dIDXmi8g+8XxKpCRD5U7+faT7
# ks0yEG5bOVmP8t8L8tQqTtefpHnnR8Kc66Em6iHwgrZScaHLrTFPmnNApvKhrnW4
# nTzGXql78sk+8JTU8c4FPjpuFwqkl80J9H2+TO64e8oMN4J3q8zdNf4l/F5iezYG
# 4/5SDXw7sqgj8YEm4YrHfvrFeZHk41ztNaf9iTAq+nbXER/fEisSMALhNYq6yBJ8
# j7J0erYaid+2d96UusftbuGmUzG8cz4YhB0znXnTSAIP0gEcNV2ydFsCKgJbcc/F
# bqaEHg/OwFnSJleKVnS7ML8tkV6zoOrivhJ9NMxcSu324AjAspdkasjRXI27g4pT
# XAvTFb04IGGxOOIZalL1OvkDvwr9ryDdT9HxQz6Ocxr/hB0+oGNwJgnKVkS7LKlj
# BRvpJk8KosF+kfNi0W7FbOjFsG44HUw0AtwB+orVZkeTxxjmYvA7so9QziEg5cN2
# C+oemKgf7zjI6eY5MKmfg/d3xiyXy/1hGcntdD/rnWToAhtJgKyKJoqNV7v9ZE9T
# zRMmTdgm2es+A6oOcZIq+jEN8ExCBzU/IJTlbQ==
