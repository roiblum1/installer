...
.PARAMETER VgpuDevices
List of vGPU devices. If unset, no vGPU devices are present.
.PARAMETER DynamicDirectPathIODevices
List of Dynamic DirectPath I/O devices. If unset, no Dynamic DirectPath I/O devices are present.
.OUTPUTS

NamespaceManagementVirtualMachineClassesVirtualDevices<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/VirtualMachineClasses/VirtualDevices/
#>

function Initialize-NamespaceManagementVirtualMachineClassesVirtualDevices {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/VirtualMachineClasses/VirtualDevices/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementVirtualMachineClassesVirtualDevices' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "NamespaceManagementVirtualMachineClassesVirtualDevices"
            "vgpu_devices" = ${VgpuDevices}
            "dynamic_direct_path_IO_devices" = ${DynamicDirectPathIODevices}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCImUKHp+8R+D/L
# Nxcr/1fbyCMBiaFITYVlIoj8KYaJV6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII08VvWoH49PtLGF
# f9W+o6yLC2bBIMN9RGk90BwiSYONMA0GCSqGSIb3DQEBAQUABIICAJpoTC2eNTL6
# XtyXS2NlzFsIH3Y0ClU0NyB8c+LwnW5ZqgpKLfjL0orzeEfi51Ralyl2omj7z26i
# TWWE/DbZqwZe+8wqciA7BzkYxpocleOGbPLTUVAoGkjN1MzKdzOLrEMybH0VLHJO
# 33EGztKuBMFJU3dYeswQHlrVAmOx+aYCTJ+giO5kp4x1wmawRC6f1eOhdvld8oVf
# 2TbravocXLmW6WCcgoJm5S1mzWwBtqQMS7prL7wFFqkuahM6G0K4XVLbyWBrqkXV
# 06PXtCZCm2ScIaYtJCLvQD98e3aPDINWAAbHm5qb4qLpbriO4J8mvxbYbVwitjmr
# bBId5TB6+BoZr70T2jl+PD4NgzoevAacO7h21pLNLKzYlbJVS87IYozp8CT5X3k5
# UHGWcKBoL5Ps9Bxgg1bTqZsvjzk/aufj/v9Lo7b5YDZb+XJ+0qR24XWnh2Jl/HVc
# ye4nEpDMcbnfhw5l1IjArnYyHUjIfyzB5Ct1QXz141z5DGCa4tbQx4q9HBA+T/hE
# R87TSBqcvx1UaK3royMOrQxQos0+ZmHbjM05CKdcYERttkp+JXFBhMTimFqrSC9P
# wKFVcq0c/20h1Bq9RWGiKVwNv6HC8ObFNcaeu4DKGQzFz8KhT0BtTGemFNCPXYiB
# KSHxVVjZKwBo7Old/9JnCrzDgQ+wXjRcoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IN6sWsiIWuM3vBgHlr2t7kyqVmv21PPv10Y9o2YpjFASAhEAwIqcRpH0TpNO+iEG
# JDD78xgPMjAyNDA3MjQxOTQyNDBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQyNDBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCB3kCMhPGQNBNdTi8yaR+Fu
# BqeGenoNFzc1i/qdGl/lqDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgACVxRh
# RTW/XzMq2CKdVvv/lODUSuf9ZUgaiJc+fBbA5J6Mzu6SFTbVMsafJ1fEdq6FZqA0
# iInItPZ5K0qMYnBUjmexIGOQtzBHIi/5CDCW3ebelUlQhHuw6KVsJygbOGAO/nhI
# YEQkdl7lEEaJy9bLWv+nJVVLSnNLpSGKUrsEJNeRvtH6Aahd01PKWcYivJTu17Re
# 2ecv2pqCuK0qvF4lQo/p5JXlooPFymwuYLavcpz6Bc8C34FCVcQxCFEuZ68Ytpi1
# Qv048N0S3mdTPFGiKMLhtUrXhD7DT6fb1Fs8g+NQo3egRk/5I1+7nBTVgRMLcQaT
# HjcykFRCvRaGh64B/P3gyf0znvAffABm8Q6X6sbgBQtKZsPdh159+8x3zEWrTrNs
# 4CK1uRUhnNgLVbvGKizodnQGX1DiSpU2CKtWSOs8KPNrmEhnjZ6PO3O0xvCE8OGw
# I0jCR6ZM1nmUBa3/S9xFr1PF7lSw4x6h0m0p9DgQ1b5n9ofMUgsvXLSGs5D5eVcS
# est8Tz2ILbDiJHj2GpCLgYMMLHpjKSsJ3g2JnUHvhNcqeTYmBQf6CAkpmUTKvcVp
# Nh7AiA03ZEAPgAgjHZ+YNoTkTSMw23e/EX09rSnWcaAFNcxgJj4ktP1k87EzA6KZ
# g2+UOM5L634Dj13LwjjlUzBZw9Q50wRB++MoIw==
