...
NamespaceManagementNetworksIPAssignment<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Networks/IPAssignment/
#>

function Initialize-NamespaceManagementNetworksIPAssignment {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Networks/IPAssignment/")]
    Param (
        [Parameter(Mandatory = $false)]
        [ValidateSet("POD", "NODE", "SERVICE")]
        ${Assignee},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementNetworksIPAssignment' | Write-Debug

        if ($Ranges -eq $null) {
            throw "invalid value for 'Ranges', 'Ranges' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "NamespaceManagementNetworksIPAssignment"
            "assignee" = ${Assignee}
            "ranges" = ${Ranges}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDvjNizQ/z13kcy
# 3YRK53hcn4jSVqU+2p0AqWeOqhyfHaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIwZrNlr3Wo55ylh
# gGAliu+TYX5LoLL60003rLU5yiMjMA0GCSqGSIb3DQEBAQUABIICAJsBc4nqt4bj
# KQncG7zJKZn0LTXvbeicAZV5YS0JLmAmqfUcNMesRlL1X2Dk4AxHWU+rBANg21nW
# 0+DRnRrpnnWXSOigqGSKaUi05wdLDMZ7/GH9R7I6nuHSynVgTzp4/BXkyuoCznY6
# E1AGqvx1z/9E05jXR1dT9iZwwq+AbkH79jeUAafQclx/9/TRohkL7Jl91DLQFrsu
# GkonQbHV81Z+rzBufm6VgjGJ/l0F//Ss8zB3aSXnMKNA23sGB846lBt/w0VtTTrY
# E1/0c8possJNYk2JvMIRJ6OchqqSNMElGbDeh63MaEbE/oiERV57M6ceyEwBDEGP
# 4OMtMrKL+q3EmaFhy+XygxtWcngtaJ+9Ax1+9GaBi9TnY8jLij0IZd1aPNCPjPQt
# 0wTlH76K4O5oR/VGp/4qT0wifZeVgXYl6dL4C1nEchO3OMM7224JOF3PXe8F6TQE
# CPo2aYJ3b8ckyiEPYzKC//7qZz8uf1ngfiU8bSCQv8xyD94f3DbPiJWJ6FLQzoE8
# d7kqrMizER7Ra1a8Fw/3+VbT5UTKis9UBu+6K+QdJVVi7XWYRi4P+qoDR67JPS4F
# 6mqEOYsImpXDu+pZToszjQrJBmeEf863U8GAK6J7C0S/dtEpd86PIjUXG9fDLLW3
# h/hTjltXssQHythEKjr9iScNTVdRY1/poYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INXPwnRIkewoROoSxtqxYyGlkrj5vhb3q4qAeNgPCu7rAhAieKXVTMr3MGr0vUGG
# SMC9GA8yMDI0MDcyNDE5NDIwMlqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDIwMlowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIA+E4l8A1Mlij+cv2FLeE8M3
# qvzDNKEF1BGh77EFQBfOMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICABIqJEjG
# 1iAtBTfJGsnEN3okxtL3DQJPQXTSEMFtJn3V5Gtd33xn+xtuX91PCeBqlp4ffT10
# LThasP+LqTynJnSPeM1lu80TVJqMe6W/8haoAZ85f6eUXYPa4DAlvbQlj58shI8h
# tvC6dniszPI3FsYyBHrdUCt7hEmJsfGx9r9nfNwDP/gyTGiWq74pWI1qSypeT2iD
# yryNeTGp9+k0ualxsZG8VK+0rwm2V9C8Ov4PcU+rhCDPkvjigw1rRONneXB8e9zi
# ikbk0h9KKZ4o3ovGMZUNgJBNYjHWnttDOS9yCA1cm+XNjuRWJH2q4PN1em9UYgIl
# wOti4pYslg9XYtZwMamJPXjE0OA1MFgr9Ds7V0GHcNdGXPiZHRWbGNNjp/fkJIlb
# lTBnhWzziTpglUwpJZbIs9319FfrgGbpSszlPPov/avryg1SGBUpi9E7D66SFfg3
# mq65wLeUqYYPJIwnwQUtv2u+W10hiahL6j+O4CSJZKQA+n0n7f39P1GgcuiwOVSs
# /EjcJXC2wE88ZNdJr6ZHYzPhBNfaDEbH/SNdFGjNalmVvLmdLWwpE3uIES0nL56l
# GnJ26E71ziixR0KcKg4BwrHA148f/Agwqbn1PIya3UeB5fZa8Y1wo1wBcxOT3Iad
# 8KWR9vnv0vCc36TMg5mmefSHOnoa8VcXIIPY
