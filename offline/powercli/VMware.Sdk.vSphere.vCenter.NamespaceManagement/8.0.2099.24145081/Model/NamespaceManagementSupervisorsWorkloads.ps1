...
.PARAMETER Edge
No description available.
.PARAMETER KubeAPIServerOptions
No description available.
.PARAMETER Images
No description available.
.PARAMETER Storage
...
NamespaceManagementSupervisorsWorkloads<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/Workloads/
#>

function Initialize-NamespaceManagementSupervisorsWorkloads {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/NamespaceManagement/Supervisors/Workloads/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NamespaceManagementSupervisorsNetworksWorkloadNetwork")]
        [PSCustomObject]
        ${Network},
        ...
        [PSTypeName("NamespaceManagementSupervisorsKubeAPIServerOptions")]
        [PSCustomObject]
        ...
        ${Images},
        [Parameter(Mandatory = $false)]
        [PSTypeName("NamespaceManagementSupervisorsWorkloadsStorageConfig")]
        [PSCustomObject]
        ${Storage}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.NamespaceManagement => vSphereNamespaceManagementSupervisorsWorkloads' | Write-Debug
        ...
        if ($Edge -eq $null) {
            throw "invalid value for 'Edge', 'Edge' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "network" = ${Network}
            "edge" = ${Edge}
            "kube_API_server_options" = ${KubeAPIServerOptions}
            "images" = ${Images}
            "storage" = ${Storage}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBW+G5mmoH1UIkb
# R89rMMawKBmCG9c+VD6HTFCSPFkOC6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDfI48xIj96LzlR9
# YodrmooZsgmQIBY96ZpX/ZO/sMAnMA0GCSqGSIb3DQEBAQUABIICABGhPnGRk4g6
# 66tQHrPH7e8zy3r4PQS1uhFi3H9knHBbQiHyN3MqnJsiTWLYTRDTV/1CVgC3aZ7j
# gkiUV7N/YrewDRyH3VhSEslhoWBxZopY7N981mn8anijBFZHnS00rSBm2zMm8Uj8
# ydsS+SUGQK9f/hRdUFoWs3Lx5hM2xHQFWFU3glm2iWHBX5uyhPTmKurhbmZYKsN6
# R1OE+ydHAZ3EzccHdYdOdDxiZxuu153aPJaX0R1PkYM1EkFz6oiZ5DgFg9l42rQy
# ckDvsNGNKNe2b9A4uwhmZJJhN/lelB35PKJFwFHLMpFkED6Ri097zdF81P5y3ygx
# sUEN4KA4oiU0pMBror4+Jq/Qg88tlZOf3nrL/VqXCjzl0yOchuicfbwOjRnne9FG
# pHwXtbvgXoiH6dldw37wleTMeLOBJ7R4ghjkRw8b2b39ObKekgG+AaSlEF0eZHwI
# ldMZYpI3ZI0RJUdjAiWxpivMN23VjJPEthdKEcI7GmCSxsjPIEwE3cT2nZ0RVDUF
# t+g3r/u0qdm2U1UiqPHrRGI99QsdMwI6+AnczCuGFl8Z0ywdUODiyL4Rz7njVSUc
# Yl5wOVtKFkRWd3UVg0/O8id7Hudt2SNRTxLG6mp/MnKgT4b8l0b37dM7CV24SXyy
# ygeK5wkErNnhpC3saeP+Vd2zFNhc6a7RoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IFmRqKt75veu3dh5IaPtDOwdKrG/GTdzTM6cAv0axftLAhEAnUD6dsz5IsogfmRM
# S6SbZxgPMjAyNDA3MjQxOTQyMzZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQyMzZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCATsye0PaduADyt7X6Nb89u
# cdf3a7YDNDpYkFPGCw018TA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBBnqpy
# LRffSSEKUDkbFKSxARq0b/dZ85O3vI0db1rkWqROcF5P8xsq47PPtGQvKkZSuQir
# Z0PqZCKjaR5eJh438oLwSP1z0UpAO919Ga2iHXSsdE8Tl7DvgeYJraT8JS30q4b6
# cGM42krrkep0ts8FcTY9tX9Pi+bFZPpU2cifHwsV2NwJHxGKZTAFegMce3BS16Is
# qeWmYaylzgxpnO9pWRyQcigDsJFQCVIULaJHbo6vQj5GX9Mv6JFQjAkn91IknRxo
# IuyV7BP195Yz4CZdCmY21jq4H8T8LB1d5bPGn1e2efSbedJ/vSbpKqzRr6iZxqA1
# 8vmi7RxpPkaIe9AXjRmROM4itYNU3JAKgOcuqiuhdu0GPjGQPiFfYSJ04eS8rSUE
# BOo0mrq3oRye+dcTCtt3Mhd2LjbRQyhrdM8pcek1whlVXXlyAHE3rF7amZsaFdNy
# o06xIiNIiYHe+o9oNoWWYi1GY3yv0HIgLfJ5w4d9zAWk6m6rhOSXeopYJhHXt0O9
# 5/c+1zk61iJ4FcuC4AqirSsQN5qaFOcGX47AutpOmM3UlwfbQTW18JIdsDofzagi
# DUkVgJSWMcmbJsfmxb8rdabvQ0IINe86n8WZJ+/7/1JcAL04iRg8CGMsxCh1qXsB
# 6eXXPLZNfI5TMKDD/GLgP0t8boalYEgyVc+7pA==
