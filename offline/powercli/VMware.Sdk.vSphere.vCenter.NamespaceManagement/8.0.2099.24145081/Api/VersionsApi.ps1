...
.PARAMETER NamespaceManagementSupervisorServicesVersionsCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/post/
#>
function Invoke-CreateSupervisorServiceNamespaceManagementVersions {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/post/"
    )]
    Param (
        ...
        [PSTypeName("NamespaceManagementSupervisorServicesVersionsCreateSpec")]
        [PSCustomObject]
        ${NamespaceManagementSupervisorServicesVersionsCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateSupervisorServiceNamespaceManagementVersions' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateSupervisorServiceNamespaceManagementVersions' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisor-services/{supervisor_service}/versions'
                $LocalVarMethod = 'POST'
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling createSupervisorServiceNamespaceManagementVersions."
                }
                ...
                if (!$NamespaceManagementSupervisorServicesVersionsCreateSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorServicesVersionsCreateSpec` missing when calling createSupervisorServiceNamespaceManagementVersions."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorServicesVersionsCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorServicesVersionsCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorServicesVersionsCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorServicesVersionsCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorServicesVersionsCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorServicesVersionsCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorServicesVersionsCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorServicesVersionsCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorServicesVersionsCreateSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorServicesVersionsCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/version/delete/
#>
function Invoke-DeleteSupervisorServiceVersionNamespaceManagement {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/version/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteSupervisorServiceVersionNamespaceManagement' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteSupervisorServiceVersionNamespaceManagement' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisor-services/{supervisor_service}/versions/{version}'
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling deleteSupervisorServiceVersionNamespaceManagement."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor_service}', $SupervisorService)
                $LocalVarPathParameters['supervisor_service'] = $SupervisorService
                if (!$Version) {
                    throw "Error! The required parameter `Version` missing when calling deleteSupervisorServiceVersionNamespaceManagement."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/version/get/
#>
function Invoke-GetSupervisorServiceVersionNamespaceManagement {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/version/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetSupervisorServiceVersionNamespaceManagement' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetSupervisorServiceVersionNamespaceManagement' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling getSupervisorServiceVersionNamespaceManagement."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor_service}', $SupervisorService)
                $LocalVarPathParameters['supervisor_service'] = $SupervisorService
                if (!$Version) {
                    throw "Error! The required parameter `Version` missing when calling getSupervisorServiceVersionNamespaceManagement."
                }
                $LocalVarUri = $LocalVarUri.replace('{version}', $Version)
                $LocalVarPathParameters['version'] = $Version
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementSupervisorServicesVersionsInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorServicesVersionsInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/get/
#>
function Invoke-ListSupervisorServiceNamespaceManagementVersions {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListSupervisorServiceNamespaceManagementVersions' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListSupervisorServiceNamespaceManagementVersions' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling listSupervisorServiceNamespaceManagementVersions."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor_service}', $SupervisorService)
                $LocalVarPathParameters['supervisor_service'] = $SupervisorService
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementSupervisorServicesVersionsSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorServicesVersionsSummary")
                        }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/versionactionactivate/patch/
#>
function Invoke-UpdateSupervisorServiceVersion {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/versionactionactivate/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateSupervisorServiceVersion' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateSupervisorServiceVersion' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisor-services/{supervisor_service}/versions/{version}__action=activate'
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling updateSupervisorServiceVersion."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor_service}', $SupervisorService)
                $LocalVarPathParameters['supervisor_service'] = $SupervisorService
                if (!$Version) {
                    throw "Error! The required parameter `Version` missing when calling updateSupervisorServiceVersion."
                }
                $LocalVarUri = $LocalVarUri.replace('{version}', $Version)
                $LocalVarPathParameters['version'] = $Version
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/versionactiondeactivate/patch/
#>
function Invoke-UpdateSupervisorServiceVersion_0 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisor-services/supervisor_service/versions/versionactiondeactivate/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-UpdateSupervisorServiceVersion_0' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateSupervisorServiceVersion_0' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisor-services/{supervisor_service}/versions/{version}__action=deactivate'
                $LocalVarMethod = 'PATCH'
                ...
                if (!$SupervisorService) {
                    throw "Error! The required parameter `SupervisorService` missing when calling updateSupervisorServiceVersion_0."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor_service}', $SupervisorService)
                $LocalVarPathParameters['supervisor_service'] = $SupervisorService
                if (!$Version) {
                    throw "Error! The required parameter `Version` missing when calling updateSupervisorServiceVersion_0."
                }
                $LocalVarUri = $LocalVarUri.replace('{version}', $Version)
                $LocalVarPathParameters['version'] = $Version
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/WI8AwpZcdYH+
# asuyAgAoIRxR1W3o682OtHk4R/allKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIE+6Qh1/Ui3gd8w1
# HhR+hk0LfXuoIoND+674RwLJSrsaMA0GCSqGSIb3DQEBAQUABIICABTD2z0xRSrv
# 5UMhMYOWqJI4fU/W/ewt+eUWTbvk+gyuMXRdfXXANOxpQ3fQWDMvMWB+1BpxPvJh
# 7RwR0pUyhSHe+itT7jSphi9hGSjfA30n4EzBXk7Mtd368nfwl35M4W2R/FlcaT7t
# ODtGstHiG1aZ+GcJ80Plip3cuY0AidtbQq6MvrGP1Ch7z2WEwWxn7qyFuSRwfZwC
# 0lKnlEYCOjV7g6kYECSksp85PokvJ0ueLf5kRygm81cY5Boe1FlGJb7RdqFzS6eQ
# BPDnG2f7/kjNd6Sxh5iIdC+oYebEXEPvtiyGbZhffIK+N51BeQoyn5/akEyjh3VJ
# jQ5b7U/fNJSTXah/2mAwv3VVJngDf49XvHQ6TSkjg21GMEGN/aBpdl7hPsc0a/9F
# lGAcJnvVFCmX253qq5d6PXxN3fDOND6TitsGf5zHyZ7Q0IrR1QEEGKRSrkDG95jf
# lIDes4tjiha+M7B7wuvSPxgrjDnrsfC+quAHygNSo3YWAs6WtCSc0VV3xLYak2n9
# ZCNu8eRYckYTR25Zp35IsEcovubEt/ce8wPLLzKw91SGqwOntCqDzC1FePnFdQRN
# aCv7aXA5cJNZYEgd7XvNLioF2lOfsV29eUlg6JkebwPGiN51mxgCxjDzGDHpgxlM
# B0h6gRNWBaE0NfkH5L3Zy9MigzK0NedJoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IPyXxLRoz8nc1bgrlzw4Unsy++CwOW8sZ5a7kcj15jGgAhEAjItYAnW9P9VT4utD
# bCoYxhgPMjAyNDA3MjQxOTQxNDBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAqQagMeS1Tdk8N/Wn7bCFJ
# GhJeg74IgjUpTpSHbhz8KTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBlP/7D
# dQRJLsd5RAyBBrT486+IOF8gArrYldK0VfnzIUfdULkbmIdeaVvmvlIfwiziTtI9
# a/s2CYivF5Mxj2z3kYYt0UHniV/xBupwoQEmg3VwJnQhIQVbKNi4V4xoVCSM08pZ
# /rmsjomm8DQZNFtqa9N7KqUSuCHuwPIUYQ4Oojvg5LzhzPwibDtwFczi4ghwhozL
# uSVRjJKPJUWPFNQzutBdeUEgeUZhRNcU6DHvYMQsZRqlLiF8JnP3dbo6cZ9c55U0
# ZSge40UhTmAJnvsN8Hc8MDnFkAZOhWplbtBDCLgsxjzv/uBEl56ZIpdk4vSOi8Up
# yugnLxtZz083cE6VH+GQA3BAoRmUkzspDElL5xVjh2hT27sxm9ZXmQgOYIM2S2de
# jWBBdefYezcN7zD4OSY+tdVFOudZMxqBNERZmfhKmwuQqsBWaWIm2MVK9dDH+9Ua
# VbKNlvbjzJSoHMqwgJIs3UmyDRTFtpWj49mIAEl3QrvdFaMZWe1xwkPI871ZpwRm
# We7QCIHwz48h0yOjmZb6SUbJVJv0HXJs+5vEPbLeSUYVZ5CsHFg0nfF9TvD+rgQl
# gZb0B2ewzIe7TMEJQJ3JTY5uLDupZaG++ooZoEWuLXIxmvO1LUtQAGqUVrGHZ6TV
# Y8gV//pfMN7xrNji7p1rBUhTxz/V+GS1W7kNMQ==
