...
.PARAMETER Id
Identifier of the load balancer LoadBalancers.ConfigSpec.id. The parameter must be an identifier for the resource type: com.vmware.vcenter.namespace_management.LoadBalancerConfig.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/get/
#>
function Invoke-GetClusterIdNamespaceManagementLoadBalancers {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetClusterIdNamespaceManagementLoadBalancers' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterIdNamespaceManagementLoadBalancers' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/clusters/{cluster}/load-balancers/{id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterIdNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Id) {
                    throw "Error! The required parameter `Id` missing when calling getClusterIdNamespaceManagementLoadBalancers."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NamespaceManagementLoadBalancersInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementLoadBalancersInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/get/
#>
function Invoke-ListClusterNamespaceManagementLoadBalancers {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListClusterNamespaceManagementLoadBalancers' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListClusterNamespaceManagementLoadBalancers' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/clusters/{cluster}/load-balancers'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling listClusterNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementLoadBalancersSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementLoadBalancersSummary")
                        }
...
.PARAMETER NamespaceManagementLoadBalancersSetSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/put/
#>
function Invoke-SetClusterIdNamespaceManagementLoadBalancers {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-SetClusterIdNamespaceManagementLoadBalancers' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetClusterIdNamespaceManagementLoadBalancers' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling setClusterIdNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Id) {
                    throw "Error! The required parameter `Id` missing when calling setClusterIdNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
                $LocalVarPathParameters['id'] = $Id
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NamespaceManagementLoadBalancersSetSpec) {
                    throw "Error! The required parameter `NamespaceManagementLoadBalancersSetSpec` missing when calling setClusterIdNamespaceManagementLoadBalancers."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementLoadBalancersSetSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementLoadBalancersSetSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementLoadBalancersSetSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementLoadBalancersSetSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementLoadBalancersSetSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementLoadBalancersSetSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementLoadBalancersSetSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementLoadBalancersSetSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementLoadBalancersSetSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementLoadBalancersSetSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER NamespaceManagementLoadBalancersUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/patch/
#>
function Invoke-UpdateClusterIdNamespaceManagementLoadBalancers {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/clusters/cluster/load-balancers/id/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Id},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespaceManagementLoadBalancersUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateClusterIdNamespaceManagementLoadBalancers' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateClusterIdNamespaceManagementLoadBalancers' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling updateClusterIdNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Id) {
                    throw "Error! The required parameter `Id` missing when calling updateClusterIdNamespaceManagementLoadBalancers."
                }
                $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
                $LocalVarPathParameters['id'] = $Id
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NamespaceManagementLoadBalancersUpdateSpec) {
                    throw "Error! The required parameter `NamespaceManagementLoadBalancersUpdateSpec` missing when calling updateClusterIdNamespaceManagementLoadBalancers."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementLoadBalancersUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementLoadBalancersUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementLoadBalancersUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementLoadBalancersUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementLoadBalancersUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementLoadBalancersUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementLoadBalancersUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementLoadBalancersUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementLoadBalancersUpdateSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementLoadBalancersUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD