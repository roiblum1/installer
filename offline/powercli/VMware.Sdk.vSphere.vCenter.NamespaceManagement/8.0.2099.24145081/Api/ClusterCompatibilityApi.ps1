...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/cluster-compatibility/v2/get/
#>
function Invoke-GetNamespaceManagementClusterCompatibilityV2 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/cluster-compatibility/v2/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetNamespaceManagementClusterCompatibilityV2' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNamespaceManagementClusterCompatibilityV2' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/cluster-compatibility/v2'
                $LocalVarMethod = 'GET'
                ...
                if ($null -ne $Compatible) {
                    $LocalVarQueryParameters['compatible'] = $Compatible
                }

                if ($null -ne $NetworkProvider) {
                    $LocalVarQueryParameters['network_provider'] = $NetworkProvider
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NamespaceManagementClusterCompatibilityZoneCompatibilityInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementClusterCompatibilityZoneCompatibilityInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/cluster-compatibility/get/
#>
function Invoke-ListNamespaceManagementClusterCompatibility {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/cluster-compatibility/get/"
    )]
    Param (
        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [System.Nullable[Boolean]]
    ...
    Process {
        'Calling method: Invoke-ListNamespaceManagementClusterCompatibility' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListNamespaceManagementClusterCompatibility' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/cluster-compatibility'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementClusterCompatibilitySummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementClusterCompatibilitySummary")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB187+sUxUPaLZw
# bA6V5kt39hLerTg3LzTnTNRKZ8briqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMW5hRQxf1b/qr1C
# ungBkXuVRrbhkV4+tHmWl+WS0o0rMA0GCSqGSIb3DQEBAQUABIICAHvgsFE33qzv
# 6ISFNXCl1vQWHncWdijJxp/imw98/DV0+4Hl6LJE+GFnkkMFMUNWUNB5bUisDS6H
# rbeP5/cdpvJ7KUzTvvU8lvHhRrbRlCoaQ5h+dL/aqTJcqQK6gj1qwc6gybzvsduk
# 1TrlGTdD+afOwiRFhP8yyZfXbINNLzJKVwXFLi9INteTxh0KBdYmkIuJk/qc0Rkk
# aMI7HFajgB+vJaIzYZvO2DKYHpu2Qllxjs+8+9NjfwOl4DQ0HqqCkSy/ZTEsmIhh
# mH/0OAbCZQaLvG7hW8iU5x9BTD3PKVlDREgZeRCPEnT1WHI+TFyKmsKezcDoBEUe
# LOKvIwlSXrWUzkuchH5F8cShwE29mXQk3nadnSxEUvtn96jEy32MD8L+FjtFH7u5
# XXn0Zkaty1IByMpdkq7LPPqq3xLBaQ474sjQRGRLwgFPExZhlam+9lZ72f6N5GJt
# ixCpchrky3lP1AotjBWH5H4Y7z90UYBHA9TlnMegfZ2V0fyxor5DKyXiqoDqHVoK
# WtbnufQ6U+ZTGq2asSTHWshF/SU9q7RBbOx8CRMeNZXL1Y2RZc+jStFoV9MsGUSk
# ucBLdbb27r94Q/WkbAVWp30kI0ickhrTV+KL6IixDKwvnB39ef0jWuWSLez9+JUl
# thAraeoXw3q3vU1hoOnkgIxhp0n6mjTgoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# INnj+ZV3u4fwv4mo54hbHXnu0qUj6NJr2JFmB5gIqmozAhADuHyRl0T/40M8TaYi
# wP2nGA8yMDI0MDcyNDE5NDIyMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJ2w1LVFL0414hIEbz8YU4ba
# 6y7aHlmATXYgWovyH8+1MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAD9v0kRX
# BajBFc3xY+bmSdYo9poJXePJhfr0fdd0ytwVLJzWI//katgcZZA6fUnKCDbMllr1
# hO6BDIToywN6DGKk+uqkMjA2UvKudYT7VzbicwHGkpBsswQA/s5ivBIkG/Vr9UY6
# sneQZy/LjxjJd0QqTlJDvOpVXFZJN6sJyrH/Z12sGyx+XOiVDXF8bxqb0NXNl2bc
# Ik+G6J8NA7vq9MldUxvE6+Gr1A8MtGSjUC68PmQr8cEhAqjt1P5qOqVn825GFDmq
# yEiAHByCnTbQoZPI2+vcCirCKwpeDbJGWTKUJLTWB0S1OjFWtBpdZFYo9MKsKGLi
# 7fEysW+BKIL6NFJ0fQ7j1vbdbKSa9LGfEFTukqM6O++Fvgk/kTZIX7YL5SkcNbhk
# NbEpEY1MjWg/uMThwl7nTssR9V2O7nAMJ8cCMk1GZIFGy/VmFuTovvYg319mKXXX
# M+Md32Aj/7Tp1CzAZbdJ22Aa6HAHAcKRFJq7yESbkhn7ElsuarWDUvgqNERwEBkc
# GJaIv24xMMvsg0EjIKIhyTeshKQyY3ChT8P0OZq3KwO8wKWhM1QoWOvvIGxEYRRm
# c8IrYveCmgpECMgw1O4S79qAUlqtj3NoIjglet9AiLq706c2C7hvBPh/rlKbJrqu
# LJhG5BUp/bsS9Y5KYAeIlkRTZMI/6mDIw8b3
