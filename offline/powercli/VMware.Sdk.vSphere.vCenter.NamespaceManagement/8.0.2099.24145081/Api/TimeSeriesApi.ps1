...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/stats/time-series/get/
#>
function Invoke-GetNamespaceManagementStatsTimeSeries {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/stats/time-series/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateSet("CLUSTER", "NAMESPACE", "POD")]
        ${ObjType},
        ...
        [PSTypeName("NamespaceManagementStatsTimeSeriesPodIdentifier")]
        [PSCustomObject]
        ${Pod},
        [Parameter(Mandatory = $false)]
    ...
    Process {
        'Calling method: Invoke-GetNamespaceManagementStatsTimeSeries' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNamespaceManagementStatsTimeSeries' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/stats/time-series'
                $LocalVarMethod = 'GET'
                ...
                if (!$ObjType) {
                    throw "Error! The required parameter `ObjType` missing when calling getNamespaceManagementStatsTimeSeries."
                }

                if ($null -ne $ObjType) {
                    $LocalVarQueryParameters['obj_type'] = $ObjType
                }
                ...
                if (!$Start) {
                    throw "Error! The required parameter `Start` missing when calling getNamespaceManagementStatsTimeSeries."
                }
                ...
                if (!$End) {
                    throw "Error! The required parameter `End` missing when calling getNamespaceManagementStatsTimeSeries."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NamespaceManagementStatsTimeSeriesTimeSeries[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementStatsTimeSeriesTimeSeries")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdN5fSCseD6L93
# uqvJyT/KKVtMjiwwPnu+nUf1NbBU0KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHJO5tIUJggE7qh8
# 2G5SrPdOSKnDkK/GW901tXymt58qMA0GCSqGSIb3DQEBAQUABIICAHl3zrJeUxKI
# M3ela5dlDXU09QOYhfyTPTti+Z/4Kn1H3g3ZgDzr9SpT04aPp+Lmy+PEbTPs+lG0
# qi/+7vtqSp8JFflfUWXUK0cKlVeQ4hg+3/2EfcvrDdP2avmifiJLc+qfdygxbaSt
# FH8ArPL3A335Fy3qTbn61ng9t9XsOXCDdVJS5o3m4ufugsOUrOUAykgPwI4/EehW
# 51IbjkbiY3x4dJarhRD63pu+5KZ/F68CJcEYYeywZSeIMkb9M+hSexvHD/fctISb
# HuvEe+2KhG11apaeo2UKXDaWcOZM/owKG2hTNjMUDNdw8fPIwu5hdvXSL0zi9MQN
# acoEV85kwTHsyjuqZ051M28O2dWQW3TC+V3AgQXkqgxXoipK2RUjVKFlJDTFWDAE
# TPY4vkFix64F87RGahIPd7OeYo3gRXx4ZqIJ2fdzYJV8wPSanBaycKAwf97fD/7P
# N29LFi5tM7JySczMvhiQN0g195HD1KodXla7rlrI7QNni3QkziceQQ9GgOJ+uNma
# xquIQCGUM0t1tRlMOl5aCbD1yANqXHua/fbjvGk0IdF7IGWDMNZhPk6F5ax8/IJd
# L0M5mQysiBiyHq7A+m92gvA3OqrW6p09r2MvVsPuo1i6ZjlsmpGeKwdEkxvgTvv/
# nTG+939aQha8I3lQZpJ16q3x6zXMXzKboYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IOMwUTl881i0LHO7gWiA/FnVphOdAizvS27oRzPCk6BaAhA6vOlu+MMZjyo7s6QA
# J/AEGA8yMDI0MDcyNDE5NDE0MFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDE0MFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIHTnq5lZC55Q+yAG3A05sO3Y
# TdgbBqacWus8dUMq/qLTMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJ3MJmkF
# ZP82plRYAC+5J7SyNePjo5EiCwBKQxtMFT+xVE6owRFs77seznycHpCDliAdsmWH
# ReYCZHthLrqsfwa69vJm1PnELR0GDVM51gtHjF5T5tOGQE09nYOAprY6EcyuYqYD
# khxOuC9iN6sJ+fu9ihsfMc4fowgrgNVbfEg383xOsFov+quHVjHLTGTzdU1wvdxz
# 82S27pV7pZqID5Jr0r5OH3O+yg5GuwiUOMpiI8UpCwn1P1JDmscUPubvdgY4DJnr
# LO8x0AMPU8S+TrBZR6REJKfSPM3XlqZAF4duQPlHBvhN8+Ee8Ws4hS3ziSX/3MJA
# Q82GzPBVrsNNedemGoiconE4pz6Vd0Any/QWWjpVASXeYFd621chF6UW3jdQ7rwP
# DhDF1AK9TuUaIO/0nHwmZELxKCRUhxKYwrMqUNQOnmYxyIAiw1z/6BEFBZClunxw
# eEOcYhyoQrx8L/H75tBgsPxqJRVvzzv+mV4i2tz0MkHunOGb8+Pq9PDLWlrYibjt
# CthornrQ4dPTi8L6hVOE2xiGzXS2ykD8PwqzgWFbV2Sr1l6ArSdylu1jUHoRrW9T
# 7ywqqU/ToES9SmEBjQvaDwfvcc8lmkEJmAnby+LWwv3kzHnA76gWK3qptWshi4Oh
# /LezthXYUjghIOS/4Z7he0QXL66Jc21KRK5Y
