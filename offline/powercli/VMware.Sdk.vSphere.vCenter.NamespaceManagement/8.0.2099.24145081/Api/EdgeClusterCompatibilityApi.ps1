...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/edge-cluster-compatibility/get/
#>
function Invoke-ListNamespaceManagementEdgeClusterCompatibility {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/edge-cluster-compatibility/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListNamespaceManagementEdgeClusterCompatibility' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListNamespaceManagementEdgeClusterCompatibility' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/edge-cluster-compatibility'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling listNamespaceManagementEdgeClusterCompatibility."
                }
                ...
                if (!$DistributedSwitch) {
                    throw "Error! The required parameter `DistributedSwitch` missing when calling listNamespaceManagementEdgeClusterCompatibility."
                }

                if (![string]::IsNullOrEmpty($DistributedSwitch)) {
                    $LocalVarQueryParameters['distributed_switch'] = $DistributedSwitch
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NamespaceManagementEdgeClusterCompatibilitySummary[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementEdgeClusterCompatibilitySummary")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwb4MpKh0ajrJy
# VUXv78omnlwfGDJ77W+psH1ngIBPKqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINq+9xlGHuN1q+Oz
# 3XZyOXHR6kUz3CK0J1QVm+5b6bzvMA0GCSqGSIb3DQEBAQUABIICACkVubilywHu
# ZD0W3iZRCMklWoGipnAv4XfEBCXTLagSu8N7XxaY6y0cpWkNPeCP3s0bFGzjybd9
# 2sSqREbQvKYNeQ/Wg9tpZfpI+M79dzRfGFQgh2y2e81JKddnGJxXwJLOU6TmXYz3
# b0qrGoZzsppjYviSc0jD15K0MOX8+owewVNpGBVnXUnk5DtaamstEHrDQM+0VWzd
# 53Ebs79pVhDk7UBvNQBdPj3vIC0mKq2ZypQr1XMQ7QiWgOpk+z9vbtjJHm9oakeo
# YAAgH9U5gLBgG/DQZE+S2i8XJurffh1wHiWZIGvmacVpSp6Z+6qBhxulyu4MbWYo
# MPKBlzzhto3kTcNny45k6CjtC3745dAS8BgNkt7w0iilwkyVovIGNbEnmnCvgYbZ
# uvXkM/LdFE9pdBXHV/AY/JEqzjxPXbcb1H1Bwy/rEwQo5bIO/KkR2CmPdP9XEbxu
# a4wipl+WdwYn7jWCWtVDv4V5GPuFOVeVvHH1CYwIAFolR7P+vWbNtAel8X6Ykf/9
# dZvqtN27+KbfhIWTMw/srmwIqWEnaIWHO1zKYYfVzlr/WWwSxcYYKcA0Z0xn8RJy
# y0uw77w+vslVsVGU/NWYG68uLUWWVnShvigu++E76nFNqdI96jeEC44tq/ATxPxh
# zxx+gv0/4qoFanuVG+picFqc4LfV8P5MoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# II7SXgSndoHWAOp6S2JuzioK/kRMTEap51p4NN2XT1zsAhEApe877cWLdoQ8t3iG
# qcxFuhgPMjAyNDA3MjQxOTQxMzNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQxMzNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCwiwNQ513G+v+DgGHHlM+N
# 8ttIPR5saaFR4KbAH89h8TA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBAPOsS
# KEFu5eXhanLHSuKctT5d6SMzjd4P2cysvUt8VL+A5KKD1Bv+Xd6yoDWif/IBtKLX
# 01OEdgrV33QVSs2BWNIwzCCYpOFGrSuiqu6uloy8KvcC5C/GNY0gdX+2lrm6bD0U
# DlqOLEoYEyNX6XzKpdTzx+tQUosxPfAXXa0ZiCK68zguAYyqj6NYrWtxJr6mxDv5
# T+a2w+v+tgroSJboip2LKeiuLEJnJ7n8H9bR2iweqbglb/a0nuERohZWkqiLaMmK
# 1m01nmydr1RZEkM+/AqpCT/58FCV4XVOIA/f3TgGiftm8V6N8ydOtGDkNOqpMlAN
# QetE6rO4i7Ls3AMtt7BwJwP49/DotlF+VxkgoOes4KtoHEeAU6JAAb9oH5Dgv/Oe
# bK+B6sXGKceyrsMLmeTpHH40fUVBvuVCpVUtiZDwjIyCWVJea1njuh74BHoA2ErT
# dI9T537F3TyeIfPjjZtC18rcUOmLIUZv+TrruKb2mv87oDKbn8YCbYtI4PxT4Eju
# 5QDCRTVwMYQpRFQzXCQ85HXjR+n2t9AR0ki6t7HZY0F5lYSLipug6J+ydsw/qlA5
# Yhzxmr3YDpAiZJuv0DKQzR9wjFoID9zIuLfsQu6uskjVsnmvlh0AB90/bbOtjgpp
# MK3ER2RzzwdejRGB3kHyP7aIVmEZNGXy2IHkmQ==
