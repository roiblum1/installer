...
.PARAMETER NamespaceManagementSupervisorsEnableOnComputeClusterSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/clusteractionenable_on_compute_cluster/post/
#>
function Invoke-EnableOnComputeClusterClusterSupervisors {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/clusteractionenable_on_compute_cluster/post/"
    )]
    Param (
        ...
        [PSTypeName("NamespaceManagementSupervisorsEnableOnComputeClusterSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-EnableOnComputeClusterClusterSupervisors' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'EnableOnComputeClusterClusterSupervisors' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors/{cluster}__action=enable_on_compute_cluster'
                $LocalVarMethod = 'POST'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling enableOnComputeClusterClusterSupervisors."
                }
                ...
                if (!$NamespaceManagementSupervisorsEnableOnComputeClusterSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorsEnableOnComputeClusterSpec` missing when calling enableOnComputeClusterClusterSupervisors."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorsEnableOnComputeClusterSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorsEnableOnComputeClusterSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsEnableOnComputeClusterSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsEnableOnComputeClusterSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorsEnableOnComputeClusterSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorsEnableOnComputeClusterSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorsEnableOnComputeClusterSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorsEnableOnComputeClusterSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorsEnableOnComputeClusterSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorsEnableOnComputeClusterSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER NamespaceManagementSupervisorsEnableOnZonesSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisorsactionenable_on_zones/post/
#>
function Invoke-EnableOnZonesNamespaceManagementSupervisors {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisorsactionenable_on_zones/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NamespaceManagementSupervisorsEnableOnZonesSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-EnableOnZonesNamespaceManagementSupervisors' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'EnableOnZonesNamespaceManagementSupervisors' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors__action=enable_on_zones'
                $LocalVarMethod = 'POST'
                ...
                if (!$NamespaceManagementSupervisorsEnableOnZonesSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorsEnableOnZonesSpec` missing when calling enableOnZonesNamespaceManagementSupervisors."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorsEnableOnZonesSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorsEnableOnZonesSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsEnableOnZonesSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsEnableOnZonesSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorsEnableOnZonesSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorsEnableOnZonesSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorsEnableOnZonesSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorsEnableOnZonesSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorsEnableOnZonesSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorsEnableOnZonesSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCDySN7oncdPoMF
# OdB+DiU3410M7KcXOFu4TzeI1K9k/qCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI