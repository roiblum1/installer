...
NamespaceManagementSupervisorsSummaryInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/summary/get/
#>
function Invoke-GetSupervisorNamespaceManagementSummary {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/summary/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetSupervisorNamespaceManagementSummary' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetSupervisorNamespaceManagementSummary' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors/{supervisor}/summary'
                $LocalVarMethod = 'GET'
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling getSupervisorNamespaceManagementSummary."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NamespaceManagementSupervisorsSummaryInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorsSummaryInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/summaries/get/
#>
function Invoke-ListNamespaceManagementSupervisorsSummaries {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/summaries/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListNamespaceManagementSupervisorsSummaries' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListNamespaceManagementSupervisorsSummaries' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors/summaries'
                $LocalVarMethod = 'GET'
                ...
                if ($null -ne $ConfigStatus) {
                    $LocalVarQueryParameters['config_status'] = $ConfigStatus
                }

                if ($null -ne $KubernetesStatus) {
                    $LocalVarQueryParameters['kubernetes_status'] = $KubernetesStatus
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementSupervisorsSummaryListResult"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorsSummaryListResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAl+DYhq+4/J1Cw
# B8kvmeWNROcE7YSNgqlwZEawJi8IUaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG2huO+5viZWUpFO
# yj+kIHxfN86Y5OYpkoqE0VhO3WWvMA0GCSqGSIb3DQEBAQUABIICAKwvBv0BXTds
# rOcPDV9eqb4qfvRw1Cx028RLgjQPazVngux1FXOzadkiVpKsYhfFy+LkUyc0fptd
# 4xq9gcv/Whb/To6LFzAQZ4+5vWknRDx1G0fJIC0DykZK0CcyQAWltriIUHhYJfKp
# rnlKHb1dKMhWAXMQ+MmuWr1z0MKuIZsj3pbS01tSqkyT8AHCUcgEIrBflh5i2B1e
# P/yR/M0brwNjtMWFbLy0iODntUONS1XpXTPlPt7uoJKDrLmGv7JSJRIZAN9A9ycz
# znvuI3XaRHywyBe0RKgCSOPydO+kevUhOkqUHi1tn1UhyptTC6BzH37uBQ81Z4Mz
# oyjfVKJL9X3er6gI435lVl5CHUDI3O4YeB/APSgcE2EnOT0Jf6oWUQ15sUVcDFWL
# wjoQfZuzpZPah+tERS3NgBfZcqNqNn/f+YdULS2UVEQ0Q7tUPPaLGCH+CVE1pJdb
# oTCOZn1vBvNirthM05l0mu+pTaN/1DhS5bUhxMjssOzvuDSdCQxRIxFf1CQzwm83
# nyWsuQjUs9OO1XxEDyHWh1RMapl/GZMVDEYiH7YZUbr5EC0u6zeEf7r2wOgbQx4u
# CZk5KxptFMOilv6xPfKDDeoq5NPLsJG3Mq69JBurGRVT8O0zHV7nSgpIMziwnYj1
# OiIze1p2AVGibikCtLk/+0semomo2fEpoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ICaiz1TecugyVoYKEpHWD86eqeTJAZbWe3aMpGJx9jKyAhBmA+Z5s4j02yKlCt5k
# 1KQ7GA8yMDI0MDcyNDE5NDEzOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDEzOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEILsPChxuvcMR5Tk636KBkIUB
# C5RxBNskFGUgmjerRS5IMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGwvrjVJ
# r+WgWLKh8bNryZuupiFljIHpdS+dWIycLbIj+qhqA/iDRy/swclme55HuRY3U+cQ
# tw4mKFQLCxhXEfKMt7jHW22MMYEbMr8X/YHz1PrTAgl8RM2owLmPOtn94BuI/Bff
# I0LHEAPiZUmXrg3facmDKM1LfZMaWm6ut3/dIG95oR2grTwyiTcfdzKJkA39tVqC
# QC1hXLLD0d9RnZRGhwTZmD5Fpz8N8E8QuBzgHUEyRXR7Hnf/oSpAhYTnBstfp/ph
# 6ck2LwM4cOAR62//TGlnVvLchsC3fmX42nn7gIyh61hw+FqdfFd/Uj14AkqVKilv
# 8YVTBHUZcM6uHJFqzdAgrCI18L95lI8nqHdQBQwQbz0HM4HQYZVsywhgwfAu11mN
# HgQNmmUGOQWUs0moDXfYUKFNxtIuEFjBPingey68++C0gCdfKlM2YxVzsiQglek4
# F/gbQhPobT4crkPQmh/RSL6ZE1kb3coyNFMphxGjuZCzDm4AECzLzLPs0NDBSV7r
# voIcpEJDpmEjvqg1OC4K4NmVQpgPJjAY9dxCOExKWTkOi1jkVggLAap99GymohLI
# 6DJsWIRNijOv7JWURHsxYz0aRjfx809+u331ZX+WImmxYzZ2mohgVkJJnZ6482Dg
# kxSP4GGK32y+YZ35xfjalwMpqg9oLJm5Kgxt
