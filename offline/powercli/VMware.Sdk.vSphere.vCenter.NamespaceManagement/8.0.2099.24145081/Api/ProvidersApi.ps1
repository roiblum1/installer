...
.PARAMETER NamespaceManagementSupervisorsIdentityProvidersCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/post/
#>
function Invoke-CreateSupervisorNamespaceManagementIdentityProviders {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/post/"
    )]
    Param (
        ...
        [PSTypeName("NamespaceManagementSupervisorsIdentityProvidersCreateSpec")]
        [PSCustomObject]
        ${NamespaceManagementSupervisorsIdentityProvidersCreateSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateSupervisorNamespaceManagementIdentityProviders' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateSupervisorNamespaceManagementIdentityProviders' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors/{supervisor}/identity/providers'
                $LocalVarMethod = 'POST'
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling createSupervisorNamespaceManagementIdentityProviders."
                }
                ...
                if (!$NamespaceManagementSupervisorsIdentityProvidersCreateSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorsIdentityProvidersCreateSpec` missing when calling createSupervisorNamespaceManagementIdentityProviders."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorsIdentityProvidersCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorsIdentityProvidersCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorsIdentityProvidersCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorsIdentityProvidersCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorsIdentityProvidersCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersCreateSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorsIdentityProvidersCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/delete/
#>
function Invoke-DeleteSupervisorProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteSupervisorProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteSupervisorProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespace-management/supervisors/{supervisor}/identity/providers/{provider}'
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling deleteSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor}', $Supervisor)
                $LocalVarPathParameters['supervisor'] = $Supervisor
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling deleteSupervisorProviderIdentity."
                }
...
NamespaceManagementSupervisorsIdentityProvidersInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/get/
#>
function Invoke-GetSupervisorProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetSupervisorProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetSupervisorProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling getSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor}', $Supervisor)
                $LocalVarPathParameters['supervisor'] = $Supervisor
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling getSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementSupervisorsIdentityProvidersInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorsIdentityProvidersInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/get/
#>
function Invoke-ListSupervisorNamespaceManagementIdentityProviders {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-ListSupervisorNamespaceManagementIdentityProviders' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListSupervisorNamespaceManagementIdentityProviders' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling listSupervisorNamespaceManagementIdentityProviders."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor}', $Supervisor)
                $LocalVarPathParameters['supervisor'] = $Supervisor
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespaceManagementSupervisorsIdentityProvidersSummary[]"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "NamespaceManagementSupervisorsIdentityProvidersSummary")
                        }
...
.PARAMETER NamespaceManagementSupervisorsIdentityProvidersSetSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/put/
#>
function Invoke-SetSupervisorProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Provider},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespaceManagementSupervisorsIdentityProvidersSetSpec")]
        [PSCustomObject]
        ${NamespaceManagementSupervisorsIdentityProvidersSetSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetSupervisorProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetSupervisorProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling setSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor}', $Supervisor)
                $LocalVarPathParameters['supervisor'] = $Supervisor
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling setSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NamespaceManagementSupervisorsIdentityProvidersSetSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorsIdentityProvidersSetSpec` missing when calling setSupervisorProviderIdentity."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorsIdentityProvidersSetSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorsIdentityProvidersSetSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersSetSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersSetSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorsIdentityProvidersSetSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersSetSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorsIdentityProvidersSetSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorsIdentityProvidersSetSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersSetSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorsIdentityProvidersSetSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER NamespaceManagementSupervisorsIdentityProvidersUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/patch/
#>
function Invoke-UpdateSupervisorProviderIdentity {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespace-management/supervisors/supervisor/identity/providers/provider/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSCustomObject]
        ${NamespaceManagementSupervisorsIdentityProvidersUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateSupervisorProviderIdentity' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateSupervisorProviderIdentity' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Supervisor) {
                    throw "Error! The required parameter `Supervisor` missing when calling updateSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{supervisor}', $Supervisor)
                $LocalVarPathParameters['supervisor'] = $Supervisor
                if (!$Provider) {
                    throw "Error! The required parameter `Provider` missing when calling updateSupervisorProviderIdentity."
                }
                $LocalVarUri = $LocalVarUri.replace('{provider}', $Provider)
                $LocalVarPathParameters['provider'] = $Provider
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NamespaceManagementSupervisorsIdentityProvidersUpdateSpec) {
                    throw "Error! The required parameter `NamespaceManagementSupervisorsIdentityProvidersUpdateSpec` missing when calling updateSupervisorProviderIdentity."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespaceManagementSupervisorsIdentityProvidersUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec) {
                    $LocalVarBodyParameter = $NamespaceManagementSupervisorsIdentityProvidersUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCyxuGRcT2X5p26
# de6+DjUdBPYOPKMkrbXAtIs08tQFFqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGTv0ZzddOxV8HRo
# 0rCZviPMO4k2T5JP1VS+67ENNutvMA0GCSqGSIb3DQEBAQUABIICADQyWYRDXaWp
# o05tG88GhJ9D0+MVKtZzzIGSA1eiebydeCTcouh8yuvz8Q01PZWIE1T/pON2h+8Q
# kD34I5foTP32HzdFv9SvG0rB4/X/B0vPmqyaViTaYQc+IxnHBhujML1PUfH1F/UM
# sSaQ3mDpzO/hEqxlV/w9FPFUWRRLH3gaThvPqBK3r8QNhiHOFnX3uRpLsmP+Ib2K
