...
ModuleToProcess = 'VMware.VimAutomation.Srm.Commands.dll'

# Version number of this module.
ModuleVersion = '13.3.0.24145081'

# ID used to uniquely identify this module
GUID = 'c484dca5-b99c-4fcc-8e18-cdf88e7f33da'
...
Description = 'This PowerShell module contains PowerCLI SRM cmdlets.'
...
RequiredAssemblies = @(
    'VMware.VimAutomation.Srm.Commands.dll',
    'VMware.VimAutomation.Srm.Types.dll',
    'VMware.VimAutomation.Srm.Impl.dll',
    'VMware.VimAutomation.Srm.Interop.dll',
    'VMware.VimAutomation.Srm.Views.dll',
    'VMware.VimAutomation.Srm.WsdlTypes.dll'
)

# Script files (.ps1) that are run in the caller's environment prior to importing this module
#ScriptsToProcess = @('Initialize-VMware.VimAutomation.Srm.ps1')

# Type files (.ps1xml) to be loaded when importing this module
TypesToProcess = @()

# Format files (.ps1xml) to be loaded when importing this module
FormatsToProcess = @('VMware.VimAutomation.Srm.Format.ps1xml')

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.VimAutomation.Srm.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCL3EUIqScZKgXe
# 9b/JYvEIlMt8N/oAZHNekH9IIjHvJqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA+9Gj/uvl26K+lJ
# JAv8ywVS+6OqtMewHrAClY7eZZxSMA0GCSqGSIb3DQEBAQUABIICAGXaPO5zFWf4
# uDZ5oQtB5tAKiDju/dQ9OdtyCbMxt3V0GgTUGRNI1UbW85iesBVscXUpsrUtOsuF
# ZdIwd2OYf+InN++2DzcHLsnOjtZX12EG9YAqfZjZxEmJB/lA4F8m08CV5GuSI4vP
# qHQLHfNxSTZe/uBoIsVifofVmA5PVz7r23dkqSgn7BolsLExbA51eC7ozh41thdD
# EPRzGTofMl4prg4N3k8HKAGaeO9G22uHKLBbOihrnRrPJRhIcEncaapo20t9rfmw
# TMJFS4uT8l0CmFdNMNXb4SfmOhTq2BtUAVZByQTfVixpgvr/oLUp+zgcHUjmCCvF
# xfl4W/jhUZLFhcnIonXoBPjXU8i3lNU+eb2kcl275Al/nSd34850F/Z8lTEl92tA
# k8ibTXItBDMBAHaLVQUwFDcQsyhLgRG4l6yIK5EEGMOuQwEC9lz2bFMCMFdf3PXO
# mh0XlhUIE4bIZCcV6OnKDHjo43C347Pq2uMR42eOKsAvqK1aOYdNAi2164eAV/NS
# 5m32JqKT6bVikzDA0TmYI4p1XSRpxNmuTbl3cxJLQ95Ogbj2D9N3frvY2qAnvYkb
# c3BxSxULEIGo2a0tNlN0VxmxPNESHXry6BqilvLXGCYGrd4U8Nyg5CEdsyO1LcsE
# v3vh1PmTMyNzFD2SfWMNdkExr1sf5V4moYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGQJXb7X9CyuJzZO2YvHtoC97BoEZKfmZQn2OMs3BlKFAhEA8KLNj8hjUArVXWO9
# 2HS0cxgPMjAyNDA3MjQxOTMzMTdaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTMzMTdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBI3ytsje09c+pARBj/mqet
# s3aFLmE1/tv6FZHBvmQMIjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCU+b1m
# tm/fH8V766zQ5o7wqpn1Kwg4QOHvuO5lC6mulSHrmauQwPpdY8B0UzqqCoIxAPUl
# C3gEcAW5sQFF0nT6D/vliVT/2G80hjFwb5qDJFy06tCo/XIo9XAZwBR/ImeAAhpS
# MOchHD57P76IiqaYrjInafVsH5FUvSw8hxAgABX/xozTCrw2Nl/x6r+R6A+pb+Nt
# Q/g7V3RnW5ohCNAQOOI909gXn4QtOrDVyxC4m//vEuQdtuJh3JpMzpgyEvrsyFPc
# 06AziEZL1p00zqKq2nYQrzytIiS1IWKqWkYpqO7hWSeCJeGJLnVoCDOiI1+dEl0+
# FVr98rIxLds+kMz41wtJtRQJfgZMg9skfJVzXrcT5KYc8IchTkr2Rw6WxeZiVnz3
# 0x1lo5h/95ZIfTvYH/pwESnXRAXPuIo45BNWe3XAKkNTMVVzZlAQ8QGzvpTOiUpe
# gAtv3il/ZtiJuYZgP4lk13qE1I4mnBYOpe2j6IcLVMx28isl7d0geSSlyFmsfdSk
# Pm3sMU2dlcKny10FDG8tvuSQaA4ld7YTdMl5ReJAFPVg9bCU959mCzplwmaLCT6R
# T0iov8mlY5+5cSUDXJRl/CmRGKUileoScDlU37y2ztvRvXBZS4Li0gyHd5PKpCKC
# HOaaljVyF9yf5RHiepko1zxP0h5rJ5VfQFTPAA==
