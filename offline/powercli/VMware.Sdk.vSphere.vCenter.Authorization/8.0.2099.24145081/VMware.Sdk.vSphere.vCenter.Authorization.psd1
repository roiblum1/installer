#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.Authorization'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.Authorization.psm1'
...
GUID = 'cd58e8b8-a9c6-49e7-adeb-d3fae5df291d'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.Authorization.'
...
FunctionsToExport = 'Invoke-GetAuthorizationPrivilegeChecksLatest',
               'Invoke-CreateAuthorizationVtContainersMappings',
               'Invoke-DeleteMappingVtContainers', 'Invoke-GetMappingVtContainers',
               'Invoke-ListAuthorizationVtContainersMappings',
               'Invoke-ListAuthorizationPrivilegeChecks',
               'Initialize-AuthorizationPrivilegeChecksFilterSpec',
               'Initialize-AuthorizationPrivilegeChecksListRequestBody',
               'Initialize-AuthorizationPrivilegeChecksPrincipal',
               'Initialize-AuthorizationVtContainersMappingsCreateSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBL8bFvSy9SZN/z
# V1a3G+/v09rXjilij9J7sH5bQj50hqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJGYsAPwJ6Zd8OOD
# 7SkbiuNqbwuEgkCdXC7jGd0OxttdMA0GCSqGSIb3DQEBAQUABIICAGRUPObnqzsx
# Kd6ejuIY/b1JzU4FWJBTzoHMelepZTwO5yC3nFHXv21gLx1S0KW2/7b737n8OUpC
# jKaK4/PSMDfJHjySIXNRGSu0AsCXkmzoHAzZpFBL6BS79tUF2OOyex0MFcpxw9PY
# M6fAbJHy5JXU8QnvcpzPgsIpz6Dhgfz5zNBwien0u3JTJRXBEgZlBRKK5h/uVH4n
# Q2gjqG1B/IW0oTFSbrocaGAsje6Z1DKfzVwQUWMUxXrCwXh1usYste9UVjtcUPHe
# bphd0VigsRkfWxZvPKvV366FRiszwm7Qu68VUO48E3dyygz9agvclcfUoXUCZWWc
# QOf7/nXn0BUI4FGfahgoInO5Yt+H4hSG8YwnCHeIY31RWXkA5W3GYpds6VStsD2x
# xG+0v/Qyk8inO5KlBCI8ce3paLqgqoDOe6334tL1Jb5cmCuoZrFkOXwieAAuS8Qy
# vV01SXpuzHu4yGYsbyo61KBXTPOaX5c5X/aDHrZTZ+72bGTUTU0qY1nnr/2MdeUL
# rc2i2JLpoMNLnff/wiqRdlt9e21AUtKi4GPwKm/vg9kDFosp3mT+bQxiN8B2FqSX
# qn0G83lsiXHY253R2rBFtB21SpE8FzW2FBgu+F3/3wjj/v2U5SOMW0uEyZiP3LZm
# Hn/i2lrFkn1gCB59GxXEDGog9HNkTA8FoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGZV9wR3cjg4NwG1BWfGQixc5UG+EhYhcv1Kb0Cpc6lpAhEAr2L4QvUanxwfDqP8
# GGQi+RgPMjAyNDA3MjQxOTQwMDRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQwMDRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAgClRjQfZHHP1xxBwoA4PG
# wMAUieT0RaKLkU4KLzxg1zA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgByEU0a
# /ljXRD8aybItEVa1hiTpy9LJlXJ18zzZug7DH1phkRy9gWwnEsS29nL+1ZlBb442
# PNLu47/4DkQfaqtGQA4XNOcYXxmUs8MKKXZ5urENobrNmrkf4+TKb+SjYXfqTNm+
# D1DJ5BEv4nk0zhpIhZdnxRNMgvihiVGzffqvnP1riQ8KRVC6tgCKSRV/A7cuO2JD
# I6xMCTbjdzexX3SIbVso/+ADbBfgVRzHW3XTPTlGsT+1JeARTu49xK1GVixH/g2n
# Bk0QZCNie/qHs9HW6g48iXgR4Pe1nt9e3bnOQO/2elIxi+mReUzO1sZ6Kt1e0xqc
# k7LlKDlo86KfGjoddx8y+Mxzjw9ZISGWyIN6SunUdBW0Znh3t791Ffxmz2TMGJcc
# lDtC/5mA7QxGmEA68i6iAiBcFeq/WYfgCcnWE36nmjgug+bmion9EffoCIVfnRFd
# sb2L0YhphW9YAdCFJnVNBS76l+vZDiKj7cE0bWCkfcpxDBWwhlezkMeJdlMvEGaE
# ANGCsdtJqLjdAG0WipejGUypuL8WG3TNf3ADNOW6yEERhNQxYPivWU7Avnop7iVE
# wrn3mdC/LUp00DC9QGgkY+tS7aVv50huVHYMqJGlDBbSPxpBw9vmLJradO96eepU
# y21p2l0ir4lTnj9Wjekv1jm3jxIrLugGt1x1QQ==
