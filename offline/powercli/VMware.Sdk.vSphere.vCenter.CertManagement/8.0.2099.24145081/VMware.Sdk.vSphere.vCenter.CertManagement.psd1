#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.CertManagement'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.CertManagement.psm1'
...
GUID = '41411f1c-dc19-46da-8900-e1b9bee1d8b7'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.CertManagement.'
...
FunctionsToExport = 'Invoke-GetCertificateManagementSigningCertificate',
               'Invoke-RefreshSigningCertificate',
               'Invoke-SetCertificateManagementSigningCertificate',
               'Invoke-GetCertificateManagementTls', 'Invoke-RenewTls',
               'Invoke-ReplaceVmcaSignedTls', 'Invoke-SetCertificateManagementTls',
               ...
               'Invoke-GetChainCertificateManagementTrustedRootChains',
               'Invoke-ListCertificateManagementTrustedRootChains',
               'Invoke-CreateCertificateManagementVmcaRoot',
               'Initialize-CertificateManagementVcenterSigningCertificateRefreshRequestBody',
               'Initialize-CertificateManagementVcenterSigningCertificateSetSpec',
               'Initialize-CertificateManagementVcenterTlsCsrSpec',
               'Initialize-CertificateManagementVcenterTlsRenewRequestBody',
               'Initialize-CertificateManagementVcenterTlsReplaceSpec',
               'Initialize-CertificateManagementVcenterTlsSpec',
               'Initialize-CertificateManagementVcenterTrustedRootChainsCreateSpec',
               'Initialize-CertificateManagementVcenterVmcaRootCreateSpec',
               'Initialize-CertificateManagementX509CertChain'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtEorLPcWb6bPW
# y3aqex+q6/aab8+hFAXhCbrFTCgC4KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDt/DhFF9w3aGPib
# C44yS18oiUebCQFmHhRDTZGzv63OMA0GCSqGSIb3DQEBAQUABIICAKlR7vtExPRa
# 7HK4gY6KIlT/SUL3nPUUKiRLFZK+jjaGo9AZRX9GPjfIwKewUiYMDfmrL7QDCeeI
# kBsUwt+6BsJNr4grKzB0e7jy0Fxwe8luD70hurc4S7NH5eb2/xgHjOe/ET22sYTF
# e/BixOQTsaSCF8SgPCfJH10ZZ0qcCHYKlJU/duSXWhztrkTnOVGU9CzpyVQLiruW
# itPutHUk0MOdfS0iiAVX9/2nJNATcq6A94jm4Eq9ZA4Yz/hgngQzeaKwZe3aYYjT
# Ttja1Ri9vNskJkl0nawYC77P2zBKILPKT22UanEnA1PaDo6HcFzhmiIPDpQCYlsQ
# F3p74NkoveamjRuBB/lkmEYt99y8XA1n/hzF/UCT8dRNO6OjM9tsT/hBZBQ/+lu1
# 0cAp5zL4J32U3UhnmkWkuhDofDXZE2NDxMdR+AecaT3IJltfIY+5dktDElGe8mP7
# hOCaeHNuXWBL8fyuyJI2xPP9V9XijOJTVxA6Sv5MaxMGltmG+4s7cthqIApd1sZb
# ByH2HbE19cRmtAWHd2rwXG4fOZ57RDNK8QOm7845Gp7j8l2e93m6u/u0TAxHVcES
# ZWcXV9QaOvKwZIZsYL0lQgw7OOsIMmuJ9wkzmEiX5zegBJxEY8rGrw5Cnn/Q6Psy
# NhbaW/iGYV4/bWprppclwUe/7FHbrUIQoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IKQFdLB4kHa1H9F6lRkm6ZlpO65AnpZvmTZuIOlycdOgAhBIhohxToCjCFov0izb
# PVEWGA8yMDI0MDcyNDE5NDAxMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDAxMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJUpz6LdSI33F4Q99dtreHgf
# 8e4L8H7hhiS+s4RvMXWzMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAFoVzBP+
# T+InkErcc/kdMpvs+bAv0X15WhUmeGbjjRKDOWdWkkxNoouIDuqGhefJgtY4gkYk
# w818+GF4zkUwyMDc13ZWHJV1z2BkLm5ycx1AX2FVBTY6husI/Q0IKihhKrKX+VeY
# hzoIzKT9rT3Ug9kJ4xYzEs3QUrJ1l34Rar9fV9tNP1EzlR7Aj6AO6KTe6Y3d7/AM
# M7NMnFdvNW6o7gNLavQj69KhmcEa2/M1AC/A2aKgd94Z0lyy1HsjT6sS/+GTFNtg
# Vtt1DhHosiI5/EcMXAmaaF7JXYoWPxUWYCUAdA920i7l9l9Hsjwl+9Y2ZNti0UVO
# xaSTdxXPYbhJz3RYL9jz76nh99tUW0V/XOIHOpH+4FoVvTn3ObtidZOhPXtKvYwK
# 4+tWhWX1u6n/SPJHrWXBrGOMfajwmupP9JmVMdMzlDcfoDd66oLxsyu+BkZMARln
# xlGealXnBRagWVljGbAI9KwI6oJ67n2w1s03IwY1NhP+SR9yrGvML2Kr5ugm+Zlf
# 1RnHJLUoKvP3xvitr1LhReuEbL8NYMN8jkALtvJZfJtL7k1thEdBJBnbjGzk29k3
# TEtJH2Ct70m4o/jpW4nm92tSKvrapnyhCGHTNI4ioJ4NWumfaoMkxAPC2JHkzQPo
# vJdivj09jVlhfghKmHWIBSl/tL7qFHhIHvNe
