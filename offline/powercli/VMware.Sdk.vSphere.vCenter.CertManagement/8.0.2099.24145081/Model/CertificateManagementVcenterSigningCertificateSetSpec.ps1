...
.PARAMETER SigningCertChain
No description available.
.PARAMETER PrivateKey
The corresponding unencrypted PKCS#8 private key in base64-encoded PEM format.
.OUTPUTS

CertificateManagementVcenterSigningCertificateSetSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/CertificateManagement/Vcenter/SigningCertificate/SetSpec/
#>

function Initialize-CertificateManagementVcenterSigningCertificateSetSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/CertificateManagement/Vcenter/SigningCertificate/SetSpec/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("CertificateManagementX509CertChain")]
        [PSCustomObject]
        ${SigningCertChain},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.CertManagement => vSphereCertificateManagementVcenterSigningCertificateSetSpec' | Write-Debug

        if ($SigningCertChain -eq $null) {
            throw "invalid value for 'SigningCertChain', 'SigningCertChain' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "CertificateManagementVcenterSigningCertificateSetSpec"
            "signing_cert_chain" = ${SigningCertChain}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCs/hlCp2j9/v1J
# Z8GO+f599CstpEEKpgggS1KPcgxn26CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAVS8Dweiwzz8ozp
# FMPvUrky8LwnhA24X+x9/1IbsRC8MA0GCSqGSIb3DQEBAQUABIICAF2oNbaYtf3t
# bKtXryzL85SzkkO2tWE/OtpzKR3dsqQ/Lc+d8cj8Aex2vF+WhDYJ/JmEkf+G6hLu
# xgH7142PGN18gx6CZBIO+h2a4CLumccKEPXY/KBZ2/E4aXSoDyOfhUQDdtkSugN1
# 3sLK/63w+SAsFj71znY86ahkT6bADJxJH8LKiXBeZhU53fuGfDvuFyBzv4Sxulox
# ftzkiUuVnmH+TZlsT6JgYchzJGPjOnHFavosC/Lzpbu661i27pf01L5IHvZGyfl/
# 9GWeFnZpXpzJaf0tegDHxg1vPU64gaHVAY2qHkUhJjA951OwxahBgilyLoQUlQnQ
# t2L80v01U9P7hOUoLc4lur2GLIRESjfOhOQW74Ktuny6F5ANlzI9qcUWjPOHLRrH
# NsyGD8cDkkaGVZZwTT6PlqL2k0wK5U6H8sdgqZYFHGos0c7JONmNa+429lDM/UJO
# 9BI91NH7nVEs0ffkuhMS6ckCxujHlgGytdpZrtryZa3BQ0HIUZPSdUyFAdymxL32
# yjA9Z2Qxut5oRH1IGGD1VAPCzTZAtR42jUk2RNsIIRS5PWdQF5s6PJuP0no83G5v
# U2BZK08bfkUUSF5AciXPb1ZD+KgYNAqdKIN3GOEVEnxg6bhY6QWs5bdvWAguxB6I
# jirRvp9brxWCbaz2F0uQSZD4KfXeIn02oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ILBkb3oUi9Wa4LeXAGkNBUGxw+39oivbHvNcxNRGsvyKAhAlMhBvh/hnW5I6i3vF
# jwClGA8yMDI0MDcyNDE5NDAxNVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDAxNVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIFk+05bfcWH0YnkSUcCfAi3n
# twA8qnXN3LBBOcyS7F/FMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICACuINq0s
# VB8sW+PPZSvpRmletLsv2vrOfA7gW2Z/Znbwmi2W4YLkN2NuRoUFfyGY7HD4Z+c6
# VisRIvDekviLyMcpBmrsnn2SmjtoL8xbc1BBHz/hVKSwx1LkmxhEKsHidNZI78pR
# wS+5fkzDzD5F5aI0mAOaniRw/JHOxIdk2cG4nQLwefHoVBF/pu6UAIDOf8cbTPK0
# H5wec1csEJGym1aXboVG3WYLEWifCTytkCraNBGBoCHk80o07ykCgKLyIPSpFQnh
# Kdk/T6unor7ITUvLwEChOfJWUu3UPq+NebcrpJ9JD7cLAqo5qaBFskkLPBOrtjQs
# +lys7fd7PWzuj01lWrNMSNzsPsNt+esQ/sZLXsvOdizaY5zIr4KLCqict4qtgMzx
# gWpw44lvfh3yEpktVh7BTJkSvSHhncoOgFt0Yxm7B0TD3gunwAwdee7QsEpQaKLh
# EuORKU5zDjH1vdgyXdtjD6eJqqeNLuNB1wSMnCf70EOlq4fVlTwNMjGpWznPyP1a
# WrhcViPZb6xxUFxzr2/uybPV/f7JL3JQaOmZ6D3y+GoaFpHewQ5u45JfRnTb1d+z
# MCh4aRyYhCuS0Nc3BNWH0etu+cRGCajT2RHiO7YwmYT7EdaW0G7ELRJ65iztW+l3
# USs7S7gRe0iFJuMvstImlH7ABiuTrhFmbkAj
