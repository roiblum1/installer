...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tls/get/
#>
function Invoke-GetCertificateManagementTls {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tls/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetCertificateManagementTls' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCertificateManagementTls' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/certificate-management/vcenter/tls'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "CertificateManagementVcenterTlsInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "CertificateManagementVcenterTlsInfo")
...
.PARAMETER CertificateManagementVcenterTlsRenewRequestBody
No description available.
...
#>
function Invoke-RenewTls {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tlsactionrenew/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-RenewTls' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RenewTls' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/certificate-management/vcenter/tls__action=renew'
                $LocalVarMethod = 'POST'
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $CertificateManagementVcenterTlsRenewRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$CertificateManagementVcenterTlsRenewRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsRenewRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsRenewRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $CertificateManagementVcenterTlsRenewRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $CertificateManagementVcenterTlsRenewRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $CertificateManagementVcenterTlsRenewRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $CertificateManagementVcenterTlsRenewRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $CertificateManagementVcenterTlsRenewRequestBody) {
                    $LocalVarBodyParameter = $CertificateManagementVcenterTlsRenewRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER CertificateManagementVcenterTlsReplaceSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tlsactionreplace-vmca-signed/post/
#>
function Invoke-ReplaceVmcaSignedTls {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tlsactionreplace-vmca-signed/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ReplaceVmcaSignedTls' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ReplaceVmcaSignedTls' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/certificate-management/vcenter/tls__action=replace-vmca-signed'
                $LocalVarMethod = 'POST'
                ...
                if (!$CertificateManagementVcenterTlsReplaceSpec) {
                    throw "Error! The required parameter `CertificateManagementVcenterTlsReplaceSpec` missing when calling replaceVmcaSignedTls."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $CertificateManagementVcenterTlsReplaceSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$CertificateManagementVcenterTlsReplaceSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsReplaceSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsReplaceSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $CertificateManagementVcenterTlsReplaceSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $CertificateManagementVcenterTlsReplaceSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $CertificateManagementVcenterTlsReplaceSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $CertificateManagementVcenterTlsReplaceSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $CertificateManagementVcenterTlsReplaceSpec) {
                    $LocalVarBodyParameter = $CertificateManagementVcenterTlsReplaceSpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER CertificateManagementVcenterTlsSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tls/put/
#>
function Invoke-SetCertificateManagementTls {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/tls/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("CertificateManagementVcenterTlsSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-SetCertificateManagementTls' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetCertificateManagementTls' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$CertificateManagementVcenterTlsSpec) {
                    throw "Error! The required parameter `CertificateManagementVcenterTlsSpec` missing when calling setCertificateManagementTls."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $CertificateManagementVcenterTlsSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$CertificateManagementVcenterTlsSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterTlsSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $CertificateManagementVcenterTlsSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $CertificateManagementVcenterTlsSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $CertificateManagementVcenterTlsSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $CertificateManagementVcenterTlsSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $CertificateManagementVcenterTlsSpec) {
                    $LocalVarBodyParameter = $CertificateManagementVcenterTlsSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9ADt0lFlOahVc
# oPMImqivxaHJ9AW0Mg/gcTvj69m1R6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE