...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificate/get/
#>
function Invoke-GetCertificateManagementSigningCertificate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificate/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetCertificateManagementSigningCertificate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCertificateManagementSigningCertificate' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/certificate-management/vcenter/signing-certificate'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "CertificateManagementVcenterSigningCertificateInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "CertificateManagementVcenterSigningCertificateInfo")
...
.PARAMETER CertificateManagementVcenterSigningCertificateRefreshRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificateactionrefresh/post/
#>
function Invoke-RefreshSigningCertificate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificateactionrefresh/post/"
    )]
    Param (
        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [PSTypeName("CertificateManagementVcenterSigningCertificateRefreshRequestBody")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-RefreshSigningCertificate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RefreshSigningCertificate' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/certificate-management/vcenter/signing-certificate__action=refresh'
                $LocalVarMethod = 'POST'
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $CertificateManagementVcenterSigningCertificateRefreshRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$CertificateManagementVcenterSigningCertificateRefreshRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterSigningCertificateRefreshRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterSigningCertificateRefreshRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $CertificateManagementVcenterSigningCertificateRefreshRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $CertificateManagementVcenterSigningCertificateRefreshRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $CertificateManagementVcenterSigningCertificateRefreshRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $CertificateManagementVcenterSigningCertificateRefreshRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $CertificateManagementVcenterSigningCertificateRefreshRequestBody) {
                    $LocalVarBodyParameter = $CertificateManagementVcenterSigningCertificateRefreshRequestBody | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "CertificateManagementX509CertChain"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "CertificateManagementX509CertChain")
...
.PARAMETER CertificateManagementVcenterSigningCertificateSetSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificate/put/
#>
function Invoke-SetCertificateManagementSigningCertificate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/certificate-management/vcenter/signing-certificate/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("CertificateManagementVcenterSigningCertificateSetSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-SetCertificateManagementSigningCertificate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetCertificateManagementSigningCertificate' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$CertificateManagementVcenterSigningCertificateSetSpec) {
                    throw "Error! The required parameter `CertificateManagementVcenterSigningCertificateSetSpec` missing when calling setCertificateManagementSigningCertificate."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $CertificateManagementVcenterSigningCertificateSetSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$CertificateManagementVcenterSigningCertificateSetSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterSigningCertificateSetSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $CertificateManagementVcenterSigningCertificateSetSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $CertificateManagementVcenterSigningCertificateSetSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $CertificateManagementVcenterSigningCertificateSetSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $CertificateManagementVcenterSigningCertificateSetSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $CertificateManagementVcenterSigningCertificateSetSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $CertificateManagementVcenterSigningCertificateSetSpec) {
                    $LocalVarBodyParameter = $CertificateManagementVcenterSigningCertificateSetSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBi4umFukNwpIf2
# 5UfLHsxeVPcwPJ3dMDvCERM0bFWnBqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINE8ddYtFN9t4AOK
# yj/dn5pbe50K6pFrxShhEQOiQxGYMA0GCSqGSIb3DQEBAQUABIICAJOcJd6NDq7w
# LoKBMHpW3mtrrFbpstrqMeW8ok+CpP819zLcsTL+kLTV3fIVvY/ahJf6fgpTarFh
# DcKdodP1JQ78iqin/QmWkhSsWNh84rn0lzs7M2eW/nZEXu6tzFATJqW6umg9m4p5
