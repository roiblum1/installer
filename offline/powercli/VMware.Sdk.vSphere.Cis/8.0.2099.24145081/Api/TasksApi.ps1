...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasks/taskactioncancel/post/
#>
function Invoke-CancelTask {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasks/taskactioncancel/post/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-CancelTask' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelTask' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tasks/{task}__action=cancel'
                $LocalVarMethod = 'POST'
                ...
                if (!$Task) {
                    throw "Error! The required parameter `Task` missing when calling cancelTask."
                }
                $LocalVarUri = $LocalVarUri.replace('{task}', $Task)
                $LocalVarPathParameters['task'] = $Task
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasks/task/get/
#>
function Invoke-GetTask {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasks/task/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetTask' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetTask' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tasks/{task}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Task) {
                    throw "Error! The required parameter `Task` missing when calling getTask."
                }
                $LocalVarUri = $LocalVarUri.replace('{task}', $Task)
                $LocalVarPathParameters['task'] = $Task
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if ($null -ne $ReturnAll) {
                    $LocalVarQueryParameters['return_all'] = $ReturnAll
                }

                if ($null -ne $ExcludeResult) {
                    $LocalVarQueryParameters['exclude_result'] = $ExcludeResult
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TaskInfo")
...
.PARAMETER TasksListRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasksactionlist/post/
#>
function Invoke-ListTasks {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/cis/api/cis/tasksactionlist/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("TasksListRequestBody")]
        [PSCustomObject]
    ...
    Process {
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListTasks' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/cis/tasks__action=list'
                $LocalVarMethod = 'POST'
                ...
                if (!$TasksListRequestBody) {
                    throw "Error! The required parameter `TasksListRequestBody` missing when calling listTasks."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $TasksListRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$TasksListRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TasksListRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $TasksListRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $TasksListRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $TasksListRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $TasksListRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $TasksListRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $TasksListRequestBody) {
                    $LocalVarBodyParameter = $TasksListRequestBody | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEHfM+pv+rLCOT
# 0vcQZaLw/1UYAK74RbPhJliHS5VEu6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFXCxUqy6MLvKxIu
# QSiW48lLChwoQDocsBQwTDfxrQrGMA0GCSqGSIb3DQEBAQUABIICAK+0CTimT4VJ
# +ZHA8AjWVI0H8GTHRWtZbzFN4CwjC6iTIWk4YhIpX1eKdzCK8GTCgpzok4OmJD0D
# Q+aEsuOn4uAxMACy0C5KBWvfbbXsyfCzZVIa+0RzA5WDrrskgLTtBnv1m8VJ9QQ0
# luDaacapGKtV+tFSMnH24cBcWysi+r+BKrpn7HMB1h2vq1JcMfcmnwV5Up8KyM6L
# BXI0XmhPNU+2fWP22p1f8ycJi9yhuFjvA1IUSeTNi/7c9BUe9lbMK00M5sovAMbc
# nSVyY0xHb12VkweyHo/h9nn25WDNuFPqrF5DqzfltCJLV1YJJvI8Oi/PtLVRfa9x
