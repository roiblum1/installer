...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/system-config/psc-registration/get/
#>
function Invoke-GetSystemConfigPscRegistration {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/system-config/psc-registration/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetSystemConfigPscRegistration' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetSystemConfigPscRegistration' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/system-config/psc-registration'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "SystemConfigPscRegistrationInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SystemConfigPscRegistrationInfo")
...
.PARAMETER DeploymentRemotePscSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/system-config/psc-registrationactionrepoint/post/
#>
function Invoke-RepointSystemConfigPscRegistration {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/system-config/psc-registrationactionrepoint/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentRemotePscSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-RepointSystemConfigPscRegistration' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'RepointSystemConfigPscRegistration' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/system-config/psc-registration__action=repoint'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentRemotePscSpec) {
                    throw "Error! The required parameter `DeploymentRemotePscSpec` missing when calling repointSystemConfigPscRegistration."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $DeploymentRemotePscSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$DeploymentRemotePscSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentRemotePscSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentRemotePscSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $DeploymentRemotePscSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $DeploymentRemotePscSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $DeploymentRemotePscSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $DeploymentRemotePscSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $DeploymentRemotePscSpec) {
                    $LocalVarBodyParameter = $DeploymentRemotePscSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCfMIlk3ipEQCSy
# X3Vu8hwSwQ7xqs8QZ0a3ihkhVSIjSqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILIZ8GfVe4APHStI
# Hw+kiaR0n8PHwUSYOn2QPV3ce9FyMA0GCSqGSIb3DQEBAQUABIICACvZ5DtsVsfz
# cgci2rAccB6PcOBxOwxQXqvJA016BK/INZ7bB5Qe09KJWOPZhBfC0Bs8SnKfAC0l
# /28yK++k/a3LUfxEN+wL5AW4O178JB5pw2QLgAkvYFMoKbRrPM9d4moR4FdQGxXh
# 1Fet99lcbIhXydLFq/XASztGG2o2c/6SAGkvbU/zR3M0YYaGOVGmstOynfE0S/Pt
# LgqDueKKIHDYB9u7q7vy2QFOlMuxHWQVuynKgri8AHCmrFgrdUOrT0EwcHEczlT4
# 94yOP5+h1C2Qy4mRfq0KQeahb9snuXidemobOaKFJEqguaZWNgPsEnY5RGrrjA0c
# HdqC+blvzjRjw+2NmtJQb+4bYYhsuY4OaQoxfMS7t+DABe416x49BKR6HduIIJxM
# jvSyxEReF9LeyhtO5Pp+yhjwCOatQb015zaXKwOBtVsDIxQ098oF8qcIutcskq/W
# rSDO3fnWbt+4x5M6F3L036KXaAXnjNJBKItyvjZrvB4fh6qrPcP9eF8jjz7bk7gd
# cDCFns1pQ6gWj+WuJsladYkNQuKYd7tLlrFyR8k1gekh4LKEOhBo5dWqwEKOOoOu
# /GfZI3FkhCKCNNwc9TzKZTovPlzyCtptiyeJxrI0bBldReNDIHIBclAu7cjm74L8
# 2DIZoT2OEkKuabRSV4hKsjNFRHo1zL2ToYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IBqygxvqQsqrOJd3o142L72t0DV7UdsUmDk9LPDGG7MTAhAVAruhsknM/f+R427e
# 8d7RGA8yMDI0MDcyNDE5NDMwOFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDMwOFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBtSAAx4xJvHUMY4yLnJiVj7
# GpgaaWrcBm56b0pFs017MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADtE8onK
# x/Duy2Q7xJNCdL0jh7Hc8AGXQUPl33NZ63RzsU7LrltXfpZyFN/Gmbs5z+5swfls
# pc+azrxDWwBSu4UEN91hw08iAHy9BJnZ1HzZHxud/2Zn2pStqdXxChNNCGcPeLuc
# tawQIWBtx1gpq8gr9G4dosN1X6P18+nAtgbWB6la1bnrdL1htZ6qqktN1UyH2318
# KpncDnGRVJQ0YtTpLX4oOgTHaQaMZmND5EPdJp6f8y+ZqYZF21OIEY7xUKPH3JKQ
# W+sZ7MjnEWK/Ur2eLZx6/jTwdduS99OmoxzjfexXsBcWxEj9o+4kWm/J0zyoUJA2
# 6JRi2+AnM51zz1E4m9eLxD9Z/JsLXMQYgRWmqig2GWMpb8Cs7FlOiopu5m6aI0eM
# RxkAEOe3Rh54dTCuenFQJkaH4gUCL12S53ajr0IiMd4+VYBsWMclt0vi6QkeI1ca
# XvYubv4nyFGoW7qQmb4atIlE7fxawPpTGhxdWkCKL+BwZRZlMuB43TEq5wsakA8w
# sJa8aYAJcVnrdd4bqxJ/4Bxei9DEe5NpOOQ+j2VBSRXTdPwX78MuFnVdLFUGVoSz
# tknxjuycEHjc0K0+P6IPBuawDACCq9eBo1ASnOpFW1zy65N05UO31Q+BmqsHVw5H
# 4FFb3wbvMO8fyWY+1p9RjYIW4cNbOQ9rPVDV
