...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactioncancel/post/
#>
function Invoke-CancelDeploymentInstall {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactioncancel/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CancelDeploymentInstall' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelDeploymentInstall' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/install__action=cancel'
                $LocalVarMethod = 'POST'
...
.PARAMETER DeploymentInstallInstallSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactioncheck/post/
#>
function Invoke-CheckDeploymentInstall {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactioncheck/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentInstallInstallSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CheckDeploymentInstall' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CheckDeploymentInstall' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/install__action=check'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentInstallInstallSpec) {
                    throw "Error! The required parameter `DeploymentInstallInstallSpec` missing when calling checkDeploymentInstall."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $DeploymentInstallInstallSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$DeploymentInstallInstallSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentInstallInstallSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentInstallInstallSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $DeploymentInstallInstallSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $DeploymentInstallInstallSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $DeploymentInstallInstallSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $DeploymentInstallInstallSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $DeploymentInstallInstallSpec) {
                    $LocalVarBodyParameter = $DeploymentInstallInstallSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/install/get/
#>
function Invoke-GetDeploymentInstall {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/install/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDeploymentInstall' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDeploymentInstall' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/install'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "DeploymentInstallInstallSpec"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "DeploymentInstallInstallSpec")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactionstart/post/
#>
function Invoke-StartDeploymentInstall {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/installactionstart/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentInstallInstallSpec")]
    ...
    Process {
        'Calling method: Invoke-StartDeploymentInstall' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'StartDeploymentInstall' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/install__action=start'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentInstallInstallSpec) {
                    throw "Error! The required parameter `DeploymentInstallInstallSpec` missing when calling startDeploymentInstall."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD8JeBZw4CgLaM1
# uyuFxEblTpvNzJPmK5YqpSTgTCdvcKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICTIwh0TIischNzI
# Qx6rE6RFQF2upw0GtoxFfx/trNpGMA0GCSqGSIb3DQEBAQUABIICAF7V81uMH91g
# /BaY7OIbRvPvLQ6hvLBwed/twZamyI9BmwErrs+IsYnzFN7krPiTKVamR5qvVjsg
# g1aoTFpdHc69lUQJyZ00MUZGYRbc9Z7qsMhbViL6xKsuBZ9DrkEho4d6YGnww8u1
# yOSA4rfTaQkLuPYuhdnuS02c+ClRXCj25kPnUNKHQ1QcTDvtmnguYj2DM0queo7X
# ueWrmoQvI4wfWBKzPSd85L0UB/i6VsagiC1EOAtq/sVWpe+zku90V+3VX8MijJ6m
# GSN/lOFKLQf4jmtiy21KALUBPiCfbQWGg6nVwO8WrO7A60/dQESqNIOi9CWMGpLp
