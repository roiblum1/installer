...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactioncancel/post/
#>
function Invoke-CancelDeploymentUpgrade {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactioncancel/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CancelDeploymentUpgrade' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelDeploymentUpgrade' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/upgrade__action=cancel'
                $LocalVarMethod = 'POST'
...
.PARAMETER DeploymentUpgradeUpgradeSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactioncheck/post/
#>
function Invoke-CheckDeploymentUpgrade {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactioncheck/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentUpgradeUpgradeSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CheckDeploymentUpgrade' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CheckDeploymentUpgrade' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/upgrade__action=check'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentUpgradeUpgradeSpec) {
                    throw "Error! The required parameter `DeploymentUpgradeUpgradeSpec` missing when calling checkDeploymentUpgrade."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $DeploymentUpgradeUpgradeSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$DeploymentUpgradeUpgradeSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentUpgradeUpgradeSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentUpgradeUpgradeSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $DeploymentUpgradeUpgradeSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $DeploymentUpgradeUpgradeSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $DeploymentUpgradeUpgradeSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $DeploymentUpgradeUpgradeSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $DeploymentUpgradeUpgradeSpec) {
                    $LocalVarBodyParameter = $DeploymentUpgradeUpgradeSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgrade/get/
#>
function Invoke-GetDeploymentUpgrade {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgrade/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDeploymentUpgrade' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDeploymentUpgrade' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/upgrade'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "DeploymentUpgradeUpgradeSpec"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "DeploymentUpgradeUpgradeSpec")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactionstart/post/
#>
function Invoke-StartDeploymentUpgrade {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/upgradeactionstart/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentUpgradeUpgradeSpec")]
    ...
    Process {
        'Calling method: Invoke-StartDeploymentUpgrade' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'StartDeploymentUpgrade' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/upgrade__action=start'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentUpgradeUpgradeSpec) {
                    throw "Error! The required parameter `DeploymentUpgradeUpgradeSpec` missing when calling startDeploymentUpgrade."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAL+DJVMAz1ABct
# 1QXHSoxFf9wUJzStcvGqebg4Bv3nU6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJtu+Cs6YQDRChEY
# zVqiRP5+XXmRDyOp+ZacZTPVsValMA0GCSqGSIb3DQEBAQUABIICAJxOUPlPIK1F
# ZTrq91zjkFvfOpnSMPfK4qUSs2JmL3zoelfqHn/tLbftJ4KNqdsXRgdKkxSzDLTg
# oOPIz3Sp2PDWKcTKJJE6a1JvmDC04A6dgrlCF/E0Uj6wrxmd4DNFFXh9AfO7Gx8S
# OHf4KijapzoWliP5PchzSyc1uVr4KsFqgrnbqe5KF6NLeumT11jnPrlxcFuRh+YB
# kitdcoAHmko+ufLcZZLZCYb3zRH0nZZPQqtyEzILoC6T4UYGTiDz8ass+f58//Tx
