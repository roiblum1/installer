...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactioncancel/post/
#>
function Invoke-CancelDeploymentHistory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactioncancel/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CancelDeploymentHistory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelDeploymentHistory' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/history__action=cancel'
                $LocalVarMethod = 'POST'
...
DeploymentImportHistoryInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/history/get/
#>
function Invoke-GetDeploymentHistory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/history/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDeploymentHistory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDeploymentHistory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/history'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "DeploymentImportHistoryInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "DeploymentImportHistoryInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionpause/post/
#>
function Invoke-PauseDeploymentHistory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionpause/post/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-PauseDeploymentHistory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'PauseDeploymentHistory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/history__action=pause'
                $LocalVarMethod = 'POST'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionresume/post/
#>
function Invoke-ResumeDeploymentHistory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionresume/post/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ResumeDeploymentHistory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ResumeDeploymentHistory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/history__action=resume'
                $LocalVarMethod = 'POST'
...
.PARAMETER DeploymentImportHistoryCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionstart/post/
#>
function Invoke-StartDeploymentHistory {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/historyactionstart/post/"
    )]
    Param (
        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentImportHistoryCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-StartDeploymentHistory' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'StartDeploymentHistory' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/history__action=start'
                $LocalVarMethod = 'POST'
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $DeploymentImportHistoryCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$DeploymentImportHistoryCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentImportHistoryCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentImportHistoryCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $DeploymentImportHistoryCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $DeploymentImportHistoryCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $DeploymentImportHistoryCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $DeploymentImportHistoryCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $DeploymentImportHistoryCreateSpec) {
                    $LocalVarBodyParameter = $DeploymentImportHistoryCreateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDynLfJLPJMVsA6
# swW8XNutDk8HJYzDUPOHe/dv5UUyrKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEID4nTN+FmPt8PbyB
# i65UwIBy+qHf434fYB1Zzp9zBEFcMA0GCSqGSIb3DQEBAQUABIICAC92FjkbmZMT
# qexBNOPLSERx3467HAzWuOhdOLYYmj0LBfb04euQLxbswdRsOS4QScd41CIxEVzw
# hhmo1LDq/Qp31ZBa2xjhXKcY36uQH2IIDe0v88MYJxpzUBwh9mPMqLAQYgF4lxOO
# +RJ73avRWjRDNAcAgb72S9QAQim+pTfXqjC+dIsRlDXeXAzySdfin46pH4Is7GPM
# F3mquCYrB19lePKQszuXz170HbJKdwOu1lsFPQu/i39E7MGElxfg6ycW0fWvY3i2
# EdDC0XV7xQvuiXpettURG5BSDqZEiovilOWBVsXpTurtZWkK88ZEFwJ1LnD8zKAa
# gfg6GIWttKWq1qYxmCF3KDe1PD4/cuiawhheq4LRdCcsKIfYZ3/cbjNDVBUTl3sy
# Fz4jh7a8itbDLdvpTIi8uCOXH79bNSSyK9Rt+3HcReC/cGqizX01WGWLN502fbxd
# lZ0piX+u6vT4xysu2x32aJEDtq0QUZx3JzHl8MiGnkDFO69kHyONqSETpH2zCjO2
# IkBI3fr1S66a/ew/8es/pAIJJ1zcT7kbYgpfkDDWR0d2aLqiCxHSiqkyzJremsTY
# kIAux1zeuIV3oV03ZlilKKEAQU2VW2/1nSF8TXqGSxs5sfmIrm+eroAyV5eahZ9v
# rbkHJaPRfy7wel8eJ9VviS5f13P7OEZKoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ID/7WNbJtB4mEW8dcRkAtPyFmsevoa4YZdOznnryHgSQAhAkf7H62nrer4Nm98yb
# gxVcGA8yMDI0MDcyNDE5NDAzMlqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDAzMlowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIDZZPqAlRkFJS69HUJgakWms
# x59qyZEblwy0HCq/lUMKMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAADDsR5O
# Ft4zdCRYJOn0n65u0V4Ed2rwRD+k4Ut7gtzkrtMZBN9DHsnHBV4jS/FMyhlBlrkW
# ns60xl2TRDecKA2XMYj2KIwAc7hqLPhTiqyVf79YyVO8qilc9uDgabpzT3dkAePA
# Nn3VhcEBN2C692LhbAwWDVsrNiJ9SAMKK6qJlFy56X9iz/2N4bt42gxO7cPW6auS
# MdfBZb7eKG0BC985f+kKBxuPYopGGibNwnaLImYnlPhToyGRzby08nhc6g0Szyw0
# ZowjEru8eztuL3z7VLVsTSeDBkWnFhriUN+V2wLce7JzBEX+V/awrrc7AA6CII8T
# HRtIk1FNXeCNOTH/ZtXkBt/uzCNMqhfXvAi/aNn8qhZlYZILOPWp6KwXn+kjhDVj
# jXrjoEqqzYvJgleUZEyZzyzhO8o1Vx/uXAnWZ5/ctK1gk4MwnqZPsI04QztoPRZH
# Io+vCKs4dhYFScsodxnK5UTFzif+vDtIcxaPcuC4jSJFjGbeSZabBJaD7FP6ascm
# yfh0dTT05pMvfN67L18rEiucY5ESTUxOrsSJSbVu83EmcQvJWuCnrnPxMPlMY/0J
# Y1nA7W/FT4rFF567gvCN9HQdW+Ol9/vxdMvksTWriGWDRkETojLw1OUtU1GldIDv
# XzOVaEiML4JsbYsBkCiu5l/ksSxnOx/98uOO
