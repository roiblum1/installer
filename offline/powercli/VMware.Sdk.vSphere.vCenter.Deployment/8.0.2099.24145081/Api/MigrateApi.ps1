...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactioncancel/post/
#>
function Invoke-CancelDeploymentMigrate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactioncancel/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CancelDeploymentMigrate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CancelDeploymentMigrate' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/migrate__action=cancel'
                $LocalVarMethod = 'POST'
...
.PARAMETER DeploymentMigrateMigrateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactioncheck/post/
#>
function Invoke-CheckDeploymentMigrate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactioncheck/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentMigrateMigrateSpec")]
        [PSCustomObject]
        ${DeploymentMigrateMigrateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-CheckDeploymentMigrate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CheckDeploymentMigrate' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/migrate__action=check'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentMigrateMigrateSpec) {
                    throw "Error! The required parameter `DeploymentMigrateMigrateSpec` missing when calling checkDeploymentMigrate."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $DeploymentMigrateMigrateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$DeploymentMigrateMigrateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentMigrateMigrateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $DeploymentMigrateMigrateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $DeploymentMigrateMigrateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $DeploymentMigrateMigrateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $DeploymentMigrateMigrateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $DeploymentMigrateMigrateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $DeploymentMigrateMigrateSpec) {
                    $LocalVarBodyParameter = $DeploymentMigrateMigrateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrate/get/
#>
function Invoke-GetDeploymentMigrate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrate/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDeploymentMigrate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDeploymentMigrate' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/migrate'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "DeploymentMigrateMigrateSpec"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "DeploymentMigrateMigrateSpec")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactionstart/post/
#>
function Invoke-StartDeploymentMigrate {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/migrateactionstart/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentMigrateMigrateSpec")]
    ...
    Process {
        'Calling method: Invoke-StartDeploymentMigrate' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'StartDeploymentMigrate' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/migrate__action=start'
                $LocalVarMethod = 'POST'
                ...
                if (!$DeploymentMigrateMigrateSpec) {
                    throw "Error! The required parameter `DeploymentMigrateMigrateSpec` missing when calling startDeploymentMigrate."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBasJQdx2tAXim4
# zgfq2v3zn8Y1EmMYlsu5dJeFKNgZq6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILKRHm4xjh+T6p8d
# 4yuGvldkOBUSYJa/OuIEF37U2QZlMA0GCSqGSIb3DQEBAQUABIICACQyFbo2FHNr
# 6+WuH8mSS1tQHcsQ3Lc730xdclp3co/xKddzqA0+yRmJH7iPNW0vwThRNoscQh+a
# Pw5qUdAvw9mCoVC1rP1etk3Iwmp+p8pPFoA8/AgqydHWxBR9j6suYURgoAPQFUKg
# SYPxxh4M7rP7Oj78WFHTkPnyTkMOThc2cnq8I554h7BSHymvYPEvoKEJtkRkh1iE
# cnTALLbtB0MSCu5FllcE8mjmc01mEA06tTp2IEOwYjxVbDFt1zLLApVjWSWE9/XS
