...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/install/initial-config/remote-psc/thumbprint/get/
#>
function Invoke-GetInitialConfigRemotePscThumbprint {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/deployment/install/initial-config/remote-psc/thumbprint/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetInitialConfigRemotePscThumbprint' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetInitialConfigRemotePscThumbprint' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/deployment/install/initial-config/remote-psc/thumbprint'
                $LocalVarMethod = 'GET'
                ...
                if (!$Address) {
                    throw "Error! The required parameter `Address` missing when calling getInitialConfigRemotePscThumbprint."
                }
                ...
                if ($null -ne $HttpsPort) {
                    $LocalVarQueryParameters['https_port'] = $HttpsPort
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAQGRH43W+TInNC
# mrshrQyE+ZxjeQNwmoCzTbQ18oVkIqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBfKzJs9XyTFeSee
# EPbf8l/7GWzq91hi1QqwYPrleYtfMA0GCSqGSIb3DQEBAQUABIICABRb+Tctr+la
# 9QNsF17eypvS9rcCJpROaUkO/YuPs7wQaoub19Wvqquj543Tca5MglNb34u5tXoB
# LUlXIMpFNfJ0dABwdjwShgwGv24jlyTGfzu+DZE/z+IkoNJaE8GP7qse8cHidtGy
# kFxprfHG7uoRWhpkaAkrAKMHkoNA+TPLgePfy8xZi26Z0Didpl2l2twpYSyIaMrn
# RaPvVwU+WThvKQuZzJZemlMEQCxs1P5v/n50SlwrqGrgxG3Uyb4tDJLj2Ftayugj
# facTdA7kp3Fp3/mKPCPOLDsfjYSrGuAK6nZRq7sC19KYjK10Z8YNjKpIHqMyT/C6
# KIUR29SNN8whxroAvSZ4AZZXaBOGSn/07I/67IzMVO7XYGXKU42GmYJkWlLcQCFB
# 1wJ9edj3qQV7g5E/C9MnRxR+ufx1G7H1zTkz3gH0Xa16xmI1/GFGt3P2L7avXb0+
# MMzyet4426Ovf/M2hFdAeJzDh1T/Gey0bVbVBZTCU8/A9Llk2trLe053XNDeNQzY
# 8lqoJ+KbPppEr0Dw5c0b9dahFa0EIru7ZxwTUAGti5KfyhoDofPj3CBgQ82BFuko
# V5gID6+JAbefGAuwqsYR/udeGZwi0ShFadaNR/5C8BqlQqYmcG+2PMMxGTdZN+0t
# 8rTPpcmd5GIrOqPDIhZ9la+mAfAsgfeKoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ICb2zRuR8J5tWAae72xU3+fALL7/OksFUd6Z33vFtOFPAhBKn45vM+8BLWe1B6tF
# uZvwGA8yMDI0MDcyNDE5NDAzN1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJAlZZIit2BFuzV0jJEDP5DG
# +7eMnQecLiN65v6sp5QOMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAIU+75jT
# oUvu1AsDEO19SvPdvrixTOqe34BSLs4g95/ztP4PPH2zcXi/bekfstPBiyA23HLA
# KW8J0ekd7QAIQS8DbzTL/rgwtisYdHhsSbRGjdBtQTsWqGXUFbwLjkqXWOVc+2Ic
# 7FJSAHx+qrkZ7Qcym6nlLOkfe9jnpPg+dUrTFOxo8mER6++iIvHHQj29fDL6OQlZ
# LMfbzpYQlNrSITIsPhyF+/an82SRtw+VxvxvdNIFwtNmTkLe9faqGJehL5wwuJVU
# 8ES/enV5TOOcvmBhmd+o/Ikvytlbm06fM8cHwzZQrTo04TljgAkCrRu8lTXYw6L/
# pCyUH+Lyq6wPBMXSdTG0hicEWb3VI2gvsN7rK1pacdCwn8oVW2ILDpaayeSCx8Xk
# X9gj6pWONKKXYfROtFdA0NuRiOFhQW34AebI6LqVFYiV7aaAGQYgUyDy0OJ8j601
# hVvEXumAKJojY5ARoXrDgFvu3lWKoseqOWu7fTokP8j44Wg5FlSVZ1hpFWhkmaUN
# QiZqgb99bhJOSJdoM2zCb8JCiFFdG2KWDny2gXbpw4rN3GZe7vp5rQbFvU9cyWWd
# XiUJamkR3RYlG4jwMM7Z6MD3xZ5dwr8ns9jiiOlmmGXsMTpWhicR1OhtkNbHu5Fh
# OGIa8cgHSEMr9eimFdswOGpkyw7YQ3kb/mWc
