#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.Deployment'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.Deployment.psm1'
...
GUID = '6293e930-aae2-453d-925e-b52d466a6571'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.Deployment.'
...
FunctionsToExport = 'Invoke-CheckMigrateActiveDirectory',
               'Invoke-CancelDeploymentHistory', 'Invoke-GetDeploymentHistory',
               'Invoke-PauseDeploymentHistory', 'Invoke-ResumeDeploymentHistory',
               'Invoke-StartDeploymentHistory', 'Invoke-CancelDeploymentInstall',
               'Invoke-CheckDeploymentInstall', 'Invoke-GetDeploymentInstall',
               'Invoke-StartDeploymentInstall', 'Invoke-CancelDeploymentMigrate',
               'Invoke-CheckDeploymentMigrate', 'Invoke-GetDeploymentMigrate',
               'Invoke-StartDeploymentMigrate', 'Invoke-AnswerDeploymentQuestion',
               'Invoke-GetDeploymentQuestion', 'Invoke-CheckInstallRemotePsc',
               'Invoke-CheckPscReplicated', 'Invoke-CheckPscStandalone',
               'Invoke-GetInitialConfigRemotePscThumbprint',
               'Invoke-CancelDeploymentUpgrade', 'Invoke-CheckDeploymentUpgrade',
               'Invoke-GetDeploymentUpgrade', 'Invoke-StartDeploymentUpgrade',
               'Initialize-DeploymentHistoryMigrationSpec',
               'Initialize-DeploymentImportHistoryCreateSpec',
               'Initialize-DeploymentInstallInstallSpec',
               'Initialize-DeploymentInstallVcsaEmbeddedSpec',
               'Initialize-DeploymentLocationSpec',
               'Initialize-DeploymentMigrateActiveDirectoryCheckSpec',
               'Initialize-DeploymentMigrateActiveDirectorySpec',
               'Initialize-DeploymentMigrateMigrateSpec',
               'Initialize-DeploymentMigrateMigrationAssistantSpec',
               'Initialize-DeploymentMigratePscSpec',
               'Initialize-DeploymentMigrateSourceVcWindows',
               'Initialize-DeploymentMigrateVcsaEmbeddedSpec',
               'Initialize-DeploymentQuestionAnswerSpec',
               'Initialize-DeploymentReplicatedPscSpec',
               'Initialize-DeploymentReplicatedSpec',
               'Initialize-DeploymentStandalonePscSpec',
               'Initialize-DeploymentStandaloneSpec',
               'Initialize-DeploymentUpgradePscSpec',
               'Initialize-DeploymentUpgradeSourceApplianceSpec',
               'Initialize-DeploymentUpgradeUpgradeSpec',
               'Initialize-DeploymentUpgradeVcsaEmbeddedSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBVsg/KYjs8naBF
# xA1PBmjxiZcc/sMgtXUo/23/Bl8P8aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIItGxVtYsje40/bA
# uYkoEERRDBNI1pqu81/rO0LZsuWcMA0GCSqGSIb3DQEBAQUABIICAAmPcvpULTLy
# ejEbcGwBb2c6XlA6kImufHKa0puXLRjDLcjUzbhIUYBVibZbj53QU640ht/uGI+T
# qwZMIsaeGCDgs7VSTCmtJv+jYBM07yDMRhtgDq72j4GERcKSlwr6i1ooqIK/3M2L
