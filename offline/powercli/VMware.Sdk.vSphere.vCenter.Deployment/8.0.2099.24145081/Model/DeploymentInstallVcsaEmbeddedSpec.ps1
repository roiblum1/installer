...
DeploymentInstallVcsaEmbeddedSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Install/VcsaEmbeddedSpec/
#>

function Initialize-DeploymentInstallVcsaEmbeddedSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Install/VcsaEmbeddedSpec/")]
    Param (
        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentStandaloneSpec")]
        [PSCustomObject]
        ${Standalone},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentReplicatedSpec")]
        [PSCustomObject]
        ${Replicated},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Deployment => vSphereDeploymentInstallVcsaEmbeddedSpec' | Write-Debug

        if ($CeipEnabled -eq $null) {
            throw "invalid value for 'CeipEnabled', 'CeipEnabled' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "DeploymentInstallVcsaEmbeddedSpec"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDc4+6GTbcfuBTh
# ZqqJuAnu7W5RGXwL30KSja3nUErEraCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMSIJHI6+EQGkPBp
# pRfTGEmACQRJ8t8wW9X9a9OSDL2LMA0GCSqGSIb3DQEBAQUABIICAFGekiiMTFwk
# tZlcJUtSAayHgfkPoHZ7Vxb9i7KQPyNHhf4GXuMQHep1YD6pgUupG+04tXAQeyq0
# dJu3WCSOO76ORAZKsp79cc6VZ/A6qfSYxcKe7TIyJPo6azAxuBXfINtl9sA8DDYl
# IZDS/aIwBG6F+THxkaO8tbmqm53uW8lZtF2PfEqBSLAzxC1whtXcqnHlcWf5F/NC
# SpjlmPlffk+0/iIspPsa/7U0gCQkfGhnjG5XqmFCjDg2TR4gjPBX5DZx6RrPaX+O
# 2BNZBG/INxQPA9BGtjKMnOpQOuvROHcKGJEG0mFAULFHKrAq710DBRvaUNpRery9
# H1Y9p66aWg9ujcPKid44wluvT40OqscUCvtr7ToCTrdKbwDXqSZeByCfU9nbeSvJ
# q7vFDxBbzRY1gZcHmhYbchP45C6nuEm4BRJJdrH7bLIJeKghOOu0HBpdvfv7wWHt
# YfKy6Hu0gMmPwYXIrZPrLzCuJk2uSdAkfElHTnsNoiL/7zZEuh21sJofxRnRhvxE
# 4EcfniNsouxqRQ4P757/ewF/algrOpLFyTmzV4dom0EAZyYkRPzo9jZM3RS1iZqH
# WFTOjMrTQESDLFRm44zxvge4GpJCk+VJ+l3su85KQFFGbSoVkMTJI+4hjhXxYZN5
# VMXGsDmkkNUMJQndvs+Mf8eKq/PeP3j6oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IOqJDynyLIsvIgWcoSEzTkVIp4+82ycX2+JMcnaNaQUCAhA+GhFFkh/NSv4ymahQ
# OiClGA8yMDI0MDcyNDE5NDA0MFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDA0MFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIMK4jMewa8453Hw6avJoFTmB
# Y/L1ciqycm8WS8zfAzH6MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADzI8iUd
# lvuGywMTr03BP6zC8Md7qnCsIAwHvanmibt06q5KRjcivBzxoF93W7ggSFqpbOH8
# zOwajRbwRBJT2kGD1wM6IoPhXCVkNc03h0cWi7+wMDy6DHwYVvhZHPkgK9Vb9yFi
# NYR5/Tsjds++w5WSryf2CkkqqBYDEUKJ3sCwnPw72WaFF/FF1HHF38XzofgkhTJf
# +kmoea9GUnMy0Ls74Cc8uM2ljNDxr5onZA3O5jVvvPN6nCWbwkS8aHdnJMCeBtUm
# YlnFC2MdKurRUzL3BYRqubV97taHQSCHQGqjmiSeQzk8lB3DUIYf5jpJdzs87Rqj
# k/5F55Y+0SuqgPllH74b+Bv6wyqnSmFyIV907C0FkcLmju0Kb3JVaY/buLtNCfAq
# qvOBWXFISb4UUOnQjEWUkwZuz/ECcQEeQi/SgJJsh52Oqh70i9buecKDOqfUr/CR
# p45M4PfAGRgGKYbBJZseLj4zMxBEkDH0+c8Y0nu/v+81k5WAug2xyp3np78f+Xqp
# f8oe1ZnmyETloyAmzEU5P4u0GcBUm9VhYLWLkB56N5T0zkW/hFDz04GDJnuayclD
# N4/lAZfcsO4B/VrsHxq3AjQUCj9t7I9BL8Xg3nnkkdWn9XkWDYaWOWC07ZfiE+Cr
# FbzTV3QUt17I54NAw7HfGwF5WdLLUtAk7Q2l
