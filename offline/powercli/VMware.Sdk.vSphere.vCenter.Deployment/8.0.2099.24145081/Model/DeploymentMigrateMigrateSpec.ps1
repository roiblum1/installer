...
.PARAMETER SourceVcWindows
No description available.
.PARAMETER ExistingMigrationAssistant
No description available.
.PARAMETER History
No description available.
.PARAMETER VcsaEmbedded
No description available.
.PARAMETER Psc
No description available.
...
DeploymentMigrateMigrateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Migrate/MigrateSpec/
#>

function Initialize-DeploymentMigrateMigrateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Migrate/MigrateSpec/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentMigrateSourceVcWindows")]
        [PSCustomObject]
        ${SourceVcWindows},
        [Parameter(Mandatory = $true)]
        [PSTypeName("DeploymentMigrateMigrationAssistantSpec")]
        [PSCustomObject]
        ${ExistingMigrationAssistant},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentHistoryMigrationSpec")]
        [PSCustomObject]
        ${History},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentMigrateVcsaEmbeddedSpec")]
        [PSCustomObject]
        ${VcsaEmbedded},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentMigratePscSpec")]
        [PSCustomObject]
        ${Psc},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentMigrateActiveDirectorySpec")]
        [PSCustomObject]
        ${ActiveDirectory},
        [Parameter(Mandatory = $false)]
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Deployment => vSphereDeploymentMigrateMigrateSpec' | Write-Debug

        if ($SourceVcWindows -eq $null) {
            throw "invalid value for 'SourceVcWindows', 'SourceVcWindows' cannot be null."
        }

        if ($ExistingMigrationAssistant -eq $null) {
            throw "invalid value for 'ExistingMigrationAssistant', 'ExistingMigrationAssistant' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "DeploymentMigrateMigrateSpec"
            "source_vc_windows" = ${SourceVcWindows}
            "existing_migration_assistant" = ${ExistingMigrationAssistant}
            "history" = ${History}
            "vcsa_embedded" = ${VcsaEmbedded}
            "psc" = ${Psc}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxeAjtxisF1l4D
# pGZXgjZJ5wFW8hkhVyeE9CVv/+xgNKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEUldiDghTcCQSez
# HEW9eUf+B8Ipmm0VU8kvUGb+SA/TMA0GCSqGSIb3DQEBAQUABIICAGMQjRCsD53t
# 5umRsMyBtIO2Mv0ZSkPqU94TpLm4fpBBnASKM6KIDsaLgwDtXtXklIMkZ4ajexss
# J8vdNHe/9vLVSfYGqMyvq3Z9KXEG4zs1F3GSo1P6f2u4yYPOdFHklqUsL1rqloP8
# dooX9u0A3w4kBrsuLZoworSMOGyrpe9VFe7WugorJ8SLXA4BShd7c3eG7i03lr1z
# X0X+om+ui5DHu27y4Sd3MsrHvar+1YFSyDC1KKVnF1QLCmdwRzw0luP6ToEFwK2e
