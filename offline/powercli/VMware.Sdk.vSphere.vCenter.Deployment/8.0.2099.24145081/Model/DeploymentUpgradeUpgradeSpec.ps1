...
.PARAMETER SkipProductsPrechecks
Use the option to skip products interoperability checks during upgrade prechecks. If unset, will default to false.
.OUTPUTS

DeploymentUpgradeUpgradeSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Upgrade/UpgradeSpec/
#>

function Initialize-DeploymentUpgradeUpgradeSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Deployment/Upgrade/UpgradeSpec/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("DeploymentUpgradeSourceApplianceSpec")]
        [PSCustomObject]
        ${SourceAppliance},
        [Parameter(Mandatory = $true)]
        [PSTypeName("DeploymentLocationSpec")]
        [PSCustomObject]
        ${SourceLocation},
        ...
        ${History},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentUpgradeVcsaEmbeddedSpec")]
        [PSCustomObject]
        ${VcsaEmbedded},
        [Parameter(Mandatory = $false)]
        [PSTypeName("DeploymentUpgradePscSpec")]
        [PSCustomObject]
        ${Psc},
        [Parameter(Mandatory = $false)]
        ...
        [Parameter(Mandatory = $false)]
        [System.Nullable[Boolean]]
        ${SkipProductsPrechecks}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Deployment => vSphereDeploymentUpgradeUpgradeSpec' | Write-Debug

        if ($SourceAppliance -eq $null) {
            throw "invalid value for 'SourceAppliance', 'SourceAppliance' cannot be null."
        }

        if ($SourceLocation -eq $null) {
            throw "invalid value for 'SourceLocation', 'SourceLocation' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "DeploymentUpgradeUpgradeSpec"
            "source_appliance" = ${SourceAppliance}
            "source_location" = ${SourceLocation}
            "history" = ${History}
            "vcsa_embedded" = ${VcsaEmbedded}
            "psc" = ${Psc}
            "auto_answer" = ${AutoAnswer}
            "skip_products_prechecks" = ${SkipProductsPrechecks}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCArn2QZGCbcBpI8
# 1E40B7LS5RRRKbjzT+AAjmj6zXzXx6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIH1dfYifUMOVjj/o
# aCerr20YQWbAHq2nE/XK0RkbtayjMA0GCSqGSIb3DQEBAQUABIICAHDxTeXGlwH7
# iCcAzSmXqXhvLCOTq8Wt6gL/7uU81NpN9T8k0oiApLN7R0U5AsK9Kod7k7md1N0t
# 0VqqSP6mINgkABQULtvOWNfNyvuJNe7Fc9jcywHrtVVGPuK1r1nyhy5O+vZswN+b
# dG0tl1CfqYsuQzaeUqxfD42ADHpuPRpPYNWV/OXu0xpeAfrzk29CrI5C+OMjz5VC
# Yb7J0CFGG0ZN77hLx3guJPntD2+qRzBArV3OrxAk7MK5K8mmICFmJWLzK5cNnh+S
# Kl/1L5a3q/8ZYfKIWh443elSnp7xfKu8mLcRNaLLP2RPobbNt0UzVxQvzvlrOPiW
