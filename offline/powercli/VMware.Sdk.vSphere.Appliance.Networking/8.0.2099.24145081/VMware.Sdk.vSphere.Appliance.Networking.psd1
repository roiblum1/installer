#
# Module manifest for module 'VMware.Sdk.vSphere.Appliance.Networking'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.Appliance.Networking.psm1'
...
GUID = 'bc657650-a24b-4bfe-9455-f4ee6f034e8c'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.Appliance.Networking.'
...
FunctionsToExport = 'Invoke-CreateNetworkingDnsDomains',
               'Invoke-ListNetworkingDnsDomains', 'Invoke-SetNetworkingDnsDomains',
               'Invoke-GetNetworkingDnsHostname',
               'Invoke-SetNetworkingDnsHostname', 'Invoke-TestDnsHostname',
               'Invoke-GetNetworkingFirewallInbound',
               'Invoke-SetNetworkingFirewallInbound',
               'Invoke-GetInterfaceNameNetworking',
               'Invoke-ListNetworkingInterfaces',
               'Invoke-GetInterfaceNameNetworkingIpv4',
               'Invoke-SetInterfaceNameNetworkingIpv4',
               'Invoke-GetInterfaceNameNetworkingIpv6',
               'Invoke-SetInterfaceNameNetworkingIpv6',
               'Invoke-GetNetworkingNoproxy', 'Invoke-SetNetworkingNoproxy',
               'Invoke-DeleteProtocolNetworkingProxy',
               'Invoke-GetProtocolNetworkingProxy', 'Invoke-ListNetworkingProxy',
               'Invoke-SetProtocolNetworkingProxy', 'Invoke-TestProtocolProxy',
               'Invoke-CreateNetworkingDnsServers',
               'Invoke-GetNetworkingDnsServers', 'Invoke-SetNetworkingDnsServers',
               'Invoke-TestDnsServers',
               'Initialize-NetworkingDnsDomainsAddRequestBody',
               'Initialize-NetworkingDnsDomainsSetRequestBody',
               'Initialize-NetworkingDnsHostnameSetRequestBody',
               'Initialize-NetworkingDnsHostnameTestRequestBody',
               'Initialize-NetworkingDnsServersAddRequestBody',
               'Initialize-NetworkingDnsServersDNSServerConfig',
               'Initialize-NetworkingDnsServersTestRequestBody',
               'Initialize-NetworkingFirewallInboundRule',
               'Initialize-NetworkingFirewallInboundSetRequestBody',
               'Initialize-NetworkingInterfacesIpv4Config',
               'Initialize-NetworkingInterfacesIpv6Address',
               'Initialize-NetworkingInterfacesIpv6Config',
               'Initialize-NetworkingNoProxySetRequestBody',
               'Initialize-NetworkingProxyConfig',
               'Initialize-NetworkingProxyTestRequestBody'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCLQL4qjmYNFglM
# dl42lyVMnOb3AxpLqK3IlR61HTlo4qCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIO9kQrqrJZsSzYIm
# KZdAbi4u0Mr1wBBiwUaqgc0x6/HjMA0GCSqGSIb3DQEBAQUABIICAGmlyf4XOmFk
# x7gGqad8r7JShFfYGpIJplFFcFgkVLGwppujeAxDHRdLXTdrnU7jLWC2u2r84CNF
# JxWyTjIKY4Nkch29UpXOnj90TPzzW8uZrwGj2YoR8++qWnb6BpKahrHZYvD5SRs/
# WGRkxvEZDm7CRKakW6AdvPe6hibekLUyS7E8fUk1Dwl5aUlIWxj1f27d306f7nOU
