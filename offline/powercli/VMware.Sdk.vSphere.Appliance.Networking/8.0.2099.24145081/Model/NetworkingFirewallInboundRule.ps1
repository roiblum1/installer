...
Inbound.Rule structure Structure that defines a single address-based firewall rule.
...
NetworkingFirewallInboundRule<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/Networking/Firewall/Inbound/Rule/
#>

function Initialize-NetworkingFirewallInboundRule {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/data-structures/Networking/Firewall/Inbound/Rule/")]
    Param (
        ...
        ${Prefix},
        [Parameter(Mandatory = $true)]
        [ValidateSet("IGNORE", "ACCEPT", "REJECT", "RETURN")]
        ${Policy},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Appliance.Networking => vSphereNetworkingFirewallInboundRule' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            "PSTypeName" = "NetworkingFirewallInboundRule"
            "address" = ${Address}
            "prefix" = ${Prefix}
            "policy" = ${Policy}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD2/N6l0QWNeAYX
# H3efA2S2uqlTn1nsMKGpmHFepu1Dl6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIB7bmERpuux2Rvyo
# 31y1pn3KuNd/cCfZLGI+otvPRVU4MA0GCSqGSIb3DQEBAQUABIICAFWBkgmIvoIe
# LHlCtvVL9mD1CVvl9+JliiX3ixoijtTxgYVKiPcNLsQlCAwUVtap0nKBc7pcki4S
# 2oCcl4eCRS925dawPPS/Yw7GkvWOIV3NG3oTr0oPEPKb+HuSTbvySzRItoQU6Htf
# yLZqfXMRO0KsuvSJIUY8Z3+l8sHmgW6n5ysgPQAeRybm45GPLQUomGnOOlRl/lSn
# IcCxsTnUVcu/K6niNmHefX+Ycop003ucLmAZfVBgue4GvByqforbqwZ8xGXl9Cbl
# f17Y/vY+1ACsHijl6RLFW+7jhZOdRUkCvf0GkSVkShl3671F1g4MSjPeGSHGwvcw
# QVNBu81LoWXrm2OlD7Vohri6YhQFX4n4tNf1msr/rm0L3NlhafbDccDTiSzx627x
# VLCp1wX1IgwGvetCC1FzogTKAIofAt5RC7xSlisAkrCzuXvk6pM6zA/PM9o+TQw1
# N8JIiTAWni84VH/EjWmK4ekmAcFho4QOjP+VwmauBzu943ETc8bNHrVF6apRYwxw
# p7qDtQqL6DkZKzk8ff6tD9/9jtFrgoetZXM0Bt3vs/LbeAVVisAX9yQ7q0Yz2XFn
# eD3rhpp4x+ajXjtiZAPdkwNiS+JtdMKhnBmLmpaxO9y8bkOwwhKQbv82Kcof2x0g
# y0upS6x7vfxNE7Q7z7TSxIwzYpCRKiGBoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IDGeJsPotGhaHnYUnsgD0x0N1uQ9WHR2xa8JxNrloc46AhEAkyv/oUGfNel7q3MS
# 7COzHBgPMjAyNDA3MjQxOTM0NTZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM0NTZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDLFoiIwejnw0qWPLyXUQYE
# 32N9a6Ewx2RGZ5P1ejpMmDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBf+K9D
# gnqki94tg3em8C07Q56h2zZaaRWhy93qz108t9paaYXlPLLBeYt6RvU5CYBaosef
# N6iRLe70hzmX0iXYoIau+M4RBtDsh7h9qoa2JVaNvuxeQAFJM0QZzQDhM8lFdwsm
# pPfqevJnFOsnuqShIiffKgA8FPNWYJ5b+jZLeeGwCv0hFQs7+9rRulbMmNkK27jV
# 3ijqhUOox5Xd+BFNMIFTSgo+iu7mEi3JzDg9czRYXsugxnuZJEZBJQjNVMN5snOD
# yYGp/TOfd3dfevNid2iqWx4b5UgcVbE0+KaQELpfmldTy5o0NiXKkuM61Rvj/nNx
# ZpOVmTc6EvobTnmEPcxAWvIdoX21/xvARNaZgbv9An6nEGVNWeDucigmtTC+OU5s
# mbhZtliCTr+VaOiwWcJwiFtUgdBDdI5FRr0KXqGEGcilHdybkC9LRhCb1T11gZid
# AzfKO31FzMWS0rFxnrZxswlJe2qrdtZXGiEfhvDd1hhag8p+lPcmg2fN9/9Y49eo
# BvjmW9UaYPzTIFRm0Gl/9ygAUas4pM4oZ06wsbmq92J+rlULIkahW0HdesQfI6Vl
# WH7Vktgc1gM9cDFOflEoOptySUfKhiYe9Q+Nv4YfOoGm/oL3H0DDLp7Ijp/YzSYo
# RuvgruTZVwPU0A3EJASXUdCcnMcFb89uzDpp0Q==
