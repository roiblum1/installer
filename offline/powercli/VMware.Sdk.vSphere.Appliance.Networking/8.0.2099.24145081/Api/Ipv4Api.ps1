...
NetworkingInterfacesIpv4Info

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv4/get/
#>
function Invoke-GetInterfaceNameNetworkingIpv4 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv4/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetInterfaceNameNetworkingIpv4' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetInterfaceNameNetworkingIpv4' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking/interfaces/{interface_name}/ipv4'
                $LocalVarMethod = 'GET'
                ...
                if (!$InterfaceName) {
                    throw "Error! The required parameter `InterfaceName` missing when calling getInterfaceNameNetworkingIpv4."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NetworkingInterfacesIpv4Info"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NetworkingInterfacesIpv4Info")
...
.PARAMETER NetworkingInterfacesIpv4Config
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv4/put/
#>
function Invoke-SetInterfaceNameNetworkingIpv4 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv4/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("NetworkingInterfacesIpv4Config")]
        [PSCustomObject]
        ${NetworkingInterfacesIpv4Config},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetInterfaceNameNetworkingIpv4' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetInterfaceNameNetworkingIpv4' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$InterfaceName) {
                    throw "Error! The required parameter `InterfaceName` missing when calling setInterfaceNameNetworkingIpv4."
                }
                $LocalVarUri = $LocalVarUri.replace('{interface_name}', $InterfaceName)
                $LocalVarPathParameters['interface_name'] = $InterfaceName
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NetworkingInterfacesIpv4Config) {
                    throw "Error! The required parameter `NetworkingInterfacesIpv4Config` missing when calling setInterfaceNameNetworkingIpv4."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingInterfacesIpv4Config -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingInterfacesIpv4Config)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingInterfacesIpv4Config -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingInterfacesIpv4Config -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingInterfacesIpv4Config = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingInterfacesIpv4Config) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingInterfacesIpv4Config | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingInterfacesIpv4Config = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingInterfacesIpv4Config) {
                    $LocalVarBodyParameter = $NetworkingInterfacesIpv4Config | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB4bg4HNjbYVUWk
# 0KJcmDzgDwI1gUMS/mOhBMw++k5OEaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJS29t8vy20/mjAu
# ORDUWd2/ZjPd0sG+yjsiSijqliw2MA0GCSqGSIb3DQEBAQUABIICAJNkZj0gqpdR
# RepB8F4V8PfJAF0TCGV24lbdUxhtxOQg2KIL1Mortt6XnIQdclqkcWcy10CY5bEH
# rBZD36uZHOjaxAgjh8cYpJK7r0VCJQSoc5u36IFDsAva7oaiyFivyUVLJ4zM7fl7
# CEBSC8oi8vD2LnixYocyvETwCEIP74f73RbnbtEixWfrTdn7JhbTOxWbk1PkVylh
# 5OQDZJ/veg96hUhpQG7bKutKAiRBuFjquDxf7Xf5/4jOPBbeFz7JHFAwssWqI3+3
