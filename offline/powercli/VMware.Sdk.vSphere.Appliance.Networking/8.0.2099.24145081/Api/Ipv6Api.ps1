...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv6/get/
#>
function Invoke-GetInterfaceNameNetworkingIpv6 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv6/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetInterfaceNameNetworkingIpv6' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetInterfaceNameNetworkingIpv6' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking/interfaces/{interface_name}/ipv6'
                $LocalVarMethod = 'GET'
                ...
                if (!$InterfaceName) {
                    throw "Error! The required parameter `InterfaceName` missing when calling getInterfaceNameNetworkingIpv6."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "NetworkingInterfacesIpv6Info"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NetworkingInterfacesIpv6Info")
...
.PARAMETER NetworkingInterfacesIpv6Config
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv6/put/
#>
function Invoke-SetInterfaceNameNetworkingIpv6 {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/interfaces/interface_name/ipv6/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSCustomObject]
        ${NetworkingInterfacesIpv6Config},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetInterfaceNameNetworkingIpv6' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetInterfaceNameNetworkingIpv6' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$InterfaceName) {
                    throw "Error! The required parameter `InterfaceName` missing when calling setInterfaceNameNetworkingIpv6."
                }
                $LocalVarUri = $LocalVarUri.replace('{interface_name}', $InterfaceName)
                $LocalVarPathParameters['interface_name'] = $InterfaceName
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$NetworkingInterfacesIpv6Config) {
                    throw "Error! The required parameter `NetworkingInterfacesIpv6Config` missing when calling setInterfaceNameNetworkingIpv6."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingInterfacesIpv6Config -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingInterfacesIpv6Config)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingInterfacesIpv6Config -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingInterfacesIpv6Config -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingInterfacesIpv6Config = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingInterfacesIpv6Config) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingInterfacesIpv6Config | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingInterfacesIpv6Config = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingInterfacesIpv6Config) {
                    $LocalVarBodyParameter = $NetworkingInterfacesIpv6Config | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDK8F5e/kFEcRym
# A+1ReVraaETYau8al/U18JZFtH0PyaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBW8+kCdy+98ZtQK
# rug900uTXnOedcnBI7j8p2mpGf6zMA0GCSqGSIb3DQEBAQUABIICAImLMqwhV2cu
# 9KuGwL8rzbx9RR0bnrcMUpjyusjloea8BfAf1HUeZKH9ZXL70QCKz0NLQ7/ITguc
# g1UQadCQUZC74mob1M42i5iVpiJr1yqJIv6TpS93ItxCrRqHpucrTqK/O17ckpmG
# bwV0EDSTrQFwiiQ0arly7oEwfhDgBJtOAWRZ699/5g4UuIauRsUptP15tRh/bFAO
# V6oodDill/yU00vsJ6IdqwuSqnLz28GnI1QF/vxkX3k2Jm9Qq8yti338/x3HQU7e
# 65IQGB7jIwwvKariiBIkQLt5uBsujC+tgvYK4Gu0uAGWYYFJPXwTcLn6735Tu890
