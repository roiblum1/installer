...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostname/get/
#>
function Invoke-GetNetworkingDnsHostname {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostname/get/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-GetNetworkingDnsHostname' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNetworkingDnsHostname' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking/dns/hostname'
                $LocalVarMethod = 'GET'
...
.PARAMETER NetworkingDnsHostnameSetRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostname/put/
#>
function Invoke-SetNetworkingDnsHostname {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostname/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NetworkingDnsHostnameSetRequestBody")]
        [PSCustomObject]
        ${NetworkingDnsHostnameSetRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetNetworkingDnsHostname' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetNetworkingDnsHostname' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$NetworkingDnsHostnameSetRequestBody) {
                    throw "Error! The required parameter `NetworkingDnsHostnameSetRequestBody` missing when calling setNetworkingDnsHostname."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingDnsHostnameSetRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingDnsHostnameSetRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingDnsHostnameSetRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingDnsHostnameSetRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingDnsHostnameSetRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingDnsHostnameSetRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingDnsHostnameSetRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingDnsHostnameSetRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingDnsHostnameSetRequestBody) {
                    $LocalVarBodyParameter = $NetworkingDnsHostnameSetRequestBody | ConvertTo-Json -Depth 100
                }
...
.PARAMETER NetworkingDnsHostnameTestRequestBody
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostnameactiontest/post/
#>
function Invoke-TestDnsHostname {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/appliance/api/appliance/networking/dns/hostnameactiontest/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("NetworkingDnsHostnameTestRequestBody")]
        [PSCustomObject]
        ${NetworkingDnsHostnameTestRequestBody},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-TestDnsHostname' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'TestDnsHostname' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/appliance/networking/dns/hostname__action=test'
                $LocalVarMethod = 'POST'
                ...
                if (!$NetworkingDnsHostnameTestRequestBody) {
                    throw "Error! The required parameter `NetworkingDnsHostnameTestRequestBody` missing when calling testDnsHostname."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NetworkingDnsHostnameTestRequestBody -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NetworkingDnsHostnameTestRequestBody)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingDnsHostnameTestRequestBody -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NetworkingDnsHostnameTestRequestBody -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NetworkingDnsHostnameTestRequestBody = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NetworkingDnsHostnameTestRequestBody) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NetworkingDnsHostnameTestRequestBody | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NetworkingDnsHostnameTestRequestBody = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NetworkingDnsHostnameTestRequestBody) {
                    $LocalVarBodyParameter = $NetworkingDnsHostnameTestRequestBody | ConvertTo-Json -Depth 100
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NetworkingDnsHostnameTestStatusInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NetworkingDnsHostnameTestStatusInfo")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAl693TQ76+mdgd
# jl53QSpy6FC0XW0d+niirEZXp9VTQKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFCnJmswlAE3fStM
# kGk5Aq1w4cYPUfn/6WMf/Pzfn2PiMA0GCSqGSIb3DQEBAQUABIICAGIFAnXE0Lfo
# czJ7YLzSJ1AC15l5+XLGbvEnlDG+7I+aYObBIQ9Rfaca/IrzQl01kJLg8aXGp+MB
# av1YJED0JJ2bSAVJOrIIzHahXLgUSyem+JhrQqdmmkIBsyCi7rLU43rhD+sLVZkl
# kcyiOzuA6JT7yQVO8ZzJPoo0kYpBeNI+zQZi9fBjVxYx7rrfyzaRy5q2Ay5p8XoM
