...
.PARAMETER SettingsDepotsOnlineCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/post/
#>
function Invoke-CreateDepotsOnline {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("SettingsDepotsOnlineCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateDepotsOnline' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateDepotsOnline' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/online'
                $LocalVarMethod = 'POST'
                ...
                if (!$SettingsDepotsOnlineCreateSpec) {
                    throw "Error! The required parameter `SettingsDepotsOnlineCreateSpec` missing when calling createDepotsOnline."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsDepotsOnlineCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsDepotsOnlineCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDepotsOnlineCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDepotsOnlineCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsDepotsOnlineCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsDepotsOnlineCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsDepotsOnlineCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsDepotsOnlineCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsDepotsOnlineCreateSpec) {
                    $LocalVarBodyParameter = $SettingsDepotsOnlineCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/delete/
#>
function Invoke-DeleteDepotOnline {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-DeleteDepotOnline' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteDepotOnline' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/online/{depot}'
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling deleteDepotOnline."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depotvmw-tasktrue/delete/
#>
function Invoke-DeleteDepotOnlineAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depotvmw-tasktrue/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteDepotOnlineAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteDepotOnlineAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/online/{depot}__vmw-task=true'
                $LocalVarMethod = 'DELETE'
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling deleteDepotOnlineAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depotactionflushvmw-tasktrue/post/
#>
function Invoke-FlushDepotOnlineAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depotactionflushvmw-tasktrue/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-FlushDepotOnlineAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'FlushDepotOnlineAsync' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/online/{depot}__action=flush&vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling flushDepotOnlineAsync."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/get/
#>
function Invoke-GetDepotOnline {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetDepotOnline' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDepotOnline' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling getDepotOnline."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsDepotsOnlineInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsDepotsOnlineInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/get/
#>
function Invoke-ListDepotsOnline {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListDepotsOnline' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListDepotsOnline' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
...
.PARAMETER SettingsDepotsOnlineUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/patch/
#>
function Invoke-UpdateDepotOnline {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("SettingsDepotsOnlineUpdateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-UpdateDepotOnline' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateDepotOnline' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling updateDepotOnline."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsDepotsOnlineUpdateSpec) {
                    throw "Error! The required parameter `SettingsDepotsOnlineUpdateSpec` missing when calling updateDepotOnline."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsDepotsOnlineUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsDepotsOnlineUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDepotsOnlineUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDepotsOnlineUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsDepotsOnlineUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsDepotsOnlineUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsDepotsOnlineUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsDepotsOnlineUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsDepotsOnlineUpdateSpec) {
                    $LocalVarBodyParameter = $SettingsDepotsOnlineUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAPeJW6jB5TUDSW
# FK7iImqOTz/CSMLG5Byy1HcvySP1WaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE