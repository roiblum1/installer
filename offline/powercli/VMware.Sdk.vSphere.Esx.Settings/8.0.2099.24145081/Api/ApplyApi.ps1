...
SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/defaults/hosts/policies/apply/get/
#>
function Invoke-GetDefaultsHostsPoliciesApply {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/defaults/hosts/policies/apply/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDefaultsHostsPoliciesApply' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDefaultsHostsPoliciesApply' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/defaults/hosts/policies/apply'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec")
...
SettingsHostsPoliciesApplyConfiguredPolicySpec

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/policies/apply/get/
#>
function Invoke-GetHostPoliciesApply {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/policies/apply/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostPoliciesApply' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostPoliciesApply' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/hosts/{host}/policies/apply'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostPoliciesApply."
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsHostsPoliciesApplyConfiguredPolicySpec"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsHostsPoliciesApplyConfiguredPolicySpec")
...
.PARAMETER SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/defaults/hosts/policies/apply/put/
#>
function Invoke-SetDefaultsHostsPoliciesApply {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/defaults/hosts/policies/apply/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec")]
        [PSCustomObject]
        ${SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetDefaultsHostsPoliciesApply' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetDefaultsHostsPoliciesApply' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec) {
                    throw "Error! The required parameter `SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec` missing when calling setDefaultsHostsPoliciesApply."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec) {
                    $LocalVarBodyParameter = $SettingsDefaultsHostsPoliciesApplyConfiguredPolicySpec | ConvertTo-Json -Depth 100
                }
...
.PARAMETER SettingsHostsPoliciesApplyConfiguredPolicySpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/policies/apply/put/
#>
function Invoke-SetHostPoliciesApply {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/policies/apply/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ${Host},
        [Parameter(Mandatory = $true)]
        [PSTypeName("SettingsHostsPoliciesApplyConfiguredPolicySpec")]
        [PSCustomObject]
        ${SettingsHostsPoliciesApplyConfiguredPolicySpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-SetHostPoliciesApply' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetHostPoliciesApply' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling setHostPoliciesApply."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsHostsPoliciesApplyConfiguredPolicySpec) {
                    throw "Error! The required parameter `SettingsHostsPoliciesApplyConfiguredPolicySpec` missing when calling setHostPoliciesApply."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsHostsPoliciesApplyConfiguredPolicySpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsHostsPoliciesApplyConfiguredPolicySpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsHostsPoliciesApplyConfiguredPolicySpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsHostsPoliciesApplyConfiguredPolicySpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsHostsPoliciesApplyConfiguredPolicySpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsHostsPoliciesApplyConfiguredPolicySpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsHostsPoliciesApplyConfiguredPolicySpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsHostsPoliciesApplyConfiguredPolicySpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsHostsPoliciesApplyConfiguredPolicySpec) {
                    $LocalVarBodyParameter = $SettingsHostsPoliciesApplyConfiguredPolicySpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpu249eWUkmRFd
# PH9amv2Ie/nZiY9HgfCUrn/5h+jshKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILMpYafA/1105q6F
# WdSOUl38Bwa4/572SRnVBLPuF15fMA0GCSqGSIb3DQEBAQUABIICABIX7AugrqqU
# t1i3Rw58/0NxrTKwQCTmWT8234YCNvtYsBkzbc6URI7DuHl/63FMqrQmpebsTwNx
# iiHNiFx7Z7SmtEqSm4cdp2lc8ozjZuL0npfJKjuL0QlKH0MMnsT1iLuLs3rQMqEW
# /nzkpDGKcnSRKqBSTqLRCB4dJlTDiIy/9WzPsMMhzhSpNGulX12baBBH/wnizKWB
