...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/base-image/get/
#>
function Invoke-GetClusterDraftSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/base-image/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetClusterDraftSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterDraftSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/base-image'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling getClusterDraftSoftwareBaseImage."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "SettingsBaseImageInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsBaseImageInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/base-image/get/
#>
function Invoke-GetClusterSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/base-image/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/base-image'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/base-image/get/
#>
function Invoke-GetHostDraftSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/base-image/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostDraftSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostDraftSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/hosts/{host}/software/drafts/{draft}/software/base-image'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling getHostDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/base-image/get/
#>
function Invoke-GetHostSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/base-image/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/hosts/{host}/software/base-image'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
.PARAMETER SettingsBaseImageSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/base-image/put/
#>
function Invoke-SetClusterDraftSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/base-image/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Draft},
        [Parameter(Mandatory = $true)]
        [PSTypeName("SettingsBaseImageSpec")]
        [PSCustomObject]
        ${SettingsBaseImageSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetClusterDraftSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetClusterDraftSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling setClusterDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling setClusterDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsBaseImageSpec) {
                    throw "Error! The required parameter `SettingsBaseImageSpec` missing when calling setClusterDraftSoftwareBaseImage."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsBaseImageSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsBaseImageSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsBaseImageSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsBaseImageSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsBaseImageSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsBaseImageSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsBaseImageSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsBaseImageSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsBaseImageSpec) {
                    $LocalVarBodyParameter = $SettingsBaseImageSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/base-image/put/
#>
function Invoke-SetHostDraftSoftwareBaseImage {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/base-image/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-SetHostDraftSoftwareBaseImage' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetHostDraftSoftwareBaseImage' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling setHostDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling setHostDraftSoftwareBaseImage."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsBaseImageSpec) {
                    throw "Error! The required parameter `SettingsBaseImageSpec` missing when calling setHostDraftSoftwareBaseImage."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDjWgWPkjTPrIfy
# qRaMOFmn7G7uv61RQ0wLrx7JVvX8nqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKBdL/jWuA9WbE6G
# ACb7UvYmTVogIBHi9g/zOUsLsWy4MA0GCSqGSIb3DQEBAQUABIICAJAP3vnrUDOp
# lahNHqxUWZvCWzu2CR7AmceavwZ1GIR/Hy19lrRxjnTfeDvAPYCy6WfKn+YsE9AC
# g2jxnmpIMXruGlW+QaL1U7cwFb+n/mUhEdli5kIAvWyxPP1HJL4I8KBoNZx/3vRJ
# +pQEemuFagpuJspoh4aW3ZWEDf9yO3NCgkKE4lZm2OpgcbMmRsx4e4keGD0peea/
