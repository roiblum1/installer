...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/delete/
#>
function Invoke-DeleteClusterDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/delete/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeleteClusterDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteClusterDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/add-on'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling deleteClusterDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling deleteClusterDraftSoftwareAddOn."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/delete/
#>
function Invoke-DeleteHostDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteHostDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteHostDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/hosts/{host}/software/drafts/{draft}/software/add-on'
                $LocalVarMethod = 'DELETE'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling deleteHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling deleteHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/get/
#>
function Invoke-GetClusterDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling getClusterDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsAddOnInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/add-on/get/
#>
function Invoke-GetClusterSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/add-on/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/add-on'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/get/
#>
function Invoke-GetHostDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling getHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/add-on/get/
#>
function Invoke-GetHostSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/add-on/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/hosts/{host}/software/add-on'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/put/
#>
function Invoke-SetClusterDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/add-on/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-SetClusterDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetClusterDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling setClusterDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling setClusterDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsAddOnSpec) {
                    throw "Error! The required parameter `SettingsAddOnSpec` missing when calling setClusterDraftSoftwareAddOn."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsAddOnSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsAddOnSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsAddOnSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsAddOnSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsAddOnSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsAddOnSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsAddOnSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsAddOnSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsAddOnSpec) {
                    $LocalVarBodyParameter = $SettingsAddOnSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/put/
#>
function Invoke-SetHostDraftSoftwareAddOn {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/hosts/host/software/drafts/draft/software/add-on/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-SetHostDraftSoftwareAddOn' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetHostDraftSoftwareAddOn' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling setHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling setHostDraftSoftwareAddOn."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsAddOnSpec) {
                    throw "Error! The required parameter `SettingsAddOnSpec` missing when calling setHostDraftSoftwareAddOn."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKDnV10iXR7LV9
# AxnbHclUVoaubqlS8xG+ivvB6ktauqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINPrksdRhhrqH+iG
# ANFOV56llLM8U8V+IMfUwJtL8HRlMA0GCSqGSIb3DQEBAQUABIICACVKdffvJ6Rp
# vFKy8VyKDLgiww2RlYZT3Gz1io/Z4o0si93xtzJePznQY8qOLS0ZNEQVZaPf3z02
# eXqbSe4rW5/OXO0kerfJUaZQraw6ziwlv0v3X6S9j6u55bZX1K+Q1TFeiP9W0OcC
# l2jk5R4sAiUWHPe+qTJmU7/WA2AsebpOe4ExymCk3kwDbxBRI+TZp1fKqVYU2qwi
