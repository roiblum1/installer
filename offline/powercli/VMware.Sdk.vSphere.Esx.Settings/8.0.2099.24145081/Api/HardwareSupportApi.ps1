...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/delete/
#>
function Invoke-DeleteClusterDraftSoftwareHardwareSupport {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/delete/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeleteClusterDraftSoftwareHardwareSupport' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteClusterDraftSoftwareHardwareSupport' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/hardware-support'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling deleteClusterDraftSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling deleteClusterDraftSoftwareHardwareSupport."
                }
...
SettingsHardwareSupportInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/get/
#>
function Invoke-GetClusterDraftSoftwareHardwareSupport {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterDraftSoftwareHardwareSupport' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterDraftSoftwareHardwareSupport' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterDraftSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling getClusterDraftSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsHardwareSupportInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsHardwareSupportInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/hardware-support/get/
#>
function Invoke-GetClusterSoftwareHardwareSupport {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/hardware-support/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetClusterSoftwareHardwareSupport' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetClusterSoftwareHardwareSupport' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/hardware-support'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling getClusterSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
.PARAMETER SettingsHardwareSupportSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/put/
#>
function Invoke-SetClusterDraftSoftwareHardwareSupport {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/drafts/draft/software/hardware-support/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Draft},
        [Parameter(Mandatory = $true)]
        [PSTypeName("SettingsHardwareSupportSpec")]
        [PSCustomObject]
        ${SettingsHardwareSupportSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetClusterDraftSoftwareHardwareSupport' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetClusterDraftSoftwareHardwareSupport' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling setClusterDraftSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{cluster}', $Cluster)
                $LocalVarPathParameters['cluster'] = $Cluster
                if (!$Draft) {
                    throw "Error! The required parameter `Draft` missing when calling setClusterDraftSoftwareHardwareSupport."
                }
                $LocalVarUri = $LocalVarUri.replace('{draft}', $Draft)
                $LocalVarPathParameters['draft'] = $Draft
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$SettingsHardwareSupportSpec) {
                    throw "Error! The required parameter `SettingsHardwareSupportSpec` missing when calling setClusterDraftSoftwareHardwareSupport."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsHardwareSupportSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsHardwareSupportSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsHardwareSupportSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsHardwareSupportSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsHardwareSupportSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsHardwareSupportSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsHardwareSupportSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsHardwareSupportSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsHardwareSupportSpec) {
                    $LocalVarBodyParameter = $SettingsHardwareSupportSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBd0cOo602h6oOz
# +0+reePTApYL0wMlqFPmZ0jvvZiNAaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIK0onfqxS+j22WD
# cIh60vzIy8lL/JSKzGdw4bpfXgBGMA0GCSqGSIb3DQEBAQUABIICAKIh1TuuAre4
# 0ZFW62mJpujO+zsQgOyDGuFnN8bimD65BBLPD3F3CwRAIgZVr05Y3DH0iaEiYBoU
# UIgwW362bXtonIdCHL5FDaZzySds/V2UfVd+28ZkW+MB/E6wEEfo7I7gqze/lBh2
# FqY20esQPn46mLUFuFAlbeBYhvwRoWhEiBhV+WDMbAzLFYjEihpCvIAp9nPKlgaw
# 8c5w8VbWwVy3453QkmK4M2p0mRSUgUjcy/OWRDFXZezaR8abUWgTA1APoANfjIGN
