...
.PARAMETER SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/reports/hardware-compatibility/storage-device-overrides/compliance-statusvmw-tasktrue/patch/
#>
function Invoke-UpdateClusterStorageDeviceOverridesComplianceStatusAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/clusters/cluster/software/reports/hardware-compatibility/storage-device-overrides/compliance-statusvmw-tasktrue/patch/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-UpdateClusterStorageDeviceOverridesComplianceStatusAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateClusterStorageDeviceOverridesComplianceStatusAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/clusters/{cluster}/software/reports/hardware-compatibility/storage-device-overrides/compliance-status__vmw-task=true'
                ...
                if (!$Cluster) {
                    throw "Error! The required parameter `Cluster` missing when calling updateClusterStorageDeviceOverridesComplianceStatusAsync."
                }
                ...
                if (!$SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec) {
                    throw "Error! The required parameter `SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec` missing when calling updateClusterStorageDeviceOverridesComplianceStatusAsync."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec) {
                    $LocalVarBodyParameter = $SettingsClustersSoftwareReportsHardwareCompatibilityStorageDeviceOverridesComplianceStatusUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAuGR3KuzLAlxhD
# pUaSMUs8Fl2R68vnGTAeFN6TTYvRzKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICXAv4XNi6QJJrum
# 4rw913DWBs/ykq7ZE/5Vmm6+1gq4MA0GCSqGSIb3DQEBAQUABIICACdPpcLTF0/M
# rMS3N65Sjqz8wu2DqvhyS3QcTgfKpcdqUZ6tYOqgLBg1zBTwI6lPCYECAgFrtc7M
# b7p6Ti9W8nKIApF00nJkWpLvUTg9JRZl9lqZoTVVK1zUpYDf8fj0Q0EFGJrA5N+6
# tae0nFmQKr+xdpAkQBhKsAO9aqf6bvZgsBNEIHHTMinu4uAl59vFbY+ukyhQ/sci
# MTR43CMOTvGuXb6HVXZOKA0I2KSV/2xg/4ACIKUvkcZEnsJlJYGqPo02SX0ZkQQs
# IdR7Eshege4QHJEeqX4I9nuxFUpgytABD9TeGqvUIC0hcQQMaKAqxJLY1JCvy5uI
# gs4ArsSkWgL4AAi072fB3uMKYGC8jQVuvCWw37YpX9E8mJauYAnoTw6o3usN8+G4
# nsq7NARzlzqwx3/BOvB+ZFTy2Qt6EURwiUxfkY/KfpOAo+T78YFRsHQJ5+6Vm8ct
# fvYdydWx0VkUWqYF7+hNUY6iadRbIms5rveHLDV9hrC0H7eNrSjmQkWN6SzV/23x
# ixPTrX6AZNwRE9GzzT8gEO3HCjarVoawz874jwNmjXYxPrWOdDSkWgkguTyykgUB
# 1ZiUt/kSM264A0+k2RTabVWNwjbeSTzAGVx5b/onnwKxgrTVA3VGniRvTYBdW+OA
# 3o577/qAGgTQ+YnYLGJf20gqpUsvI8uYoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IC0nJjiTMXJp2gxkRbrtBS/mhcPJp67bZyBtCJcK6iejAhAiGwwBsTvRcjsPACuW
# EoO3GA8yMDI0MDcyNDE5MzcxM1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5MzcxM1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEILVmV5OGlJud/ZTtnVgRbtoA
# VQBy1r9xC7BWCaJJIuL4MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADPsGnqJ
# cCV7+saresiLuZ1PWyRU+d74BI/5Vu9GJbE1AeIWU5v3t7H0fCqkaRRZ1iU3WGPA
# nbnBAiCI4F8Yyc/pnh/M+S+cIgqrmzBUE0uLRRqlCJwr287jWt4fmCVH0mqLuXFF
# KMmfNaF87oXOGIKBQwrtt2Y4EXIlojWFINK74nwd210sYikP+xQMjKLxm94+RWFx
# pFT49Cxy7tQxwKHJjZcew3NRKjVdf/XgYuBMOLBTs98QqJNSA3Wg2pS2Ch6aexSx
# ksDIbKlKo2big10JeXmxzVsHfj3zvAaLnENQlHyCC4hbWe6Nn+hOTjKmS25O0+0P
# DX8aQg9mIZ7Dd2/bgWOr6pdMEmv+fPMBXRFVSCSsgnoDreONEEqM/JCjnsYPCu7P
# rrTz6K1mTzJiw5IbcNPaKPnPwdFZ7q+VZOzXXf/lHJlFydUM0K1ETUN14xaSfPwi
# HO0eJ2FLFTfpAbrc4yS+WnzSqjqZchsYDI3uVG0EEW1NEzah8hMn88pOzMVC16sr
# 2wkgQ5Flv8eBOTKlsxzm0Kx3ohvc90Ft78HeUI8zz4kdhCzNwXHaX9TF1eIz86KD
# UYAesoVcd49inxP6j/zNZg+zVgjX4JZlnBuZaGysSjYs2ygDkYIuHMoC+zBx5aqd
# LLzxAIRbf3QEmahR2Fu3vbk4lN86bG10P66Y
