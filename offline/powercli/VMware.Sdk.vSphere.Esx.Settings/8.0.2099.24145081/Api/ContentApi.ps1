...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/offline/depot/content/get/
#>
function Invoke-GetDepotOfflineContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/offline/depot/content/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetDepotOfflineContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDepotOfflineContent' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/offline/{depot}/content'
                $LocalVarMethod = 'GET'
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling getDepotOfflineContent."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "SettingsDepotsOfflineContentInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsDepotsOfflineContentInfo")
...
SettingsDepotsOnlineContentInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/content/get/
#>
function Invoke-GetDepotOnlineContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/online/depot/content/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetDepotOnlineContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDepotOnlineContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/online/{depot}/content'
                $LocalVarMethod = 'GET'
                ...
                if (!$Depot) {
                    throw "Error! The required parameter `Depot` missing when calling getDepotOnlineContent."
                }
                $LocalVarUri = $LocalVarUri.replace('{depot}', $Depot)
                $LocalVarPathParameters['depot'] = $Depot
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsDepotsOnlineContentInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsDepotsOnlineContentInfo")
...
SettingsDepotsUmdsContentInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/umds/content/get/
#>
function Invoke-GetDepotsUmdsContent {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/settings/depots/umds/content/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetDepotsUmdsContent' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetDepotsUmdsContent' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/settings/depots/umds/content'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "SettingsDepotsUmdsContentInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "SettingsDepotsUmdsContentInfo")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAkxtlKWtMsNVCm
# R/4e+Vy7pzyWd874gAt+zoOfcBRuxKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEQJnTYLbNhWEfTQ
# kBIfkKb1GKhMyx2e/x0wL+EWIbHtMA0GCSqGSIb3DQEBAQUABIICAIF2NU9Z44CP
# 5U/iaBBnpkOf54Uy3S7kG1OUIPYvcD5A/5jhiMm6t+uFoEPobhtrPfxXF2m7XjZc
# x//UEc0sZIVAXUuUvbJAhrouyt9cKIL2xpJhLxb+6ZL0HO2+zELR94kuftbvkmoa
# eQTc5N11qJjuO6L02wZcH7yOIJnV0JluyhskAPjYA5gtuFAw99AbqpqNf4jLfH56
# dFRv+rgppmgbxF56NmmXM4MnlQnelCIOK1/ousPYGTcM2q0cQrvMWGrXtSF/URVk
# 66EAfcjQVyZ5U6tDdIeW0vKXNESoalmVlfhIc5LjHSwzEsrR5yzt9DI84+AoVK7e
# r5eXIsaQLXkwzDI9gBJaKxGxC8LzE8m93EP8/PiYPGj2SQbHhmpbEJc5j7h6SrxP
# e/Za3iwQrUTvvGeRDWxBm/InsDOLdAHOGruILYzgwJxEILrPoPr0sn26rKcPDfL4
# CB5C2UsVFYqwHLBMZmSdQLXD2i77MDrMABjUKS1kOVNpuyHwHw2fkNofGEO67awB
# qV7oGnc92uky3QT9J/nm6+PtnHlr2rS+zTlN5XCWeO/EW9Na+mPKSO1mRe5BFS7L
# Zd4Cq7DZRrHhVKYEwEFVv2BS7kStxI8QYlnXvoRzlyTWhOrk6DEkNL+TT0o9BTMl
# MYZoQBNBubrJtCi0/5tYhmLkXisXpF7ZoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IKx56yZ9Fz4DQi3YB7DyIlRRABkB44DDwiFmNClPSlzpAhEAsQQGYm5JB2eKTww0
# DVQX+hgPMjAyNDA3MjQxOTM3MTVaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM3MTVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDnuOul9jROe/yrrOVbBW3l
# GAYl/v1JTfwFdKsRX+IafDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgA0zgwj
# J6gHuFy4vB5EfWkXr51h2s2/I+Hw9GsbK4HIQ55DNYkQNyiB/o7Ca5S2uIrgpmp4
# dA0QL7XHZREOTNawqXBD5HPTRB3efApr12dgCJaIokXLdOi7AQTmv1eUGYO9l4b8
# FE+UDQvrgnqfRH+dzecIutyvucv6FX13OpH8k4CScPuE7RkxMTrvVSN2BCkGZ7aO
# 10TrY/e0O/rfc4wbzKsMqEEfoloY2GSO70Dgk1ks8XcXi8BBRJ43j4GjPi9Y05H2
# CBqJRATVaqondHR3ULexvzr6uxrzka9eTipz8vMz41vohMYNCsMexZ+gYUEeJlU6
# CcuuBEdY1LLcQi3WYmqh2lKUB616lCgtJLho0IYXW3fL95C6v7cd651yF0Ucg7RA
# JJL5WzV9B5OUlyKlGCxkeT+6sgj4cWBjRn109jRcC3ikfHbLrgAdvO/NJHRQ8UwQ
# /t/z4OcL0p5S8FeYty2LhzMAPVKobqQx1SdJ/TWcA0BW9S9qU3QdpZpZYNGdfwba
# bLavZXdLeBkJLRfoy1LlZIIr/QyDX5G6gRwBNfNhjAvNPmDOSc0vLXLdQm9B+SKt
# M/H4uQVNvsNlv73OQmIkBnlKKHbWjtOpndxUfANRKoSsSPx+t9/ayiZpwXAlMuXB
# MyfcUscIAbHzMjQz6fGgciyV7J96qe8tRbPIgQ==
