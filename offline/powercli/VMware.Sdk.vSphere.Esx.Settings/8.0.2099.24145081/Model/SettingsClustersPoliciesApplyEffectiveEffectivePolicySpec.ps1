...
.PARAMETER ParallelRemediationAction
No description available.
.PARAMETER EnforceQuickPatch
Enforce quick patch on the cluster for images that support it. This field is optional because it was added in a newer version than its parent node.
.PARAMETER ConfigManagerPolicySpec
No description available.
.OUTPUTS

SettingsClustersPoliciesApplyEffectiveEffectivePolicySpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/data-structures/Settings/Clusters/Policies/Apply/Effective/EffectivePolicySpec/
#>

function Initialize-SettingsClustersPoliciesApplyEffectiveEffectivePolicySpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/data-structures/Settings/Clusters/Policies/Apply/Effective/EffectivePolicySpec/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("SettingsClustersPoliciesApplyEffectiveFailureAction")]
        [PSCustomObject]
        ${FailureAction},
        ...
        [Parameter(Mandatory = $false)]
        [PSTypeName("SettingsClustersPoliciesApplyEffectiveParallelRemediationAction")]
        [PSCustomObject]
        ...
        ${EnforceQuickPatch},
        [Parameter(Mandatory = $false)]
        [PSTypeName("SettingsClustersPoliciesConfigManagerPolicySpec")]
        [PSCustomObject]
        ${ConfigManagerPolicySpec}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Esx.Settings => vSphereSettingsClustersPoliciesApplyEffectiveEffectivePolicySpec' | Write-Debug

        if ($FailureAction -eq $null) {
            throw "invalid value for 'FailureAction', 'FailureAction' cannot be null."
        }

        if ($PreRemediationPowerAction -eq $null) {
            throw "invalid value for 'PreRemediationPowerAction', 'PreRemediationPowerAction' cannot be null."
        }

        if ($EnableQuickBoot -eq $null) {
            throw "invalid value for 'EnableQuickBoot', 'EnableQuickBoot' cannot be null."
        }

        if ($DisableDpm -eq $null) {
            throw "invalid value for 'DisableDpm', 'DisableDpm' cannot be null."
        }

        if ($DisableHac -eq $null) {
            throw "invalid value for 'DisableHac', 'DisableHac' cannot be null."
        }

        if ($EvacuateOfflineVms -eq $null) {
            throw "invalid value for 'EvacuateOfflineVms', 'EvacuateOfflineVms' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "SettingsClustersPoliciesApplyEffectiveEffectivePolicySpec"
            ...
            "parallel_remediation_action" = ${ParallelRemediationAction}
            "enforce_quick_patch" = ${EnforceQuickPatch}
            "config_manager_policy_spec" = ${ConfigManagerPolicySpec}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJm0sI8sb8UtWs
# Cfd6z13iGKyGRnt5hfsrirm0eoFbOqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIzCQEwqVIBEQHKk
# 7o3MQqhIkySMqeYZSxX6fKmldaCcMA0GCSqGSIb3DQEBAQUABIICAD9JJlF3AkYM
# nxZgoxhals+tcutYu2zJB3pGjQGCcNMgRosSRZVoIrP4akqwsRj7UHAmC4mmQ45x
# 62zazgoADf7Q4lsQRKOuXT8XZZ+9mqLufthzat4Ha3Z/vN0Ik3lBZ530MEZQKPm6
# aq4nvazmxMxurMJ8+qz3R2R0JE6uGLV7xgPSCZiYKVCscvVTR+pAotK5EEq4dgrS
