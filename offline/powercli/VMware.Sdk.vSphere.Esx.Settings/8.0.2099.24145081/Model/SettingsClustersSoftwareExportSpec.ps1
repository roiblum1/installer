...
.PARAMETER ExportSoftwareSpec
Whether to export software specification document.
.PARAMETER ExportIsoImage
Whether to export ISO image.
.PARAMETER ExportOfflineBundle
Whether to export offline bundle.
.OUTPUTS

SettingsClustersSoftwareExportSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/data-structures/Settings/Clusters/Software/ExportSpec/
#>

function Initialize-SettingsClustersSoftwareExportSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/data-structures/Settings/Clusters/Software/ExportSpec/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.Esx.Settings => vSphereSettingsClustersSoftwareExportSpec' | Write-Debug

        if ($ExportSoftwareSpec -eq $null) {
            throw "invalid value for 'ExportSoftwareSpec', 'ExportSoftwareSpec' cannot be null."
        }

        if ($ExportIsoImage -eq $null) {
            throw "invalid value for 'ExportIsoImage', 'ExportIsoImage' cannot be null."
        }

        if ($ExportOfflineBundle -eq $null) {
            throw "invalid value for 'ExportOfflineBundle', 'ExportOfflineBundle' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "SettingsClustersSoftwareExportSpec"
            "export_software_spec" = ${ExportSoftwareSpec}
            "export_iso_image" = ${ExportIsoImage}
            "export_offline_bundle" = ${ExportOfflineBundle}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPRcIV68/t+Bm3
# dOb+LFXtmbT/0r4u5vIn56UEljE4JqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGXc19Ynp/vHUZq2
# EJz0cHfb7hoNaKMnmrFTFxiZCumGMA0GCSqGSIb3DQEBAQUABIICAB+gBIw2gipl
# HcsT5B/PxNIFoWn788tQcW87RnS7Sz9i+7W2rCTCjLjqYwQS6Uw/2Fzmzsi2wy7z
# CxNLBI3ioy54ZwVVBwheKYO1uHNObI5sondQEWiq48LXIy4Q/kEk4LwtjXGXk2sQ
# LJdK+PU/fLARYX6qAM7Gn3rwn0P/Yt9E/WUKMm2jQnpVXTivb+Ok7bHRuWCe1s8W
# /0PX/cUMJIYPzX6CDm45Ji0WDvvE6uYJY15GqDMFrpMasLNjJpgR4lP6kYAHdmws
# mEVBq3J3yanPc2zwWIwWuj6EbP0iKbmjCjuqxaD1rQTOqpW3Zv5hJYsKid4LrrqI
# 6F8iJQQxj4nSnIVkoO+t5aLUMjX7iKr/w1A6V4vKkPqO9DZ/K4udLzFhrtIOvvdD
# VKNVxogeOiFv7875kwyGgj7VH5JqIV3S7I+Rs+6EdfR80u4+ZqJT2KKj+etS1BbQ
# Umjh2fLh7M++QXfFLQViYB3cMU5S4zCEd8b4e5bFcoMclPzfPxRwvrKZOvqCBslo
# oiNDX3VKi2ETtNPZm65kezZStIVuLSe2KcqnQY6AQ2jEF7xIPyZukU2ORyZBIZEQ
# UEo3qosyGYE4O+v0O/7ZCr9EjLfXJ5hGR1J5RBQi9raigpd6wccMjxwQFHTpsLCX
# Utno30sMXHShASIjYTRLIwT55FckWxXSoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IHm0IU5inZ8EVTmznWxuG24C9BAdYy1QC/G2vENsiMMKAhEA03PgW7znG/SvnepM
# fanDPRgPMjAyNDA3MjQxOTM5MzNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM5MzNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCASW53Ub12rf95SeRW1LcjG
# n+K1JbmyyxSREIQRFrZJ3TA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCFBIdQ
# w55AKZXgrvbUwkuhxIdnZEZbPgOo/i0NKN2q76CwbaW1PkmU0tzVtNQg9e/rqd0D
# wOl+Rn9UqIAVcchc5IJzcdsyBUjCcUHcliNyjL/o1Qask7EgloLDC2iR3y836tn4
# pp9nQuEaM6PYeMDA3KWLOdjfSsnN7q0sumUImkyvOcf59JcDiD83f9HFRrBzxPZZ
# M7KpRwGs01B++1TYy46KFLHDv17UbPsKPDLPxYZ/41tQ4i7nsgk65A/9TiSpxqAE
# sTLbHZPHVUfYD0iuQXV3xo2iZkQszHyxPnDBp7MX4M+BRnApMKjGv8wc54tUsSVz
# bcwSVqwsuCaaMllMsNAOev3ltIba+sNnrrsfi3TWWzUbmotNx/q/9/KOEJT9I6UG
# TqxGi7g0si296vie0Z2YwRBnJ3+jqEcw4NxaANDs/9rPdZrwlDkySZnJ4nFmAkdr
# CY+Fa1rOZMKf0zUSRCUhTANvMABDuUsMRcC1KfcRzYHOoIhu4TBklIr5lkTbZPOG
# BYbbYPuXlcgDqyORXAT8uL7TbNLaTszQFBleLJBSaKtM/rdFKhR6Grp/lgtHkuAf
# 8TNcwdOvGKSMOza/sfCODW6nNTeObgsquuuAqoiwOSZwHZQDU4YhmeQX0QPFsxgh
# R/9koV95GTV5uvnvRDiVEwS/vjtOr0JwcciWQg==
