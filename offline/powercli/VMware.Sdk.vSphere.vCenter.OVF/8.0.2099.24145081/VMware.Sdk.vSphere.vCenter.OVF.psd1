#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.OVF'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.OVF.psm1'
...
GUID = '30f059d8-7bdf-4034-b70f-9e72b1b2047c'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.OVF.'
...
FunctionsToExport = 'Invoke-ListOvfExportFlag', 'Invoke-ListOvfImportFlag',
               'Invoke-CreateOvfLibraryItem', 'Invoke-DeployOvfLibraryItemId',
               'Invoke-FilterOvfLibraryItemId',
               'Initialize-OvfLibraryItemCreateRequestBody',
               'Initialize-OvfLibraryItemCreateSpec',
               'Initialize-OvfLibraryItemCreateTarget',
               'Initialize-OvfLibraryItemDeployableIdentity',
               'Initialize-OvfLibraryItemDeploymentTarget',
               'Initialize-OvfLibraryItemDeployRequestBody',
               'Initialize-OvfLibraryItemFilterRequestBody',
               'Initialize-OvfLibraryItemResourcePoolDeploymentSpec',
               'Initialize-OvfLibraryItemStorageGroupMapping',
               'Initialize-OvfLibraryItemVmConfigSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCsRrUtR8JQh8t4
# i0H4KdawHOEYM6xrixt/BCrhpGfsBKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBKgHVwDPIXxa/0+
# U3dDf4FL5aa3yYoA0VKce8qHjeMUMA0GCSqGSIb3DQEBAQUABIICABAZl7wA7PB5
# f3yDf4rt/CvTv18M9P6eNFycWbHPONkpKlAlMx0XNZNEFziqk/iaKtp/ZY4nThzH
# PqNG/89LkCNb1DREirjiqdQsRUDgsxIMT+lLSP8KWacn8Cr0hi3vniei0uumUp5P
# QKiy7TO1IdO8+7jLH4n/efLXtlpzd18lufVE87VnGeg8SdVZp7clWgBO3LCGmBBd
# hgXrlSnZWIy2GStwU9XWHwaXSudqww4yusVMbn5pPg/VIB/kszq9FLUkxT0ZnHbQ
# 4v2he2fBJocfM4TTVnQHQrkaZxhk1zzd1s/rfP9rxovL+nxFYigK8W/F5BM9wpUY
# ZJcm2UyQWIeSnPF4kTsIY29yyFRRoOeIjOgF4qk1p+JqyDT9eUvImlK3vKuG2FD2
# NQllxLbBTbvdNU5sQiS6oGQN4kJ3ffbQxcj6YNtUGVu6Vw3xtgwSWSkjsdcd5C6S
# DgwA0o2CNIeFrmunLf+mLy8UBYR1Mr1ggkohUL5shgbZ+3u3rkV8sufal56PddcP
# D2Tco0Q7Y29Yrta2epjPMAwWe5bstK/+nVUd4ph4ADdCWy3XnzqRaC2qqE20h/GY
# uvt14DXlqgC5Fwm3yeywnlUEWl/+a/Q3DaBiG1S0BgBE1MfKiMXYeAQqsz5XNYAe
# jwJgezsKQhi5yj8cDcB7hfEumLt/XxA4oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IHkUGvGHuGybQpl1On0xz0sXH0ZEWTSJNzue25VLA40MAhAM56LQWl3FhzhacgWj
# qOrNGA8yMDI0MDcyNDE5NDI1M1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDI1M1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIHZAHWBjm1AbJjT9jmu97vsW
# klb9NpXYjXqj6OxcwVBtMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAIDwFV9y
# bBVLepqAK8jSO0yu+ol2rh8Yf3pWNicTzKyQt1X0lJfR+xn6LpoYYdnRFMv0jhtY
# wNLqO4Q9S9c3Rno6/MhzXUd97JUKpFmxizBNR5WFJNOidNzFn+sWO26TCmTWyT1l
# hN42nCjM5kmSiA8lQzrD+6B/U+UMRCkP5r/q0hYXOu1pAPdzajBrhybb7kqJDU9+
# qt80AVn5BNvNR3rz4kZAQ57uLxcdeQFSuOJ2btoYZCOIxnSxiZd6t/hiMmP5UDKi
# 7G03ud1ow3SFoioeETXwSqwwYY20FxkmcfbYtalyJSdwT0yiL80OrVqL+n1VtuLL
# Gs2LTELsW+lvBeGyH5Z+Y+WASOPHeujMybSVoxlbDVs42NlHZUPpwDtk5JFzMmUG
# RDwWwZOfqPPBFvH93UN+Z/mWSDGcTCSRH61IXNrEebhZ7DH6jnYdin5k3PShOKsQ
# xYZKxBqc1k0kvlHfP6A3+Ax2te3L0MXh6wSPF/9DloaiV5CvpF/KGrJrKl9eN9Gq
# Go779au7HM2GhkCO9LTfWYkWa2QeH6Cbwgeo5wfy+hXwp6o/zXU+nuG4qsYbQeEY
# 2C7biCoc0aPk+dclnOGnxvglAkZA7/pdgwJqT7Ivu9tcttyI1B36NI53m8LMv667
# lhGFPYR+5OqeEqeVqXkAKgRnEaBrhvp5jVXV
