...
.PARAMETER VmConfigSpec
No description available.
.OUTPUTS

OvfLibraryItemResourcePoolDeploymentSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Ovf/LibraryItem/ResourcePoolDeploymentSpec/
#>

function Initialize-OvfLibraryItemResourcePoolDeploymentSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Ovf/LibraryItem/ResourcePoolDeploymentSpec/")]
    Param (
        ...
        ${DefaultDatastoreId},
        [Parameter(Mandatory = $false)]
        [PSTypeName("OvfLibraryItemVmConfigSpec")]
        [PSCustomObject]
        ${VmConfigSpec}
    )

    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.OVF => vSphereOvfLibraryItemResourcePoolDeploymentSpec' | Write-Debug

        if ($AcceptAllEULA -eq $null) {
            throw "invalid value for 'AcceptAllEULA', 'AcceptAllEULA' cannot be null."
        }


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "OvfLibraryItemResourcePoolDeploymentSpec"
            "name" = ${Name}
            "annotation" = ${Annotation}
            "accept_all_EULA" = ${AcceptAllEULA}
            "network_mappings" = ${NetworkMappings}
            "storage_mappings" = ${StorageMappings}
            "storage_provisioning" = ${StorageProvisioning}
            "storage_profile_id" = ${StorageProfileId}
            "locale" = ${Locale}
            "flags" = ${Flags}
            "additional_parameters" = ${AdditionalParameters}
            "default_datastore_id" = ${DefaultDatastoreId}
            "vm_config_spec" = ${VmConfigSpec}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVXF9nWXJX6Yij
# 7ouWFNqCQnmCGwMveQi9nrMX4CiDcKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG1ceMJ72BzUyIrI
# jx2+86Ie2m8Eav65hJt35J9/bTTmMA0GCSqGSIb3DQEBAQUABIICAKQ+f1AF1AD8
# 57CiJ1J7cweuq3odWiIzGHcwXwGaZdzG0d9PHsTBOL6cCW6UkirnvcHdFVMrmXHo
# Rgc8l0HPILMr4GptzHwFz/UG0763kE12mkD7lkxo/KUS/Uu+qz0+jkAm6n9nP5te
# iIrnopuH7B8iEMkSpx8lpb4RB8NTX6GSxfDSFq3ynmTe+cwmOoCkNfGjDqv57Jha
# ho/5/xFZby6bmL4DrWG9myYFtHOHaoR+sXfIpLV1WmZSvUv/FnPypHcUJ64GefaS
# z15inpdkhBVeGM3jFsjbBDKYgEMVlbJZMj7+uyRW5MCti82iwgsVvSRI1qGGrKm/
# 34kWbTAvQSWq9w3hZVZgDmlcGGJ+maiQjbzcNctFdHy11y297q+FUbgvc+4/qJqo
# 1rl8dyS9vhOF2NP7hA4p308tF8JrV80gmLpVxnZ+PhlArv5EyRW13lYG3KIPyVf2
# 5/6N1Ylfcbs8gTMI/yqgP4PPOPBGcg0iJ86wkrLeVmmeaQT0WzhT9NFWF3hrUi0H
# Mef0B/12xbKVgVWhod90FyPlwHN1KOS3NAbufBKHl2WXgs1qqH2pdiccYxIeUS5+
# 0uua3SN50YIQ5ljOStObGBtj9wnm8GIvbjI6NtDbbVZr7nHSBN+9zJN699S1azo6
# nyEaHiyFuFwH6L3sOauWnXbDqWUxnP8ioYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGqUiHk0sK3IP3W8YtIP6QIyBFU4LkGQOQ2CE2eI9gOfAhEAlFISLD8+e4RPkKea
# pbvZCxgPMjAyNDA3MjQxOTQzMDBaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBnW2lOMC9V0D/J0UZTW+em
# bDzr4kSh2jS5Pf00LcZLmTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCCpHBA
# 83yOUWcKIQ62wLoefzWSNpQ+XNtPDy5ciZlNGheaPcNOfhpc7X33I6hxt/KMkn9s
# Qq02l0Y5YcPIVyC7/CA1FJSK7TYiYACj+y2E5VO7tcQrwJvlO4JgM2KdP9MKfOr5
# WuQIxo6v3am9mFFU6o9NulLhIFL79jmIfLOaQiWimaXmRB8uGYxxuqDIkvqALKkc
# vXuq0tyxReZ7i8lp3+SWrL84/VC88AINyWxXn7VB5YcExyAOfH4VHdmUmJCZ5L4B
# BPIn3AHziaK/qDY/yp4s1ZAPDtSkQe3tVAtBWTxIA/PwmUCBzvYaS9oYAz5p3OId
# QxoNnry+Z66MZzpEPHgbjuFkV3LO8hMRzET482eDVBmCPVELIeHsCoWrf3eQ0fe/
# 8khQhRim01pXXIWaQzUrcdHtxT0qR8V+skvf9o44RYYpYOmyKnFCvdw+RotnW3KU
# VmswcTnr0K0N1G5s/2cCuEVr4HwxFcH0/9YCVaDW4V4mSvDcuVE+3DkBlwOrSOsh
# 6hfz2dlvvjA+1qlTBU1d8Iksku/LPew58jsSfdQ+eByQwxafEF3M8pOFoZRQ4NF4
# EtdiwELa1N6Uc4LTPy0qn2lL7rzNvbpYMrxCITyzIHXsGaA10VO7PgAibyOdw1nR
# lV4K4/gQJa0EAkk4S35I2H41rhM8spsRHZSmDQ==
