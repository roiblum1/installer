...
.PARAMETER DeploymentSpec
No description available.
.OUTPUTS

OvfLibraryItemDeployRequestBody<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Ovf/LibraryItem/Deploy/RequestBody/
#>

function Initialize-OvfLibraryItemDeployRequestBody {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Ovf/LibraryItem/Deploy/RequestBody/")]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [PSTypeName("OvfLibraryItemDeploymentTarget")]
        [PSCustomObject]
        ${Target},
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.OVF => vSphereOvfLibraryItemDeployRequestBody' | Write-Debug

        if ($Target -eq $null) {
            throw "invalid value for 'Target', 'Target' cannot be null."
        }

        if ($DeploymentSpec -eq $null) {
            throw "invalid value for 'DeploymentSpec', 'DeploymentSpec' cannot be null."
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCq3Nx0NfXe/84z
# tD12dO13Nw2J1cLCvoKVMRIN2XvgPKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINXN8YCP0gifmimM
# 6z4T0UoGuTtADxoc3Dob9dU27QDOMA0GCSqGSIb3DQEBAQUABIICAG+kSc8wdNMA
# Wtc/aAwUxzDOdCwLLlgV7GCJHGbz0cFzPAhyVTKOPLEApqAasXhrC8BSuaBcyut0
# 6wF1eG+pgw/PqRVt9bEm6FcYr9TPQ0JMOorW8Ql4Yuc+LDwjK/Jvc9sV37Qs+VsV
# 7ZfXKVy8GJDUIb6/iLsw080yLJwprL+e142aKfS+wCCrf5xS8tcb2nVru/kofBTq
# bENt+qLCCKIvXp2Su7jl/+r4RWZSiveDyDfio7m9v42xwXRZc4FB/olhi4f7+2xn
# APLkcpNFCIenTQihKJ+RkCGG+45ET4Xs5TNxaoXLJBxhcPU46Mut78j+jXuQFQ/i
# memtACZeqPK+F0kaHuc3SLx0ugwZaDMw2i8Arv+BCWzrRf560u+nUXkpAKigGIve
# ZLiFSYV0hzzCNkyPqH/QIGWGSBPIuYwiPR9hd0MrHz1iaG5BgEwCUm9SbtoeNO3Z
# oE9bz7yOEmHT9se2KrJQRHJBqZHRjikcButWOW4SH9fwfbanaZ8ZcoTCPLRDzTrJ
# 0PTXlBSl4wSfBUx5MqdBd4tDo5E1EvBSBXmfG7NucbBdQIYFpChqxON8xwFYeAFB
# QeXxdShSD+bfJln6zP2fx4VO7hyAR1URbuCUHcOfDzT1F45fdF5x7h1k/4wrYH0x
# OYnAG6pbNX06xiLRvtnHVjOUtP14M7q4oYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IG09PrmFWrI3AG6cixQWqCBPdOpMq6sOhrFY2OyrYcjBAhAh2JbGe/F78Pks4UKR
# vbUdGA8yMDI0MDcyNDE5NDI1OFqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDI1OFowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJT42+ARHyWq+8e/z9iVp9N/
# Jg9z76HOu1Z9wjzJ+91hMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEDAYQjc
# w5Wynz3q49di1Wq79JtZb95wu9Vjo0a4tgb4KHE4SijREfIqbdG6CYiOnE8lcoDO
# S+Lp9sWnWkjlgHUexIAJoH/jUGeErlEUkgAkukGSe5MkAQp6OvpFj56Khwl2Etcw
# p5cohRNEFYfYqU5C0I+avy79E9MF+CbpH+GFrfxQSxmROtKW7FkOfqZly/Or0zsB
# drEeXPinrVb4eaP/t3oy5mHLQ2uJf3kxsWE6XHu1ZSV5a9qzVBtdnVvJOi9por2T
# V1ZW3VIVSVfIGDFzSg0c0I5E9F7WIH4IY1Mxz4xU7txsbJaxktf6gJ5iJnFlhVyA
# flp7DSTmftiBxLCWe9wujy/JFVDow5Id3n+S5c4HYkBUJCgfPJFtbQLnfPSY0MBA
# OGtyddXmoCFWxuCDhY8h27VVAyf2MGtuVo+ZIxE5//0c7z0SoheLnbA8EgyMZnPq
# ozhVH4vcB6Y2erZhZE6dWm7EgIFfbkQGc2Gr1lBzD8ysQ1FSLabbVbgSoKpA1BgF
# PgX1GHHk1fpyWAB0Hsm9n14Vjbk2BeZVlewH6ebvQgKmjRF/ypqUlTlEztzWPZE9
# TULW6uDIEsVgipN+GnhETTRn5yzzhbGI1fjTIpiMeS6Qv90stwjMrbR473HDjLT/
# 7d27+69L8KPRJiHWJxDyVfRsiklR/iVJD0in
