...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/compatibility-dataactiondownloadvmw-tasktrue/post/
#>
function Invoke-DownloadHclCompatibilityDataAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/compatibility-dataactiondownloadvmw-tasktrue/post/"
    )]
    Param (
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-DownloadHclCompatibilityDataAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DownloadHclCompatibilityDataAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/hcl/compatibility-data__action=download&vmw-task=true'
                $LocalVarMethod = 'POST'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/compatibility-data/status/get/
#>
function Invoke-GetHclCompatibilityDataStatus {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/compatibility-data/status/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetHclCompatibilityDataStatus' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHclCompatibilityDataStatus' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/hcl/compatibility-data/status'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "HclCompatibilityDataStatus"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "HclCompatibilityDataStatus")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjJ0MwVgcFQwtN
# OcWXX5urtTaUgY8Zl+YvDcsaNU77qaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKqcS3mWvtm9P3Pz
# qggHcgBHpdoCOm7AEwflPoutdhhqMA0GCSqGSIb3DQEBAQUABIICAAhOjotUaB+d
# Bu2FKYOwbDOOfvwCydyphI9cLpiojV2K26UcLGQihnbpb+Gxxm38MYITuWQUHths
# 42iVSSueaTudG8/7Iyw6oYxCehmYmo44wauwPevkKS26P3L2fAQ1E9GUdgz9Z0jI
# /hl1nctJaxTdxN1EZ5/gxZKtbqxBW6mxzz2qKtV3yFnXXSjxl/WDZNmTg3Dc+t9M
# wFexD7kH4RRwYY28xHCP49j8/1OMvzPhRl9vNVY4q9SguJFvRT3LFOC0ER0YCoA5
# ULCV3hzkvVppKlWGwtT+3eAVbDtEraeA/MetGn1oirky2khbD+r7Yb+3QvsZ5nFh
