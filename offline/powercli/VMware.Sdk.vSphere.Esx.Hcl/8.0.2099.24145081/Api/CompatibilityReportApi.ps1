...
.PARAMETER HclHostsCompatibilityReportSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/hosts/host/compatibility-reportvmw-tasktrue/post/
#>
function Invoke-CreateHostCompatibilityReportAsync {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/hosts/host/compatibility-reportvmw-tasktrue/post/"
    )]
    Param (
        ...
        [PSTypeName("HclHostsCompatibilityReportSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateHostCompatibilityReportAsync' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateHostCompatibilityReportAsync' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/hcl/hosts/{host}/compatibility-report__vmw-task=true'
                $LocalVarMethod = 'POST'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling createHostCompatibilityReportAsync."
                }
                ...
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $HclHostsCompatibilityReportSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$HclHostsCompatibilityReportSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HclHostsCompatibilityReportSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $HclHostsCompatibilityReportSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $HclHostsCompatibilityReportSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $HclHostsCompatibilityReportSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $HclHostsCompatibilityReportSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $HclHostsCompatibilityReportSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $HclHostsCompatibilityReportSpec) {
                    $LocalVarBodyParameter = $HclHostsCompatibilityReportSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/hosts/host/compatibility-report/get/
#>
function Invoke-GetHostHclCompatibilityReport {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/esx/api/esx/hcl/hosts/host/compatibility-report/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetHostHclCompatibilityReport' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetHostHclCompatibilityReport' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/esx/hcl/hosts/{host}/compatibility-report'
                $LocalVarMethod = 'GET'
                ...
                if (!$Host) {
                    throw "Error! The required parameter `Host` missing when calling getHostHclCompatibilityReport."
                }
                $LocalVarUri = $LocalVarUri.replace('{host}', $Host)
                $LocalVarPathParameters['host'] = $Host
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "HclHostsCompatibilityReportResult"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "HclHostsCompatibilityReportResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVOzZfhHbKbxlt
# llTb6tm1CthH2LbRAd0H9oG35t9zg6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI