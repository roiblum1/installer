...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/service/get/
#>
function Invoke-GetService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/service/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/services/{service}'
                $LocalVarMethod = 'GET'
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "ServicesServiceInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ServicesServiceInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/get/
#>
function Invoke-GetServices {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-GetServices' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetServices' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/services'
                $LocalVarMethod = 'GET'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionrestart/post/
#>
function Invoke-RestartService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionrestart/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-RestartService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/services/{service}__action=restart'
                $LocalVarMethod = 'POST'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionstart/post/
#>
function Invoke-StartService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionstart/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-StartService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/services/{service}__action=start'
                $LocalVarMethod = 'POST'
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionstop/post/
#>
function Invoke-StopService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/serviceactionstop/post/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-StopService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/services/{service}__action=stop'
                $LocalVarMethod = 'POST'
...
.PARAMETER ServicesServiceUpdateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/service/patch/
#>
function Invoke-UpdateService {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/services/service/patch/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [PSTypeName("ServicesServiceUpdateSpec")]
        [PSCustomObject]
        ${ServicesServiceUpdateSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-UpdateService' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'UpdateService' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Service) {
                    throw "Error! The required parameter `Service` missing when calling updateService."
                }
                $LocalVarUri = $LocalVarUri.replace('{service}', $Service)
                $LocalVarPathParameters['service'] = $Service
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$ServicesServiceUpdateSpec) {
                    throw "Error! The required parameter `ServicesServiceUpdateSpec` missing when calling updateService."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $ServicesServiceUpdateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$ServicesServiceUpdateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ServicesServiceUpdateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $ServicesServiceUpdateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $ServicesServiceUpdateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $ServicesServiceUpdateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $ServicesServiceUpdateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $ServicesServiceUpdateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $ServicesServiceUpdateSpec) {
                    $LocalVarBodyParameter = $ServicesServiceUpdateSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDX3MUgeT68reUs
# nSY4fAn1Fq2x084wjAgz5QLeUJ40aaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIfKmAFPa4EEx3Fa
# olU9KcNr9N5/a0Ms4r20oFyB/AAMMA0GCSqGSIb3DQEBAQUABIICADMOJk7cMpRo
# GWN+6FEoIC4Iz/P5s1MC2fB9ItayKvR4G8Klw9NI1z/xSSdsfCL/vfmgPtL3H1ld
# +wkZTZyuWLa9t1WzRFtJTLcChmjQKzWaSPFQt26Qo3ctI0ayk/4TQu2kLcfMe2Wl
# fwx+TQeVO6p8Gi/Ft+6tl+b9xE92jJQxv0vmXyh4fpmUWc9m+l/N2mq/wau7l+Y9
# EITVVznD3IbBJvm6t7ZGIafaSjZo2wUeItjnEA+i43nvU3ZU5T6lCPeg7NvIqmA/
# yqTNVIvIElbGp6EFf7VHSqA048QV8tmTwlQv3EPKA0uz4pZzJlvsuLqjyxw+AQSb
# F+M7fR12jdG15hKiAlr0Hympqtq3vmOzTyYyGo0IXnTvbYAoV2uz5bapi9eKAVPF
# LWAut/mPKnQywU8bnQihxU6PWlpkts2dX68tuIn3Wdb2B73Q7oVavQ/UZuc/JOeS
# bnBjFmEYdDm2haUV13QpI48h8zIPouYvA8NmiedAT49HOf1KkeIVVzTVBf2gQRGH
# 28Aev0v88eJhvsdkKCYB6p2/KrGLoEYEZINKur0KZ5jGePaG1X7xzSXgFj5Kpk1c
# /LrCimJ7hTYvIvLzHV8OJorsw9ZXcKcpXNu51D2BD2U02XzrEwOR+utT2gdNeayV
# pFs2+e7pEdznO4dw9dJjCGpbLKKi5qsGoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IPVmsZyJ1gMvfzuodahyq8LoYekJOc7AV8QNznvWAwUUAhEApbZqX6DDNuGYDjIp
# WV3TwBgPMjAyNDA3MjQxOTQzMDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQzMDJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAr75dig1ntBZrTxBA572JU
# okGpEPGPy15g48JTGrz8kTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCBhZ+G
# kOhJgLG0Bd4JHol9BJwX64CKA+NXxmDklFtvGZRbGA/+SFHuyvFiwSF/7wB0rmQe
# ZtKgLCHa/seQctPMZGHQiyBjb9W9lAQQ6SExUl9fPFd5Zq0+WTud+LRveD6xxIPI
# OHwmwv53iBISHzSxdcZ/ytfsvW1Ev3zBQQevGiY1h7uvIoJm68Z0wkXE9sGx9BEN
# zgjWvpVTweNWBI+jO/D5DgxmYzON+aNQXyz7Emk9pN7es52byCQa34JxZx980sPC
# IqkswspqoNmrnRoLNaHGIt7phNmHgRlMSqjHWdeBgPT+sOB3PlfApyJ40P0zwxhi
# A2PWAW3+b6ir6aQ0rGYACNUc/XpA6dJy1wP3gP/aRg/pfTMz1orn9BLFMuYbCc8z
# yWYb4bJvMrIbEgW35S/l8M61LQdgoe+FyBy/LV6OqAj99v6D0h5MaGKckcwE3ZEE
# 3+da1e0Gtozhu5XhynsEDqwTQSxSAPMqS0F76K/XDKPNtLmcPJsEKX4CTNA4THw8
# 2D3vSYeX/xSjOWRdVog/yu4cp4U9q5ep27l+qRTlE2KZJ1UUbAcb1S9k/QRC8jW/
# Iy52Z1lEjaTMwyY0+Znko1UrOA2eNssdVloBn9OBmUjSrUUQVS6aTzROmvzFe6dO
# 7pl0UbD7o1MO7hT2q8tKbuVJAMU6BfzjQYU/6Q==
