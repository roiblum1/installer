#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter.Namespaces'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.Namespaces.psm1'
...
GUID = '662568dd-c65c-4b82-8336-7d70eeadaa41'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.Namespaces.'
...
FunctionsToExport = 'Invoke-CreateNamespaceDomainSubjectAccess',
               'Invoke-DeleteNamespaceDomainSubjectAccess',
               'Invoke-GetNamespaceDomainSubjectAccess',
               'Invoke-SetNamespaceDomainSubjectAccess',
               'Invoke-CreateNamespaceInstancesRegistervm',
               'Invoke-CreateNamespacesInstances',
               'Invoke-CreateNamespacesInstancesV2',
               'Invoke-DeleteNamespaceInstances', 'Invoke-GetNamespaceInstances',
               'Invoke-GetNamespaceInstancesV2', 'Invoke-GetNamespacesInstancesV2',
               'Invoke-ListNamespacesInstances', 'Invoke-ListNamespacesUser',
               'Invoke-SetNamespaceInstances', 'Invoke-UpdateNamespaceInstances',
               'Invoke-ActivateClusterNamespaceSelfService',
               'Invoke-ActivateWithTemplateClusterNamespaceSelfService',
               'Invoke-DeactivateClusterNamespaceSelfService',
               'Invoke-GetClusterNamespacesNamespaceSelfService',
               'Invoke-ListNamespacesNamespaceSelfService',
               ...
               'Invoke-GetSupervisorNamespaceTemplates',
               'Invoke-GetSupervisorTemplateNamespaceTemplates',
               'Invoke-ListClusterNamespacesNamespaceTemplates',
               'Invoke-UpdateClusterTemplateNamespaceTemplatesNamespaces',
               'Invoke-UpdateSupervisorTemplateNamespaceTemplates',
               'Initialize-NamespacesAccessCreateSpec',
               'Initialize-NamespacesAccessSetSpec',
               'Initialize-NamespacesInstancesAccess',
               'Initialize-NamespacesInstancesContentLibrarySpec',
               'Initialize-NamespacesInstancesCreateSpec',
               'Initialize-NamespacesInstancesCreateSpecV2',
               'Initialize-NamespacesInstancesIpv4Cidr',
               'Initialize-NamespacesInstancesNetworkCreateSpec',
               'Initialize-NamespacesInstancesNsxNetworkCreateSpec',
               'Initialize-NamespacesInstancesPrincipal',
               'Initialize-NamespacesInstancesRegisterVMSpec',
               'Initialize-NamespacesInstancesSetSpec',
               'Initialize-NamespacesInstancesStorageSpec',
               'Initialize-NamespacesInstancesUpdateSpec',
               'Initialize-NamespacesInstancesVMServiceSpec',
               'Initialize-NamespacesNamespaceSelfServiceActivateTemplateSpec',
               'Initialize-NamespacesNamespaceTemplatesCreateSpec',
               'Initialize-NamespacesNamespaceTemplatesSubject',
               'Initialize-NamespacesNamespaceTemplatesUpdateSpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB12amSG+zyxP9F
# KeSalLdQfQ8ZlLS58zHF+TNuNMUgJqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIE