...
List of Content Libraries used by the VM Image Service. This list refers to existing Content Libraries in vSphere inventory.  The Content Libraries specified in {VMServiceSpec#contentLibraries} will also be included in this list but will be read-only by default to users.   If the same Content Library is present both here and in {VMServiceSpec#contentLibraries}, then:      -  The Content Library is only surfaced to users once.    -  The settings here are honored.     NOTE: Any change in the VM Image Service Content Libraries associated with the namespace will be updated and merged with the Content Library list in Instances.VMServiceSpec. If {UpdateSpec#vmServiceSpec#contentLibraries} is unset, the Content Libraries specified here will be honored and the Content Libraries removed from the current Content Library list by Instances.get operation will also be removed from VM Service.  If unset, the Content Libraries get configured based on the values in {UpdateSpec#vmServiceSpec#contentLibraries}, if it is specified.
.OUTPUTS

NamespacesInstancesUpdateSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Namespaces/Instances/UpdateSpec/
#>

function Initialize-NamespacesInstancesUpdateSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Namespaces/Instances/UpdateSpec/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Namespaces => vSphereNamespacesInstancesUpdateSpec' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBE2FsNK38w4Fai
# 8RUT9yOzmlAAh+zMer8VmxTFSwsIKqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFX0M01o26JaHBSw
# soEjpb8G6Fqdu0iiw+cYtskcGGvCMA0GCSqGSIb3DQEBAQUABIICAA5wTt0qn+Y0
# La0AgpwSEkFBfo0Gm5snPBKM8EVUOrmurIbNP6sf2moKA1d09ux9A7dgOtaxwXiE
# fSBwqd5YASAocCXfCZUNymrv+TG0tCeBQxOQJQiWj+hRfiwul8sIUlok80vrA/HW
# L79x4JZC2fr1UOkumqaiZ3xJnYKtnVs2SMDsA7pg5Qc+2ziFQByUg7/BDGg0MW1k
# BiCDJ1ycdDoKtLbTvAP77wIfiyoxaEcY/HH9HPMOG9SLJJEkl/mzWyCpI/XX/mcI
# TDiUTggvICa3Z4JvyQyPd3tks4hzFXE/6VDq1DsDtyJ8VsAl+jVdmsX3m7/N9JBT
# TAhG+/6oFE0eGVya1Ag//CF67C/rH6rB+b9m7qjAtv7vPxKZZEU6mGRFwRk8UPpZ
# chCLHFMS/C+i3HfYAzMLqykGOlVnoG/y/nFYYlHXbchSDrhthBEB7hiCA68IRQnL
# CL1XDz/szcYQGOyUUxY8Nh2FT7CiQaglB0MrJLf9egRl5/hukadjKyHdYPxP3pNV
# IqiHsiRSViIBFr2/A9rTQR5PIKo22uFvewyzczMeZT5lAA+qt0eCJxDQrkd3HmKp
# kUujhDE7k0icMqs8HPZAPyfx3Repk8g/L14oM5+top8jaHxO0ZoMgeZInexMdNDx
# S9gEoeBJok0YZ1RL4qTEaVedmMov0q0AoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# ID9Sqx2JH5d8904tD/dlRgdIQkLLej4SpCRPOTHZeLw+AhAMtNSN0OPsGVxu5Jao
# V+XTGA8yMDI0MDcyNDE5NDI0OVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDI0OVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJgd2i0L9D4CHcNImTEDTCwo
# aA24qZ6LoBj4Cc3YJpuBMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAKAqmuLV
# Rthiew+gJGluUcrIlD+7uGvnAuvT8oS78XIorzzNPzun/AHSDS7NeWMOjLKtVfy8
# BWvyzq+P6utgaMBceqDw/GjaxUDgi7+tZYwhhJfevvU86XwrukZQjvVUlqoLXbI6
# CayoeF13lribSURkVibue5EgpYPYwG1VONR0h5W6z6No0+I0Ugk8w3BfUcerVNTQ
# +EFpvtz2xM0w2FRO3fgOSZkT3Ety4+Mu3x8Qe8aP2g+4jMQpHVuAh37/7UanG188
# 27GtmrCxrF3T5amdLaqhbMM5aXtN+Lm9JjxrvgH0+qjPPE1vyUgAhJMcpCm9xuDM
# OnDcZ68x+FN8xdJPVNemjgTVfQ4WxdxymSMDY7RlOCNjd89RYSmz4YKRwLfzujKH
# seKwfptmwc0KhnjtXI03hW5wSiJba3PFnq5dwOZzJX++lN3MCoIXlt4cwq9MOgiz
# hQk7eTeF1uWZLGOsalzIVs3bAdRElIqqW9HSid4MxfzKOvJ2R/wBBTj2A+sWp1Yy
# TqSPsIEFR5LpDQVnNOJEw1NdF782CeuoB0rVGoAmNHwO0MCbVunFmlvV6BJ00TLG
# Vj9rQlSNa4FUzYoK+m0b+FvwXZ6FLI77Mhyity6wRCMun/O/t9U3RDlVS0gBH8uO
# YgcUT4luJFJbhcPwyFv3mF/ftdxNgLq0MaLM
