...
.PARAMETER Writable
Flag to indicate if the Content Library is writable. When set to true, users with Access.Info.role of type OWNER or EDIT on a Supervisor namespace can add or delete Content Library items in vSphere from this Supervisor namespace. A subscribed Content Library is not allowed to be marked as writable.  An InvalidArgument error will be thrown from Instances.create operation, Instances.update operation and Instances.set operation if a subscribed Content Library has the Instances.ContentLibrarySpec.writable flag set to true.  If unset, the value defaults to false and the Content Library is read-only to users.
.OUTPUTS

NamespacesInstancesContentLibrarySpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Namespaces/Instances/ContentLibrarySpec/
#>

function Initialize-NamespacesInstancesContentLibrarySpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/Namespaces/Instances/ContentLibrarySpec/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter.Namespaces => vSphereNamespacesInstancesContentLibrarySpec' | Write-Debug


        $PSO = [PSCustomObject]@{
            "PSTypeName" = "NamespacesInstancesContentLibrarySpec"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGrlqMj53S72Qb
# 7KU0NAVawqmXRQDl7dM38aTnJC6JUqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBSyLmO5mnhdq/li
# QY+xr8pkzBB8OJoqeGEFK+laCLrZMA0GCSqGSIb3DQEBAQUABIICAElNmB/gVx7i
# 9VuRuR3e+H/voh5PFegLiN67VAzCLbLm4T7/aEN8sRFGJIenJF8dyrZ6d+I4OJuk
# eOazGA+vu8BkJSdm9G5StVESKOaTYUbVQPUTz2Ak2yH/NhSUPgrpvt+uRFtig5Ir
# zCE+JPCYNgf+lEnQL1OV+d1e6P6axW1wpISIeUmVKmKrCzUaaTyhxt06Lk1XtnxO
# ssHjjqaMAS4Fin+QwJWEtVKmicfOI9h8wLuzLkOW1AzJumEuI+WKtrlvfP69CNRO
# 2k/hnXTGUOWzVM0lrbrdGsWp0R4cdJxWVa3fu9edlLZHnQ7uzoo7G8tdLwWp8za0
# PTRtTe+YrJ8csYvw63Y8wW8JTvgqUYS5cGmxsthuXZgRhj4obhDDvOcvUtIMmMEj
# y1H06gesY/sLge2OH+DXyCOUHhRJ0tAKpkMKxAckqxrUHFzrZGAJfpaQuHvZfBf/
# mbQKfOw/HA39Zv614h84QWuMLQicXETXtP1dHmFVowc7BYdVrW9Ax1K8l5Qmk+Qz
# U5URF6vG2yBtzYa6HeZAkDlqlrwQpnHHNyojI6gQ1XTORWtj6PMQOZOK9+UpOZfz
# n+nZZiSufcwbCPSfdPgSlmaRiWVHxNT2kmF/4tp7KpfUbM+Vw3qWraYt1rW0y+G8
# YO+E4p8ABAv5iLlZt4tpHUcz4vBMA1vMoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IMrSEgu57bgMGmi4bqg1Tc0P4kWJmxIy14u8gkJ80JRuAhAZLGpKokXFwI+Ux6gI
# UBfDGA8yMDI0MDcyNDE5NDI0NVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDI0NVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIMK3b2xe4ok/+DFd1950Oryl
# b+Rt8n7KcmPqaNh9OvYOMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADg56Lv/
# QRwtBK9FoXSBSge08jBXLroONoJc5JswBIF1DkMuBIQ+JRzcXGnq6soTr4WYiKle
# jsVdo0jGyovHemtr4KDTxOnTFnN0snys0el9rKHh/t4RMn5/PrrnNhRK1VbvxQSa
# xA4pA3qI4OyHCpB9kNhlmG4/zZFcLN9c/+XHEO75Vvz9V9cqAl8EyxkdQRSe4f78
# XaImdp6xllIpDSBM99vGI6hpqNekfrc8QYPZbqjYl7RtPyV30faLxxosJPH/USDQ
# +i5KtUnSUjgeN4n+Q5g6fikcN+WVTOAhn4vtZcECI/dmX5bJ8Kh96ELwXEtfvlk5
# BewJDgTCgGUuTm7+OKtH4ASj3mIkSWr2Uv1xlEOMs2pLGJIeNGedAlO78qZMpw8Q
# rwxzcoZ7N3II1JAaZsyTTT6oY+bK0YgFyesrfCjFuHJfGteUbbk3DU9nNQ9rrk4D
# A9EKsQgAt2MEZ0sTRTn1Vnyh5eFFT6dV7BE9CFSGfKZ0IJWxMffC6fp+qCnuJotz
# ROPZxxu5VE5cWY3RnqARFJSp2y6TA7D346Ec28Y1bIxnbqJ9czY1BeXQKQc4tapz
# b5KefQi5yCl5LnKn7sDMAGcpgTFSmN0k46qdVUs4hoestu0XpJTHQuWcvT//MwJB
# zYdwSGuVjKOZH3JiwnksaXWqNBAYguVcmjCU
