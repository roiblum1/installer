...
.PARAMETER NamespacesInstancesRegisterVMSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/registervm/post/
#>
function Invoke-CreateNamespaceInstancesRegistervm {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/registervm/post/"
    )]
    Param (
        ...
        [PSTypeName("NamespacesInstancesRegisterVMSpec")]
        [PSCustomObject]
        ${NamespacesInstancesRegisterVMSpec},
        [Parameter()]
    ...
    Process {
        'Calling method: Invoke-CreateNamespaceInstancesRegistervm' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateNamespaceInstancesRegistervm' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespaces/instances/{namespace}/registervm'
                $LocalVarMethod = 'POST'
                ...
                if (!$Namespace) {
                    throw "Error! The required parameter `Namespace` missing when calling createNamespaceInstancesRegistervm."
                }
                ...
                if (!$NamespacesInstancesRegisterVMSpec) {
                    throw "Error! The required parameter `NamespacesInstancesRegisterVMSpec` missing when calling createNamespaceInstancesRegistervm."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespacesInstancesRegisterVMSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespacesInstancesRegisterVMSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesInstancesRegisterVMSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesInstancesRegisterVMSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespacesInstancesRegisterVMSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespacesInstancesRegisterVMSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespacesInstancesRegisterVMSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespacesInstancesRegisterVMSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespacesInstancesRegisterVMSpec) {
                    $LocalVarBodyParameter = $NamespacesInstancesRegisterVMSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCIeS0UbQEpwPM+
# XKcchBq1q4WaLWIXs4TH1KUQKX1gbqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKu2potPctIwLS+e
# eoGPOcFB79F3m71n7no+9llGVTRbMA0GCSqGSIb3DQEBAQUABIICAKW7fMU+NbjZ
# nzQ8xpZHTbC/ksH2y2y8Dp2O1AOWF2zj8ZTDUZyEJKQr/Ii1WDmTAZzbSoCbamaQ
# SVAnmjXK+0nN2x/0eh1kOiJ7BHbysF8FTgbgOD+Ns1qT3B4MIbDpYbwfAVtGjKwG
# KEmg4jlWF3m/ATw5CdI1onA5sebWusApwiF9InjtXwU5C/PR2qtX1DhN+T4Vsz3z
# Q9itKcGylndaG7OgobYcpghg0yosS4+yrtL805g9/hz51TcA3WP2erEFzA9xG6DW
# ORTvhdi3Jix9wqJJeJiHWfl/HOp9q0VVgi2C7byMXBMp4Btiznc8+dKTLElopTrd
# cDQeVK2qkuKZuHZ4u9kmetOgpKbeEl92k94+c7aHvbLaXKbiN3RFshJz1Mbq0FBJ
# +svprstWR2ltOjpytfEJ8RMyWnbvkv2FaAZb+YzbQv4N8oqU01loxpYnHDlK8IaN
# qoOvLBjzKmCpJRzyzjFDeuvN9RMwifXLSo3Hu1w9Kl4v8T6AePSzHzY8wjC0dheB
# tH3HS8dzwDDg3vkCnDAlxZeMkV5+WUllQpRVYVFSfnN11G4Om51r+OGSHpDCJrnj
# G3P0CVPTBSZTzFUbB5TNIxL+WGOncyE2rLSvgKqW0rjvHBNsHE26Gm/dDv5HFSL9
# vSUGs4Hik9QuUnsMY+D+7myxjTOeRsIeoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IEFGPPZ0OCTwBHYsSPkeNc0PPlEJEhYv9Vr1aRfrXxgVAhAAhmyCgAk4BC49AjB2
# BYpkGA8yMDI0MDcyNDE5NDI0M1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIDs9jH19J6Ob1Dj91WFGkkUW
# KwPqKwAQrVoVzgARz29uMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADEVAWeb
# Ip3EIvA4QqCAmoANjwxKIuKjYtsZAFBz/TlpKm9QqU4CXqIL3fTzzNsI69upKIrg
# t067zfAR8W0uAQ5OKBLWqUOFDjjBxTJNaHgBd86g3eQq7vxel89D422xaoLsIbaJ
# QnsaZbKaN4DEPRFj0wml4qoQaBq8lbF03jIGWjZSrdaLwXt++a3DcudmVj0M4Gdj
# RFGxP/NipRi9GdWf8YcvTp8LyROHlMcSNrYrN2eXpHuWqnK+SBL2/TlT5eOOLv0C
# qtTOIRLLC68t2AUwNyDRWXcYBzSjQMyo0qUKp7F4aebh7SnGpiYXUD3rcEDLvDTJ
# HgjBjjG7FdHlhT4BJg5zQuEdiu6k25tovv0N/JCiVs98oujKnjM723hODDQqJv4b
# py5G8s5+MNcqEWVIPAiqgzTHwZrdqMA/rMxzMu5TAqaPNLUdVN1TJR1X+j/u2ZiD
# Q892ziVAg+MkZGo5QXJdxlPbEU/Y7As9BCc7KswJsCbc8Z31OlNEo5sK1Vku/XAP
# 9OOsLaih1Aq07qvBd/7mBgvF2jFjE4G9l1D4MT7OiLWhAQ7byLh6wLyLV9ofr9Pz
# uiagDSOt6Rnl8mDs8s9HsLalYjHS6+r19WAnNSV0zXDpyq1c6QdGiQ8/8LA+GDZh
# VLyhFY38ODaeo32C5ze0C3MGjURFyuVAmKfM
