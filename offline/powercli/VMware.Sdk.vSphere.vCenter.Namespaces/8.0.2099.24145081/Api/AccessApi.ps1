...
.PARAMETER NamespacesAccessCreateSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/post/
#>
function Invoke-CreateNamespaceDomainSubjectAccess {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Low',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/post/"
    )]
    Param (
        ...
        ${Type},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespacesAccessCreateSpec")]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CreateNamespaceDomainSubjectAccess' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'CreateNamespaceDomainSubjectAccess' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/namespaces/instances/{namespace}/access/{domain}/{subject}'
                $LocalVarMethod = 'POST'
                ...
                if (!$Namespace) {
                    throw "Error! The required parameter `Namespace` missing when calling createNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{namespace}', $Namespace)
                $LocalVarPathParameters['namespace'] = $Namespace
                if (!$Domain) {
                    throw "Error! The required parameter `Domain` missing when calling createNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{domain}', $Domain)
                $LocalVarPathParameters['domain'] = $Domain
                if (!$Subject) {
                    throw "Error! The required parameter `Subject` missing when calling createNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{subject}', $Subject)
                $LocalVarPathParameters['subject'] = $Subject
                ...
                if (!$Type) {
                    throw "Error! The required parameter `Type` missing when calling createNamespaceDomainSubjectAccess."
                }
                ...
                if (!$NamespacesAccessCreateSpec) {
                    throw "Error! The required parameter `NamespacesAccessCreateSpec` missing when calling createNamespaceDomainSubjectAccess."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespacesAccessCreateSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespacesAccessCreateSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesAccessCreateSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesAccessCreateSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespacesAccessCreateSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespacesAccessCreateSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespacesAccessCreateSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespacesAccessCreateSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespacesAccessCreateSpec) {
                    $LocalVarBodyParameter = $NamespacesAccessCreateSpec | ConvertTo-Json -Depth 100
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/delete/
#>
function Invoke-DeleteNamespaceDomainSubjectAccess {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'High',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/delete/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-DeleteNamespaceDomainSubjectAccess' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'DeleteNamespaceDomainSubjectAccess' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Namespace) {
                    throw "Error! The required parameter `Namespace` missing when calling deleteNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{namespace}', $Namespace)
                $LocalVarPathParameters['namespace'] = $Namespace
                if (!$Domain) {
                    throw "Error! The required parameter `Domain` missing when calling deleteNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{domain}', $Domain)
                $LocalVarPathParameters['domain'] = $Domain
                if (!$Subject) {
                    throw "Error! The required parameter `Subject` missing when calling deleteNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{subject}', $Subject)
                $LocalVarPathParameters['subject'] = $Subject
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$Type) {
                    throw "Error! The required parameter `Type` missing when calling deleteNamespaceDomainSubjectAccess."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/get/
#>
function Invoke-GetNamespaceDomainSubjectAccess {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetNamespaceDomainSubjectAccess' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetNamespaceDomainSubjectAccess' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Namespace) {
                    throw "Error! The required parameter `Namespace` missing when calling getNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{namespace}', $Namespace)
                $LocalVarPathParameters['namespace'] = $Namespace
                if (!$Domain) {
                    throw "Error! The required parameter `Domain` missing when calling getNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{domain}', $Domain)
                $LocalVarPathParameters['domain'] = $Domain
                if (!$Subject) {
                    throw "Error! The required parameter `Subject` missing when calling getNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{subject}', $Subject)
                $LocalVarPathParameters['subject'] = $Subject
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$Type) {
                    throw "Error! The required parameter `Type` missing when calling getNamespaceDomainSubjectAccess."
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "NamespacesAccessInfo"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "NamespacesAccessInfo")
...
.PARAMETER NamespacesAccessSetSpec
No description available.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/put/
#>
function Invoke-SetNamespaceDomainSubjectAccess {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'Medium',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/namespaces/instances/namespace/access/domain/subject/put/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        ${Type},
        [Parameter(Mandatory = $true)]
        [PSTypeName("NamespacesAccessSetSpec")]
        [PSCustomObject]
        ${NamespacesAccessSetSpec},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
        $Server,
    ...
    Process {
        'Calling method: Invoke-SetNamespaceDomainSubjectAccess' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'SetNamespaceDomainSubjectAccess' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                if (!$Namespace) {
                    throw "Error! The required parameter `Namespace` missing when calling setNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{namespace}', $Namespace)
                $LocalVarPathParameters['namespace'] = $Namespace
                if (!$Domain) {
                    throw "Error! The required parameter `Domain` missing when calling setNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{domain}', $Domain)
                $LocalVarPathParameters['domain'] = $Domain
                if (!$Subject) {
                    throw "Error! The required parameter `Subject` missing when calling setNamespaceDomainSubjectAccess."
                }
                $LocalVarUri = $LocalVarUri.replace('{subject}', $Subject)
                $LocalVarPathParameters['subject'] = $Subject
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                ...
                if (!$Type) {
                    throw "Error! The required parameter `Type` missing when calling setNamespaceDomainSubjectAccess."
                }
                ...
                if (!$NamespacesAccessSetSpec) {
                    throw "Error! The required parameter `NamespacesAccessSetSpec` missing when calling setNamespaceDomainSubjectAccess."
                }

                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    if ( $NamespacesAccessSetSpec -is [PSCustomObject]) {
                        $addTransformationInput = Format-Body -OperationTranslateSchema $translationSchema -Body ([ref]$NamespacesAccessSetSpec)
                        Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                    }

                    $tranlatedBody = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesAccessSetSpec -InputType Body
                    $translatedQuery = Convert-InputStructure -OperationTranslateSchema $translationSchema -OperationInputObject $NamespacesAccessSetSpec -InputType Query
                    if ($null -ne $translatedQuery) {
                        $LocalVarQueryParameters = @{}
                        $translatedQuery.PSObject.Properties | Foreach-Object { $LocalVarQueryParameters[$_.Name] = $_.Value }
                    }
                    $NamespacesAccessSetSpec = $tranlatedBody
                    ...
                    if ($null -ne $transformedOpertaionInput.Body) {
                        if ($null -ne $NamespacesAccessSetSpec) {
                            foreach ($keyValue in $transformedOpertaionInput.Body.GetEnumerator()) {
                                $NamespacesAccessSetSpec | Add-Member -MemberType NoteProperty -Name $keyValue.Key -Value $keyValue.Value
                            }
                        } else {
                            $NamespacesAccessSetSpec = [PSCustomObject]$($transformedOpertaionInput.Body)
                        }
                    }
                }

                if ($null -ne $NamespacesAccessSetSpec) {
                    $LocalVarBodyParameter = $NamespacesAccessSetSpec | ConvertTo-Json -Depth 100
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVQDUI4D1vpz20
# hRX9Rv/kI4v6nzyYMH85zE2s3+ANTKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMlMCxrTcnuI5UEs
# IcKmyUCp6iUSzn9mkI4QNbsEBBTrMA0GCSqGSIb3DQEBAQUABIICAH+lRL+phdWC
# T9u25EUm/hj8zfkXNteux97BPCwDCIrkdPwCTbF9HJaVzuGw4DDgmbfuRBKYrHki
# DnzrIr+V6MCq/9vt65KRj+sWE1NbxsccFydo0Dq58//GLG0e11NFwJ5TV2e6Ejg1
# kCWpROnddZ9jAi3VpUZb+AfKdVLOTmytWYr12oTjlXP4hnEBnzax8IRPnTU4YXyl
# 2ow+QtK4lgaV3fW5MOMIc5466DvlX3V0q6LyPhZ/Lgv3CmMHlmVX97QDKPXK49pT
# zU10ZZCCNVeGYRx7WHJk+37ZQzav2EmntJH/MviNmh7LvBkZzO67StCKp2F79kDH
# KvYG2HTtnQ0uMljMXtDdN97Ch+nyS78Rih/Y/Ty3IOEJPh/KRIHNIZ2HZvBl6mBx
# hKpvd1KZF9xiE2qyEsea37uYM0nhMxU3SkH41Li7h7zWWbn19PswiRPho2D2GfdU
# 609Q+Z8JYhjLu8Oi5cLzeADr0lRw9+8rpVObcHavdulJkAOIiMG1cgEeDBMNOxuB
# OqwoUjqmXVBNEYEYCanCSljGdsd9hxr8yl/WzrrR9M0VCnZz1m2L27tRdkZij7QR
# 2P/4UEIR1bG41MPfA319vVtjnuSR+u/p5bDbaYwBf1g3VbPRX9fDMMnw566ZBQZo
# PRYnDmweLoHQckOv3Uvfp3QzW2Yjc9zzoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INRWQNZ6+pEJZBpjMIwJaqA58SKu11+K+PyHo/ZKlMTfAhEAsHDC1xBbx1wUGSSD
# OCfDdxgPMjAyNDA3MjQxOTQyNDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQyNDJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDamHQkkgX5BHdJ2PtbaNtn
# 7l9c+3UTi0WdV8Pe/CFY5DA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCWpeWi
# x84oSHunXOH3jlL8q1OEoJw/MPyYJFyO1k/fyijIUbw3ERRJOtku4+yUFEtfgKeB
# ZgUUtxSP+N2RhbwQOkvas/tPIY22NUBvMqG4uvV2ipyXPcn101ZjmXO31vdNwKJh
# kN7Jpq5AUM7wPyG41iAc/zCEvb06wy+64aYEK/Oin/7elRvq+q2dM497YGjkpja6
# uC4zKlztby03Yruv+PtoT+GmbVUtGYL2M+qRHU1mKjzVWQDF/TK2xsmatM0lrg3e
# 6DOrheeViN3hidwUl9QC2q6mZiWCZMf5n5J/x9UXJoBDSK/+pKZdpqfY68WOrVBX
# 7HswY6lmmv0kRpoYLyz1wldpvlg4Ep79GopZSzNAqxdjoP3J1DP4/7AOOl7u20nA
# IzbCHRLM+EOiUYWhUAFw1fWKBQibpdTSflON/ZF/hBsh/xOqtIHDVs4pT1DlNkYt
# 1sHg1t3kEVJS9NvPGh1cbhGwzj0zDccmjXAuC4NpCLA5nlYyoOLeO77djCo9CK17
# kIKYaeRa/cBLIqS/L7xgznQT/OQ7XaXBqfs6m1w6NQvydL76cDg2zUZnAebTutIB
# M8XLKKHyEn6uHlb9lmc1VgNvqDvpCG69Y1bdK1GyI8WKQdedAZqodofn0O3zAuh1
# ooNob93thr+/qjfc1b2AnFQSu8HNWfxZobPAyw==
