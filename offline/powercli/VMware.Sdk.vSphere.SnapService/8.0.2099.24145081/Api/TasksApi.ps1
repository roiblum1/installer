...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/snapservice/api/snapservice/tasks/task/get/
#>
function Invoke-GetTaskSnapservice {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/snapservice/api/snapservice/tasks/task/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetTaskSnapservice' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetTaskSnapservice' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/snapservice/tasks/{task}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Task) {
                    throw "Error! The required parameter `Task` missing when calling getTaskSnapservice."
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TasksInfo")
...
.PARAMETER Tasks
Identifiers of tasks that can match the filter. This field may be unset if other filters are specified. If unset or empty, tasks with any identifier will match the filter. When clients pass a value of this structure as a parameter, the field must contain identifiers for the resource type: com.vmware.snapservice.task. When operations return a value of this structure as a result, the field will contain identifiers for the resource type: com.vmware.snapservice.task.

.PARAMETER Operations
Identifiers of operations. Tasks created by these operations match the filter (see CommonInfo.operation).    If unset or empty, tasks associated with any operation will match the filter. When clients pass a value of this structure as a parameter, the field must contain identifiers for the resource type: com.vmware.snapservice.operation. When operations return a value of this structure as a result, the field will contain identifiers for the resource type: com.vmware.snapservice.operation.

.PARAMETER Services
Identifiers of services. Tasks created by operations in these services match the filter (see CommonInfo.service). This field may be unset if Tasks.FilterSpec.tasks is specified. If this field is unset or empty, tasks for any service will match the filter. When clients pass a value of this structure as a parameter, the field must contain identifiers for the resource type: com.vmware.snapservice.service. When operations return a value of this structure as a result, the field will contain identifiers for the resource type: com.vmware.snapservice.service.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/snapservice/api/snapservice/tasks/get/
#>
function Invoke-ListSnapserviceTasks {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/snapservice/api/snapservice/tasks/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListSnapserviceTasks' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListSnapserviceTasks' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/snapservice/tasks'
                $LocalVarMethod = 'GET'
                ...
                if ($null -ne $Tasks) {
                    $LocalVarQueryParameters['tasks'] = $Tasks
                }
                ...
                if ($null -ne $Services) {
                    $LocalVarQueryParameters['services'] = $Services
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "TasksListResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBHRsX30L3ovEQ/
# 10sbEm3Wg+7tWYTmGZ4FP3cxPtD326CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPR5L+boUAk8VcZ6
# +5DrUOnRDNj913vlcrw8i0mDL4nYMA0GCSqGSIb3DQEBAQUABIICADrZWhcqQ+ia
# 9IgUsOqaQkGRGG1+PNTSwDlvZLPSSKpnJTJ1wB/bjucasuuTkgCXWwM4sKNevDVe
# +VtDcJBZoQ1p8gxbaiw/5Ev8DvmLS26PeIQDlP9TRuagpgp0E5mTzPdKvF2MMGBR
# PaUGYX33ieZ9SORgMzAw5LYvsJlmfysJRb5JSh7xivaGsmtfvp40tNq5qAu2fVmg
# bRMEQc3qAFqHEhJYVBPcPqlRFroSkCcbev+UhuNJAnO+yVI7i+/bMdmGFhbYMevF
