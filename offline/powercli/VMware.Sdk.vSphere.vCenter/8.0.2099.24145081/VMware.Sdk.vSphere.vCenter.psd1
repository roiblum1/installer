#
# Module manifest for module 'VMware.Sdk.vSphere.vCenter'
#
# Generated by: VMware
#
...
RootModule = 'VMware.Sdk.vSphere.vCenter.psm1'
...
GUID = 'e0333dc6-5751-47b7-b780-dd0de63c211a'
...
Description = 'This PowerShell module contains PowerShell Advanced functions for VMware.Sdk.vSphere.vCenter.'
...
FunctionsToExport = 'Invoke-GetCluster', 'Invoke-ListCluster', 'Invoke-CreateDatacenter',
               'Invoke-DeleteDatacenter', 'Invoke-GetDatacenter',
               'Invoke-ListDatacenter', 'Invoke-GetDatastore',
               'Invoke-ListDatastore', 'Invoke-GetDeployment',
               'Invoke-RollbackDeployment', 'Invoke-ListFolder',
               'Invoke-ConnectHost', 'Invoke-CreateHost', 'Invoke-DeleteHost',
               'Invoke-DisconnectHost', 'Invoke-ListHost', 'Invoke-ListNetwork',
               'Invoke-CreateResourcePool', 'Invoke-DeleteResourcePool',
               'Invoke-GetResourcePool', 'Invoke-ListResourcePool',
               'Invoke-UpdateResourcePool', 'Invoke-HelloSystem', 'Invoke-CloneVm',
               'Invoke-CloneVmAsync', 'Invoke-CreateVm', 'Invoke-DeleteVm',
               'Invoke-GetVm', 'Invoke-InstantCloneVm', 'Invoke-ListVm',
               'Invoke-RegisterVm', 'Invoke-RelocateVm', 'Invoke-RelocateVmAsync',
               'Invoke-UnregisterVm', 'Initialize-DatacenterCreateSpec',
               'Initialize-HostCreateSpec', 'Initialize-ResourcePoolCreateSpec',
               'Initialize-ResourcePoolResourceAllocationCreateSpec',
               'Initialize-ResourcePoolResourceAllocationUpdateSpec',
               'Initialize-ResourcePoolSharesInfo',
               'Initialize-ResourcePoolUpdateSpec', 'Initialize-SystemHelloSpec',
               'Initialize-VMClonePlacementSpec', 'Initialize-VMCloneSpec',
               'Initialize-VMCreateSpec', 'Initialize-VMDiskCloneSpec',
               'Initialize-VMDiskRelocateSpec',
               'Initialize-VMGuestCustomizationSpec',
               'Initialize-VmHardwareBootCreateSpec',
               'Initialize-VmHardwareBootDeviceEntryCreateSpec',
               'Initialize-VMInstantClonePlacementSpec',
               'Initialize-VMInstantCloneSpec', 'Initialize-VMPlacementSpec',
               'Initialize-VMRegisterPlacementSpec', 'Initialize-VMRegisterSpec',
               'Initialize-VMRelocatePlacementSpec', 'Initialize-VMRelocateSpec',
               'Initialize-VMStoragePolicySpec'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZMHUv3T5E2GKQ
# 3OSuNT3QxNMa0B967HMqFif5kFvq9KCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEOf5G3+OkNssSs6
# 3sZB4to75o3W2aterVagf6TXT6pzMA0GCSqGSIb3DQEBAQUABIICAJWhhzuKb/mV
# ycnKen0OWNwtIQPs5P/f89bI5tJYJAsTpzLuOQDlGs2442WnUMQd8JzV5hVYA6CQ
# jVd4FP51Pu9097OkPR/KGtNr5UkSDhTX+ZyXP4fYwHcdo9J9i+uGVV7/vL1AjIyJ
