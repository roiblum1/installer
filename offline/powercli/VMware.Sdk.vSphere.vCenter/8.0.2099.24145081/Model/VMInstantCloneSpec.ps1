...
.PARAMETER ParallelPortsToUpdate
...
VMInstantCloneSpec<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VM/InstantCloneSpec/
#>

function Initialize-VMInstantCloneSpec {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/data-structures/VM/InstantCloneSpec/")]
    Param (
        ...
        [PSTypeName("VMInstantClonePlacementSpec")]
        [PSCustomObject]
        ${Placement},
        [Parameter(Mandatory = $false)]
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vCenter => vSphereVMInstantCloneSpec' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "name" = ${Name}
            "placement" = ${Placement}
            "nics_to_update" = ${NicsToUpdate}
            "disconnect_all_nics" = ${DisconnectAllNics}
            "parallel_ports_to_update" = ${ParallelPortsToUpdate}
            "serial_ports_to_update" = ${SerialPortsToUpdate}
            "bios_uuid" = ${BiosUuid}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAdRnBT+HsP9M4d
# 5Se0/tq7bKpEayRG6r8sefi8Tjw8FqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJk0EgYMWw3EqcDh
# 2Yk7wR3qWQ+4l+PIdh/w5Z0fclK1MA0GCSqGSIb3DQEBAQUABIICACLz33/Z7lD8
# q0fBYMpyra9DgXdvDMJ4oEZUlc9OUPtcIJDgK96o8AVHYuv/9FHqx73OFN1lZkzo
# 0Q47GxiD92/MKmt4dxHCa7JpmrfBuL++8uOgOQJHn/wQ/05/MyxPKjEF/NomL+Hb
# KVSMRjXmQeoXDWzq1IkRxMI6cMIbGiXK2p9T3RTEvidENQCqX5ty49HHyckbPbin
# 10oJGU62t5EwexTNROv/UWpmmrwep2G1G0OzgnBzqHpcCjvhHa5fUGGb/977CvIg
# x8n67PTBaqNE1GDHtgam3fr3quf01CtMzyv4o14BOGeyoLKlCBQX6zTOha+/pp05
# OvVzb8KCx9pXBk6BGspGC0JbHFdMoSifJCZ9zWjsHxCM0S4S6/BCkOc+PpyTcEUS
# ls/jk9hTdsnlcOz/ky5qWrJkeCk75zFhvijbHgq82k4kd+yjmRkaf0gPGX6jtFkL
# n2trquibva6FcAH2dqdv11l2DGHsMasagyfgcUKkycYo2eDMhbjGheTOz3MDdAUN
# wnxJrquPzBdoEt4AjQTh0lYNKSS+u3KJOnXhM6hi1ZeyGN1F8dvm6oN0ryFam3hZ
# s/fPpK7jg/pDWPDuXnphiI5rO1t+pciLfZcr3Bh+uSyku4XjAUxc1ea9qMn3xsvr
# B5WauitlCV3w18SHyfFx1WPaFJtRDFQyoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# IGgk8sIXk3M85yFWri6C9jji8Og+kK7asV2qtGeyrMq3AhEAi6fetkcxVuXmi0BM
# +Wb3ORgPMjAyNDA3MjQxOTM5NTFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTM5NTFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBxkYvoC3+N6vYyHvn4WVGd
# CbGcFbiTPWpxKJxk0jPOAzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAxpzrZ
# rgTD+z3sSQoPHvlvafkFldNiGZdcG82IX8Ebbgs21M7ciLKqQMevUgTl6yVuJ2bU
# NUL8pgoJRgyUL+XtrJXduFi1m0ktmMOxz0A6ksemqJIYhqKWDx4WfqVC1VGvElG7
# OPyX8WsjEV1ti0X6lLlE8Lmbz4tvyEYuSmVjK5mxJBxRTdY+tMMQgALdOJu4eM2a
# zjvPLWo4pyHLPVhCQP47u54/15Gj4+y9joGkYACsDL3HDRj00NrF6WiW3DMmhv+6
# tIg+ZPV22cI+OeYxcxNvmZaXwygiFf2PfqZ33F2JDSCVta4Pq9CJKrvoTZwGGJ9i
# eZxpsVj1WWiOgakDiRXf11bjm3jU+cmY2o8I2hzxYH4yi6cYRDutj73rFooSLmeX
# yFIYUj/wBwm8zFNQCFM46TWOWlUTSkeDGo2XeFGHquaeV9MNYnzfFps9Pxuie8rh
# natwN0pP8Y1rbAOUyDIu3htHVWtE+LYVbON+HBq8JSpvKaKzUxhdHKVbFy07H5U7
# Xwddb+AKvzVZlcEcZkZ4Z2pUM8RxsuqeZHX9VBkQOIkRvl56M9yp1afrhJUk+xVm
# VBoUi5Z60kLq9s/o89hpLB/BWxNLkTNM5vdMeXArxnWUGthOt7lNbjtb/eHzMXTr
# njV4KEfG5O62MFpic/NG//eAbb68WhIFlzHVnA==
