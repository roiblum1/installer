...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/storage/policies/compliance/vm/get/
#>
function Invoke-ListPoliciesComplianceVm {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/storage/policies/compliance/vm/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListPoliciesComplianceVm' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListPoliciesComplianceVm' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/storage/policies/compliance/vm'
                $LocalVarMethod = 'GET'
                ...
                if (!$Status) {
                    throw "Error! The required parameter `Status` missing when calling listPoliciesComplianceVm."
                }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/storage/policies/policy/vm/get/
#>
function Invoke-ListPolicyPoliciesVm {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vcenter/api/vcenter/storage/policies/policy/vm/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
    ...
    Process {
        'Calling method: Invoke-ListPolicyPoliciesVm' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListPolicyPoliciesVm' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/vcenter/storage/policies/{policy}/vm'
                $LocalVarMethod = 'GET'
                ...
                if (!$Policy) {
                    throw "Error! The required parameter `Policy` missing when calling listPolicyPoliciesVm."
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCe/Tw4maQyqqhJ
# 6CvoNX5ifr9g1FPto/MO1Y32LdCZpKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIINoNzSF3VVr056c
# slOMBB1JXfZhv+Sj/AmmFY6iga00MA0GCSqGSIb3DQEBAQUABIICAKTdqnxZckit
# RkaEhKNYx6RafbxnT9nMJADVp8koVxU6VviBDrTSURwLff9QrhlY6Jo4uuJSzXyX
# on9Q/uVnyR8KClRDPn37AEs+usUsu56x1M6xDqKr3/ZnBTvzLVgPCR4hdD6vyowR
# eldOOBwS4giF7T2NNnyUAZm66uW/cAE3toCOBMQndPbMsjGRHaGTpaS0DK1jj0iL
# JjszCPuXq9yG7W7J5Kb6Ebrr3SLI9AtsYWF34s5atMpH2oJKzgcvXwYBoHOAiGA3
# dIVInVW3j5IJPBCCfsgm9etFNal0lw9wbc5tnxtH2BMGP1ofQryhabkuZFi0NHLU
# ct2AvadJIyh2He4yq3Iv+HObvN6G1p2Ue8gZ5Hxyh145eTE1KvThe4LAixcS5Af7
# OOZBtbDpvrZwdNu9EOgMesJPtKcRdXYII2kd5yuS4sizrH8N8kpnTD97/P2Mowj1
# l4zuzyXlXYiGT6agRQk1visUq1PIkFK/5GAj7BKMcdRVCtbfi8keQ3jAKh0V2JW1
# puUFgSkCT3ctO4AZlQoya7ctcaYxVluH1qB2X1SjhJSEp6gawFH19oSFSfYqRR6M
# b2f0Uo4M79WEkCcmMXnN3QhdiBGRtSV7uhFsO+O4e6dRVjbzkhfy5epuonn7XXXs
# t/LCk0CkIkB9Y+VrO7ckzcYKKZxUWQrcoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IB+Ufb9CXl8P4ApUq1hzdRTeAJottCGb00AUQFWpY2tlAhAxMKf2yU4S94vM+99o
# Suz7GA8yMDI0MDcyNDE5NDMwNVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIGM5bYhkvIHm1rfyuVTWV28A
# TQdkW4QAsRi1cR2GtKxgMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJ4c//L5
# uVpzrup65I0E+Y9JwHyVS/jcuaYxDdkEio3XEbNrzsPXNjv3/fXKRPYHLzbwlfUC
# mYLIbJEwAZ3hYqKgW+sWudMQrXCtslWfNDbhsncmWO2yvThug7BRNHa8Y8l7QQLp
# PSz/eNv5/BKetx0SsHtegUR23HBgGKroiA3/KBdbraZINvRoKpBaznRWI1CeSGsL
# qC4K+p+VvyY5rg17QVcKuZ6LEJcM/mnn3B7vf2/eOO//TLTMiFPdDHtBa3K2FoC8
# W7iZ++IG4HZsOM1bqBsxmB4j2yT9ECDpYxxEYTGdbpyZjmFfC+HmxVgzednWV8As
# a+g/q5KBt+2A5g8vUSRf1V7jsSfwF5rIkXQNYvf8k4a0ae9eQxtqb+EEQpO7YtW8
# LOzKwaAfMtLflrhbLpej5vbt+1Gtgyng3dVoFj/zxYLtS0nz5N0sfGqTu6zYNedz
# ADF2h6DobzXTnbzn2EFPhh8fPOkaSN3Vi0Zuf3R9krGGhvMRWrEQV9glHtN60oVK
# zLLdtJ0EOU+4Ddp/lK4oBc0QYWYFnbnyzZ1ABR0K2vFHDfEdAwpsJtTs10m3BYM2
# 22SOcsEH286+pCDnV1o5Fzp57FyEKrGkjxeAz/APC8SDFzZD1vIN0Q3GctY45hXq
# QuRkRRI2UwPiuZyp0W5vFeqekY1aXis9JjLj
