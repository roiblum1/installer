...
The RsrcId structure specifies identification of a resource to be monitored by an acquisition specification record. Warning: This structure is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments.

.PARAMETER Key
Key relates to the corresponding ResourceIdDefinition of the related resource address schema. Warning: This attribute is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments. When this field is unset, type field will be used.
.PARAMETER Type
...
RsrcId<PSCustomObject>

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/data-structures/RsrcId/
#>

function Initialize-RsrcId {
    [CmdletBinding(HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/data-structures/RsrcId/")]
    Param (
    ...
    Process {
        'Creating PSCustomObject: VMware.Sdk.vSphere.vStats => vSphereRsrcId' | Write-Debug
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBoK2kBDNtHvcGV
# 9FTwmJQWj0cVtSR+WvYZda5bWpvvS6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICEapAcaOSD4WPuw
# TUbrOjlHYiB/OHyXmZo96p0ilVwrMA0GCSqGSIb3DQEBAQUABIICAHoUc5iUeNcN
# XDwgERJ5eAvY+Sr0Iuxnj4HqBfKR+7fRCI7tfjYbIPi3dIiBFbwOSiBgd0I35A1G
# UI4OcKNUclCMSqOm+GjVeJYQNpJM8+JedtGPyKInJwEnK6GsF2ACFbnX5XkBxNBA
# 4v7pE39yUkTdJF5QwzWaWoyA1EnC44ZDGKdRivNy+Kd0s/XG2eWW2tcALcmNKFOn
# BTb8nLcDjoCKSzEZQTF5YXphTKFerGXPIfxppIQGFGOOI1uPH7mhkircVWSViTjl
# Qzjp8xF+HgF/D6t+cFogdNaRi7fOYELAuC9neCF/sC0N8lcUIk4mNh2co8dE2fvT
# g8ciskYb7587rPq+H41xOYo3n6a4ILzUIPtOr2qrF6F27atw7OeJza5b27rykemC
# Sc7DjQEID3R0oBcBh60gI5GGy09g7ZJqdTasbhD+v1e7hBHv5r1Wq/Hh5KENg93B
# T4+kbE+Edj9Xlnbx5Nz7Ym5F1XB2LuVQI38wbir/f5f8PnMFph3R8l0v6aQZW3T7
# h4/vWLjYurzir7y5tARMBD/OjdY+9dkt2NqUQUE5FrSHswAw4F8DS78YckFBctzu
# qy468COUCBkN8udLQPNR5KiJ0AEIeQJmt/G9aLcP+Zke/pGo+/DGrsRSo/+0jZb+
# uqYJJ/HNybPdwqh489nJUhBVHSHW0SFCoYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# INxV3aFvF+5FcvE9iO/5zJg7fiY1bCjnxBUKkcCJWIFwAhEA6ZRYvzqsmHSFf8Ef
# 0rIiuRgPMjAyNDA3MjQxOTQ1MzZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ1MzZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBa3oGLz050XcUXw0KR2i+A
# 30lFERf/3NPnB+5GMeAGQzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBwLZUb
# GtV0MgMRvcLSwkyTK/J9p0LyCLF39vbKZvRMVND/Lp00pl0hJ6+YJz1RFIYKoeoo
# wGkmiy6YEQOQz+zDeDS7c8AKrQrZZkB7xFjM1HgDiSxHXm5g+o3N5zQG0muW865O
# v9MYZbvK56z0zTE/uZ3YJdMwQoiw2uQj/PRfKDkuTK5BLXPVm0mYUdBkZ6WCvJIr
# Qj7udnPMm+63xPKOjWcNTz0co1Mpi8/WarKFUBBlVu6jlyNyRhofznmsj/Cr1LGy
# qsVTE2SJ+jkYq2gess049lED9vp29XyACu8WHIc96aHn68Ow/DNseduM0aYMpQnL
# TORfbsGZXBh1Y6q6sApcFIP7DmIe5wS6olAHKDtk/+llXwLNIFAoQRcL2WNjiOpV
# ZBFLNpc+wNhmz3XVaOoLzVHiTW9L8L1qUDkPah3Qh2w5yV2cWdpThAl+YdWApk8z
# +SrEQHN9ZnTmaxzzAvSwm6IFdNd66EJdzgYb4IuzOVIbSPVkEAqLQvRZP5NwyeSp
# ozcB2N/F0ZIkGwQuf4ffJqtCWpE70SwzVDyKRllmwAEAlH9XQkiVdQ8uDdjdKJ1m
# 6hkcNmZx1olLSWOynZjGI61c4mipifiDEy2OC5H0BiM4HuR6dJ3Y+FU5cOCXK+0r
# dqSLOmKWaAagaGjZruh32ig/kSREI6jdTjvZNQ==
