...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counter-sets/counter_set/get/
#>
function Invoke-GetCounterSetStats {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counter-sets/counter_set/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetCounterSetStats' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCounterSetStats' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/counter-sets/{counter_set}'
                $LocalVarMethod = 'GET'
                ...
                if (!$CounterSet) {
                    throw "Error! The required parameter `CounterSet` missing when calling getCounterSetStats."
                }
                $LocalVarUri = $LocalVarUri.replace('{counter_set}', $CounterSet)
                $LocalVarPathParameters['counter_set'] = $CounterSet
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "CounterSetsInfo")
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counter-sets/get/
#>
function Invoke-ListStatsCounterSets {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counter-sets/get/"
    )]
    Param (
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
    ...
    Process {
        'Calling method: Invoke-ListStatsCounterSets' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListStatsCounterSets' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/counter-sets'
                $LocalVarMethod = 'GET'
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "CounterSetsInfo")
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCloePO6cuY8Idp
# 8xYTxtfOkhIS3Uz1+NbgXZHzjjSdUaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKXsEjTfesQk/rbg
# wfNjkBB/JeEf8rZrBnAebyJTI0rYMA0GCSqGSIb3DQEBAQUABIICAGskPspmvter
# OxVDlh55Y8e2Sau/ZvcCq3MY/aXjR5BNHK5vs1lyuLQRlInOKPGmv9usFA7na/8n
# E0JvFgbAcFwqM6Q5r+dJq3DlUkBXnaL4bB09d5TBUH0yrMZy2ukLMtYjVXuoO+cy
# BplfxcUsVl7OUeW/Czsmh4aKoo3l8FvjqAL4ZnXGQh8SqYCgZOArrV3zuMPKKzym
# pb98DyeMgEicTZbSRUCpQrg8JKgw0myS/A7vIea4MC2W5KlWiAZMYljt3F1OuSJR
# dKhHiT/bMSXlmTmN+y4Td1HUbOi7Ht5kTIh54KGTguvo/S8q+LsaAHlDK2lHniEz
# RrUn2mXGCKaZ4w5jIszjwA3xmMhJSAWmfkJ1SH1QxARHGeohGpja0dfW+vklxmJ0
# hmkezpCEK0QvKe/3CZWLZDZaPVO8lGCa78iR/N4KChd+sSOVpAFzXKz4T+Qev2R1
# 41VNaN8+39LFZAD7M4T/eMRHDT2k7LxWCgDOd0K6COMKmfO9NdWFwv2itPt0f7rP
# ZWGUQg+OdwXUGf2PHMo5v2s0XMaZI8HeVXllo2hqNUlDOmEmMpq4sN9svceMlSSy
# 3IX+WIg0NQid2goP1GuOEUHMaERI6D8ncqQBfw0xKfJbsLVzBYu+bf5NIHYNiStx
# plcGR7lXTH5Zl636z7mhI1e5z2VfoKdBoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IN/skQvhW6y/fewsEXi9UV7Ma5QpdRGt+cDA9cwOj+BLAhAe7N1fFhEpEczrVqe3
# qA38GA8yMDI0MDcyNDE5NDUzMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDUzMVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBKLm6SrftiBZ+jQMJ9V6JYs
# fkOJxcf6es4atRBpifRhMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAASlpnf6
# urJvCOxgI8+d5wh9iBUPhJhkSDde1OjEyo10L+AmE8e3SXshR8tg87qB+M0MHya/
# Z2PvByYxrgLy4nPZs8zbrIgLEbHDLHNykVC9LS5vRZonQr4J9+bVKNYz0kivqj8c
# NPFcOuWrGIfpCTvKUtT2FH9tRo2z4YfFIQSx4OjA6RpS5JZFLJwCAvgxc8E1nPKk
# NnASo30Z+2s0YqpEcBWRQGSFelyeTA5D98LovEZrxW79QS0KqkjOTZRp/E8ETM8E
# /HEuW2QWbLGbzaMChXbVd5StJ7v6mQhiAZM+iM8YhYoWCGXMR4qFN7GcCeWmERLN
# Q8wIZw+kXuzQZ1ECWZsILpnP7XdhhfxqtxZ2Ig+M3bE3yqIJcYPxkaozErDMaHLU
# TPOZhhaWa5Q+od95V+20vxiQCs7m5fI5HjWe4XFHGIydMf1hptS7bQtUWaloFyCm
# aBwHxoyddjRCeX29TMlI5K/ROLl4BgcMzwMNWodgbVFhLzQ+UCrp4OfRTDb3q5xd
# OUYGtzTlryXZNFYTcgpLTbZFwXDbX5rjipC6npVCyexjsGjdavcytBjHvD7Twk5K
# BEjcaG/9R0877v+oHcChK9ZyBjPhq6kpzyjDOWQJHb06LvTQRY5aNhIJktjEUfu/
# 8F+SBJCKiI00xbhKvH1d9zomVyfpGv+q4sIw
