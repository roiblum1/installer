...
ResourceAddressesInfo

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/rsrc-addrs/id/get/
#>
function Invoke-GetIdStatsRsrcAddrs {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/rsrc-addrs/id/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetIdStatsRsrcAddrs' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetIdStatsRsrcAddrs' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/rsrc-addrs/{id}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Id) {
                    throw "Error! The required parameter `Id` missing when calling getIdStatsRsrcAddrs."
                }
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "ResourceAddressesInfo"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ResourceAddressesInfo")
...
.PARAMETER Page
The ResourceAddresses.FilterSpec.page field is used to retrieve paged data for large result sets. It is an opaque paging token obtained from a prior call to the ResourceAddresses.list API. Warning: This attribute is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments. when set a follow up page in a paged result set will be delivered.
...
ResourceAddressesListResult

.LINK

Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/rsrc-addrs/get/
#>
function Invoke-ListStatsRsrcAddrs {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/rsrc-addrs/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListStatsRsrcAddrs' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListStatsRsrcAddrs' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/rsrc-addrs'
                $LocalVarMethod = 'GET'
                ...
                if ($null -ne $Resources) {
                    $LocalVarQueryParameters['resources'] = $Resources
                }
                ...
                $invokeParams = @{
                    ...
                    'FormParameters' = $LocalVarFormParameters
                    'CookieParameters' = $LocalVarCookieParameters
                    'ReturnType' = "ResourceAddressesListResult"
                    'IsBodyNullable' = $false
                    'Server' = $serverConfiguration
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "ResourceAddressesListResult")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3RoSraeq3FVXN
# uZOsqte/QCYexZk7/bbdrV6y1TLR06CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICDLiPruymMOEgQM
# +iVDWpYA7vzFX3z7eMxrZFu++5eoMA0GCSqGSIb3DQEBAQUABIICAJMZaRe19XOO
# fXsSGeEDr/X5u1LEGHzqF0dG+QHFxptxUqmKsnHtjYFvOPMJbm6+L5kP88v4yAs9
# BtrTqxl3KmZpvyvuWFWaY/BSBkm6SwabnUbGHo5TpAA3SkdFhnLOzPwbSkhBCIZH
# WWAWcp8p3LBtxpxKcLpPBhOB91pgRlNVV4//iPg3QKvIOoG6aLxupkUwsNt2Qnv9
# oFTQDMspidj4ecfSlWJ5k0mxlSVSDL8rOIeeLXWkhzpyV0qQitQGiSoOxWLQqx8I
# Z/uh3hnlsvXyheZg8HtjlzokkQRaexFNUDbEwIJxppXvVxwsMyV9+XFZpELHrU+G
# 1eC0Bn1UG8jpnyMySYeITlKcgXaiFKZmqxX8UE1cW8qguqW3YGe7NTy4OZ2W8cvd
# BenNjJQ2/BJesuEzgvw1/VpOh6PwHv9SA24SpZrbF7MRFvUlUeB2q8ZUr4X5lGuB
# XHHQHR4S+uo5UoBvFbOW2QTbpqngaqy/sQECUwzAkw2xPPue82cS6VgwTqGhFSF8
# zYGFQ/m0wDHwiNOlzA9FpGo7EpbGz31YPYZ1czy38WrfZYUtQ/dfnZZZ3mbkVQE9
# gN9CBP/B7iKtz9H9XKzCDK5JK0pjswVWS1btPPVnBlayvee6QZi3ewEAa8nNwL/2
# XQN5L46Cuh9HeVWeWFVQ7E5gOVB533hvoYIXPzCCFzsGCisGAQQBgjcDAwExghcr
...
# IKakuWEcHIADFSWxY15ZKzQLpBj1A9KpC9YaDLy401BlAhBKzuOyPWvCZ1EXSe/m
# z5r0GA8yMDI0MDcyNDE5NDUzMlqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85SdCDmm
...
# MQ8XDTI0MDcyNDE5NDUzMlowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLC
# yQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJavajjoab5GkZgWNxvW4vhN
# nTjnBgAHIIdkRKTL5VcAMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM
# 0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAAciBjPW
# xwHsk1Ukc6TF7+dHEiCm4G+IcozG3WyxYe5IZonzsmytzKJ9A5e/DQ868zxjFRxs
# WPpcrFWVPclZyExrbN9Vo5eSeV0aSwwSFYNhKhwut/Z2gbhXfBsd0CYWf17bvBZq
# 3RbrmWZsAUNBXeDPa1IfM/D9Fsw07LHffmPZbSKRPVLrqdYTxBdg8amC88+O4hdg
# e/ZJLSGXCDhL1HnddYQMtZSdqoqfwH7Anmpc2WvtUuXi1TB9Jx+8VfcES8yJR2pH
# ZfbIs1yuMRpkoVNeZMlHETolwLLbO3QML3/0Fi5FlUxmx5HzIT8v0SPSNmtBXLyf
# oe62Un9hkAp4jlkHDI07Nt83xYKLJR72RAKWGcizruJX6+paKw302PmkHZuYQPTB
# b5VIl4QCBG6WljyAbb0vGc3V2a50URly5YaIEFnhsMZlKhjtcujDP+3rC6mBm/DC
# 2Jn8qdkKwcnwpS7AnXvtPMNGzM/eDRE/NnA6Kn/3Ui4U+5QTbidfHzwbiO/G3ub6
# 5K4Q8bQ13oYXlZkXHIsaDz8GVfmMnmJdItSAi//SdfgZvZ0PdFsHkjxiWM2CdmKB
# fHQgvcbSrsV9Rld2hYrCGlJJzt71IK6ilaqPPpauZzjoz0xXmKnIynPYU0aIDBLr
# fBWIAbtOcWAsUOY0+NK0eAM5aE2Urtv7kv8d
