...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/default/get/
#>
function Invoke-GetCidCountersMetadataDefault {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/default/get/"
    )]
    Param (
    ...
    Process {
        'Calling method: Invoke-GetCidCountersMetadataDefault' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCidCountersMetadataDefault' on target server '$($serverConfiguration.ToString())'."
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/counters/{cid}/metadata/default'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cid) {
                    throw "Error! The required parameter `Cid` missing when calling getCidCountersMetadataDefault."
                }
                $LocalVarUri = $LocalVarUri.replace('{cid}', $Cid)
                $LocalVarPathParameters['cid'] = $Cid
                ...
                $invokeParams = @{
                    ...
                    'ReturnType' = "CounterMetadataInfo[]"
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        foreach ($element in $SingleServerResult["Response"]) {
                            $element.PSObject.TypeNames.Insert(0, "CounterMetadataInfo")
                        }
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/mid/get/
#>
function Invoke-GetCidMidCountersMetadata {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/mid/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
    ...
    Process {
        'Calling method: Invoke-GetCidMidCountersMetadata' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'GetCidMidCountersMetadata' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/counters/{cid}/metadata/{mid}'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cid) {
                    throw "Error! The required parameter `Cid` missing when calling getCidMidCountersMetadata."
                }
                $LocalVarUri = $LocalVarUri.replace('{cid}', $Cid)
                $LocalVarPathParameters['cid'] = $Cid
                if (!$Mid) {
                    throw "Error! The required parameter `Mid` missing when calling getCidMidCountersMetadata."
                }
                $LocalVarUri = $LocalVarUri.replace('{mid}', $Mid)
                $LocalVarPathParameters['mid'] = $Mid
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
                    $addTransformationInput = Format-PathParams -OperationTranslateSchema $translationSchema -PathParams $LocalVarPathParameters
                    Join-InputTransformationStructure -Base ([ref]$transformedOpertaionInput) -Addition $addTransformationInput
                }
                ...
                $invokeResult | Foreach-Object {
                    ...
                    if ($SingleServerResult -is [hashtable]) {
                        ...
                        $SingleServerResult["Response"].PSObject.TypeNames.Insert(0, "CounterMetadataInfo")
...
.PARAMETER Status
Counter edition status. Warning: This attribute is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments. When unset no filtering on counter metadata status will be made.
...
Online Version: https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/get/
#>
function Invoke-ListCidCountersMetadata {
    [CmdletBinding(
        SupportsShouldProcess = $true,
        ConfirmImpact = 'None',
        HelpURI = "https://developer.vmware.com/docs/vsphere-automation/latest/vstats/api/stats/counters/cid/metadata/get/"
    )]
    Param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true)]
        [ValidateScript({ $_ -is [string] })]
        ...
        [ValidateSet("DEFAULT", "CURRENT", "DEPRECATED", "EXPERIMENTAL", "REMOVED")]
        ${Status},
        [Parameter()]
        [vSphereConnectionToServerConfigurationArgumentTransformationAttribute()]
        [PSTypeName('vSphereServerConfiguration')]
    ...
    Process {
        'Calling method: Invoke-ListCidCountersMetadata' | Write-Debug
        ...
        foreach ($serverConfiguration in $serversToProcess) {
            $shouldProcessActionMessage = "Performing the operation 'ListCidCountersMetadata' on target server '$($serverConfiguration.ToString())'."
            $shouldProcessActionCaption = 'Are you sure you want to perform this action?'
            ...
            if ($PSCmdlet.ShouldProcess(
                ...
                $LocalVarUri = '/api/stats/counters/{cid}/metadata'
                $LocalVarMethod = 'GET'
                ...
                if (!$Cid) {
                    throw "Error! The required parameter `Cid` missing when calling listCidCountersMetadata."
                }
                $LocalVarUri = $LocalVarUri.replace('{cid}', $Cid)
                $LocalVarPathParameters['cid'] = $Cid
                if ($useDeprecatedApis -and ($null -ne $translationSchema)) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCApSt1g6jhUjiq/
# 2f23Qo8KqDyf93CUlRsqZz/UxNP3kaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF7/9dFUuoQskNSI
# xrROGLpfG4Vv/Lv2eLoSz8juwOpnMA0GCSqGSIb3DQEBAQUABIICAItXIFYmz63a
# wEBXbpEuTURB7cFCZGQKnT2mK0aLdrYFfjx68ZE9bKv4tz8T1c32dtCvHOx9+p/z
# 8qUd0lsEj6AORnMjwPT1na5Oe3sROWXyndkFW6IK+10mdlwsyjY/dwDw5png6B4w
# 5EDiaKNC3sZu2szTH8okyinb/9gOQWHLoaBmVncTLFNE6JiR9VleKtqVoh9vQDiU
