...
class CertificateInfo {
    ...
    [string] ToString() {
        return "Certificate [$($this.Subject)]"
    }
}
...
class ViMachineCertificateInfo : CertificateInfo {
    [object] $Entity
    [CertificateEntityType] $EntityType

    [string] ToString() {
        return "Certificate [$($this.EntityType)/$($this.EntityName) - $($this.Subject)]"
    }
}

class TrustedCertificateInfo : CertificateInfo {
    [string] $Uid
    [object] $TrustedByEntity
    [CertificateEntityType] $EntityType
}
...
class ViMachineCertificateRequestInfo : CertificateRequestInfo {
   [object] $Entity
   [CertificateEntityType] $EntityType

   [string] ToString() {
       return "Certificate request [$($this.EntityType)/$($this.EntityName)]"
   }
}
# SIG # Begin signature block
# MIIpiAYJKoZIhvcNAQcCoIIpeTCCKXUCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAYgumD9du8PNMR
# XAP76Yv0JR2DXX1ItshC4cIIFN/4vqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOZ4Iir7zGxu53+2
# BGpFCVLsNRoLYRzmaW+PULp9XWURMA0GCSqGSIb3DQEBAQUABIICAK00K22fpG1+
# e41H8HFnE2FvmF0a0szTiydTH+VkRcBMN14qVWqOSzPjg6NQLtmJsxm8wMAlBlEA
# K0KyPYTvavyxR/3LyoaGQxgUb0N5xWGt+/ECbeTCN+V3n62NG/nFzLfWhfl+HJmn
# kaYb9YFXOTfW3xtdaH0Dyebhm5w9M6aRPokq5hOwowpl+aR27zbUUZdaQg7JQ8re
# 4p+RdasJS/op3x1ofuKkZoPnrRjHTjRg9psPse/jiaPMW6TJxYvYbRCcWl/lu2qz
# OkYnpOcLog7NH1H+Iv7nRAmoVmjjFg0LCH/Hc+zrayIO2iACSXjZs5MoL4N0vi3r
# mJQBeQtjyUBxOiPN6qGoKmIrBtfpgCEZD/qkc8fxhbnoqChCRUKLyLdqEBolXL2D
# XYvBGCA/eFsLfojIv1jp4NIgZcJHwB+M/qUq7RVXynAjS2FIGfnDWR+d0NkO0eMj
# F3N56BlNCampIwcFHLkO9sLxF81K3x+R4X0whdThAbpPMS7Ac6lZCzc+5PVPLNjF
# KOkILYS67UvnBbtXhkSTxEmjE7lYSvfWtqZHcroHflYXLWftF6cf0Axm1gnSPC0P
# lK85TZDaS6tErWtwZpudhAeQB+uTEtkiMP6UKDYgQGg5J6IFCGoJ03FyV1YajAKm
# vSrqCUxGBe35x/QDTxil0h+ITdt80J+loYIXQDCCFzwGCisGAQQBgjcDAwExghcs
...
# ILrfl5vk9CRY5E1b7gb4zgav0iUc9hobORouzjBVKSGZAhEA8PyXi6RO969Mmenq
# /pbN+hgPMjAyNDA3MjQxOTQ5NDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OUnQg5
...
# BTEPFw0yNDA3MjQxOTQ5NDJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbwKzLC
# wskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCoStzp8r+wqt8znJwNnOUi
# OlsV5nC7AwzDFJY3KrbSGjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt7XQi
# zNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCZ+0Ce
# fi3N1gUIIfCPPPeJ0E+kVewjX/4jMK6tI5hfTR/noselcSA1MPE5e8xwlFMqT7sl
# 55GRX6oqNkj8oKWotIlH7+h8jtweBQUx1hGUWjZAbxuIVoZRRQVywN78jHqwT7Lc
# DIPpD9pGWgAW4Co9ugbBllyTXGsThLw4Db4UNjWou5a28lffnHW+oUnSA7YRLxpc
# 1Al1jvqew1F5xlGHfUL57NS16721oALS9WIFK6YvdW2CQQCcW/HCbvN+CPuvZ4p0
# wqyO6C0Ft0WTO35PtIKeyw7pNxjY+M80FxD7KL/TMA4gRTWV3pCZolMtcuBofsXr
# rmuE2+87RhNFGNKJnPJNV1K4V+71yf4VeXMSrywcwnz+Xu42kOQs8GsNwt7D19Jb
# Edn0DeRFMNOup6siJmMmBZTh40hrXxhTlLzxuNjFgyBhp/t9dUB8KBccI/6nLWsZ
# MD3PDL6p084kTWut0ZuXeKfaLvfwaXTsYoGP4wsyn66eDiDKmkShBlj6sfRwCNfG
# 4nWB2bpv4krtB0XL/xgJI55y/Pa6xLnAHW1eAAAc4cVjXX8eIYHkW3+ob+daBQ4v
# UA0fTQ6Uzmg2oelcq/xvMiGHMeur1MocizhCWf4xzlYjV4UoCOY/RLXkTHfeetd3
# eLZ3mtE6VHlrRw213vvTnIl+2P0DNFisolBInA==
